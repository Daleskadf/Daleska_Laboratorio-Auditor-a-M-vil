...
public final class Z extends AbstractC0797y {
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [R3.Z, com.google.crypto.tink.shaded.protobuf.y] */
    static {
        ?? abstractC0797y = new AbstractC0797y();
        DEFAULT_INSTANCE = abstractC0797y;
        AbstractC0797y.v(Z.class, abstractC0797y);
    }
    ...
    public static Z B(AbstractC0781h abstractC0781h, C0787n c0787n) {
        return (Z) AbstractC0797y.t(DEFAULT_INSTANCE, abstractC0781h, c0787n);
    }

    public static void y(Z z7) {
        z7.keySize_ = 64;
    }
    ...
    public final Object k(EnumC0796x enumC0796x) {
        switch (X.f4745a[enumC0796x.ordinal()]) {
            case 1:
