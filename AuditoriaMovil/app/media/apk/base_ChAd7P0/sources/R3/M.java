...
public final class M extends AbstractC0797y {
    ...
    /* JADX WARN: Type inference failed for: r0v0, types: [R3.M, com.google.crypto.tink.shaded.protobuf.y] */
    static {
        ?? abstractC0797y = new AbstractC0797y();
        DEFAULT_INSTANCE = abstractC0797y;
        AbstractC0797y.v(M.class, abstractC0797y);
    }
    ...
    public static M B(AbstractC0781h abstractC0781h, C0787n c0787n) {
        return (M) AbstractC0797y.t(DEFAULT_INSTANCE, abstractC0781h, c0787n);
    }

    public static void y(M m7, int i7) {
        m7.keySize_ = i7;
    }
    ...
    public final Object k(EnumC0796x enumC0796x) {
        switch (K.f4737a[enumC0796x.ordinal()]) {
            case 1:
                return new AbstractC0797y();
            case 2:
                return new AbstractC0794v(DEFAULT_INSTANCE);
            case 3:
                return new com.google.crypto.tink.shaded.protobuf.f0(DEFAULT_INSTANCE, "\u0000\u0002\u0000\u0000\u0002\u0003\u0002\u0000\u0000\u0000\u0002\u000b\u0003\u000b", new Object[]{"keySize_", "version_"});
            case 4:
