...
public final class C0307m0 extends AbstractC0797y {
    private static final C0307m0 DEFAULT_INSTANCE;
    ...
    static {
        C0307m0 c0307m0 = new C0307m0();
        DEFAULT_INSTANCE = c0307m0;
        AbstractC0797y.v(C0307m0.class, c0307m0);
    }

    public static void A(C0307m0 c0307m0, C0780g c0780g) {
        c0307m0.getClass();
        c0307m0.keyValue_ = c0780g;
    }

    public static C0307m0 B() {
        return DEFAULT_INSTANCE;
    }

    public static C0305l0 F() {
        return (C0305l0) DEFAULT_INSTANCE.j();
    }

    public static C0307m0 G(AbstractC0781h abstractC0781h, C0787n c0787n) {
        return (C0307m0) AbstractC0797y.t(DEFAULT_INSTANCE, abstractC0781h, c0787n);
    }

    public static void y(C0307m0 c0307m0) {
        c0307m0.version_ = 0;
    }

    public static void z(C0307m0 c0307m0, C0318s0 c0318s0) {
        c0307m0.getClass();
        c0318s0.getClass();
        c0307m0.params_ = c0318s0;
    }
    ...
    public final Object k(EnumC0796x enumC0796x) {
        switch (AbstractC0303k0.f4757a[enumC0796x.ordinal()]) {
            case 1:
                return new C0307m0();
            case 2:
