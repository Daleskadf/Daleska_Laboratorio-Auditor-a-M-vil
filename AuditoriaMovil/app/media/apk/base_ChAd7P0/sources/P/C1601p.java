...
public final class C1601p extends ImageButton {

    /* renamed from: a  reason: collision with root package name */
    public final h1.t f14858a;

    /* renamed from: b  reason: collision with root package name */
    public final A3.N f14859b;

    /* renamed from: c  reason: collision with root package name */
    public boolean f14860c;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C1601p(Context context) {
        ...
        this.f14858a = tVar;
        tVar.o(null, R.attr.toolbarNavigationButtonStyle);
        A3.N n7 = new A3.N(this);
        this.f14859b = n7;
        n7.j(R.attr.toolbarNavigationButtonStyle);
    }

    @Override // android.widget.ImageView, android.view.View
    public final void drawableStateChanged() {
        super.drawableStateChanged();
        h1.t tVar = this.f14858a;
        if (tVar != null) {
            tVar.l();
        }
        A3.N n7 = this.f14859b;
        if (n7 != null) {
            n7.c();
        }
    }
    ...
    public final boolean hasOverlappingRendering() {
        if (!(((ImageView) this.f14859b.f105c).getBackground() instanceof RippleDrawable) && super.hasOverlappingRendering()) {
            return true;
        }
        return false;
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        A3.N n7 = this.f14859b;
        if (n7 != null && drawable != null && !this.f14860c) {
