...
final class zzcd implements InterfaceC1084d {
    ...
    static {
        ...
        zzc = new C1083c("isColdCall", Y.n(hashMap2));
        zzai i9 = Y.i(3);
        ...
        zze = new C1083c("detectorOptions", Y.n(hashMap4));
        zzai i11 = Y.i(5);
        HashMap hashMap5 = new HashMap();
        hashMap5.put(i11.annotationType(), i11);
        zzf = new C1083c("contourDetectedFaces", Y.n(hashMap5));
        zzai i12 = Y.i(6);
        HashMap hashMap6 = new HashMap();
        hashMap6.put(i12.annotationType(), i12);
        zzg = new C1083c("nonContourDetectedFaces", Y.n(hashMap6));
    }
