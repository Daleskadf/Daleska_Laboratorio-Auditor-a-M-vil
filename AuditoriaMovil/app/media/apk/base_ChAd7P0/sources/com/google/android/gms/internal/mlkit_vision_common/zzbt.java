...
final class zzbt implements InterfaceC1084d {
    ...
    static {
        ...
        zzf = new C1083c("modelNamespace", Y.n(hashMap5));
        zzai i12 = Y.i(6);
        HashMap hashMap6 = new HashMap();
        hashMap6.put(i12.annotationType(), i12);
        zzg = new C1083c("delegateFilter", Y.n(hashMap6));
        zzai i13 = Y.i(7);
        HashMap hashMap7 = new HashMap();
        hashMap7.put(i13.annotationType(), i13);
        zzh = new C1083c("httpResponseCode", Y.n(hashMap7));
    }
