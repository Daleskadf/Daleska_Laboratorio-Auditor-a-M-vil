...
public abstract class zzaz extends zzaw implements List, RandomAccess {
    ...
    public static zzaz zzg(Object[] objArr, int i7) {
        if (i7 == 0) {
            return zzbc.zza;
        }
        return new zzbc(objArr, i7);
    }
            ...
            if (size == list.size()) {
                if (list instanceof RandomAccess) {
                    for (int i7 = 0; i7 < size; i7++) {
                        if (zzar.zza(get(i7), list.get(i7))) {
                        }
                    }
                    return true;
                }
    ...
    @Override // java.util.List
    /* renamed from: zzh */
    public final zzbg listIterator(int i7) {
        zzas.zzb(i7, size(), "index");
        if (isEmpty()) {
            return zza;
        }
        return new zzax(this, i7);
    }
}
