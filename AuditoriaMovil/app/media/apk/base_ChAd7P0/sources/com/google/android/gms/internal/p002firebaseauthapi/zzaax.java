...
public final class zzaax implements zzaew<zzahs> {
    ...
    public final /* synthetic */ void zza(zzahs zzahsVar) {
        ...
        if (zzahpVar instanceof zzaht) {
            ...
            throw new IllegalArgumentException(AbstractC0059i.M("startMfaEnrollmentRequest must be an instance of either StartPhoneMfaEnrollmentRequest or StartTotpMfaEnrollmentRequest but was ", this.zza.getClass().getName(), "."));
        }
    }
}
