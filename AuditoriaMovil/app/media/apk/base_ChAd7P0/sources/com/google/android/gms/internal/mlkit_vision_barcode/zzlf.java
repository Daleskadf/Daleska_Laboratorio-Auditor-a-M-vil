...
final class zzlf implements InterfaceC1084d {
    ...
    static {
        ...
        zzd = new C1083c("detectedBarcodeFormats", Y.n(hashMap3));
        zzfe g9 = Y.g(4);
        HashMap hashMap4 = new HashMap();
        hashMap4.put(g9.annotationType(), g9);
        zze = new C1083c("detectedBarcodeValueTypes", Y.n(hashMap4));
        zzfe g10 = Y.g(5);
        HashMap hashMap5 = new HashMap();
        hashMap5.put(g10.annotationType(), g10);
        zzf = new C1083c("imageInfo", Y.n(hashMap5));
    }
    ...
    public final /* bridge */ /* synthetic */ void encode(Object obj, Object obj2) {
        ...
        interfaceC1085e.add(zzb, zzrrVar.zzd());
        interfaceC1085e.add(zzc, zzrrVar.zze());
        interfaceC1085e.add(zzd, zzrrVar.zza());
        interfaceC1085e.add(zze, zzrrVar.zzb());
        interfaceC1085e.add(zzf, zzrrVar.zzc());
    }
}
