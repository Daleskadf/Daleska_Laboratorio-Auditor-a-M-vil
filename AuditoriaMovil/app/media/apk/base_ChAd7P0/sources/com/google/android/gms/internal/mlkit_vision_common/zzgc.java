...
final class zzgc implements InterfaceC1084d {
    ...
    static {
        ...
        zzc = new C1083c("imageInfo", Y.n(hashMap2));
        zzai i9 = Y.i(3);
        HashMap hashMap3 = new HashMap();
        hashMap3.put(i9.annotationType(), i9);
        zzd = new C1083c("detectorOptions", Y.n(hashMap3));
        zzai i10 = Y.i(4);
        HashMap hashMap4 = new HashMap();
        hashMap4.put(i10.annotationType(), i10);
        zze = new C1083c("loadDurationMs", Y.n(hashMap4));
        zzai i11 = Y.i(5);
        HashMap hashMap5 = new HashMap();
        hashMap5.put(i11.annotationType(), i11);
        zzf = new C1083c("sessionDurationMs", Y.n(hashMap5));
        zzai i12 = Y.i(6);
        HashMap hashMap6 = new HashMap();
        hashMap6.put(i12.annotationType(), i12);
        zzg = new C1083c("sessionTotalInferenceDurationMs", Y.n(hashMap6));
    }
