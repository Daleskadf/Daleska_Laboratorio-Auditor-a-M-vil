...
final class zzfu implements InterfaceC1084d {
    ...
    static {
        ...
        zzd = new C1083c("identifyLanguageResult", Y.n(hashMap3));
        zzai i10 = Y.i(4);
        HashMap hashMap4 = new HashMap();
        hashMap4.put(i10.annotationType(), i10);
        zze = new C1083c("identifyPossibleLanguagesResult", Y.n(hashMap4));
    }
