...
public abstract class zzev<MessageType extends zzev<MessageType, BuilderType>, BuilderType extends zzet<MessageType, BuilderType>> extends zzdq<MessageType, BuilderType> {
    ...
    */
    ...
    private static zzev zzo(zzev zzevVar, byte[] bArr, int i7, int i8, zzel zzelVar) {
        zzev zzc = zzevVar.zzc();
        try {
            zzgi zzb2 = zzgf.zza().zzb(zzc.getClass());
            zzb2.zzg(zzc, bArr, 0, i8, new zzdt(zzelVar));
            zzb2.zze(zzc);
            return zzc;
        } catch (zzfb e7) {
            e7.zze(zzc);
            ...
            if (e9.getCause() instanceof zzfb) {
                throw ((zzfb) e9.getCause());
            }
            zzfb zzfbVar = new zzfb(e9);
            zzfbVar.zze(zzc);
            throw zzfbVar;
