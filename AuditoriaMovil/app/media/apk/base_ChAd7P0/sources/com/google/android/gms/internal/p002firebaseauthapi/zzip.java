...
public final class zzip {
    ...
    public static zzio zza(zzit zzitVar, Integer num) {
        zza(zzitVar);
    ...
    private static void zza(zzit zzitVar) {
        if (zzitVar.zzb() != 64) {
            throw new InvalidAlgorithmParameterException(b.f("invalid key size: ", zzitVar.zzb(), ". Valid keys must have 64 bytes."));
        }
    }
}
