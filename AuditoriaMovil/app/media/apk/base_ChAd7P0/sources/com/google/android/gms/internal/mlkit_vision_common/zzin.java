...
public final class zzin {
    ...
    public final zzin zzb(Long l8) {
        this.zza = Long.valueOf(l8.longValue() & Long.MAX_VALUE);
        return this;
    }

    public final zzin zzc(Integer num) {
        this.zzd = Integer.valueOf(num.intValue() & f.API_PRIORITY_OTHER);
        return this;
    }
    ...
    public final zzin zze(Integer num) {
        this.zzf = Integer.valueOf(num.intValue() & f.API_PRIORITY_OTHER);
        return this;
    }
    ...
    public final zzin zzg(Integer num) {
        this.zze = Integer.valueOf(num.intValue() & f.API_PRIORITY_OTHER);
        return this;
    }

    public final zzin zzh(Integer num) {
        this.zzg = Integer.valueOf(num.intValue() & f.API_PRIORITY_OTHER);
        return this;
    }
