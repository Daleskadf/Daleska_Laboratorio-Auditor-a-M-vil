...
public final class zzjw {
    ...
    public static zzjx zzc(zzpn zzpnVar, zzcm zzcmVar) {
        ...
        throw new IllegalArgumentException(b.h("Wrong type URL in call to HpkeProtoSerialization.parsePrivateKey: ", zzpnVar.zzf()));
    }
    ...
    public static zzkf zzd(zzpn zzpnVar, zzcm zzcmVar) {
        ...
        throw new IllegalArgumentException(b.h("Wrong type URL in call to HpkeProtoSerialization.parsePublicKey: ", zzpnVar.zzf()));
    }
    ...
    public static zzju zzb(zzpm zzpmVar) {
        ...
        throw new IllegalArgumentException(b.h("Wrong type URL in call to HpkeProtoSerialization.parseParameters: ", zzpmVar.zza().zzf()));
    }
