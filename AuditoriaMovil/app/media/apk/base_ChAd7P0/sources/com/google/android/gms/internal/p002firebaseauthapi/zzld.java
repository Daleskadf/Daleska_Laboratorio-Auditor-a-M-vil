...
public final class zzld {
    ...
    public static zzjt zzc(zzpn zzpnVar, zzcm zzcmVar) {
        ...
        throw new IllegalArgumentException(b.h("Wrong type URL in call to EciesProtoSerialization.parsePrivateKey: ", zzpnVar.zzf()));
    }
    ...
    public static zzjs zzd(zzpn zzpnVar, zzcm zzcmVar) {
        ...
        throw new IllegalArgumentException(b.h("Wrong type URL in call to EciesProtoSerialization.parsePublicKey: ", zzpnVar.zzf()));
    }
    ...
    public static zzjq zzb(zzpm zzpmVar) {
        ...
        throw new IllegalArgumentException(b.h("Wrong type URL in call to EciesProtoSerialization.parseParameters: ", zzpmVar.zza().zzf()));
    }
