...
final class zzka implements InterfaceC1084d {
    ...
    static {
        ...
        zzb = new C1083c("maxMs", Y.n(hashMap));
        zzfe g4 = Y.g(2);
        HashMap hashMap2 = new HashMap();
        hashMap2.put(g4.annotationType(), g4);
        zzc = new C1083c("minMs", Y.n(hashMap2));
        zzfe g8 = Y.g(3);
        HashMap hashMap3 = new HashMap();
        hashMap3.put(g8.annotationType(), g8);
        zzd = new C1083c("avgMs", Y.n(hashMap3));
        zzfe g9 = Y.g(4);
        HashMap hashMap4 = new HashMap();
        hashMap4.put(g9.annotationType(), g9);
        zze = new C1083c("firstQuartileMs", Y.n(hashMap4));
        zzfe g10 = Y.g(5);
        HashMap hashMap5 = new HashMap();
        hashMap5.put(g10.annotationType(), g10);
        zzf = new C1083c("medianMs", Y.n(hashMap5));
        zzfe g11 = Y.g(6);
        HashMap hashMap6 = new HashMap();
        hashMap6.put(g11.annotationType(), g11);
        zzg = new C1083c("thirdQuartileMs", Y.n(hashMap6));
    }
    ...
    public final /* bridge */ /* synthetic */ void encode(Object obj, Object obj2) {
        ...
        interfaceC1085e.add(zzb, zzqdVar.zzc());
        interfaceC1085e.add(zzc, zzqdVar.zze());
        interfaceC1085e.add(zzd, zzqdVar.zza());
        interfaceC1085e.add(zze, zzqdVar.zzb());
        interfaceC1085e.add(zzf, zzqdVar.zzd());
        interfaceC1085e.add(zzg, zzqdVar.zzf());
    }
}
