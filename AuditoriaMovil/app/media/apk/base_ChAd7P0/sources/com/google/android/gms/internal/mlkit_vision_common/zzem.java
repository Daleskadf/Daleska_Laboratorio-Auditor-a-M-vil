...
final class zzem implements InterfaceC1084d {
    ...
    static {
        ...
        zzb = new C1083c("identifyLanguageConfidenceThreshold", Y.n(hashMap));
        zzai i8 = Y.i(2);
        HashMap hashMap2 = new HashMap();
        hashMap2.put(i8.annotationType(), i8);
        zzc = new C1083c("identifyAllLanguagesConfidenceThreshold", Y.n(hashMap2));
        zzai i9 = Y.i(3);
        HashMap hashMap3 = new HashMap();
        hashMap3.put(i9.annotationType(), i9);
        zzd = new C1083c("confidenceThreshold", Y.n(hashMap3));
    }
