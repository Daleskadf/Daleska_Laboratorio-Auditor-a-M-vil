...
public class FieldNameMappingFilter extends MetadataFilter {
    ...
    @Field
    public void setExcludeUnmapped(boolean z7) {
        this.excludeUnmapped = z7;
    }
    ...
    public String toString() {
        ...
        boolean z7 = this.excludeUnmapped;
        return "FieldNameMappingFilter{mappings=" + map + ", excludeUnmapped=" + z7 + "}";
    }
}
