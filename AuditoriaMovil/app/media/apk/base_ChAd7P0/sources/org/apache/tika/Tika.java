...
public class Tika {
    ...
    public void setMaxStringLength(int i7) {
    ...
    public String translate(String str, String str2, String str3) {
        try {
            ...
            throw new IllegalStateException("Error translating data.", e7);
        }
    }

    public String parseToString(InputStream inputStream, Metadata metadata, int i7) {
        WriteOutContentHandler writeOutContentHandler = new WriteOutContentHandler(i7);
        ParseContext parseContext = new ParseContext();
        parseContext.set(Parser.class, this.parser);
        try {
            ...
            if (!WriteLimitReachedException.isWriteLimitReached(e7)) {
                throw new TikaException("Unexpected SAX processing failure", e7);
            }
        }
    ...
    public String detect(byte[] bArr, String str) {
        try {
            ...
            throw new IllegalStateException("Unexpected IOException", e7);
        }
    }
