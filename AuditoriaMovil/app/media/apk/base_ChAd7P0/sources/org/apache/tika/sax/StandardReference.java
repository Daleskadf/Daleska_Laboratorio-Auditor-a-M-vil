...
public class StandardReference {
    ...
    public static class StandardReferenceBuilder {
        ...
        public StandardReferenceBuilder setScore(double d7) {
            this.score = d7;
            return this;
        }
    ...
    public /* synthetic */ StandardReference(String str, String str2, String str3, String str4, double d7, int i7) {
        this(str, str2, str3, str4, d7);
    }
    ...
    public String toString() {
        ...
        if (str2 != null && !str2.isEmpty()) {
            str = AbstractC0059i.A(str, this.separator, this.secondOrganization);
        }
        return AbstractC0059i.A(str, StringUtils.SPACE, this.identifier);
    }

    private StandardReference(String str, String str2, String str3, String str4, double d7) {
        this.mainOrganization = str;
        this.separator = str2;
