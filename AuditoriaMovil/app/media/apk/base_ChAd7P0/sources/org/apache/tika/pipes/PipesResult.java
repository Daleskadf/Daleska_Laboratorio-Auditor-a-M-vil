...
public class PipesResult {
    ...
    private PipesResult(STATUS status, EmitData emitData, String str, boolean z7) {
        this.status = status;
    ...
    public String toString() {
        ...
        return "PipesResult{intermediate=" + z7 + ", status=" + status + ", emitData=" + emitData + ", message='" + str + "'}";
    }
    ...
    public PipesResult(STATUS status, EmitData emitData, boolean z7) {
        this(status, emitData, null, z7);
    }
