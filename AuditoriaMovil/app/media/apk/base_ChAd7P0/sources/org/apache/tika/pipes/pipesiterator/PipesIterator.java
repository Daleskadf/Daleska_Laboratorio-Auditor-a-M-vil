...
public abstract class PipesIterator extends ConfigBase implements Callable<Integer>, Iterable<FetchEmitTuple>, Initializable {
    ...
    public class TupleIterator implements Iterator<FetchEmitTuple> {
        ...
        public /* synthetic */ TupleIterator(PipesIterator pipesIterator, int i7) {
            this();
        }
        ...
        private FetchEmitTuple pollNext() {
            ...
            try {
                ...
                if (fetchEmitTuple == null) {
                    long j = PipesIterator.this.maxWaitMs;
                    throw new TikaTimeoutException("waited longer than " + j + "ms for the next tuple");
                }
                return fetchEmitTuple;
            } catch (InterruptedException unused) {
                PipesIterator.LOGGER.l("interrupted");
    ...
    public void setOnParseException(String str) {
        if ("skip".equalsIgnoreCase(str)) {
            ...
            throw new TikaConfigException(io.flutter.plugins.pathprovider.b.h("must be either 'skip' or 'emit': ", str));
        }
    }
