...
public class FileSystemPipesIterator extends PipesIterator implements TotalCounter, Initializable, Closeable {
    ...
    public static class FileCountWorker implements TotalCounter, Closeable {
        ...
        public static class FSFileCounter implements FileVisitor<Path> {
            ...
            public /* synthetic */ FSFileCounter(AtomicLong atomicLong, int i7) {
                this(atomicLong);
            }
        ...
        public /* synthetic */ void lambda$startTotalCount$0() {
            try {
                ...
                FileSystemPipesIterator.LOG.g("problem counting files", e7);
    ...
    public void enqueue() {
        ...
        if (isDirectory) {
            try {
                Files.walkFileTree(this.basePath, new FSFileVisitor(this, getFetcherName(), getEmitterName(), 0));
                return;
            } catch (IOException e7) {
    ...
    @Field
    public void setCountTotal(boolean z7) {
        this.countTotal = z7;
    }
