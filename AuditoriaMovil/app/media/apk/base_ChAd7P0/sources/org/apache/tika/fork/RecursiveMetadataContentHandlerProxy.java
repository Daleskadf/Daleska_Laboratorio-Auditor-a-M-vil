...
class RecursiveMetadataContentHandlerProxy extends RecursiveParserWrapperHandler implements ForkProxy {
    ...
    public RecursiveMetadataContentHandlerProxy(int i7, ContentHandlerFactory contentHandlerFactory) {
    ...
    private void proxyBackToClient(int i7, ContentHandler contentHandler, Metadata metadata) {
        boolean z7;
        byte[] bArr;
        try {
            try {
