...
public final class U3 extends AbstractC1266i0 {
    ...
    final Spliterator P(AbstractC1230b abstractC1230b, Spliterator spliterator) {
        if (EnumC1239c3.ORDERED.t(abstractC1230b.K())) {
            return O(abstractC1230b, spliterator, new C1233b2(8)).spliterator();
        }
        return new h4((j$.util.c0) abstractC1230b.X(spliterator), 1);
    }
    ...
    public final InterfaceC1298o2 R(int i7, InterfaceC1298o2 interfaceC1298o2) {
        return new T3(this, interfaceC1298o2);
    }
}
