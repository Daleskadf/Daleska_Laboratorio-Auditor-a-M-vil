...
public interface Stream<T> extends InterfaceC1260h {
    ...
    public final /* synthetic */ class Wrapper implements java.util.stream.Stream {
        ...
        public static /* synthetic */ java.util.stream.Stream convert(Stream stream) {
            ...
            return stream instanceof Z2 ? ((Z2) stream).f13188a : new Wrapper();
        }
        ...
        public final /* synthetic */ Object collect(Collector collector) {
            return Stream.this.h(C1270j.a(collector));
        }
        ...
        public final /* synthetic */ Optional findAny() {
            return AbstractC1210d.m(Stream.this.findAny());
        }

        @Override // java.util.stream.Stream
        public final /* synthetic */ Optional findFirst() {
            return AbstractC1210d.m(Stream.this.findFirst());
        }

        @Override // java.util.stream.Stream
        public final /* synthetic */ java.util.stream.Stream flatMap(Function function) {
            return convert(Stream.this.d(AbstractC1340x0.R(function)));
        }

        @Override // java.util.stream.Stream
        public final /* synthetic */ DoubleStream flatMapToDouble(Function function) {
            return D.k(Stream.this.z(AbstractC1340x0.R(function)));
        }

        @Override // java.util.stream.Stream
        public final /* synthetic */ java.util.stream.IntStream flatMapToInt(Function function) {
            return IntStream.Wrapper.convert(Stream.this.t(AbstractC1340x0.R(function)));
        }

        @Override // java.util.stream.Stream
        public final /* synthetic */ LongStream flatMapToLong(Function function) {
            return C1281l0.k(Stream.this.o(AbstractC1340x0.R(function)));
        }
        ...
        public final /* synthetic */ DoubleStream mapToDouble(ToDoubleFunction toDoubleFunction) {
            return D.k(Stream.this.mapToDouble(toDoubleFunction));
        }
        ...
        public final /* synthetic */ LongStream mapToLong(ToLongFunction toLongFunction) {
            return C1281l0.k(Stream.this.mapToLong(toLongFunction));
        }

        @Override // java.util.stream.Stream
        public final /* synthetic */ Optional max(Comparator comparator) {
            return AbstractC1210d.m(Stream.this.max(comparator));
        }

        @Override // java.util.stream.Stream
        public final /* synthetic */ Optional min(Comparator comparator) {
            return AbstractC1210d.m(Stream.this.min(comparator));
        }
        ...
        public final /* synthetic */ BaseStream onClose(Runnable runnable) {
            return C1255g.k(Stream.this.onClose(runnable));
        }

        @Override // java.util.stream.BaseStream
        public final /* synthetic */ BaseStream parallel() {
            return C1255g.k(Stream.this.parallel());
        }
        ...
        public final /* synthetic */ Optional reduce(BinaryOperator binaryOperator) {
            return AbstractC1210d.m(Stream.this.reduce(binaryOperator));
        }

        @Override // java.util.stream.BaseStream
        public final /* synthetic */ BaseStream sequential() {
            return C1255g.k(Stream.this.sequential());
        }
        ...
        public final /* synthetic */ BaseStream unordered() {
            return C1255g.k(Stream.this.unordered());
        }
    }
    ...
    InterfaceC1286m0 mapToLong(ToLongFunction toLongFunction);
    ...
    InterfaceC1286m0 o(C1225a c1225a);
