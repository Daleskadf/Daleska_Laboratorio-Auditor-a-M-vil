...
public class GestureListener implements GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener, ScaleGestureDetector.OnScaleGestureListener {
    ...
    public boolean endTwoFingerGesture() {
        ...
        Objects.requireNonNull(this.mCompanionView);
        if (multitouchMode != 2) {
            return true;
        }
    ...
    */
    public boolean onScroll(android.view.MotionEvent r30, android.view.MotionEvent r31, float r32, float r33) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.adobe.air.wand.view.GestureListener.onScroll(android.view.MotionEvent, android.view.MotionEvent, float, float):boolean");
    }
    ...
    public boolean onScale(ScaleGestureDetector scaleGestureDetector) {
        ...
        if (previousSpan != 0.0d) {
            ...
            if (z || (abs * 25.399999618530273d) / screenPPI > 8.0d) {
                ...
                this.mCompanionView.onGestureListener(i, 0, true, focusX, focusY, f, f2, 0.0f, 0.0f, 0.0f);
                return true;
            }
            return false;
        }
