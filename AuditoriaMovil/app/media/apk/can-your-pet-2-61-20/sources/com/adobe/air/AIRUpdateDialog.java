...
public class AIRUpdateDialog extends Activity {
    ...
    private final String RUNTIME_PACKAGE_ID = BuildConfig.LIBRARY_PACKAGE_NAME;
    ...
    public void onCreate(Bundle bundle) {
        ...
        AlertDialog create = new AlertDialog.Builder(this).setTitle(AndroidConstants.ADOBE_AIR).setMessage(AndroidLocale.GetLocalizedString(AndroidLocale.STRING_ID.IDA_RUNTIME_UPDATE_MESSAGE)).create();
        this.alertDialog = create;
        create.setButton(-1, AndroidLocale.GetLocalizedString(AndroidLocale.STRING_ID.IDA_UPDATE), new DialogInterface.OnClickListener() { // from class: com.adobe.air.AIRUpdateDialog.1
