...
public class AIRStage3DSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public boolean setFPInstance(Context context, AndroidActivityWrapper androidActivityWrapper, long j) {
        ...
        this.mFPInstance = j;
        if (j != 0) {
            androidActivityWrapper.registerPlane(this, 6);
        } else {
            androidActivityWrapper.unregisterPlane(6);
        }
    ...
    public void surfaceChanged(SurfaceHolder surfaceHolder, int i, int i2, int i3) {
        long j = this.mFPInstance;
        if (j != 0) {
            nativeSurfaceChanged(j, i2, i3);
        }
    }
                ...
                this.m_layOutListener = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.adobe.air.AIRStage3DSurfaceView.1
                    ...
                    public void onGlobalLayout() {
                        if (AIRStage3DSurfaceView.this.mFPInstance != 0) {
                            AIRStage3DSurfaceView aIRStage3DSurfaceView = AIRStage3DSurfaceView.this;
                            aIRStage3DSurfaceView.nativeSurfaceLayoutChanged(aIRStage3DSurfaceView.mFPInstance);
                        }
                    }
                };
            }
            ViewTreeObserver.OnGlobalLayoutListener onGlobalLayoutListener = this.m_layOutListener;
    ...
    public void surfaceDestroyed(SurfaceHolder surfaceHolder) {
        ...
        ViewTreeObserver viewTreeObserver = getViewTreeObserver();
        if (!viewTreeObserver.isAlive() || (onGlobalLayoutListener = this.m_layOutListener) == null) {
            return;
        }
