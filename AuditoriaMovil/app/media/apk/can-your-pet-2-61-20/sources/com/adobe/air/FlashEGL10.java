...
public class FlashEGL10 implements FlashEGL {
    ...
    public int[] GetNumConfigs() {
        ...
        int[] iArr2 = cfgAttrs;
        iArr2[1] = 4;
        ChooseConfig(this.mEglDisplay, iArr2, null, 0, iArr);
        int i2 = iArr[0];
        this.mWindowConfigCount = i2;
        int[] iArr3 = cfgAttrs;
        iArr3[1] = 2;
        ChooseConfig(this.mEglDisplay, iArr3, null, 0, iArr);
        int i3 = iArr[0];
        this.mPixmapConfigCount = i3;
        int[] iArr4 = cfgAttrs;
        iArr4[1] = 1;
        ChooseConfig(this.mEglDisplay, iArr4, null, 0, iArr);
        int i4 = iArr[0];
    ...
    public int[] GetConfigs(boolean z, boolean z2) {
        ...
        int[] iArr4 = cfgAttrs;
        iArr4[1] = 5;
        ChooseConfig(this.mEglDisplay, iArr4, this.mEglConfigList, this.mEglConfigCount, iArr2);
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            ...
            if (z2) {
                ...
                int[] iArr5 = this.mEglVersion;
                iArr[XX] = ((iArr5[0] > 1 || iArr5[1] > 3) && (iArr[XX(i3, this.kSurfaceTypes)] & EGL_BUFFER_PRESERVED) != 0) ? 1 : 0;
            } else {
    ...
    public void SetConfig(int i) {
        ...
        int[] iArr = new int[1];
        this.mEgl.eglGetConfigAttrib(this.mEglDisplay, eGLConfig, 12324, iArr);
        int i2 = iArr[0];
    ...
    public int CreateDummySurfaceAndContext() {
        ...
        if (this.mEglContext != EGL10.EGL_NO_CONTEXT) {
            if (this.mEglWindowSurface != EGL10.EGL_NO_SURFACE) {
                ...
                egl102.eglMakeCurrent(eGLDisplay2, eGLSurface2, eGLSurface2, this.mEglContext);
                return 12288;
            } else {
        ...
        egl103.eglMakeCurrent(eGLDisplay3, eGLSurface3, eGLSurface3, this.mEglContext);
    ...
    public int CreateWindowSurface(SurfaceView surfaceView, int i) {
        ...
        if ((surfaceView instanceof VideoViewAIR) || (surfaceView instanceof AIRStage3DSurfaceView) || z2) {
            ...
            if (i == this.kSwapPreserveOn) {
                ...
                EGLSurface eglCreateWindowSurface = this.mEgl.eglCreateWindowSurface(this.mEglDisplay, this.mEglConfig, surfaceView.getHolder(), fbWindowSurfaceOnAttrs);
                ...
                if (i == this.kSwapPreserveOff) {
                    checkEglError("Before eglCreateWindowSurface");
                    EGLSurface eglCreateWindowSurface2 = this.mEgl.eglCreateWindowSurface(this.mEglDisplay, this.mEglConfig, surfaceView.getHolder(), fbWindowSurfaceOffAttrs);
            ...
            if (z2) {
                ...
                final Activity activity = aIRWindowSurfaceView.getActivityWrapper().getActivity();
                if (activity != null) {
                    activity.runOnUiThread(new Runnable() { // from class: com.adobe.air.FlashEGL10.1
    ...
    public boolean DestroyWindowSurface() {
        if (this.mEglWindowSurface != EGL10.EGL_NO_SURFACE) {
            ...
            this.mEgl.eglMakeCurrent(this.mEglDisplay, eGLSurface, eGLSurface, this.mEglContext);
