...
public class ShakeListenerService extends Service {
    ...
    class BackgroundThread extends Thread {
        ...
        public void run() {
            try {
                ShakeListenerService shakeListenerService = ShakeListenerService.this;
                shakeListenerService.mShakeListener = new ShakeListener(shakeListenerService.mcontext);
