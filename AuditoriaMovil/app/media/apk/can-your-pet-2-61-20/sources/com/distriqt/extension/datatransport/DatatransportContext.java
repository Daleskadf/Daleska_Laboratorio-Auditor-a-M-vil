...
import com.distriqt.extension.datatransport.controller.DataTransportController;
import com.distriqt.extension.datatransport.functions.ImplementationFunction;
import com.distriqt.extension.datatransport.functions.IsSupportedFunction;
import com.distriqt.extension.datatransport.functions.VersionFunction;
import java.util.HashMap;
import java.util.Map;
/* loaded from: classes.dex */
public class DatatransportContext extends FREContext implements IExtensionContext, ActivityResultCallback, StateChangeCallback {
    public static final String IMPLEMENTATION = "Android";
    public static final String TAG = "DatatransportContext";
    public static final String VERSION = "1.0";
    private AndroidActivityWrapper _aaw;
    private DataTransportController _controller = null;

    public DatatransportContext() {
    ...
    public void dispose() {
        ...
        DataTransportController dataTransportController = this._controller;
        if (dataTransportController != null) {
            dataTransportController.dispose();
    ...
    public DataTransportController controller() {
        if (this._controller == null) {
            this._controller = new DataTransportController(this);
        }
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        DataTransportController dataTransportController = this._controller;
        if (dataTransportController != null) {
            dataTransportController.onActivityResult(i, i2, intent);
        }
    }
    ...
    /* renamed from: com.distriqt.extension.datatransport.DatatransportContext$1  reason: invalid class name */
    /* loaded from: classes.dex */
