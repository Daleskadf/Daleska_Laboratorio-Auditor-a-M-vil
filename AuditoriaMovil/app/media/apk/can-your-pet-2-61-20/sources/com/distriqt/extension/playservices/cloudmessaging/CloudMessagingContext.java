...
import com.distriqt.extension.playservices.cloudmessaging.controller.CloudMessagingController;
import com.distriqt.extension.playservices.cloudmessaging.functions.ImplementationFunction;
import com.distriqt.extension.playservices.cloudmessaging.functions.IsSupportedFunction;
import com.distriqt.extension.playservices.cloudmessaging.functions.VersionFunction;
import java.util.HashMap;
import java.util.Map;
/* loaded from: classes.dex */
public class CloudMessagingContext extends FREContext implements IExtensionContext, ActivityResultCallback, StateChangeCallback {
    public static final String IMPLEMENTATION = "Android";
    public static final String TAG = "CloudMessagingContext";
    public static final String VERSION = "1.0";
    private AndroidActivityWrapper _aaw;
    private CloudMessagingController _controller = null;
    ...
    public void dispose() {
        ...
        CloudMessagingController cloudMessagingController = this._controller;
        if (cloudMessagingController != null) {
            cloudMessagingController.dispose();
    ...
    public CloudMessagingController controller() {
        if (this._controller == null) {
            this._controller = new CloudMessagingController(this);
        }
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        CloudMessagingController cloudMessagingController = this._controller;
        if (cloudMessagingController != null) {
            cloudMessagingController.onActivityResult(i, i2, intent);
        }
    }
    ...
    /* renamed from: com.distriqt.extension.playservices.cloudmessaging.CloudMessagingContext$1  reason: invalid class name */
    /* loaded from: classes.dex */
