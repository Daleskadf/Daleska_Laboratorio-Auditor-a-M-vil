...
import com.distriqt.extension.gson.controller.GSONController;
import com.distriqt.extension.gson.functions.ImplementationFunction;
import com.distriqt.extension.gson.functions.IsSupportedFunction;
import com.distriqt.extension.gson.functions.VersionFunction;
import java.util.HashMap;
import java.util.Map;
/* loaded from: classes.dex */
public class GsonContext extends FREContext implements IExtensionContext, ActivityResultCallback, StateChangeCallback {
    public static final String IMPLEMENTATION = "Android";
    public static final String TAG = "GsonContext";
    public static final String VERSION = "1.0";
    private AndroidActivityWrapper _aaw;
    private GSONController _controller = null;
    ...
    public void dispose() {
        ...
        GSONController gSONController = this._controller;
        if (gSONController != null) {
            gSONController.dispose();
    ...
    public GSONController controller() {
        if (this._controller == null) {
            this._controller = new GSONController(this);
        }
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        GSONController gSONController = this._controller;
        if (gSONController != null) {
            gSONController.onActivityResult(i, i2, intent);
        }
    }
    ...
    /* renamed from: com.distriqt.extension.gson.GsonContext$1  reason: invalid class name */
    /* loaded from: classes.dex */
