...
import com.distriqt.extension.firebase.core.controller.CoreController;
import com.distriqt.extension.firebase.core.functions.ImplementationFunction;
import com.distriqt.extension.firebase.core.functions.IsSupportedFunction;
import com.distriqt.extension.firebase.core.functions.VersionFunction;
...
public class CoreContext extends FREContext implements IExtensionContext, ActivityResultCallback, StateChangeCallback {
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        CoreController coreController = this._controller;
        if (coreController != null) {
            coreController.onActivityResult(i, i2, intent);
        }
    }
    ...
    /* renamed from: com.distriqt.extension.firebase.core.CoreContext$1  reason: invalid class name */
    /* loaded from: classes.dex */
