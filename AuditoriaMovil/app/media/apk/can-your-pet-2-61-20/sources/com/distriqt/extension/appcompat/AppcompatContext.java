...
import com.distriqt.extension.appcompat.controller.AppCompatController;
import com.distriqt.extension.appcompat.functions.ImplementationFunction;
import com.distriqt.extension.appcompat.functions.IsSupportedFunction;
import com.distriqt.extension.appcompat.functions.VersionFunction;
import java.util.HashMap;
import java.util.Map;
/* loaded from: classes.dex */
public class AppcompatContext extends FREContext implements IExtensionContext, ActivityResultCallback, StateChangeCallback {
    public static final String IMPLEMENTATION = "Android";
    public static final String TAG = "AppcompatContext";
    public static final String VERSION = "1.0";
    private AndroidActivityWrapper _aaw;
    private AppCompatController _controller = null;

    public AppcompatContext() {
    ...
    public void dispose() {
        ...
        AppCompatController appCompatController = this._controller;
        if (appCompatController != null) {
            appCompatController.dispose();
    ...
    public AppCompatController controller() {
        if (this._controller == null) {
            this._controller = new AppCompatController(this);
        }
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        AppCompatController appCompatController = this._controller;
        if (appCompatController != null) {
            appCompatController.onActivityResult(i, i2, intent);
        }
    }
    ...
    /* renamed from: com.distriqt.extension.appcompat.AppcompatContext$1  reason: invalid class name */
    /* loaded from: classes.dex */
