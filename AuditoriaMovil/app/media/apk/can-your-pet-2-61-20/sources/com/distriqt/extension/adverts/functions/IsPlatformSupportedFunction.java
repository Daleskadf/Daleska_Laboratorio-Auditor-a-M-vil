...
public class IsPlatformSupportedFunction implements FREFunction {
    ...
    public FREObject call(FREContext fREContext, FREObject[] fREObjectArr) {
        try {
            ...
            boolean z = false;
            if (advertsContext.v) {
                z = advertsContext.controller().isPlatformSupported(fREObjectArr[0].getAsString()).booleanValue();
            }
