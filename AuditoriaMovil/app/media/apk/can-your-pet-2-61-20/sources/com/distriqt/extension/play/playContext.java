...
import com.distriqt.extension.play.controller.playController;
import com.distriqt.extension.play.functions.ImplementationFunction;
import com.distriqt.extension.play.functions.IsSupportedFunction;
import com.distriqt.extension.play.functions.VersionFunction;
import java.util.HashMap;
import java.util.Map;
/* loaded from: classes.dex */
public class playContext extends FREContext implements IExtensionContext, ActivityResultCallback, StateChangeCallback {
    public static final String IMPLEMENTATION = "Android";
    public static final String TAG = "playContext";
    public static final String VERSION = "1.0";
    private AndroidActivityWrapper _aaw;
    private playController _controller = null;
    ...
    public void dispose() {
        ...
        playController playcontroller = this._controller;
    ...
    public playController controller() {
        if (this._controller == null) {
            this._controller = new playController(this);
        }
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        playController playcontroller = this._controller;
        if (playcontroller != null) {
            playcontroller.onActivityResult(i, i2, intent);
        }
    }
    ...
    /* renamed from: com.distriqt.extension.play.playContext$1  reason: invalid class name */
    /* loaded from: classes.dex */
