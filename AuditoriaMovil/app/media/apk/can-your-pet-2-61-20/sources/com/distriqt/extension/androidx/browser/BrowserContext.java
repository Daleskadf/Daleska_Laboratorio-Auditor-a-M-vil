...
import com.distriqt.extension.androidx.browser.controller.BrowserController;
import com.distriqt.extension.androidx.browser.functions.ImplementationFunction;
import com.distriqt.extension.androidx.browser.functions.IsSupportedFunction;
import com.distriqt.extension.androidx.browser.functions.VersionFunction;
import java.util.HashMap;
import java.util.Map;
/* loaded from: classes.dex */
public class BrowserContext extends FREContext implements IExtensionContext, ActivityResultCallback, StateChangeCallback {
    public static final String IMPLEMENTATION = "Android";
    public static final String TAG = "BrowserContext";
    public static final String VERSION = "1.0";
    private AndroidActivityWrapper _aaw;
    private BrowserController _controller = null;
    ...
    public void dispose() {
        ...
        BrowserController browserController = this._controller;
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        BrowserController browserController = this._controller;
        if (browserController != null) {
            browserController.onActivityResult(i, i2, intent);
        }
    }
    ...
    /* renamed from: com.distriqt.extension.androidx.browser.BrowserContext$1  reason: invalid class name */
    /* loaded from: classes.dex */
