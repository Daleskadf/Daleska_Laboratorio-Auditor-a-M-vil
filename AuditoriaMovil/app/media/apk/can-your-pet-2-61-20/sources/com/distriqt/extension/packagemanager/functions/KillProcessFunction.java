...
public class KillProcessFunction implements FREFunction {
    @Override // com.adobe.fre.FREFunction
    public FREObject call(FREContext fREContext, FREObject[] fREObjectArr) {
        try {
            return FREObject.newObject(((PackageManagerContext) fREContext).controller().killProcess(fREObjectArr[0].getAsString()));
        } catch (Exception e) {
