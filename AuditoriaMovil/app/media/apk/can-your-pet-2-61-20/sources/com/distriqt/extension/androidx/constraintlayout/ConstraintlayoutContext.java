...
import com.distriqt.extension.androidx.constraintlayout.controller.constraintlayoutController;
import com.distriqt.extension.androidx.constraintlayout.functions.ImplementationFunction;
import com.distriqt.extension.androidx.constraintlayout.functions.IsSupportedFunction;
import com.distriqt.extension.androidx.constraintlayout.functions.VersionFunction;
import java.util.HashMap;
import java.util.Map;
/* loaded from: classes.dex */
public class ConstraintlayoutContext extends FREContext implements IExtensionContext, ActivityResultCallback, StateChangeCallback {
    public static final String IMPLEMENTATION = "Android";
    public static final String TAG = "ConstraintlayoutContext";
    public static final String VERSION = "1.0";
    private AndroidActivityWrapper _aaw;
    private constraintlayoutController _controller = null;

    public ConstraintlayoutContext() {
    ...
    public void dispose() {
        ...
        constraintlayoutController constraintlayoutcontroller = this._controller;
        if (constraintlayoutcontroller != null) {
            constraintlayoutcontroller.dispose();
    ...
    public constraintlayoutController controller() {
        if (this._controller == null) {
            this._controller = new constraintlayoutController(this);
        }
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        constraintlayoutController constraintlayoutcontroller = this._controller;
        if (constraintlayoutcontroller != null) {
            constraintlayoutcontroller.onActivityResult(i, i2, intent);
        }
    }
    ...
    /* renamed from: com.distriqt.extension.androidx.constraintlayout.ConstraintlayoutContext$1  reason: invalid class name */
    /* loaded from: classes.dex */
