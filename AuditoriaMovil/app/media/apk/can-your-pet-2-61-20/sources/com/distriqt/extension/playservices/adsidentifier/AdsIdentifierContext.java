...
import com.distriqt.extension.playservices.adsidentifier.controller.AdsIdentifierController;
import com.distriqt.extension.playservices.adsidentifier.functions.ImplementationFunction;
import com.distriqt.extension.playservices.adsidentifier.functions.IsSupportedFunction;
import com.distriqt.extension.playservices.adsidentifier.functions.VersionFunction;
import java.util.HashMap;
import java.util.Map;
/* loaded from: classes.dex */
public class AdsIdentifierContext extends FREContext implements IExtensionContext, ActivityResultCallback, StateChangeCallback {
    public static final String IMPLEMENTATION = "Android";
    public static final String TAG = "AdsIdentifierContext";
    public static final String VERSION = "1.0";
    private AndroidActivityWrapper _aaw;
    private AdsIdentifierController _controller = null;

    public AdsIdentifierContext() {
    ...
    public void dispose() {
        ...
        AdsIdentifierController adsIdentifierController = this._controller;
        if (adsIdentifierController != null) {
            adsIdentifierController.dispose();
    ...
    public AdsIdentifierController controller() {
        if (this._controller == null) {
            this._controller = new AdsIdentifierController(this);
        }
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        AdsIdentifierController adsIdentifierController = this._controller;
        if (adsIdentifierController != null) {
            adsIdentifierController.onActivityResult(i, i2, intent);
        }
    }
    ...
    /* renamed from: com.distriqt.extension.playservices.adsidentifier.AdsIdentifierContext$1  reason: invalid class name */
    /* loaded from: classes.dex */
