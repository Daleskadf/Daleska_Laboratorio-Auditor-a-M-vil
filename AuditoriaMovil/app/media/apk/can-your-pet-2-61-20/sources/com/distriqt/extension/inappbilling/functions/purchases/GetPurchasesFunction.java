...
public class GetPurchasesFunction implements FREFunction {
    ...
    public FREObject call(FREContext fREContext, FREObject[] fREObjectArr) {
        try {
            ...
            if (inAppBillingContext.v) {
                bool = Boolean.valueOf(inAppBillingContext.controller().service().getPurchases(fREObjectArr[0].getAsBool()));
            }
