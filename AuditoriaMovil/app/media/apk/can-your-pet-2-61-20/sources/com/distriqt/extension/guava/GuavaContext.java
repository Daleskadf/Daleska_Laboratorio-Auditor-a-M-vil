...
import com.distriqt.extension.guava.controller.GuavaController;
import com.distriqt.extension.guava.functions.ImplementationFunction;
import com.distriqt.extension.guava.functions.IsSupportedFunction;
import com.distriqt.extension.guava.functions.VersionFunction;
import java.util.HashMap;
import java.util.Map;
/* loaded from: classes.dex */
public class GuavaContext extends FREContext implements IExtensionContext, ActivityResultCallback, StateChangeCallback {
    public static final String IMPLEMENTATION = "Android";
    public static final String TAG = "GuavaContext";
    public static final String VERSION = "1.0";
    private AndroidActivityWrapper _aaw;
    private GuavaController _controller = null;
    ...
    public void dispose() {
        ...
        GuavaController guavaController = this._controller;
        if (guavaController != null) {
            guavaController.dispose();
    ...
    public GuavaController controller() {
        if (this._controller == null) {
            this._controller = new GuavaController(this);
        }
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        GuavaController guavaController = this._controller;
        if (guavaController != null) {
            guavaController.onActivityResult(i, i2, intent);
        }
    }
    ...
    /* renamed from: com.distriqt.extension.guava.GuavaContext$1  reason: invalid class name */
    /* loaded from: classes.dex */
