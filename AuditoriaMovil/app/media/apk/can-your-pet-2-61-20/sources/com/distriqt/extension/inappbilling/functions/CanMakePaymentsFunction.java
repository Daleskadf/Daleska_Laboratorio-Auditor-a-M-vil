...
public class CanMakePaymentsFunction implements FREFunction {
    ...
    public FREObject call(FREContext fREContext, FREObject[] fREObjectArr) {
        try {
            ...
            return FREObject.newObject((inAppBillingContext.controller() == null || inAppBillingContext.controller().service() == null) ? false : inAppBillingContext.controller().service().canMakePayments());
        } catch (Exception e) {
