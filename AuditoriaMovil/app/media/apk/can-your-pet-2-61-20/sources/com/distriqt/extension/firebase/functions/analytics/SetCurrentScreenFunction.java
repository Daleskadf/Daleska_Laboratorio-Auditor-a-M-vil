...
public class SetCurrentScreenFunction implements FREFunction {
    ...
    public FREObject call(FREContext fREContext, FREObject[] fREObjectArr) {
        try {
            ...
            if (firebaseContext.v) {
                z = firebaseContext.controller().analytics().setCurrentScreen(fREObjectArr[0].getAsString(), fREObjectArr[1].getAsString());
            }
