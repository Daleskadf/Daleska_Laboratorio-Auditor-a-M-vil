...
import com.distriqt.extension.androidx.vectordrawable.controller.VectorDrawableController;
import com.distriqt.extension.androidx.vectordrawable.functions.ImplementationFunction;
import com.distriqt.extension.androidx.vectordrawable.functions.IsSupportedFunction;
import com.distriqt.extension.androidx.vectordrawable.functions.VersionFunction;
import java.util.HashMap;
import java.util.Map;
/* loaded from: classes.dex */
public class VectordrawableContext extends FREContext implements IExtensionContext, ActivityResultCallback, StateChangeCallback {
    public static final String IMPLEMENTATION = "Android";
    public static final String TAG = "VectordrawableContext";
    public static final String VERSION = "1.0";
    private AndroidActivityWrapper _aaw;
    private VectorDrawableController _controller = null;

    public VectordrawableContext() {
    ...
    public void dispose() {
        ...
        VectorDrawableController vectorDrawableController = this._controller;
        if (vectorDrawableController != null) {
            vectorDrawableController.dispose();
    ...
    public VectorDrawableController controller() {
        if (this._controller == null) {
            this._controller = new VectorDrawableController(this);
        }
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        VectorDrawableController vectorDrawableController = this._controller;
        if (vectorDrawableController != null) {
            vectorDrawableController.onActivityResult(i, i2, intent);
        }
    }
    ...
    /* renamed from: com.distriqt.extension.androidx.vectordrawable.VectordrawableContext$1  reason: invalid class name */
    /* loaded from: classes.dex */
