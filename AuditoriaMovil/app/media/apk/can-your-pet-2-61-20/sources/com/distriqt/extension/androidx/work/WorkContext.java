...
import com.distriqt.extension.androidx.work.controller.WorkController;
import com.distriqt.extension.androidx.work.functions.ImplementationFunction;
import com.distriqt.extension.androidx.work.functions.IsSupportedFunction;
import com.distriqt.extension.androidx.work.functions.VersionFunction;
import java.util.HashMap;
import java.util.Map;
/* loaded from: classes.dex */
public class WorkContext extends FREContext implements IExtensionContext, ActivityResultCallback, StateChangeCallback {
    public static final String IMPLEMENTATION = "Android";
    public static final String TAG = "WorkContext";
    public static final String VERSION = "1.0";
    private AndroidActivityWrapper _aaw;
    private WorkController _controller = null;
    ...
    public void dispose() {
        ...
        WorkController workController = this._controller;
    ...
    public WorkController controller() {
        if (this._controller == null) {
            this._controller = new WorkController(this);
        }
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        WorkController workController = this._controller;
        if (workController != null) {
            workController.onActivityResult(i, i2, intent);
        }
    }
    ...
    /* renamed from: com.distriqt.extension.androidx.work.WorkContext$1  reason: invalid class name */
    /* loaded from: classes.dex */
