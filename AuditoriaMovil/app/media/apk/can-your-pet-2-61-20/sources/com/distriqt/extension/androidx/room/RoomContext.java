...
import com.distriqt.extension.androidx.room.controller.RoomController;
import com.distriqt.extension.androidx.room.functions.ImplementationFunction;
import com.distriqt.extension.androidx.room.functions.IsSupportedFunction;
import com.distriqt.extension.androidx.room.functions.VersionFunction;
import java.util.HashMap;
import java.util.Map;
/* loaded from: classes.dex */
public class RoomContext extends FREContext implements IExtensionContext, ActivityResultCallback, StateChangeCallback {
    public static final String IMPLEMENTATION = "Android";
    public static final String TAG = "RoomContext";
    ...
    public void dispose() {
        ...
        RoomController roomController = this._controller;
    ...
    public RoomController controller() {
        if (this._controller == null) {
            this._controller = new RoomController(this);
        }
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        RoomController roomController = this._controller;
        if (roomController != null) {
            roomController.onActivityResult(i, i2, intent);
        }
    }
    ...
    /* renamed from: com.distriqt.extension.androidx.room.RoomContext$1  reason: invalid class name */
    /* loaded from: classes.dex */
