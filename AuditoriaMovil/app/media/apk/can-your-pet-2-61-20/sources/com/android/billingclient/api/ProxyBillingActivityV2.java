...
public class ProxyBillingActivityV2 extends ComponentActivity {
    ...
    public final void zza(ActivityResult activityResult) {
        ...
        if (activityResult.getResultCode() != -1 || responseCode != 0) {
            ...
            com.google.android.gms.internal.play_billing.zzb.zzk("ProxyBillingActivityV2", "Alternative billing only dialog finished with resultCode " + resultCode + " and billing's responseCode: " + responseCode);
        }
        finish();
    }
