...
public class CountryCodeToRegionCodeMap {
    ...
    public static Map<Integer, List<String>> getCountryCodeToRegionCodeMap() {
        ...
        arrayList133.add("CZ");
        hashMap.put(Integer.valueOf((int) TypedValues.CycleType.TYPE_EASING), arrayList133);
        ArrayList arrayList134 = new ArrayList(1);
        arrayList134.add("SK");
        hashMap.put(Integer.valueOf((int) TypedValues.CycleType.TYPE_WAVE_SHAPE), arrayList134);
        ArrayList arrayList135 = new ArrayList(1);
        arrayList135.add("LI");
        hashMap.put(Integer.valueOf((int) TypedValues.CycleType.TYPE_WAVE_PERIOD), arrayList135);
        ArrayList arrayList136 = new ArrayList(1);
        arrayList136.add("FK");
        hashMap.put(500, arrayList136);
        ArrayList arrayList137 = new ArrayList(1);
        arrayList137.add("BZ");
        hashMap.put(Integer.valueOf((int) TypedValues.PositionType.TYPE_TRANSITION_EASING), arrayList137);
        ArrayList arrayList138 = new ArrayList(1);
        arrayList138.add("GT");
        hashMap.put(Integer.valueOf((int) TypedValues.PositionType.TYPE_DRAWPATH), arrayList138);
        ArrayList arrayList139 = new ArrayList(1);
        arrayList139.add("SV");
        hashMap.put(Integer.valueOf((int) TypedValues.PositionType.TYPE_PERCENT_WIDTH), arrayList139);
        ArrayList arrayList140 = new ArrayList(1);
        arrayList140.add("HN");
        hashMap.put(Integer.valueOf((int) TypedValues.PositionType.TYPE_PERCENT_HEIGHT), arrayList140);
        ArrayList arrayList141 = new ArrayList(1);
        arrayList141.add("NI");
        hashMap.put(Integer.valueOf((int) TypedValues.PositionType.TYPE_SIZE_PERCENT), arrayList141);
        ArrayList arrayList142 = new ArrayList(1);
        arrayList142.add("CR");
        hashMap.put(Integer.valueOf((int) TypedValues.PositionType.TYPE_PERCENT_X), arrayList142);
        ArrayList arrayList143 = new ArrayList(1);
        arrayList143.add("PA");
        hashMap.put(Integer.valueOf((int) TypedValues.PositionType.TYPE_PERCENT_Y), arrayList143);
        ArrayList arrayList144 = new ArrayList(1);
        arrayList144.add("PM");
        hashMap.put(Integer.valueOf((int) TypedValues.PositionType.TYPE_CURVE_FIT), arrayList144);
        ...
        hashMap.put(Integer.valueOf((int) LogSeverity.EMERGENCY_VALUE), arrayList177);
