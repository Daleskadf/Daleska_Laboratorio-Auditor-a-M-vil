...
public final class zzdms {
    ...
    public final View zza(final View view, final WindowManager windowManager) throws zzcgy {
        ...
        zza.zzae("/sendMessageToSdk", new zzbky() { // from class: com.google.android.gms.internal.ads.zzdmm
            @Override // com.google.android.gms.internal.ads.zzbky
            public final void zza(Object obj, Map map) {
                zzdms.this.zzb((zzcgm) obj, map);
            }
        });
        zza.zzae("/hideValidatorOverlay", new zzbky() { // from class: com.google.android.gms.internal.ads.zzdmn
            @Override // com.google.android.gms.internal.ads.zzbky
            public final void zza(Object obj, Map map) {
                zzdms.this.zzc(windowManager, view, (zzcgm) obj, map);
            }
        });
        zza.zzae("/open", new zzblk(null, null, null, null, null));
        this.zzb.zzm(new WeakReference(zza), "/loadNativeAdPolicyViolations", new zzbky() { // from class: com.google.android.gms.internal.ads.zzdmo
            @Override // com.google.android.gms.internal.ads.zzbky
            public final void zza(Object obj, Map map) {
                zzdms.this.zze(view, windowManager, (zzcgm) obj, map);
            }
        });
        this.zzb.zzm(new WeakReference(zza), "/showValidatorOverlay", new zzbky() { // from class: com.google.android.gms.internal.ads.zzdmp
            @Override // com.google.android.gms.internal.ads.zzbky
            public final void zza(Object obj, Map map) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final /* synthetic */ void zzc(WindowManager windowManager, View view, zzcgm zzcgmVar, Map map) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final /* synthetic */ void zze(final View view, final WindowManager windowManager, final zzcgm zzcgmVar, final Map map) {
        int i;
        zzcgmVar.zzN().zzB(new zzcia() { // from class: com.google.android.gms.internal.ads.zzdmr
            @Override // com.google.android.gms.internal.ads.zzcia
            public final void zza(boolean z, int i2, String str, String str2) {
                zzdms.this.zzd(map, z, i2, str, str2);
            }
        });
        if (map == null) {
            return;
        ...
        int zzf = zzf(context, (String) map.get("validator_width"), ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zzia)).intValue());
        int zzf2 = zzf(context, (String) map.get("validator_height"), ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zzib)).intValue());
        int zzf3 = zzf(context, (String) map.get("validator_x"), 0);
        int zzf4 = zzf(context, (String) map.get("validator_y"), 0);
        zzcgmVar.zzah(zzcie.zzb(zzf, zzf2));
        try {
        ...
        zzb.x = zzf3;
        zzb.y = zzf4;
        windowManager.updateViewLayout(zzcgmVar.zzF(), zzb);
