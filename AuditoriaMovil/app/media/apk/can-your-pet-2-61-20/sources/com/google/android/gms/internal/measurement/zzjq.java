...
public enum zzjq {
    ...
    static {
        zzjq[] values = values();
        zzaz = new zzjq[values.length];
        for (zzjq zzjqVar : values) {
    ...
    zzjq(int i, zzjs zzjsVar, zzkf zzkfVar) {
        ...
        this.zzbg = (zzjsVar != zzjs.SCALAR || (i2 = zzjp.zza[zzkfVar.ordinal()]) == 1 || i2 == 2 || i2 == 3) ? false : false;
    }
}
