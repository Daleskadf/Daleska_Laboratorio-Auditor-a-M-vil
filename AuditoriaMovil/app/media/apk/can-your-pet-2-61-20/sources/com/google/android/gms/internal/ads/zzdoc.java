...
public final class zzdoc implements zzhiv {
    ...
    public final zzdob zzb() {
        ...
        VersionInfoParcel zza = ((zzcjc) this.zzd).zza();
        ...
        zzhjd.zzb(zzgepVar);
        return new zzdob(context, zzdnkVar, zzawoVar, zza, zza2, zzbcxVar, zzgepVar, ((zzcyh) this.zzh).zza(), (zzdot) this.zzi.zzb(), (zzdri) this.zzj.zzb(), (ScheduledExecutorService) this.zzk.zzb(), (zzduh) this.zzl.zzb(), (zzfmt) this.zzm.zzb(), (zzefd) this.zzn.zzb(), (zzdqd) this.zzo.zzb(), (zzefo) this.zzp.zzb(), (zzfgm) this.zzq.zzb());
    }
}
