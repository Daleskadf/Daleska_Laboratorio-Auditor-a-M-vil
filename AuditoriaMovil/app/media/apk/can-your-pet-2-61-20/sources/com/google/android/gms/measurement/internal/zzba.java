...
public final class zzba {
    ...
    public final zzba zza(zzhm zzhmVar, long j) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public zzba(zzhm zzhmVar, String str, String str2, String str3, long j, long j2, Bundle bundle) {
        zzbc zzbcVar;
        ...
        if (bundle != null && !bundle.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                if (next == null) {
                    ...
                    Object zzb = zzhmVar.zzt().zzb(next, bundle2.get(next));
                    if (zzb == null) {
                        zzhmVar.zzj().zzu().zza("Param value can't be null", zzhmVar.zzk().zzb(next));
                        it.remove();
                    } else {
                        zzhmVar.zzt().zza(bundle2, next, zzb);
                    }
                }
            }
    ...
    private zzba(zzhm zzhmVar, String str, String str2, String str3, long j, long j2, zzbc zzbcVar) {
        Preconditions.checkNotEmpty(str2);
        Preconditions.checkNotEmpty(str3);
