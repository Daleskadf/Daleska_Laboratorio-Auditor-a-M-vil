...
final class zzaip implements zzaiu {
    ...
    public final zzaed zzg(long j) {
        Pair zze = zze(zzfx.zzu(Math.max(0L, Math.min(j, this.zzc))), this.zzb, this.zza);
        zzaeg zzaegVar = new zzaeg(zzfx.zzr(((Long) zze.first).longValue()), ((Long) zze.second).longValue());
