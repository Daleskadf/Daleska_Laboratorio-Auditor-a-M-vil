...
interface zzhby {
    ...
    @Deprecated
    void zzE(List list, zzhcg zzhcgVar, zzgzf zzgzfVar) throws IOException;

    void zzF(List list) throws IOException;

    void zzG(List list) throws IOException;

    void zzH(List list, zzhcg zzhcgVar, zzgzf zzgzfVar) throws IOException;
    ...
    zzgyj zzp() throws IOException;

    @Deprecated
    Object zzr(Class cls, zzgzf zzgzfVar) throws IOException;

    Object zzs(Class cls, zzgzf zzgzfVar) throws IOException;

    String zzt() throws IOException;

    String zzu() throws IOException;

    void zzv(Object obj, zzhcg zzhcgVar, zzgzf zzgzfVar) throws IOException;

    void zzw(Object obj, zzhcg zzhcgVar, zzgzf zzgzfVar) throws IOException;
