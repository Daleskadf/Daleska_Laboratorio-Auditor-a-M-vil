...
public final class zzfo {
    ...
    private final int zzO(Charset charset) {
        ...
        char zzb2;
        int i = 1;
        if (charset.equals(zzfwd.zzc) || charset.equals(zzfwd.zza)) {
            int i2 = this.zzf;
            int i3 = this.zze;
            if (i2 - i3 > 0) {
                zza2 = (byte) zzgci.zza(this.zzd[i3] & 255);
                return (zzgci.zza(zza2) << 16) + i;
            }
        }
        if (charset.equals(zzfwd.zzf) || charset.equals(zzfwd.zzd)) {
            int i4 = this.zzf;
            int i5 = this.zze;
            if (i4 - i5 >= 2) {
                byte[] bArr = this.zzd;
                zzb2 = zzgci.zzb(bArr[i5], bArr[i5 + 1]);
                zza2 = (byte) zzb2;
                i = 2;
                return (zzgci.zza(zza2) << 16) + i;
            }
        }
        if (charset.equals(zzfwd.zze)) {
            int i6 = this.zzf;
            int i7 = this.zze;
            if (i6 - i7 >= 2) {
                byte[] bArr2 = this.zzd;
                zzb2 = zzgci.zzb(bArr2[i7 + 1], bArr2[i7]);
                zza2 = (byte) zzb2;
                i = 2;
                return (zzgci.zza(zza2) << 16) + i;
            }
    ...
    public final String zzx(char c) {
        ...
        if (i - i2 != 0) {
            ...
            byte[] bArr = this.zzd;
            int i3 = this.zze;
            String zzB = zzfx.zzB(bArr, i3, i2 - i3);
            this.zze = i2;
            if (i2 < this.zzf) {
                this.zze = i2 + 1;
            }
    ...
    public final String zzy(Charset charset) {
        ...
        if (!charset.equals(zzfwd.zza)) {
            zzB();
        }
        int i = 1;
        if (!charset.equals(zzfwd.zzc) && !charset.equals(zzfwd.zza)) {
            i = 2;
            if (!charset.equals(zzfwd.zzf) && !charset.equals(zzfwd.zze) && !charset.equals(zzfwd.zzd)) {
        ...
        while (true) {
            ...
            if (i2 >= i3 - (i - 1)) {
                i2 = i3;
                break;
            } else if ((charset.equals(zzfwd.zzc) || charset.equals(zzfwd.zza)) && zzfx.zzL(this.zzd[i2])) {
                break;
            } else {
                if (charset.equals(zzfwd.zzf) || charset.equals(zzfwd.zzd)) {
                    byte[] bArr = this.zzd;
                    if (bArr[i2] == 0 && zzfx.zzL(bArr[i2 + 1])) {
                        break;
                    }
                }
                if (charset.equals(zzfwd.zze)) {
                    byte[] bArr2 = this.zzd;
                    if (bArr2[i2 + 1] == 0 && zzfx.zzL(bArr2[i2])) {
                        break;
                    }
                }
                i2 += i;
    ...
    public final String zzz(int i) {
        ...
        int i2 = this.zze;
        int i3 = (i2 + i) - 1;
        String zzB = zzfx.zzB(this.zzd, i2, (i3 >= this.zzf || this.zzd[i3] != 0) ? i : i - 1);
        this.zze += i;
        return zzB;
    }
