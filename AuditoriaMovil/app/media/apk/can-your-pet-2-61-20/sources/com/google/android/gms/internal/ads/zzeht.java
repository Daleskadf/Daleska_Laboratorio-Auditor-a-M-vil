...
final class zzeht extends zzbsa {
    ...
    public /* synthetic */ zzeht(zzehu zzehuVar, zzegm zzegmVar, zzehs zzehsVar) {
        this.zza = zzehuVar;
        this.zzb = zzegmVar;
    }
    ...
    public final void zzg(IObjectWrapper iObjectWrapper) throws RemoteException {
        zzehu.zze(this.zza, (View) ObjectWrapper.unwrap(iObjectWrapper));
        ((zzeif) this.zzb.zzc).zzo();
    }

    @Override // com.google.android.gms.internal.ads.zzbsb
    public final void zzh(zzbqx zzbqxVar) throws RemoteException {
        zzehu.zzd(this.zza, zzbqxVar);
        ((zzeif) this.zzb.zzc).zzo();
    }
}
