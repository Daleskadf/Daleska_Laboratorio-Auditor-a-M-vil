...
public interface zzbu extends IInterface {
    ...
    void zzH(zzbbu zzbbuVar) throws RemoteException;
    ...
    void zzM(zzbuy zzbuyVar) throws RemoteException;

    void zzN(boolean z) throws RemoteException;

    void zzO(zzbeu zzbeuVar) throws RemoteException;

    void zzP(zzdg zzdgVar) throws RemoteException;

    void zzQ(zzbvb zzbvbVar, String str) throws RemoteException;

    void zzR(String str) throws RemoteException;

    void zzS(zzbxw zzbxwVar) throws RemoteException;

    void zzT(String str) throws RemoteException;

    void zzU(zzfk zzfkVar) throws RemoteException;
