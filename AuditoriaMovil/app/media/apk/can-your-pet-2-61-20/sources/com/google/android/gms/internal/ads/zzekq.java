...
public final class zzekq implements zzegp {
    ...
    public final /* bridge */ /* synthetic */ Object zza(zzffz zzffzVar, zzffn zzffnVar, final zzegm zzegmVar) throws zzfgp, zzekh {
        zzdqn zze = this.zzc.zze(new zzcul(zzffzVar, zzffnVar, zzegmVar.zza), new zzdqo(new zzdiu() { // from class: com.google.android.gms.internal.ads.zzekp
        ...
        ((zzeif) zzegmVar.zzc).zzc(zze.zzm());
        return zze.zzk();
    }
