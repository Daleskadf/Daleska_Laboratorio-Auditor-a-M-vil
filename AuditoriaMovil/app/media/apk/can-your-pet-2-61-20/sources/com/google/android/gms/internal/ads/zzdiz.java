...
public final class zzdiz implements zzcyq, zzdfs {
    ...
    public zzdiz(zzbzz zzbzzVar, Context context, zzcad zzcadVar, View view, zzbdg.zza.EnumC0007zza enumC0007zza) {
        this.zza = zzbzzVar;
        this.zzb = context;
        this.zzc = zzcadVar;
        this.zzd = view;
    ...
    public final void zzl() {
        if (this.zzf == zzbdg.zza.EnumC0007zza.APP_OPEN) {
            return;
        }
        String zzc = this.zzc.zzc(this.zzb);
        this.zze = zzc;
        this.zze = String.valueOf(zzc).concat(this.zzf == zzbdg.zza.EnumC0007zza.REWARD_BASED_VIDEO_AD ? "/Rewarded" : "/Interstitial");
    }
}
