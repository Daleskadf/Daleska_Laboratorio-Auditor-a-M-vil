...
public final class zzejd implements zzeix {
    ...
    private final ListenableFuture zzg(final zzffz zzffzVar, final zzffn zzffnVar, final JSONObject jSONObject) {
        ...
        final ListenableFuture zza2 = zzdnoVar.zza(zzffzVar, zzffnVar, jSONObject);
        return zzgee.zzc(zza, zza2).zza(new Callable() { // from class: com.google.android.gms.internal.ads.zzeiy
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return zzejd.this.zzc(zza2, zza, zzffzVar, zzffnVar, jSONObject);
            }
        }, this.zzb);
    }
    ...
    public final ListenableFuture zza(final zzffz zzffzVar, final zzffn zzffnVar) {
        return zzgee.zzn(zzgee.zzn(this.zzd.zza(), new zzgdl() { // from class: com.google.android.gms.internal.ads.zzeja
            ...
            public final ListenableFuture zza(Object obj) {
                return zzejd.this.zze(zzffnVar, (zzdpx) obj);
            }
        }, this.zzb), new zzgdl() { // from class: com.google.android.gms.internal.ads.zzejb
            @Override // com.google.android.gms.internal.ads.zzgdl
            public final ListenableFuture zza(Object obj) {
                return zzejd.this.zzf(zzffzVar, zzffnVar, (JSONArray) obj);
            }
        }, this.zzb);
    }
    ...
    public final /* synthetic */ zzdkt zzc(ListenableFuture listenableFuture, ListenableFuture listenableFuture2, zzffz zzffzVar, zzffn zzffnVar, JSONObject jSONObject) throws Exception {
        zzdky zzdkyVar = (zzdky) listenableFuture.get();
        zzdpx zzdpxVar = (zzdpx) listenableFuture2.get();
        zzdkz zzd = this.zza.zzd(new zzcul(zzffzVar, zzffnVar, null), new zzdlk(zzdkyVar), new zzdjx(jSONObject, zzdpxVar));
        zzd.zzh().zzb();
        zzd.zzk().zza(zzdpxVar);
        zzd.zzg().zza(zzdkyVar.zzs());
        zzd.zzl().zza(this.zze, zzdkyVar.zzq());
        return zzd.zza();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final /* synthetic */ ListenableFuture zzd(zzdpx zzdpxVar, JSONObject jSONObject) throws Exception {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final /* synthetic */ ListenableFuture zze(zzffn zzffnVar, final zzdpx zzdpxVar) throws Exception {
        ...
        jSONObject2.put("response", zzffnVar.zzt.zzc);
        ...
        return zzgee.zzn(zzdpxVar.zzg("google.afma.nativeAds.preProcessJson", jSONObject2), new zzgdl() { // from class: com.google.android.gms.internal.ads.zzeiz
            @Override // com.google.android.gms.internal.ads.zzgdl
            public final ListenableFuture zza(Object obj) {
                return zzejd.this.zzd(zzdpxVar, (JSONObject) obj);
            }
        }, this.zzb);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final /* synthetic */ ListenableFuture zzf(zzffz zzffzVar, zzffn zzffnVar, JSONArray jSONArray) throws Exception {
