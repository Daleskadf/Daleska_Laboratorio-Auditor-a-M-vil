...
final class aj extends com.google.android.play.core.assetpacks.internal.p {
    ...
    protected final void a() {
        ...
        try {
            ...
            A = aw.A();
            e.d(str, k, A, new an(this.f, this.e));
        } catch (RemoteException e2) {
            String str2 = this.b;
            oVar = aw.a;
            oVar.b("getChunkFileDescriptor(%s, %s, %d, session=%d)", str2, this.c, Integer.valueOf(this.d), Integer.valueOf(this.a));
            this.e.trySetException(new RuntimeException(e2));
        }
    }
}
