...
public final class zzevs implements zzewr {
    ...
    public zzevs(zzgep zzgepVar, ScheduledExecutorService scheduledExecutorService, String str, zzemw zzemwVar, Context context, zzfgi zzfgiVar, zzems zzemsVar, zzdry zzdryVar, zzdwm zzdwmVar) {
        this.zzb = zzgepVar;
    ...
    public static /* synthetic */ ListenableFuture zzc(zzevs zzevsVar) {
        ...
        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zzkA)).booleanValue()) {
            str = zzevsVar.zzf.zzf.toLowerCase(Locale.ROOT);
        } else {
            str = zzevsVar.zzf.zzf;
        }
        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zzbD)).booleanValue()) {
            bundle = zzevsVar.zzi.zzg();
        } else {
            bundle = new Bundle();
        }
        final ArrayList arrayList = new ArrayList();
        if (!((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zzbM)).booleanValue()) {
            for (Map.Entry entry : ((zzfzq) zzevsVar.zzd.zzb(zzevsVar.zza, str)).entrySet()) {
                String str2 = (String) entry.getKey();
                arrayList.add(zzevsVar.zzg(str2, (List) entry.getValue(), zzevsVar.zzf(str2), true, true));
            }
            zzevsVar.zzi(arrayList, zzevsVar.zzd.zzc());
        } else {
            zzevsVar.zzi(arrayList, zzevsVar.zzd.zza(zzevsVar.zza, str));
        }
        return zzgee.zzb(arrayList).zza(new Callable() { // from class: com.google.android.gms.internal.ads.zzevn
            ...
            public final Object call() {
                ...
                return new zzevt(jSONArray.toString(), bundle);
            }
        }, zzevsVar.zzb);
    }
    ...
    private final zzgdv zzg(final String str, final List list, final Bundle bundle, final boolean z, final boolean z2) {
        zzgdv zzu = zzgdv.zzu(zzgee.zzk(new zzgdk() { // from class: com.google.android.gms.internal.ads.zzevp
            @Override // com.google.android.gms.internal.ads.zzgdk
            public final ListenableFuture zza() {
                return zzevs.this.zzd(str, list, bundle, z, z2);
            }
        }, this.zzb));
        if (!((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zzbz)).booleanValue()) {
            zzu = (zzgdv) zzgee.zzo(zzu, ((Long) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zzbs)).longValue(), TimeUnit.MILLISECONDS, this.zzc);
        }
        return (zzgdv) zzgee.zze(zzu, Throwable.class, new zzfwf() { // from class: com.google.android.gms.internal.ads.zzevq
    ...
    private final void zzi(List list, Map map) {
        for (Map.Entry entry : map.entrySet()) {
            zzena zzenaVar = (zzena) entry.getValue();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x002e, code lost:
        com.google.android.gms.ads.internal.util.client.zzm.zzh("Couldn't create RTB adapter : ", r13);
        r13 = null;
     */
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final /* synthetic */ void zze(zzbsn zzbsnVar, Bundle bundle, List list, zzemz zzemzVar, zzcbw zzcbwVar) {
        try {
