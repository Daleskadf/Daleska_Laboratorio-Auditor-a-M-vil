...
public final class zzbpu implements zzbpg {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* bridge */ /* synthetic */ void zzd(zzbpu zzbpuVar, zzbow zzbowVar, zzbpd zzbpdVar, Object obj, zzcbw zzcbwVar) {
        try {
            com.google.android.gms.ads.internal.zzu.zzp();
            String uuid = UUID.randomUUID().toString();
            zzbkx.zzo.zzc(uuid, new zzbpt(zzbpuVar, zzbowVar, zzcbwVar));
    ...
    public final ListenableFuture zzb(Object obj) {
        ...
        zzbow zzb = this.zzc.zzb(null);
        com.google.android.gms.ads.internal.util.zze.zza("callJs > getEngine: Promise created");
        zzb.zzj(new zzbpr(this, zzb, obj, zzcbwVar), new zzbps(this, zzcbwVar, zzb));
        return zzcbwVar;
    }
}
