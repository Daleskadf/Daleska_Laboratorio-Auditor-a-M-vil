...
public final class zzgis {
    ...
    public static void zza(boolean z) throws GeneralSecurityException {
        ...
        if (zzb()) {
            ...
            hashMap.put("AES128_GCM_SIV", zzgiuVar.zzc());
            zzgiu zzgiuVar2 = new zzgiu(null);
            zzgiuVar2.zza(16);
            zzgiuVar2.zzb(zzgiv.zzc);
            hashMap.put("AES128_GCM_SIV_RAW", zzgiuVar2.zzc());
            zzgiu zzgiuVar3 = new zzgiu(null);
            zzgiuVar3.zza(32);
            zzgiuVar3.zzb(zzgiv.zza);
            hashMap.put("AES256_GCM_SIV", zzgiuVar3.zzc());
            zzgiu zzgiuVar4 = new zzgiu(null);
            zzgiuVar4.zza(32);
            zzgiuVar4.zzb(zzgiv.zzc);
            hashMap.put("AES256_GCM_SIV_RAW", zzgiuVar4.zzc());
