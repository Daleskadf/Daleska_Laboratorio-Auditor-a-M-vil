        ...
        switch (i) {
            ...
            case 3:
                ...
                if (readStrongBinder != null) {
                    ...
                    if (queryLocalInterface instanceof zzbbv) {
                        zzbbv zzbbvVar = (zzbbv) queryLocalInterface;
                    }
                }
                zzazq.zzc(parcel);
                parcel2.writeNoException();
            ...
            case 4:
                ...
                if (readStrongBinder2 == null) {
                    ...
                    zzbbwVar = queryLocalInterface2 instanceof zzbby ? (zzbby) queryLocalInterface2 : new zzbbw(readStrongBinder2);
                }
                zzazq.zzc(parcel);
                zzi(asInterface, zzbbwVar);
                parcel2.writeNoException();
                return true;
            case 5:
