...
public final class zzaza extends zzazd {
    ...
    protected final void zza() throws IllegalAccessException, InvocationTargetException {
        if (this.zzi != null) {
            ...
            zzaub zza = zzauc.zza();
            zza.zzb(zzaxtVar.zza.longValue());
            zza.zzd(zzaxtVar.zzb.longValue());
            zza.zze(zzaxtVar.zzc.longValue());
            if (bool2.booleanValue()) {
                zza.zzc(zzaxtVar.zze.longValue());
            }
            if (bool.booleanValue()) {
                zza.zza(zzaxtVar.zzd.longValue());
            }
