...
public abstract class PhenotypeFlag<T> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:17:0x0026 A[Catch: all -> 0x0030, TryCatch #0 {, blocks: (B:6:0x000d, B:8:0x0013, B:15:0x0022, B:17:0x0026, B:18:0x0029, B:19:0x002b, B:11:0x001a), top: B:25:0x000d }] */
    /*
    ...
    */
    public static void maybeInit(android.content.Context r3) {
        /*
            ...
            r2 = 24
            if (r1 < r2) goto L1a
            boolean r1 = androidx.print.PrintHelper$$ExternalSyntheticApiModelOutline0.m(r3)     // Catch: java.lang.Throwable -> L30
            if (r1 == 0) goto L1a
            goto L22
        L1a:
        ...
        L21:
            r3 = r1
        L22:
            android.content.Context r1 = com.google.android.gms.phenotype.PhenotypeFlag.zzal     // Catch: java.lang.Throwable -> L30
            if (r1 == r3) goto L29
            r1 = 0
            com.google.android.gms.phenotype.PhenotypeFlag.zzan = r1     // Catch: java.lang.Throwable -> L30
        L29:
            com.google.android.gms.phenotype.PhenotypeFlag.zzal = r3     // Catch: java.lang.Throwable -> L30
            monitor-exit(r0)     // Catch: java.lang.Throwable -> L30
            r3 = 0
            com.google.android.gms.phenotype.PhenotypeFlag.zzam = r3
            goto L33
        L30:
            r3 = move-exception
            monitor-exit(r0)     // Catch: java.lang.Throwable -> L30
    ...
    private final T zzd() {
        ...
        if (zza("gms:phenotype:phenotype_flag:debug_bypass_phenotype", false)) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                isDeviceProtectedStorage = zzal.isDeviceProtectedStorage();
                if (!isDeviceProtectedStorage) {
                    systemService = zzal.getSystemService(UserManager.class);
