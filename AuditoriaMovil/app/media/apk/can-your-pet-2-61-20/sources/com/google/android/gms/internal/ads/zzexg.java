    ...
    */
    ...
    public final /* synthetic */ ListenableFuture zzc(Throwable th) throws Exception {
        ...
        if (th instanceof SecurityException) {
            zzexiVar = new zzexi("", 2, null);
        } else if (th instanceof IllegalStateException) {
            zzexiVar = new zzexi("", 3, null);
        } else if (th instanceof IllegalArgumentException) {
            zzexiVar = new zzexi("", 4, null);
        } else if (th instanceof TimeoutException) {
            zzexiVar = new zzexi("", 5, null);
        } else {
            zzexiVar = new zzexi("", 0, null);
        }
        return zzgee.zzh(zzexiVar);
    }
}
