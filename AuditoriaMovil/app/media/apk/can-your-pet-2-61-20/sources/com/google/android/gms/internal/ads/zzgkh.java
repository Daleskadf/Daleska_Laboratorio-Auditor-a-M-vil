...
public final class zzgkh {
    ...
    public static /* synthetic */ zzgjx zza(zzgot zzgotVar, zzggn zzggnVar) {
        if (!zzgotVar.zzg().equals("type.googleapis.com/google.crypto.tink.KmsEnvelopeAeadKey")) {
            throw new IllegalArgumentException("Wrong type URL in call to LegacyKmsEnvelopeAeadProtoSerialization.parseKey");
        }
        try {
            zzgvq zze2 = zzgvq.zze(zzgotVar.zze(), zzgzf.zza());
    ...
    public static /* synthetic */ zzgkc zzb(zzgou zzgouVar) {
    ...
    public static /* synthetic */ zzgot zzc(zzgjx zzgjxVar, zzggn zzggnVar) {
        ...
        zzc2.zza(zzg(zzgjxVar.zzb()));
        return zzgot.zza("type.googleapis.com/google.crypto.tink.KmsEnvelopeAeadKey", ((zzgvq) zzc2.zzbr()).zzaN(), zzguo.REMOTE, zzgvv.RAW, null);
    }
    ...
    private static zzgkc zzf(zzgvt zzgvtVar) throws GeneralSecurityException {
        zzgka zzgkaVar;
        zzgut zza2 = zzguu.zza();
        zza2.zzb(zzgvtVar.zza().zzi());
        zza2.zzc(zzgvtVar.zza().zzh());
        zza2.zza(zzgvv.RAW);
    ...
    private static zzgvt zzg(zzgkc zzgkcVar) throws GeneralSecurityException {
        try {
            zzguu zzf2 = zzguu.zzf(zzggp.zzb(zzgkcVar.zzb()), zzgzf.zza());
            zzgvs zzc2 = zzgvt.zzc();
            zzc2.zzb(zzgkcVar.zzc());
            zzc2.zza(zzf2);
