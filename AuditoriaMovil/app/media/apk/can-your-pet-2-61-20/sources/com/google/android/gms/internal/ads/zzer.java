...
public final class zzer implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public final void zzb(int i) throws zzes {
        EGLSurface eglCreatePbufferSurface;
        EGLDisplay eglGetDisplay = EGL14.eglGetDisplay(0);
        zzet.zza(eglGetDisplay != null, "eglGetDisplay failed");
        int[] iArr = new int[2];
        zzet.zza(EGL14.eglInitialize(eglGetDisplay, iArr, 0, iArr, 1), "eglInitialize failed");
        this.zzd = eglGetDisplay;
        EGLConfig[] eGLConfigArr = new EGLConfig[1];
        int[] iArr2 = new int[1];
        boolean eglChooseConfig = EGL14.eglChooseConfig(eglGetDisplay, zza, 0, eGLConfigArr, 0, 1, iArr2, 0);
        zzet.zza(eglChooseConfig && iArr2[0] > 0 && eGLConfigArr[0] != null, String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr2[0]), eGLConfigArr[0]));
        ...
        zzet.zza(eglCreateContext != null, "eglCreateContext failed");
        ...
        if (i == 1) {
            ...
            zzet.zza(eglCreatePbufferSurface != null, "eglCreatePbufferSurface failed");
        }
        zzet.zza(EGL14.eglMakeCurrent(eGLDisplay, eglCreatePbufferSurface, eglCreatePbufferSurface, eglCreateContext), "eglMakeCurrent failed");
