...
final class zzgzb {
    ...
    public final void zzs(int i, List list, boolean z) throws IOException {
        ...
        int i3 = 0;
        for (int i4 = 0; i4 < list.size(); i4++) {
            i3 += zzgza.zzE(((Integer) list.get(i4)).intValue());
        }
        this.zza.zzu(i3);
        while (i2 < list.size()) {
    ...
    public final void zzC(int i, List list, boolean z) throws IOException {
        ...
        if (!z) {
            while (i2 < list.size()) {
                ...
                zzgzaVar.zzt(i, (intValue >> 31) ^ (intValue + intValue));
                i2++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < list.size(); i4++) {
            ...
            i3 += zzgza.zzD((intValue2 >> 31) ^ (intValue2 + intValue2));
        }
        this.zza.zzu(i3);
        while (i2 < list.size()) {
            zzgza zzgzaVar2 = this.zza;
            int intValue3 = ((Integer) list.get(i2)).intValue();
            zzgzaVar2.zzu((intValue3 >> 31) ^ (intValue3 + intValue3));
            i2++;
        }
    }
    ...
    public final void zzE(int i, List list, boolean z) throws IOException {
        ...
        if (!z) {
            while (i2 < list.size()) {
                ...
                zzgzaVar.zzv(i, (longValue >> 63) ^ (longValue + longValue));
                i2++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < list.size(); i4++) {
            ...
            i3 += zzgza.zzE((longValue2 >> 63) ^ (longValue2 + longValue2));
        }
        this.zza.zzu(i3);
        while (i2 < list.size()) {
            zzgza zzgzaVar2 = this.zza;
            long longValue3 = ((Long) list.get(i2)).longValue();
            zzgzaVar2.zzw((longValue3 >> 63) ^ (longValue3 + longValue3));
            i2++;
        }
    }
