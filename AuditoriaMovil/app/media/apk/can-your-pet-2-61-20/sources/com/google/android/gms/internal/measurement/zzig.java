...
final class zzig extends zzic<Boolean> implements zzke<Boolean>, zzlu, RandomAccess {
    private static final zzig zza = new zzig(new boolean[0], 0, false);
    private boolean[] zzb;
    private int zzc;
    ...
    public final /* synthetic */ zzke<Boolean> zza(int i) {
        if (i < this.zzc) {
            throw new IllegalArgumentException();
        }
        return new zzig(Arrays.copyOf(this.zzb, i), this.zzc, true);
    }
    ...
    private zzig(boolean[] zArr, int i, boolean z) {
        super(z);
        this.zzb = zArr;
        this.zzc = i;
    }
