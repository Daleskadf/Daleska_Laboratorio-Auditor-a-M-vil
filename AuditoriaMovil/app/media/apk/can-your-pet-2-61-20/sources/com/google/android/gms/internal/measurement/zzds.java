...
public class zzds {
    ...
    public final int zza(String str) {
        ...
        Integer num = (Integer) zzde.zza(zzdeVar.zza(WorkRequest.MIN_BACKOFF_MILLIS), Integer.class);
        if (num == null) {
            return 25;
        }
        return num.intValue();
    ...
    public final void zzb(com.google.android.gms.measurement.internal.zzix zzixVar) {
        Pair<com.google.android.gms.measurement.internal.zzix, zzb> pair;
        Preconditions.checkNotNull(zzixVar);
        synchronized (this.zzf) {
            int i = 0;
            while (true) {
                if (i >= this.zzf.size()) {
                    pair = null;
                    break;
                } else if (zzixVar.equals(this.zzf.get(i).first)) {
                    pair = this.zzf.get(i);
                    break;
                } else {
                    i++;
