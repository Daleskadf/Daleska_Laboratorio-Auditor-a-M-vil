...
public abstract class zzcx {
    ...
    public static zzcp zzb(Class cls) {
        String format;
        ...
        } else if (!cls.getPackage().equals(zzcx.class.getPackage())) {
        ...
        try {
            try {
                try {
                    try {
                        return (zzcp) cls.cast(((zzcx) Class.forName(format, true, classLoader).getConstructor(new Class[0]).newInstance(new Object[0])).zza());
