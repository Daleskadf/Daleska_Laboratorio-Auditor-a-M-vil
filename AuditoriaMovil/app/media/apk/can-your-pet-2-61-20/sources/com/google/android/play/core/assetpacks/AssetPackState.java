...
public abstract class AssetPackState {
    ...
    public static AssetPackState b(Bundle bundle, String str, co coVar, ea eaVar, be beVar) {
        ...
        return a(str, i3, i, j, j2, a2, i2, bundle.getString(com.google.android.play.core.assetpacks.model.b.a("pack_version_tag", str), String.valueOf(bundle.getInt("app_version_code"))), eaVar.a(str));
    }
