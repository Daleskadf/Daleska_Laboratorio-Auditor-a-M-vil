...
public final class zzfwr {
    public static int zza(int i, int i2, String str) {
        ...
        if (i < 0 || i >= i2) {
            if (i < 0) {
                zzb = zzfxg.zzb("%s (%s) must not be negative", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i));
            } else if (i2 < 0) {
                throw new IllegalArgumentException("negative size: " + i2);
            } else {
                zzb = zzfxg.zzb("%s (%s) must be less than size (%s)", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i), Integer.valueOf(i2));
            }
    ...
    public static void zzi(int i, int i2, int i3) {
        ...
        if (i < 0 || i2 < i || i2 > i3) {
            if (i < 0 || i > i3) {
                ...
                zzl = (i2 < 0 || i2 > i3) ? zzl(i2, i3, "end index") : zzfxg.zzb("end index (%s) must not be less than start index (%s)", Integer.valueOf(i2), Integer.valueOf(i));
            }
