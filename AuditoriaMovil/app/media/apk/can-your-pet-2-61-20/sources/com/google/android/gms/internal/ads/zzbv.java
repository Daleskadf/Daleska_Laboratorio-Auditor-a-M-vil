...
public final class zzbv {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            if (zzfx.zzG(this.zzc, zzbvVar.zzc) && zzfx.zzG(this.zzd, zzbvVar.zzd) && zzfx.zzG(this.zze, zzbvVar.zze) && zzfx.zzG(this.zzf, zzbvVar.zzf) && zzfx.zzG(null, null) && zzfx.zzG(null, null) && zzfx.zzG(this.zzg, zzbvVar.zzg) && zzfx.zzG(null, null) && zzfx.zzG(null, null) && Arrays.equals(this.zzh, zzbvVar.zzh) && zzfx.zzG(this.zzi, zzbvVar.zzi) && zzfx.zzG(null, null) && zzfx.zzG(this.zzj, zzbvVar.zzj) && zzfx.zzG(this.zzk, zzbvVar.zzk) && zzfx.zzG(this.zzl, zzbvVar.zzl) && zzfx.zzG(this.zzm, zzbvVar.zzm) && zzfx.zzG(null, null) && zzfx.zzG(this.zzo, zzbvVar.zzo) && zzfx.zzG(this.zzp, zzbvVar.zzp) && zzfx.zzG(this.zzq, zzbvVar.zzq) && zzfx.zzG(this.zzr, zzbvVar.zzr) && zzfx.zzG(this.zzs, zzbvVar.zzs) && zzfx.zzG(this.zzt, zzbvVar.zzt) && zzfx.zzG(this.zzu, zzbvVar.zzu) && zzfx.zzG(this.zzv, zzbvVar.zzv) && zzfx.zzG(this.zzw, zzbvVar.zzw) && zzfx.zzG(null, null) && zzfx.zzG(null, null) && zzfx.zzG(this.zzx, zzbvVar.zzx) && zzfx.zzG(null, null) && zzfx.zzG(this.zzy, zzbvVar.zzy) && zzfx.zzG(this.zzz, zzbvVar.zzz)) {
                return true;
            }
        }
        return false;
