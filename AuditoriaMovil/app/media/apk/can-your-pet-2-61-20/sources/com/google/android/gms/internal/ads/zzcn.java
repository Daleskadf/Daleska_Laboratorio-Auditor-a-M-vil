...
public final class zzcn {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            if (this.zzg == zzcnVar.zzg && this.zzj == zzcnVar.zzj && this.zzk == zzcnVar.zzk && this.zzl == zzcnVar.zzl && this.zzm == zzcnVar.zzm && this.zzn == zzcnVar.zzn && zzfwl.zza(this.zzh, zzcnVar.zzh) && zzfwl.zza(this.zzf, zzcnVar.zzf) && zzfwl.zza(this.zzi, zzcnVar.zzi)) {
                return true;
            }
        }
        return false;
