...
public final class zzgy extends zzdd implements zzel {
    ...
    public static /* synthetic */ void zzC(zzgy zzgyVar, zzho zzhoVar) {
        zzhoVar.getClass();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ void zzD(zzgy zzgyVar, zzgr zzgrVar) {
        zzgrVar.getClass();
        zzgyVar.zzj = zzgrVar;
        zzgyVar.zze |= 4;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ void zzE(zzgy zzgyVar, boolean z) {
        zzgyVar.zze |= 8;
        zzgyVar.zzk = z;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ void zzF(zzgy zzgyVar, boolean z) {
        zzgyVar.zze |= 16;
        zzgyVar.zzl = false;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ void zzG(zzgy zzgyVar, Iterable iterable) {
        zzdi zzdiVar = zzgyVar.zzh;
        if (!zzdiVar.zzc()) {
            int size = zzdiVar.size();
            zzgyVar.zzh = zzdiVar.zzg(size == 0 ? 10 : size + size);
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ void zzH(zzgy zzgyVar, int i) {
        zzgyVar.zzg = i - 1;
        zzgyVar.zze |= 2;
    }
