...
final class zzcgc extends zzgp implements zzht {
    ...
    public zzcgc(String str, zzhy zzhyVar, int i, int i2, long j, long j2) {
        super(true);
        zzek.zzc(str);
        this.zze = str;
        this.zzf = new zzhs();
    ...
    final HttpURLConnection zzk(long j, long j2, int i) throws zzhp {
        ...
        try {
            ...
            try {
                ...
                throw new zzhp("Unable to connect to ".concat(valueOf), e2, this.zzg, 2000, i);
            }
        } catch (IOException e3) {
            String valueOf2 = String.valueOf(uri);
            throw new zzhp("Unable to connect to ".concat(valueOf2), e3, this.zzg, 2000, i);
        }
    }
}
