...
final class zzgdg extends zzgdf {
    ...
    public zzgdg(AtomicReferenceFieldUpdater atomicReferenceFieldUpdater, AtomicIntegerFieldUpdater atomicIntegerFieldUpdater) {
        super(null);
    ...
    public final void zzb(zzgdj zzgdjVar, @CheckForNull Set set, Set set2) {
        ...
        do {
            ...
            if (AbstractFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, zzgdjVar, null, set2)) {
                return;
            }
