...
public final class zzasf extends zzhie {
    ...
    public final void zzf(ByteBuffer byteBuffer) {
        ...
        double zza = zzasb.zza(byteBuffer);
        this.zzm = new zzhio(zzb, zzb2, zzasb.zzb(byteBuffer), zzasb.zzb(byteBuffer), zza, zzasb.zza(byteBuffer), zzasb.zza(byteBuffer), zzasb.zzb(byteBuffer), zzasb.zzb(byteBuffer));
        byteBuffer.getInt();
        byteBuffer.getInt();
        byteBuffer.getInt();
        byteBuffer.getInt();
