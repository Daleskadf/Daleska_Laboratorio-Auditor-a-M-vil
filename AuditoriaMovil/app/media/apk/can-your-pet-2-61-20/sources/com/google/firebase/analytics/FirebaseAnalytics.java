...
public final class FirebaseAnalytics {
    ...
    public static zzkq getScionFrontendApiImplementation(Context context, Bundle bundle) {
        zzds zza2 = zzds.zza(context, (String) null, (String) null, (String) null, bundle);
        if (zza2 == null) {
            return null;
        }
        return new zzd(zza2);
    ...
    public static FirebaseAnalytics getInstance(Context context) {
        if (zza == null) {
            synchronized (FirebaseAnalytics.class) {
                if (zza == null) {
                    zza = new FirebaseAnalytics(zzds.zza(context));
                }
            }
        }
        return zza;
    ...
    public final void setConsent(Map<ConsentType, ConsentStatus> map) {
        ...
        if (consentStatus != null) {
            ...
            if (ordinal == 0) {
                ...
                bundle.putString("ad_storage", AuthorisationStatus.DENIED);
            }
        }
        ...
        if (consentStatus2 != null) {
            ...
            if (ordinal2 == 0) {
                ...
                bundle.putString("analytics_storage", AuthorisationStatus.DENIED);
            }
        }
        ...
        if (consentStatus3 != null) {
            ...
            if (ordinal3 == 0) {
                ...
                bundle.putString("ad_user_data", AuthorisationStatus.DENIED);
            }
        }
        ...
        if (consentStatus4 != null) {
            ...
            if (ordinal4 == 0) {
                ...
                bundle.putString("ad_personalization", AuthorisationStatus.DENIED);
            }
        }
        this.zzb.zzc(bundle);
    }
