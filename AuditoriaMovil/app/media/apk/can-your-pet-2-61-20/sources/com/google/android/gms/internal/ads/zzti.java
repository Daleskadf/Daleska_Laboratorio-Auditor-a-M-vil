    ...
    */
    public static com.google.android.gms.internal.ads.zzti zzc(java.lang.String r12, java.lang.String r13, java.lang.String r14, android.media.MediaCodecInfo.CodecCapabilities r15, boolean r16, boolean r17, boolean r18, boolean r19, boolean r20) {
        /*
            ...
            java.lang.String r5 = com.google.android.gms.internal.ads.zzfx.zzd
    ...
    private final void zzj(String str) {
        String str2 = zzfx.zze;
        zzfe.zzb("MediaCodecInfo", "NoSupport [" + str + "] [" + this.zza + ", " + this.zzb + "] [" + str2 + "]");
    }
    ...
    private final boolean zzl(zzam zzamVar, boolean z) {
        ...
        if (zza != null) {
            ...
            if (zzfx.zza <= 23 && "video/x-vnd.on2.vp9".equals(this.zzb) && zzh.length == 0) {
            ...
            while (i < length) {
                ...
                i = (codecProfileLevel2.profile != intValue || (codecProfileLevel2.level < intValue2 && z) || ("video/hevc".equals(this.zzb) && intValue == 2 && ("sailfish".equals(zzfx.zzb) || "marlin".equals(zzfx.zzb)))) ? i + 1 : 0;
            }
            String str = zzamVar.zzj;
            String str2 = this.zzc;
            zzj("codec.profileLevel, " + str + ", " + str2);
            return false;
        }
        return true;
    }
                ...
                if (codecCapabilities2 == null) {
                    ...
                    if (audioCapabilities2 == null) {
                        ...
                        if (maxInputChannelCount <= 1 && ((zzfx.zza < 26 || maxInputChannelCount <= 0) && !"audio/mpeg".equals(str2) && !"audio/3gpp".equals(str2) && !"audio/amr-wb".equals(str2) && !"audio/mp4a-latm".equals(str2) && !"audio/vorbis".equals(str2) && !"audio/opus".equals(str2) && !"audio/raw".equals(str2) && !"audio/flac".equals(str2) && !"audio/g711-alaw".equals(str2) && !"audio/g711-mlaw".equals(str2) && !"audio/gsm".equals(str2))) {
                            ...
                            zzfe.zzf("MediaCodecInfo", "AssumedMaxChannelAdjustment: " + str + ", [" + maxInputChannelCount + " to " + i + "]");
    ...
    public final boolean zzg(int i, int i2, double d) {
        ...
        if (!zzk(videoCapabilities, i, i2, d)) {
            if (i < i2 && ((!"OMX.MTK.VIDEO.DECODER.HEVC".equals(this.zza) || !"mcv5a".equals(zzfx.zzb)) && zzk(videoCapabilities, i2, i, d))) {
                zzfe.zzb("MediaCodecInfo", "AssumedSupport [" + ("sizeAndRate.rotated, " + i + "x" + i2 + "@" + d) + "] [" + this.zza + ", " + this.zzb + "] [" + zzfx.zze + "]");
            } else {
