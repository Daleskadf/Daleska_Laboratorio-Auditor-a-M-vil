...
public final class zzdyc extends com.google.android.gms.ads.internal.client.zzdi {
    ...
    public final synchronized void zzh(final String str, String str2, final String str3) {
        ...
        if (c == 0) {
            ...
            builder.forNativeAd(new NativeAd.OnNativeAdLoadedListener() { // from class: com.google.android.gms.internal.ads.zzdxr
                @Override // com.google.android.gms.ads.nativead.NativeAd.OnNativeAdLoadedListener
                public final void onNativeAdLoaded(NativeAd nativeAd) {
                    zzdyc.this.zzg(str, nativeAd, str3);
                }
            });
            builder.withAdListener(new zzdxz(this, str3));
    ...
    public final synchronized void zzi(String str, String str2) {
        ...
        if (zzg != null && (obj = this.zza.get(str)) != null) {
            ...
            if (obj instanceof AppOpenAd) {
                ...
                ((RewardedAd) obj).show(zzg, new OnUserEarnedRewardListener() { // from class: com.google.android.gms.internal.ads.zzdxs
                    @Override // com.google.android.gms.ads.OnUserEarnedRewardListener
                    public final void onUserEarnedReward(RewardItem rewardItem) {
                    }
                });
            } else if (obj instanceof RewardedInterstitialAd) {
                ((RewardedInterstitialAd) obj).show(zzg, new OnUserEarnedRewardListener() { // from class: com.google.android.gms.internal.ads.zzdxt
                    @Override // com.google.android.gms.ads.OnUserEarnedRewardListener
                    public final void onUserEarnedReward(RewardItem rewardItem) {
                    }
                });
            } else if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zzjn)).booleanValue() && ((obj instanceof AdView) || (obj instanceof NativeAd))) {
