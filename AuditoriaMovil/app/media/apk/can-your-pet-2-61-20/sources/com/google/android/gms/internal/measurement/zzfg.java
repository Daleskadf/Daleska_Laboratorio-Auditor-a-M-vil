...
final class zzfg extends zzds.zza {
    ...
    public zzfg(zzds.zzd zzdVar, Activity activity, zzde zzdeVar) {
        super(zzds.this);
        this.zzc = activity;
        this.zzd = zzdeVar;
        this.zze = zzdVar;
    ...
    final void zza() throws RemoteException {
        ...
        ((zzdd) Preconditions.checkNotNull(zzddVar)).onActivitySaveInstanceState(ObjectWrapper.wrap(this.zzc), this.zzd, this.zzb);
    }
}
