...
public final class zzfcf implements zzfde {
    ...
    public final ListenableFuture zzb(zzfdf zzfdfVar, zzfdd zzfddVar, zzcxx zzcxxVar) {
        ...
        zza.zzb(new zzfdi(true));
        zzcxx zzcxxVar2 = (zzcxx) zza.zzh();
        this.zza = zzcxxVar2;
        final zzcvd zzb = zzcxxVar2.zzb();
        final zzfif zzfifVar = new zzfif();
        return zzgee.zzm(zzgee.zzn(zzgdv.zzu(zzb.zzj()), new zzgdl() { // from class: com.google.android.gms.internal.ads.zzfcd
            ...
            public final ListenableFuture zza(Object obj) {
                ...
                loop0: while (true) {
                    if (it.hasNext()) {
                        for (String str : ((zzffn) it.next()).zza) {
                        ...
                        return zzb.zzi(zzgee.zzh(zzffzVar));
                    }
                }
