...
public final class zzgyp extends zzgyt {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public /* synthetic */ zzgyp(InputStream inputStream, int i, zzgyo zzgyoVar) {
        super(null);
    ...
    public final zzgyj zzw() throws IOException {
        ...
        int i2 = this.zzi;
        if (zzj <= i - i2 && zzj > 0) {
            zzgyj zzv = zzgyj.zzv(this.zzf, i2, zzj);
            this.zzi += zzj;
            return zzv;
        } else if (zzj != 0) {
            byte[] zzP = zzP(zzj);
    ...
    public final String zzx() throws IOException {
        ...
        if (zzj > 0) {
            ...
            int i2 = this.zzi;
            if (zzj <= i - i2) {
                String str = new String(this.zzf, i2, zzj, zzhai.zzb);
                this.zzi += zzj;
                return str;
            }
        }
        ...
        if (zzj <= this.zzg) {
            zzM(zzj);
            String str2 = new String(this.zzf, this.zzi, zzj, zzhai.zzb);
            this.zzi += zzj;
            return str2;
        }
        return new String(zzO(zzj, false), zzhai.zzb);
    }
