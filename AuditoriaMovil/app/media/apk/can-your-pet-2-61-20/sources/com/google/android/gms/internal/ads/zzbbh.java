...
public final class zzbbh {
    ...
    public static void zzc(String[] strArr, int i, int i2, PriorityQueue priorityQueue) {
        ...
        while (true) {
            ...
            zze = ((((((zze + 1073807359) - ((zza(16785407L, 5) * ((zzbbd.zza(strArr[i3 - 1]) + 2147483647L) % 1073807359)) % 1073807359)) % 1073807359) * 16785407) % 1073807359) + ((zzbbd.zza(strArr[i3 + 5]) + 2147483647L) % 1073807359)) % 1073807359;
    ...
    private static long zze(String[] strArr, int i, int i2) {
        long zza = (zzbbd.zza(strArr[0]) + 2147483647L) % 1073807359;
        for (int i3 = 1; i3 < i2; i3++) {
            zza = (((zza * 16785407) % 1073807359) + ((zzbbd.zza(strArr[i3]) + 2147483647L) % 1073807359)) % 1073807359;
        }
        return zza;
    }
}
