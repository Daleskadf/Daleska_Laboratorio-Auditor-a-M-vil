...
public final class zzfiy {
    ...
    public zzfiy(final zzfhw zzfhwVar, final zzfiq zzfiqVar, final zzfir zzfirVar) {
        ...
        this.zzb = zzgee.zzf(zzgee.zzn(zzfiqVar.zza(zzfirVar), new zzgdl() { // from class: com.google.android.gms.internal.ads.zzfiw
            ...
            public final ListenableFuture zza(Object obj) {
                return zzfiy.this.zzb(zzfiqVar, zzfhwVar, zzfirVar, (zzfif) obj);
            }
        }, zzfirVar.zzb()), Exception.class, new zzgdl() { // from class: com.google.android.gms.internal.ads.zzfix
            @Override // com.google.android.gms.internal.ads.zzgdl
            public final ListenableFuture zza(Object obj) {
                return zzfiy.this.zzc(zzfiqVar, (Exception) obj);
            }
        }, zzfirVar.zzb());
    }
    ...
    public final /* synthetic */ ListenableFuture zzb(zzfiq zzfiqVar, zzfhw zzfhwVar, zzfir zzfirVar, zzfif zzfifVar) throws Exception {
        synchronized (this) {
            this.zzd = true;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final /* synthetic */ ListenableFuture zzc(zzfiq zzfiqVar, Exception exc) throws Exception {
        synchronized (this) {
            this.zzd = true;
            throw exc;
        }
