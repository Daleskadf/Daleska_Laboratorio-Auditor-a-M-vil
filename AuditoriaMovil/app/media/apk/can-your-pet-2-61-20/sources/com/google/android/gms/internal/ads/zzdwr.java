...
public final class zzdwr extends zzftn {
    ...
    public final void zza(SensorEvent sensorEvent) {
        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zziX)).booleanValue()) {
            ...
            if (this.zzf + ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zziZ)).intValue() < currentTimeMillis) {
                this.zzg = 0;
            ...
            this.zze = valueOf;
            if (valueOf.floatValue() > this.zzd + ((Float) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zziY)).floatValue()) {
                this.zzd = this.zze.floatValue();
                this.zzi = true;
            } else {
