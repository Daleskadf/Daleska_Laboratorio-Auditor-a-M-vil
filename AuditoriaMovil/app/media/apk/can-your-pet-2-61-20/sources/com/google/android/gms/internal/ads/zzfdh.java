...
public final class zzfdh implements zzhiv {
    ...
    public zzfdh(zzhjm zzhjmVar, zzhjm zzhjmVar2, zzhjm zzhjmVar3) {
        this.zza = zzhjmVar;
        this.zzb = zzhjmVar2;
        this.zzc = zzhjmVar3;
    }
    ...
    public final zzfde zzb() {
        ...
        if (((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zzgw)).intValue() > 0) {
            if (!((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zzgt)).booleanValue() || z) {
                zzfij zza = zzfikVar.zza(zzfia.Rewarded, context, zzfhsVar, new zzfci(new zzfcf()));
