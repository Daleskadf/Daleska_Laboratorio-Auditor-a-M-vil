...
public final class zzelm implements zzegp {
    ...
    public static /* bridge */ /* synthetic */ Executor zzc(zzelm zzelmVar) {
        return zzelmVar.zzb;
    }
    ...
    public final /* bridge */ /* synthetic */ Object zza(zzffz zzffzVar, zzffn zzffnVar, final zzegm zzegmVar) throws zzfgp, zzekh {
        zzdqn zze = this.zzc.zze(new zzcul(zzffzVar, zzffnVar, zzegmVar.zza), new zzdqo(new zzdiu() { // from class: com.google.android.gms.internal.ads.zzeli
        ...
        zze.zzd().zzo(new zzcpa((zzfhg) zzegmVar.zzb), this.zzb);
        zzczx zze2 = zze.zze();
        zzcyo zzb = zze.zzb();
        ((zzeig) zzegmVar.zzc).zzc(new zzell(this, zze.zza(), zzb, zze2, zze.zzg()));
        return zze.zzk();
    }
    ...
    public final void zzb(zzffz zzffzVar, zzffn zzffnVar, zzegm zzegmVar) throws zzfgp {
        if (!((zzfhg) zzegmVar.zzb).zzC()) {
            ...
            String jSONObject = zzffnVar.zzw.toString();
            ((zzfhg) obj).zzh(context, zzfgiVar.zzd, null, (zzbyb) zzegmVar.zzc, jSONObject);
            return;
        }
