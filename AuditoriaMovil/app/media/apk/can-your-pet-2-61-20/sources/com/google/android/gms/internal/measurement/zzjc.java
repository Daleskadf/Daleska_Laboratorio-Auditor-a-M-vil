...
public abstract class zzjc extends zzij {
        ...
        public final void zzb(String str) throws IOException {
            ...
            try {
                ...
                if (zzg2 == zzg) {
                    int i2 = i + zzg2;
                    this.zze = i2;
                    int zza = zznf.zza(str, this.zzb, i2, zza());
                    this.zze = i;
                    zzk((zza - i) - zzg2);
                    this.zze = zza;
                    return;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public abstract void zzc(int i, zzli zzliVar, zzma zzmaVar) throws IOException;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Deprecated
    public static int zza(int i, zzli zzliVar, zzma zzmaVar) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int zzb(int i, zzli zzliVar, zzma zzmaVar) {
