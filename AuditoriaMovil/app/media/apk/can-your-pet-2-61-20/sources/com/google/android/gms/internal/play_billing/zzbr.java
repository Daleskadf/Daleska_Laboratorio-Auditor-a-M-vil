...
final class zzbr extends zzbn implements RandomAccess, zzdk, zzer {
    private static final zzbr zza = new zzbr(new boolean[0], 0, false);
    private boolean[] zzb;
    private int zzc;
    ...
    private zzbr(boolean[] zArr, int i, boolean z) {
        super(z);
        this.zzb = zArr;
        this.zzc = i;
    }
