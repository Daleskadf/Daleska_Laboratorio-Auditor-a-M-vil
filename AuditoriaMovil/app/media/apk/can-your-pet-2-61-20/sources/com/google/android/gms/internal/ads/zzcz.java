...
public final class zzcz {
    ...
    public zzcz(String str, zzam... zzamVarArr) {
        ...
        while (true) {
            ...
            if (zzc.equals(zzc(zzamVarArr2[i].zzd))) {
                zzam[] zzamVarArr3 = this.zzg;
                if (i2 != (zzamVarArr3[i].zzf | 16384)) {
                    zzd("role flags", Integer.toBinaryString(zzamVarArr3[0].zzf), Integer.toBinaryString(this.zzg[i].zzf), i);
                    return;
                }
                i++;
            } else {
                zzam[] zzamVarArr4 = this.zzg;
                zzd("languages", zzamVarArr4[0].zzd, zzamVarArr4[i].zzd, i);
                return;
            }
        }
    }
