...
public final class zzfrg implements zzfps {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public zzfrg(Object obj, zzfrh zzfrhVar, zzfrs zzfrsVar, zzfpp zzfppVar) {
        this.zza = obj;
        this.zzb = zzfrhVar;
        this.zzc = zzfrsVar;
        this.zzd = zzfppVar;
    ...
    private static String zzi(byte[] bArr) {
        ...
        zzauv zza = zzauw.zza();
        zza.zzb(zzauk.DG);
        zza.zza(zzgyj.zzv(bArr, 0, bArr.length));
        return Base64.encodeToString(((zzauw) zza.zzbr()).zzaV(), 11);
    }
