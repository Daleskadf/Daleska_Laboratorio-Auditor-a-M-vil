...
public final class zzhdm {
    ...
    */
    public static int zzd(java.lang.String r8, byte[] r9, int r10, int r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzhdm.zzd(java.lang.String, byte[], int, int):int");
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static String zzg(ByteBuffer byteBuffer, int i, int i2) throws zzhak {
        zzhdj zzhdjVar = zza;
        if (byteBuffer.hasArray()) {
            return zzhdjVar.zzb(byteBuffer.array(), byteBuffer.arrayOffset() + i, i2);
        } else if (byteBuffer.isDirect()) {
            return zzhdk.zzd(byteBuffer, i, i2);
        } else {
            return zzhdj.zzd(byteBuffer, i, i2);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static String zzh(byte[] bArr, int i, int i2) throws zzhak {
