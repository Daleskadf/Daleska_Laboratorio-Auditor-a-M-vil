...
public final class zzun implements zzvr, zzsh {
    ...
    private final boolean zzg(int i, zzvh zzvhVar) {
        ...
        int i2 = zzvqVar.zza;
        if (!zzfx.zzG(zzvqVar.zzb, zzvhVar2)) {
            this.zzc = this.zza.zzf(0, zzvhVar2);
        }
        zzsg zzsgVar = this.zzd;
        int i3 = zzsgVar.zza;
        if (zzfx.zzG(zzsgVar.zzb, zzvhVar2)) {
            return true;
        }
        this.zzd = this.zza.zzd(0, zzvhVar2);
        return true;
    }
