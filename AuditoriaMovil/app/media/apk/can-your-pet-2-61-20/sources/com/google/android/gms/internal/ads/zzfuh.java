...
final class zzfuh extends zzfva {
    ...
    public /* synthetic */ zzfuh(IBinder iBinder, boolean z, String str, int i, float f, int i2, int i3, String str2, int i4, String str3, String str4, String str5, zzfug zzfugVar) {
        this.zza = iBinder;
        this.zzb = str;
        this.zzc = i;
        this.zzd = f;
