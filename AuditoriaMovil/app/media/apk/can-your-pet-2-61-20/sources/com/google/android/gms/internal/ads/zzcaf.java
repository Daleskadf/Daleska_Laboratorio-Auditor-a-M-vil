...
public final class zzcaf {
    ...
    public static String zzb(Uri uri, Context context) {
        ...
        if (!((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zzad)).booleanValue() || !uri2.contains(str)) {
            if (TextUtils.isEmpty(uri.getQueryParameter("fbs_aeid"))) {
                String uri3 = zza(zzd(uri2, context), "fbs_aeid", zza).toString();
                com.google.android.gms.ads.internal.zzu.zzn().zzj(context, zza);
                return uri3;
            }
            return uri2;
        }
    ...
    public static String zzc(String str, Context context, boolean z) {
        String zza;
        if ((!((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zzal)).booleanValue() || z) && com.google.android.gms.ads.internal.zzu.zzn().zzp(context) && !TextUtils.isEmpty(str) && (zza = com.google.android.gms.ads.internal.zzu.zzn().zza(context)) != null) {
            ...
            if (!((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zzad)).booleanValue() || !str.contains(str2)) {
                ...
                } else if (com.google.android.gms.ads.internal.zzu.zzp().zzj(str)) {
                    com.google.android.gms.ads.internal.zzu.zzn().zzk(context, zza);
                    return zza(zzd(str, context), "fbs_aeid", zza).toString();
                } else {
                    return str;
                }
            } else if (com.google.android.gms.ads.internal.zzu.zzp().zzi(str)) {
                com.google.android.gms.ads.internal.zzu.zzn().zzj(context, zza);
