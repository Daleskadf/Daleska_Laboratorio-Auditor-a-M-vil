...
final class zzapf implements zzapg {
    ...
    public zzapf(zzadi zzadiVar, zzaem zzaemVar, zzapj zzapjVar) throws zzcc {
        ...
        this.zzd = zzaemVar;
        this.zze = zzapjVar;
        int max = Math.max(1, zzapjVar.zzc / 10);
        this.zzi = max;
        ...
        this.zzh = new zzfo(i4 * (zzk + zzk) * i);
        int i5 = ((zzapjVar.zzc * zzapjVar.zzd) * 8) / zzk;
    ...
    private final void zzf(int i) {
        long zzt = this.zzl + zzfx.zzt(this.zzn, 1000000L, this.zze.zzc, RoundingMode.FLOOR);
        int zze = zze(i);
