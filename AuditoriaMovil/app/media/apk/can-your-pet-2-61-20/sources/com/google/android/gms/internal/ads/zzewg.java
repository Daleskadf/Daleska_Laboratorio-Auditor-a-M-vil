...
public final class zzewg implements zzewr {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final /* synthetic */ zzewh zzc() throws Exception {
        ...
        return new zzewh(isCallerInstantApp, zzE, str, zzF, i, DynamiteModule.getRemoteVersion(context, ModuleDescriptor.MODULE_ID), DynamiteModule.getLocalVersion(context, ModuleDescriptor.MODULE_ID), this.zzd);
    }
}
