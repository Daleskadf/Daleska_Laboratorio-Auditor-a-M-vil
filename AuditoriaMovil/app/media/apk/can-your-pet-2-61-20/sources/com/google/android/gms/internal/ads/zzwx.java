...
public final class zzwx implements zzaem {
    ...
    public zzwx(zzzo zzzoVar, zzsm zzsmVar, zzsg zzsgVar) {
        this.zzd = zzsmVar;
        this.zze = zzsgVar;
    ...
    private final synchronized int zzC(zzlb zzlbVar, zzih zzihVar, boolean z, boolean z2, zzwt zzwtVar) {
        ...
        if (!z && zzamVar2 == this.zzg) {
            ...
            zzwtVar.zza = this.zzk[zzB];
            zzwtVar.zzb = this.zzj[zzB];
            zzwtVar.zzc = this.zzn[zzB];
            return -4;
        }
    ...
    private final synchronized void zzG(long j, int i, long j2, int i2, zzael zzaelVar) {
        ...
        if (i3 > 0) {
            int zzB = zzB(i3 - 1);
            zzek.zzd(this.zzj[zzB] + ((long) this.zzk[zzB]) <= j2);
        }
    ...
    public final synchronized int zzc(long j, boolean z) {
        int i = this.zzr;
        int zzB = zzB(i);
        if (zzK() && j >= this.zzm[zzB]) {
            if (j > this.zzu && z) {
                return this.zzo - i;
            }
            int zzA = zzA(zzB, this.zzo - i, j, true);
            if (zzA == -1) {
                return 0;
            }
            return zzA;
