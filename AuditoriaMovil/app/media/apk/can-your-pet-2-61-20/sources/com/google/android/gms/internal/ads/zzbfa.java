...
public final class zzbfa {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:22:0x0049, code lost:
        if (((java.lang.Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(com.google.android.gms.internal.ads.zzbdz.zzjH)).booleanValue() != false) goto L19;
     */
    /*
    ...
    */
    ...
    public final void zzg(@Nonnull Context context, @Nonnull CustomTabsClient customTabsClient, @Nonnull String str, @Nullable CustomTabsCallback customTabsCallback) {
        ...
        if (customTabsClient != null) {
            ...
            this.zzc = zzbexVar;
            CustomTabsSession newSession = customTabsClient.newSession(zzbexVar);
            this.zzd = newSession;
            if (newSession == null) {
