...
public final class zzox implements zzou {
    ...
    static {
        ...
        zzb = zza2.zza("measurement.service.consent.aiid_reset_fix", false);
        zzc = zza2.zza("measurement.service.consent.aiid_reset_fix2", true);
        zzd = zza2.zza("measurement.service.consent.app_start_fix", true);
        zze = zza2.zza("measurement.service.consent.params_on_fx", false);
        zzf = zza2.zza("measurement.service.consent.pfo_on_fx", true);
        zzg = zza2.zza("measurement.id.service.consent.params_on_fx", 0L);
    }
