...
public final class zzau {
    ...
    public static void zza(zzfz zzfzVar, SQLiteDatabase sQLiteDatabase, String str, String str2, String str3, String[] strArr) throws SQLiteException {
        String[] split;
        if (zzfzVar == null) {
        ...
        try {
            ...
            zzfzVar.zzu().zza("Table has extra columns. table, columns", str, TextUtils.join(", ", zza));
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void zza(zzfz zzfzVar, SQLiteDatabase sQLiteDatabase) {
        if (zzfzVar == null) {
            throw new IllegalArgumentException("Monitor must not be null");
        }
