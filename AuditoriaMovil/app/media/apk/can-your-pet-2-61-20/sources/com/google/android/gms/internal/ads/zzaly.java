...
final class zzaly {
    ...
    private zzaly(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11) {
        this.zza = i;
        this.zzb = i2;
        this.zzc = i3;
        this.zzd = i4;
    ...
    public static zzaly zza(String str) {
        ...
        while (true) {
            ...
            if (i >= length) {
                if (i2 != -1) {
                    return new zzaly(i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, length);
                }
                return null;
            }
            String zza = zzfvx.zza(split[i].trim());
            switch (zza.hashCode()) {
                case -1178781136:
