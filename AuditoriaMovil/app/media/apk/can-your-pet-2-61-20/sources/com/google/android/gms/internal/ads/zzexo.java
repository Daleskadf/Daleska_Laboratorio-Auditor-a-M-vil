...
public final class zzexo implements zzhiv {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        ...
        zzhjd.zzb(zzgepVar);
        return new zzexm(new zzcay(), ((zzciq) this.zzb).zza(), (ScheduledExecutorService) this.zzc.zzb(), zzgepVar, ((zzezu) this.zze).zzb().intValue(), ((zzezv) this.zzf).zzb().booleanValue(), ((zzezx) this.zzg).zzb().booleanValue());
    }
}
