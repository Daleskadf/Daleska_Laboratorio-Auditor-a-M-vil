...
public final class zzcqd implements zzbpj {
    ...
    public final JSONObject zzb(zzcqg zzcqgVar) throws JSONException {
        ...
        if (zzazxVar == null) {
            ...
            JSONObject put = jSONObject3.put("afmaVersion", this.zzb.zzb()).put("activeViewJSON", this.zzb.zzd()).put("timestamp", zzcqgVar.zzd).put("adFormat", this.zzb.zza()).put("hashCode", this.zzb.zzc()).put("isMraid", false);
            boolean z2 = zzcqgVar.zzc;
            put.put("isStopped", false).put("isPaused", zzcqgVar.zzb).put("isNative", this.zzb.zze()).put("isScreenOn", this.zzc.isInteractive()).put("appMuted", com.google.android.gms.ads.internal.zzu.zzr().zze()).put("appVolume", com.google.android.gms.ads.internal.zzu.zzr().zza()).put("deviceVolume", com.google.android.gms.ads.internal.util.zzac.zzb(this.zza.getApplicationContext()));
            ...
            jSONObject3.put("isVisible", zzcqgVar.zza);
