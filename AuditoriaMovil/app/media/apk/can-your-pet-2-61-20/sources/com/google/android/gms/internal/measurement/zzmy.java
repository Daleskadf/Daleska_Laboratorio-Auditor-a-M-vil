...
public final class zzmy {
    ...
    public final int zza() {
        ...
        for (int i3 = 0; i3 < this.zzb; i3++) {
            ...
            int i6 = i4 & 7;
            if (i6 == 0) {
                zze = zzjc.zze(i5, ((Long) this.zzd[i3]).longValue());
            } else if (i6 == 1) {
                zze = zzjc.zza(i5, ((Long) this.zzd[i3]).longValue());
            } else if (i6 == 2) {
                zze = zzjc.zza(i5, (zzii) this.zzd[i3]);
            } else if (i6 == 3) {
                zze = (zzjc.zzf(i5) << 1) + ((zzmy) this.zzd[i3]).zza();
            } else if (i6 == 5) {
                zze = zzjc.zzb(i5, ((Integer) this.zzd[i3]).intValue());
            } else {
    ...
    public final int zzb() {
        ...
        int i2 = 0;
        for (int i3 = 0; i3 < this.zzb; i3++) {
            i2 += zzjc.zzb(this.zzc[i3] >>> 3, (zzii) this.zzd[i3]);
        }
        this.zze = i2;
        return i2;
    }
    ...
    public final zzmy zza(zzmy zzmyVar) {
    ...
    public static zzmy zza(zzmy zzmyVar, zzmy zzmyVar2) {
        ...
        int[] copyOf = Arrays.copyOf(zzmyVar.zzc, i);
        System.arraycopy(zzmyVar2.zzc, 0, copyOf, zzmyVar.zzb, zzmyVar2.zzb);
        Object[] copyOf2 = Arrays.copyOf(zzmyVar.zzd, i);
        System.arraycopy(zzmyVar2.zzd, 0, copyOf2, zzmyVar.zzb, zzmyVar2.zzb);
        return new zzmy(i, copyOf, copyOf2, true);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static zzmy zzd() {
        return new zzmy();
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final void zza(zznv zznvVar) throws IOException {
