...
final class zzdjb implements zzcty {
    ...
    public zzdjb(Map map, Map map2, Map map3, zzhjm zzhjmVar, zzdlj zzdljVar) {
        this.zza = map;
        this.zzb = map2;
        this.zzc = map3;
        this.zzd = zzhjmVar;
    ...
    public final zzegj zza(int i, String str) {
        ...
        if (i != 1) {
            ...
            zza = (zzegj) this.zzb.get(str);
            if (zza == null) {
                return null;
            }
        } else if (this.zze.zze() == null || (zza = ((zzcty) this.zzd.zzb()).zza(i, str)) == null) {
            return null;
        }
