...
public final class zzky extends zze {
    ...
    public static /* synthetic */ void zza(zzky zzkyVar, Bundle bundle, zzkv zzkvVar, zzkv zzkvVar2, long j) {
        if (bundle != null) {
    ...
    private final void zza(Activity activity, zzkv zzkvVar, boolean z) {
        zzkv zzkvVar2;
    ...
    public final void zza(zzkv zzkvVar, zzkv zzkvVar2, long j, boolean z, Bundle bundle) {
        long j2;
        zzt();
        boolean z2 = false;
        ...
        if (z3) {
            ...
            String str = zzkvVar.zze ? "app" : DebugKt.DEBUG_PROPERTY_VALUE_AUTO;
    ...
    public final void zza(Activity activity, Bundle bundle) {
        ...
        this.zzd.put(activity, new zzkv(bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.NAME), bundle2.getString("referrer_name"), bundle2.getLong("id")));
    }
    ...
    public final void zzb(Activity activity) {
        ...
        if (!zze().zzv()) {
            this.zzb = null;
            zzl().zzb(new zzlc(this, elapsedRealtime));
            return;
        }
        zzkv zzd = zzd(activity);
        this.zzc = this.zzb;
        this.zzb = null;
        zzl().zzb(new zzlb(this, zzd, elapsedRealtime));
    }
