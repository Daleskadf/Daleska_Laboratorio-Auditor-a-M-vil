...
public final class zzbtj extends zzbts {
    ...
    public final void zzc() {
        ...
        zzK.setPositiveButton(zze != null ? zze.getString(R.string.s3) : HttpHeaders.ACCEPT, new zzbth(this));
        zzK.setNegativeButton(zze != null ? zze.getString(R.string.s4) : "Decline", new zzbti(this));
        zzK.create().show();
    }
}
