...
public final class zzog implements zzoh {
    ...
    static {
        ...
        zza = zza2.zza("measurement.consent.stop_reset_on_storage_denied.client", false);
        zzb = zza2.zza("measurement.consent.stop_reset_on_storage_denied.service", false);
        zzc = zza2.zza("measurement.id.consent.stop_reset_on_storage_denied.service", 0L);
        zzd = zza2.zza("measurement.consent.scrub_audience_data_analytics_consent", true);
    }
