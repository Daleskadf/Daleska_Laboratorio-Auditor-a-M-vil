...
public final class zzapw {
    public static X509Certificate[][] zza(String str) throws zzapt, SecurityException, IOException {
        RandomAccessFile randomAccessFile = new RandomAccessFile(str, "r");
        try {
            Pair zzc = zzapx.zzc(randomAccessFile);
            if (zzc != null) {
                ...
                long zza = zzapx.zza(byteBuffer);
                if (zza >= longValue) {
                    throw new zzapt("ZIP Central Directory offset out of range: " + zza + ". ZIP End of Central Directory offset: " + longValue);
                } else if (zzapx.zzb(byteBuffer) + zza == longValue) {
                    if (zza < 32) {
                        throw new zzapt("APK too small for APK Signing Block. ZIP Central Directory offset: " + zza);
                    }
                    ...
                    if (j3 < allocate.capacity() || j3 > 2147483639) {
                        throw new zzapt("APK Signing Block size out of range: " + j3);
                    }
                    int i = (int) (8 + j3);
                    long j4 = zza - i;
                    if (j4 < 0) {
                        throw new zzapt("APK Signing Block offset out of range: " + j4);
                    }
                    ...
                    if (j5 != j3) {
                        throw new zzapt("APK Signing Block sizes in header and footer do not match: " + j5 + " vs " + j3);
                    }
                                ...
                                if (j6 >= 4 && j6 <= 2147483647L) {
                                    ...
                                    if (i3 <= slice.remaining()) {
                                        if (slice.getInt() != 1896449818) {
                                            ...
                                            X509Certificate[][] zzl = zzl(randomAccessFile.getChannel(), new zzaps(zze(slice, i3 - 4), longValue2, zza, j2, byteBuffer, null));
                                            randomAccessFile.close();
                                            return zzl;
                                        }
                                    } else {
                                        throw new zzapt("APK Signing Block entry #" + i2 + " size out of range: " + i3 + ", available: " + slice.remaining());
                                    }
                                } else {
                                    throw new zzapt("APK Signing Block entry #" + i2 + " size out of range: " + j6);
                                }
                            } else {
                                throw new zzapt("Insufficient data to read size of APK Signing Block entry #" + i2);
                            }
                        }
    ...
    private static void zzh(Map map, FileChannel fileChannel, long j, long j2, long j3, ByteBuffer byteBuffer) throws SecurityException {
        if (!map.isEmpty()) {
            ...
            zzapx.zzd(duplicate, j);
            zzapo zzapoVar = new zzapo(duplicate);
            int size = map.size();
            ...
            try {
                byte[][] zzk = zzk(iArr, new zzapp[]{zzapqVar, zzapqVar2, zzapoVar});
    ...
    */
    private static java.security.cert.X509Certificate[] zzj(java.nio.ByteBuffer r22, java.util.Map r23, java.security.cert.CertificateFactory r24) throws java.lang.SecurityException, java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzapw.zzj(java.nio.ByteBuffer, java.util.Map, java.security.cert.CertificateFactory):java.security.cert.X509Certificate[]");
    }
    ...
    private static byte[][] zzk(int[] iArr, zzapp[] zzappVarArr) throws DigestException {
        ...
        while (true) {
            ...
            j3 += (zzappVarArr[i3].zza() + 1048575) / PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED;
            i3++;
        }
        if (j3 < 2097151) {
            ...
            for (i = 3; i7 < i; i = 3) {
                ...
                while (zza > j2) {
                    ...
                    long j5 = j4;
                    try {
                        zzappVar.zzb(messageDigestArr, j5, min);
                        byte[] bArr4 = bArr3;
                        int i10 = 0;
    ...
    private static X509Certificate[][] zzl(FileChannel fileChannel, zzaps zzapsVar) throws SecurityException {
