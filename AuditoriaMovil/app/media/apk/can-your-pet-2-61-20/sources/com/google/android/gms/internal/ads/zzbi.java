...
public final class zzbi {
    ...
    public /* synthetic */ zzbi(Uri uri, String str, zzbb zzbbVar, zzaq zzaqVar, List list, String str2, zzfzn zzfznVar, Object obj, long j, zzbh zzbhVar) {
        this.zzb = uri;
        int i = zzcb.zza;
        this.zzc = null;
        this.zzd = null;
        ...
        if (zzfznVar.size() > 0) {
            zzbn zzbnVar = (zzbn) zzfznVar.get(0);
            throw null;
        }
