...
public final class zzak extends zzax {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public zzak(zzaw zzawVar, Context context, zzq zzqVar, String str, zzbqo zzbqoVar) {
        this.zza = context;
        this.zzb = zzqVar;
        this.zzc = str;
        this.zzd = zzbqoVar;
    ...
    public final /* bridge */ /* synthetic */ Object zzb(zzce zzceVar) throws RemoteException {
        return zzceVar.zzc(ObjectWrapper.wrap(this.zza), this.zzb, this.zzc, this.zzd, 241199000);
    }
