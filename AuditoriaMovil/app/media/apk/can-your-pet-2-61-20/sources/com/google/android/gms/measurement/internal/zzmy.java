...
public final class zzmy {
    ...
    public final Bundle zza() {
        ...
        String str2 = "granted";
        if (str.length() > 0) {
            bundle.putString(zziq.zza.AD_STORAGE.zze, str.charAt(0) == '1' ? "granted" : AuthorisationStatus.DENIED);
        }
        if (str.length() > 3) {
            bundle.putString(zziq.zza.AD_PERSONALIZATION.zze, (str.charAt(2) == '1' && str.charAt(3) == '1') ? "granted" : AuthorisationStatus.DENIED);
        }
        if (str.length() > 6 && zze >= 4) {
            String str3 = zziq.zza.AD_USER_DATA.zze;
            if (str.charAt(0) != '1' || str.charAt(6) != '1') {
                str2 = AuthorisationStatus.DENIED;
            }
