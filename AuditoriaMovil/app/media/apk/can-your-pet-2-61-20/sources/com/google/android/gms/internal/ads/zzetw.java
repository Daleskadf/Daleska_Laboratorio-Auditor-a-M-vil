...
public final class zzetw implements zzewr {
    ...
    public final /* synthetic */ zzetx zzc() throws Exception {
        if (!((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zzfV)).booleanValue() || this.zzb == null || !this.zzd.contains("banner")) {
            Boolean bool = null;
            if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zzfW)).booleanValue() && this.zzd.contains("native")) {
