...
public final class zzcxv implements zzhiv {
    ...
    public final zzcxu zzb() {
        ...
        VersionInfoParcel zza = ((zzcjc) this.zzb).zza();
        ApplicationInfo zzb = ((zzdyv) this.zzc).zzb();
        String zzb2 = ((zzdza) this.zzd).zzb();
        zzbdq zzbdqVar = zzbdz.zza;
        return new zzcxu(zzfknVar, zza, zzb, zzb2, com.google.android.gms.ads.internal.client.zzba.zza().zza(), (PackageInfo) this.zzf.zzb(), zzhiu.zza(zzhjg.zza(this.zzg)), ((zzcio) this.zzh).zzb(), (String) this.zzi.zzb(), ((zzewv) this.zzj).zzb(), ((zzcyh) this.zzk).zza(), (zzddz) this.zzl.zzb());
    }
}
