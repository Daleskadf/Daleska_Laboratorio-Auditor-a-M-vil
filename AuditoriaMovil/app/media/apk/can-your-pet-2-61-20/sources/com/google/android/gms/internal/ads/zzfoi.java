...
public final class zzfoi extends zzfoe {
    ...
    @Override // com.google.android.gms.internal.ads.zzfoe
    public final void zzi(zzfnc zzfncVar, zzfna zzfnaVar) {
        JSONObject jSONObject = new JSONObject();
        Map zzi = zzfnaVar.zzi();
        Iterator it = zzi.keySet().iterator();
        if (it.hasNext()) {
            zzfnj zzfnjVar = (zzfnj) zzi.get((String) it.next());
            throw null;
        } else {
    ...
    public final void zzn() {
        ...
        zzfnj zzfnjVar = (zzfnj) this.zzc.get((String) it.next());
        throw null;
    }
}
