...
public final class zzag extends zzim {
    ...
    public final double zza(String str, zzfq<Double> zzfqVar) {
        ...
        String zza = this.zzc.zza(str, zzfqVar.zza());
    ...
    */
    public final java.util.List<java.lang.String> zzh(java.lang.String r4) {
        /*
            r3 = this;
    ...
    public final boolean zzf(String str, zzfq<Boolean> zzfqVar) {
        ...
        return zzfqVar.zza(Boolean.valueOf("1".equals(zza))).booleanValue();
    }
