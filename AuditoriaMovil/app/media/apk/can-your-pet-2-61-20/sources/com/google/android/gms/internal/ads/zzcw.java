...
public final class zzcw {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && getClass().equals(obj.getClass())) {
            ...
            if (zzfx.zzG(this.zzc, zzcwVar.zzc) && zzfx.zzG(this.zze, zzcwVar.zze) && zzfx.zzG(null, null) && zzfx.zzG(this.zzl, zzcwVar.zzl) && this.zzf == zzcwVar.zzf && this.zzg == zzcwVar.zzg && this.zzh == zzcwVar.zzh && this.zzi == zzcwVar.zzi && this.zzj == zzcwVar.zzj && this.zzm == zzcwVar.zzm && this.zzo == zzcwVar.zzo && this.zzp == zzcwVar.zzp && this.zzq == zzcwVar.zzq) {
                return true;
            }
        }
        return false;
