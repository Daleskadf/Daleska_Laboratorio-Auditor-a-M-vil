...
public final class zzevy implements zzewr {
    ...
    public zzevy(zzgep zzgepVar, ScheduledExecutorService scheduledExecutorService, String str, Context context, zzfgi zzfgiVar, zzcik zzcikVar) {
        this.zzb = zzgepVar;
    ...
    public static /* synthetic */ ListenableFuture zzc(zzevy zzevyVar) {
        com.google.android.gms.ads.nonagon.signalgeneration.zzi zzp = zzevyVar.zzf.zzp();
        ...
        zzp.zzb(zzaeVar.zzb());
        new zzdef();
        return zzgee.zze(zzgee.zzm((zzgdv) zzgee.zzo(zzgdv.zzu(zzp.zzc().zzb()), ((Long) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zzhj)).longValue(), TimeUnit.MILLISECONDS, zzevyVar.zzc), new zzfwf() { // from class: com.google.android.gms.internal.ads.zzevv
    ...
    public final ListenableFuture zzb() {
        if (!((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zzhi)).booleanValue() || this.zze.zzq) {
            return zzgee.zzh(new zzevz(null));
        }
        return zzgee.zzk(new zzgdk() { // from class: com.google.android.gms.internal.ads.zzevx
            @Override // com.google.android.gms.internal.ads.zzgdk
            public final ListenableFuture zza() {
                return zzevy.zzc(zzevy.this);
            }
        }, this.zzb);
    }
}
