...
final class zzcm extends zzbn implements RandomAccess, zzdk, zzer {
    private static final zzcm zza = new zzcm(new double[0], 0, false);
    private double[] zzb;
    private int zzc;
    ...
    public final /* bridge */ /* synthetic */ zzdk zzd(int i) {
        ...
        return new zzcm(Arrays.copyOf(this.zzb, i), this.zzc, true);
    }
    ...
    private zzcm(double[] dArr, int i, boolean z) {
        super(z);
        this.zzb = dArr;
        this.zzc = i;
    }
