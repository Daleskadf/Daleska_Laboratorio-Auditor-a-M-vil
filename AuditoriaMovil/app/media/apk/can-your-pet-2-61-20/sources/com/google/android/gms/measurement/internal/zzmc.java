...
public final class zzmc implements ServiceConnection, BaseGmsClient.BaseConnectionCallbacks, BaseGmsClient.BaseOnConnectionFailedListener {
    ...
    public final void zza(Intent intent) {
        ...
        synchronized (this) {
            ...
            this.zzb = true;
            zzmcVar = this.zza.zza;
            connectionTracker.bindService(zza, intent, zzmcVar, 129);
        }
    }
    ...
    public final void zza() {
        ...
        synchronized (this) {
            if (this.zzb) {
                ...
                this.zzc = new zzga(zza, Looper.getMainLooper(), this, this);
        ...
        synchronized (this) {
                ...
                if ("com.google.android.gms.measurement.internal.IMeasurementService".equals(interfaceDescriptor)) {
                    if (iBinder != null) {
                        ...
                        if (queryLocalInterface instanceof zzfs) {
                            zzfuVar = (zzfs) queryLocalInterface;
                        } else {
            ...
            if (zzfsVar == null) {
                ...
                try {
                    ...
                    Context zza = this.zza.zza();
                    zzmcVar = this.zza.zza;
                    connectionTracker.unbindService(zza, zzmcVar);
