                ...
                if (context != null) {
                    synchronized (this.zzf) {
                        ...
                        if (((Boolean) zzbfr.zza.zze()).booleanValue()) {
                            if (((Boolean) zzba.zzc().zza(zzbdz.zzkO)).booleanValue()) {
                                com.google.android.gms.ads.internal.util.client.zzm.zze("Initializing on bg thread");
                                com.google.android.gms.ads.internal.util.client.zzb.zza.execute(new Runnable(context, null) { // from class: com.google.android.gms.ads.internal.client.zzec
                        ...
                        if (((Boolean) zzbfr.zzb.zze()).booleanValue()) {
                            if (((Boolean) zzba.zzc().zza(zzbdz.zzkO)).booleanValue()) {
                                com.google.android.gms.ads.internal.util.client.zzb.zzb.execute(new Runnable(context, null) { // from class: com.google.android.gms.ads.internal.client.zzed
                                    public final /* synthetic */ Context zzb;
    ...
    public final boolean zzx(boolean z) {
        synchronized (this.zzf) {
            ...
            try {
                ...
                com.google.android.gms.ads.internal.util.client.zzm.zzh("Unable to " + str + " the publisher first-party ID.", e);
                return false;
            }
        }
        return true;
