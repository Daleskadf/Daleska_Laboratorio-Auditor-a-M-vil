...
public final class zzli {
    ...
    public zzli(zzmh[] zzmhVarArr, long j, zzzf zzzfVar, zzzo zzzoVar, zzlx zzlxVar, zzlj zzljVar, zzzg zzzgVar) {
        ...
        long j2 = zzljVar.zzb;
        long j3 = zzljVar.zzd;
        zzvf zzp = zzlxVar.zzp(zzvhVar, zzzoVar, j2);
        this.zza = j3 != -9223372036854775807L ? new zzul(zzp, true, 0L, j3) : zzp;
    }
    ...
    public final long zzb(zzzg zzzgVar, long j, boolean z, boolean[] zArr) {
        ...
        this.zzn = zzzgVar;
        zzt();
        long zzf = this.zza.zzf(zzzgVar.zzc, this.zzh, this.zzc, zArr, j);
        int i3 = 0;
        while (true) {
    ...
    public final zzzg zzj(float f, zzcx zzcxVar) throws zziz {
        zzyz[] zzyzVarArr;
        zzzg zzp = this.zzj.zzp(this.zzi, this.zzm, this.zzf.zza, zzcxVar);
        for (zzyz zzyzVar : zzp.zzc) {
        }
        return zzp;
    }
