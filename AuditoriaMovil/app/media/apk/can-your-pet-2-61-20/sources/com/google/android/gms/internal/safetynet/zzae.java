...
public final class zzae implements SafetyNetApi {
    ...
    public static PendingResult<SafetyNetApi.SafeBrowsingResult> zzb(GoogleApiClient googleApiClient, String str, int i, String str2, int... iArr) {
        if (iArr.length == 0) {
        ...
        return googleApiClient.enqueue(new zzk(googleApiClient, iArr, i, str, str2));
    }
