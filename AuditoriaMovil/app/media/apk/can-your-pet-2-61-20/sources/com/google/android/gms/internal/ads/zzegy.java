...
public final class zzegy implements zzegp {
    ...
    public zzegy(Context context, zzcra zzcraVar, Executor executor) {
        this.zza = context;
        this.zzb = zzcraVar;
        this.zzc = executor;
    }
    ...
    public final /* bridge */ /* synthetic */ Object zza(zzffz zzffzVar, zzffn zzffnVar, final zzegm zzegmVar) throws zzfgp, zzekh {
        zzcqx zza = this.zzb.zza(new zzcul(zzffzVar, zzffnVar, zzegmVar.zza), new zzdhp(new zzdiu() { // from class: com.google.android.gms.internal.ads.zzegx
        ...
        zza.zzd().zzo(new zzcpa((zzfhg) zzegmVar.zzb), this.zzc);
        ((zzeif) zzegmVar.zzc).zzc(zza.zzj());
        return zza.zza();
    }
    ...
    public final void zzb(zzffz zzffzVar, zzffn zzffnVar, zzegm zzegmVar) throws zzfgp {
        ...
        ((zzfhg) zzegmVar.zzb).zzl(this.zza, zzfgiVar.zzd, zzffnVar.zzw.toString(), (zzbqu) zzegmVar.zzc);
    }
}
