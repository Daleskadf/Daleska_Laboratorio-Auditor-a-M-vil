...
public final class zzewh implements zzewq {
    ...
    public zzewh(boolean z, boolean z2, String str, boolean z3, int i, int i2, int i3, String str2) {
        this.zza = z;
        this.zzb = z2;
        this.zzc = str;
        this.zzd = z3;
    ...
    public final /* bridge */ /* synthetic */ void zzj(Object obj) {
        ...
        Bundle zza = zzfgw.zza(bundle, "sdk_env");
        zza.putBoolean("mf", ((Boolean) zzbft.zzc.zze()).booleanValue());
        ...
        Bundle zza2 = zzfgw.zza(zza, "build_meta");
        zza2.putString("cl", "619949182");
