...
public final class zzccr extends zzcct implements TextureView.SurfaceTextureListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    public static /* bridge */ /* synthetic */ void zzl(zzccr zzccrVar, MediaPlayer mediaPlayer) {
        MediaFormat format;
        ...
        try {
            ...
            if (trackInfo != null) {
                ...
                zzccrVar.zzd.zzd("onMetadataEvent", hashMap);
            }
    ...
    */
    ...
    public final void onPrepared(MediaPlayer mediaPlayer) {
        ...
        int i2 = this.zzk;
        int i3 = this.zzl;
        com.google.android.gms.ads.internal.util.client.zzm.zzi("AdMediaPlayerView stream dimensions: " + i2 + " x " + i3);
        if (this.zzh == 3) {
            zzp();
        }
        zzn();
