...
public final class zzdsd {
    ...
    public final synchronized void zzf() {
        ...
        Map map;
        this.zzd = true;
        zzcbb zzg = com.google.android.gms.ads.internal.zzu.zzo().zzi().zzg();
        if (zzg != null && (zzf = zzg.zzf()) != null) {
            this.zzb = ((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zzdW)).booleanValue() ? zzf.optJSONObject("common_settings") : null;
    ...
    public final JSONObject zzb(String str, String str2) {
        ...
        if (map != null) {
            ...
            String zza = zzdsf.zza(this.zze, str, str2);
            if (zza != null) {
