...
public final class zzdjv implements zzdlg {
    ...
    private final boolean zzH(JSONObject jSONObject, JSONObject jSONObject2, JSONObject jSONObject3, JSONObject jSONObject4, String str, JSONObject jSONObject5, boolean z) {
        try {
            ...
            if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zziy)).booleanValue()) {
                this.zzd.zzl("/clickRecorded", new zzdjs(this, null));
            } else {
                this.zzd.zzl("/logScionEvent", new zzdjq(this, null));
            }
            this.zzd.zzl("/nativeImpression", new zzdju(this, null));
    ...
    public final void zzk(View view, View view2, Map map, Map map2, boolean z, ImageView.ScaleType scaleType) {
        ...
        zzn(true == ((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zza(zzbdz.zzdz)).booleanValue() ? view2 : view, zzg, zzd, zzf, zze, zzE, com.google.android.gms.ads.internal.util.zzbz.zzc(zzE, context, this.zzz, this.zzy), null, z, false);
    }
