...
public final class zziz extends zziw {
    ...
    */
    ...
    @Override // com.google.android.gms.internal.measurement.zziw
    public final zzii zzq() throws IOException {
        byte[] bArr;
        int zzx = zzx();
        if (zzx > 0) {
            int i = this.zzf;
            int i2 = this.zzh;
            if (zzx <= i - i2) {
                zzii zza = zzii.zza(this.zzd, i2, zzx);
                this.zzh += zzx;
                return zza;
            }
        }
    ...
    public final String zzr() throws IOException {
        ...
        if (zzx > 0) {
            ...
            int i2 = this.zzh;
            if (zzx <= i - i2) {
                String str = new String(this.zzd, i2, zzx, zzjy.zza);
                this.zzh += zzx;
                return str;
            }
        }
    ...
    public final String zzs() throws IOException {
        ...
        if (zzx > 0) {
            ...
            int i2 = this.zzh;
            if (zzx <= i - i2) {
                String zzb = zznf.zzb(this.zzd, i2, zzx);
                this.zzh += zzx;
                return zzb;
            }
        }
