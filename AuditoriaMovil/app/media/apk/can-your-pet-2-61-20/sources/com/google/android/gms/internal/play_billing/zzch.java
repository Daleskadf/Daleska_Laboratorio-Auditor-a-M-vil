...
public final class zzch extends zzck {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public zzch(byte[] bArr, int i, int i2) {
        super(null);
    ...
    @Override // com.google.android.gms.internal.play_billing.zzck
    public final void zze(int i, zzcc zzccVar) throws IOException {
        zzq((i << 3) | 2);
        zzq(zzccVar.zzd());
        zzccVar.zzh(this);
    }
    ...
    public final void zzg(int i) throws IOException {
        try {
            ...
            throw new zzci(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), 1), e);
        }
    }
    ...
    public final void zzn(String str) throws IOException {
        ...
        try {
            ...
            if (zzw2 == zzw) {
                int i2 = i + zzw2;
                this.zzd = i2;
                int zzb = zzgb.zzb(str, this.zzb, i2, this.zzc - i2);
                this.zzd = i;
                zzq((zzb - i) - zzw2);
                this.zzd = zzb;
                return;
            ...
            byte[] bArr = this.zzb;
            int i3 = this.zzd;
            this.zzd = zzgb.zzb(str, bArr, i3, this.zzc - i3);
        } catch (zzga e) {
            this.zzd = i;
            zzA(str, e);
    ...
    public final void zzc(byte[] bArr, int i, int i2) throws IOException {
        try {
            ...
            throw new zzci(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), Integer.valueOf(i2)), e);
        }
    }
    ...
    public final void zzs(long j) throws IOException {
        ...
        while (true) {
            ...
            if ((j & (-128)) == 0) {
                ...
                int i4 = this.zzd;
                this.zzd = i4 + 1;
                zzfw.zzn(bArr3, i4, (byte) i3);
                return;
            }
            byte[] bArr4 = this.zzb;
            int i5 = this.zzd;
            this.zzd = i5 + 1;
            zzfw.zzn(bArr4, i5, (byte) ((i3 | 128) & 255));
            j >>>= 7;
        }
    }
}
