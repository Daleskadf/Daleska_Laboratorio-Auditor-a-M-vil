...
final class ToContinuation<T> implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            this.continuation.resumeWith(Result.m413constructorimpl(Uninterruptibles.getUninterruptibly(this.futureToObserve)));
        } catch (ExecutionException e) {
            Result.Companion companion2 = Result.Companion;
            nonNullCause = ListenableFutureKt.nonNullCause(e);
            this.continuation.resumeWith(Result.m413constructorimpl(ResultKt.createFailure(nonNullCause)));
        }
    }
}
