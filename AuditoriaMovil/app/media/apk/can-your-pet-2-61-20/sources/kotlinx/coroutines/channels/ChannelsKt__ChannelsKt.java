...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        ...
        Object mo1995trySendJP2dKIU = sendChannel.mo1995trySendJP2dKIU(e);
        if (mo1995trySendJP2dKIU instanceof ChannelResult.Failed) {
            ...
            return ((ChannelResult) runBlocking$default).m2017unboximpl();
        }
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) {
        if (ChannelResult.m2015isSuccessimpl(sendChannel.mo1995trySendJP2dKIU(obj))) {
            return;
        }
