...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2052scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1982delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1983toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1983toDelayMillisLRDsOJo(long j) {
        if (Duration.m1818compareToLRDsOJo(j, Duration.Companion.m1921getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1837getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
