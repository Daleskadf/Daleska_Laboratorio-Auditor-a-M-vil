...
public final class WorkQueue {
    ...
    private final Task pollWithExclusiveMode(boolean z) {
        ...
        do {
            ...
            return null;
        } while (!AbstractFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, task, null));
        return task;
    }
    ...
    private final Task tryExtractFromTheMiddle(int i, boolean z) {
        ...
        if (task != null) {
            if ((task.taskContext.getTaskMode() == 1) == z && Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(this.buffer, i2, task, null)) {
                if (z) {
    ...
    private final long tryStealLastScheduled(int i, Ref.ObjectRef<Task> objectRef) {
        ...
        } while (!AbstractFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, r1, null));
