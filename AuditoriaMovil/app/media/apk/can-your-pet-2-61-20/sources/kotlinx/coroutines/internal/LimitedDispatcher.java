...
public final class LimitedDispatcher extends CoroutineDispatcher implements Delay {
    ...
    public void mo2052scheduleResumeAfterDelay(long j, CancellableContinuation<? super Unit> cancellableContinuation) {
        this.$$delegate_0.mo2052scheduleResumeAfterDelay(j, cancellableContinuation);
    }
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (i >= 16 && LimitedDispatcher.this.dispatcher.isDispatchNeeded(LimitedDispatcher.this)) {
                    LimitedDispatcher.this.dispatcher.mo2051dispatch(LimitedDispatcher.this, this);
                    return;
                }
            }
        }
    ...
    public void mo2051dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        Runnable obtainTaskOrDeallocateWorker;
        this.queue.addLast(runnable);
        if (runningWorkers$FU.get(this) >= this.parallelism || !tryAllocateWorker() || (obtainTaskOrDeallocateWorker = obtainTaskOrDeallocateWorker()) == null) {
            return;
        }
        this.dispatcher.mo2051dispatch(this, new Worker(obtainTaskOrDeallocateWorker));
    }
