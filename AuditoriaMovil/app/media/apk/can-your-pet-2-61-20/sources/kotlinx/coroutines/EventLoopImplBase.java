...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    public void mo2052scheduleResumeAfterDelay(long j, CancellableContinuation<? super Unit> cancellableContinuation) {
    ...
    */
    ...
    public final void mo2051dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        enqueue(runnable);
    }
    ...
    private final void closeQueue() {
        ...
        while (true) {
            ...
            if (obj == null) {
                ...
                symbol = EventLoop_commonKt.CLOSED_EMPTY;
                if (AbstractFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater2, this, null, symbol)) {
                    return;
                }
            } else if (!(obj instanceof LockFreeTaskQueueCore)) {
    ...
    private final int scheduleImpl(long j, DelayedTask delayedTask) {
        ...
        if (delayedTaskQueue == null) {
            AbstractFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater, this, null, new DelayedTaskQueue(j));
            Object obj = atomicReferenceFieldUpdater.get(this);
