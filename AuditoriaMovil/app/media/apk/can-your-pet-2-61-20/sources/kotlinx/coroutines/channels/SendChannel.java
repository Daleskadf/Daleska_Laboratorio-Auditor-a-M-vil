...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m2015isSuccessimpl(mo1995trySendJP2dKIU)) {
                return true;
            }
            Throwable m2009exceptionOrNullimpl = ChannelResult.m2009exceptionOrNullimpl(mo1995trySendJP2dKIU);
