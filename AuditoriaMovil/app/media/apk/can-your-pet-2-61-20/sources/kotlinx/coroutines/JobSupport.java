...
public class JobSupport implements Job, ChildJob, ParentJob {
    ...
    private final void promoteEmptyToNodeList(Empty empty) {
        ...
        AbstractFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, empty, empty.isActive() ? nodeList : new InactiveNodeList(nodeList));
    }
