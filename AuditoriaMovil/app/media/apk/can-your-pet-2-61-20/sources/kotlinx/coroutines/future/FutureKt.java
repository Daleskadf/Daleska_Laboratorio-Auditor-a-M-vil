...
public final class FutureKt {
    ...
    public static final <T> CompletableFuture<T> future(CoroutineScope coroutineScope, CoroutineContext coroutineContext, CoroutineStart coroutineStart, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2) {
        ...
        CompletableFuture<T> m1781m = StreamsKt$$ExternalSyntheticApiModelOutline0.m1781m();
        CompletableFutureCoroutine completableFutureCoroutine = new CompletableFutureCoroutine(newCoroutineContext, m1781m);
        m1781m.handle(StreamsKt$$ExternalSyntheticApiModelOutline0.m1783m((Object) completableFutureCoroutine));
    ...
    public static final <T> CompletableFuture<T> asCompletableFuture(final Deferred<? extends T> deferred) {
        final CompletableFuture<T> m1781m = StreamsKt$$ExternalSyntheticApiModelOutline0.m1781m();
        setupCancellation(deferred, m1781m);
        deferred.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.future.FutureKt$asCompletableFuture$1
            ...
            public final void invoke2(Throwable th) {
                try {
                    m1781m.complete(deferred.getCompleted());
                } catch (Throwable th2) {
                    m1781m.completeExceptionally(th2);
                }
            }
        });
        return m1781m;
    ...
    public static final CompletableFuture<Unit> asCompletableFuture(Job job) {
        final CompletableFuture<Unit> m1781m = StreamsKt$$ExternalSyntheticApiModelOutline0.m1781m();
        setupCancellation(job, m1781m);
        job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.future.FutureKt$asCompletableFuture$2
            ...
            public final void invoke2(Throwable th) {
                if (th == null) {
                    m1781m.complete(Unit.INSTANCE);
                } else {
                    m1781m.completeExceptionally(th);
                }
            }
        });
        return m1781m;
            ...
            */
            public final java.lang.Object invoke2(T r2, java.lang.Throwable r3) {
                ...
                L9:
                    ...
                    boolean r0 = kotlin.streams.jdk8.StreamsKt$$ExternalSyntheticApiModelOutline0.m1787m(r3)     // Catch: java.lang.Throwable -> L2a
                    if (r0 == 0) goto L16
                    java.util.concurrent.CompletionException r0 = kotlin.streams.jdk8.StreamsKt$$ExternalSyntheticApiModelOutline0.m1782m(r3)     // Catch: java.lang.Throwable -> L2a
                    goto L17
                L16:
                    r0 = 0
                L17:
    ...
    public static final <T> Object await(CompletionStage<T> completionStage, Continuation<? super T> continuation) {
        ...
        completionStage.handle(StreamsKt$$ExternalSyntheticApiModelOutline0.m1783m((Object) continuationHandler));
