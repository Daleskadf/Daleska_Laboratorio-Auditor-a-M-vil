    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m413constructorimpl = Result.m413constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    ...
                    m413constructorimpl = Result.m413constructorimpl(invoke);
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.Companion;
                    m413constructorimpl = Result.m413constructorimpl(ResultKt.createFailure(th2));
                }
                return Result.m419isFailureimpl(m413constructorimpl) ? null : m413constructorimpl;
            }
        };
    }

    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        Integer m413constructorimpl;
        JvmClassMappingKt.getKotlinClass(cls);
        try {
            Result.Companion companion = Result.Companion;
            m413constructorimpl = Result.m413constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m413constructorimpl = Result.m413constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m419isFailureimpl(m413constructorimpl)) {
            m413constructorimpl = valueOf;
        }
        return ((Number) m413constructorimpl).intValue();
    }
