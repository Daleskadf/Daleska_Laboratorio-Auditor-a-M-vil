...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo1999receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo1999receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2000tryReceivePtdJZtk() {
        return this._channel.mo2000tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo1995trySendJP2dKIU(E e) {
        return this._channel.mo1995trySendJP2dKIU(e);
    }
