...
public final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m2028debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m1983toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> debounceDuration(Flow<? extends T> flow, final Function1<? super T, Duration> function1) {
        return debounceInternal$FlowKt__DelayKt(flow, new Function1<T, Long>() { // from class: kotlinx.coroutines.flow.FlowKt__DelayKt$debounce$3
            ...
            @Override // kotlin.jvm.functions.Function1
            public final Long invoke(T t) {
                return Long.valueOf(DelayKt.m1983toDelayMillisLRDsOJo(function1.invoke(t).m1873unboximpl()));
            }
        });
    }
    ...
    public static final <T> Flow<T> m2029sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m1983toDelayMillisLRDsOJo(j));
    }

    /* renamed from: timeout-HG0u8IE */
    public static final <T> Flow<T> m2030timeoutHG0u8IE(Flow<? extends T> flow, long j) {
        return m2031timeoutInternalHG0u8IE$FlowKt__DelayKt(flow, j);
    }

    /* renamed from: timeoutInternal-HG0u8IE$FlowKt__DelayKt */
    private static final <T> Flow<T> m2031timeoutInternalHG0u8IE$FlowKt__DelayKt(Flow<? extends T> flow, long j) {
