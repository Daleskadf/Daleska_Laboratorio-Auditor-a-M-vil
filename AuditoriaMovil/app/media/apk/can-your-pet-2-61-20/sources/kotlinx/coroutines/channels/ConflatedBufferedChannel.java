...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m2023trySendImplMj0NB7M = conflatedBufferedChannel.m2023trySendImplMj0NB7M(e, true);
        if (m2023trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2009exceptionOrNullimpl(m2023trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m2023trySendImplMj0NB7M = conflatedBufferedChannel.m2023trySendImplMj0NB7M(e, true);
        if (!(m2023trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
            Unit unit = (Unit) m2023trySendImplMj0NB7M;
    ...
    public Object mo1995trySendJP2dKIU(E e) {
        return m2023trySendImplMj0NB7M(e, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M  reason: not valid java name */
    private final Object m2023trySendImplMj0NB7M(E e, boolean z) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2021trySendDropLatestMj0NB7M(e, z) : m2022trySendDropOldestJP2dKIU(e);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M  reason: not valid java name */
    private final Object m2021trySendDropLatestMj0NB7M(E e, boolean z) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo1995trySendJP2dKIU = super.mo1995trySendJP2dKIU(e);
        if (ChannelResult.m2015isSuccessimpl(mo1995trySendJP2dKIU) || ChannelResult.m2013isClosedimpl(mo1995trySendJP2dKIU)) {
            return mo1995trySendJP2dKIU;
        }
        ...
        return ChannelResult.Companion.m2020successJP2dKIU(Unit.INSTANCE);
    }

    /* renamed from: trySendDropOldest-JP2dKIU  reason: not valid java name */
    private final Object m2022trySendDropOldestJP2dKIU(E e) {
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (findSegmentSend != null) {
                    ...
                    return ChannelResult.Companion.m2018closedJP2dKIU(getSendException());
                }
            } else {
                channelSegment = channelSegment2;
            }
            int updateCellSend = conflatedBufferedChannel.updateCellSend(channelSegment, i, e, j, symbol, isClosedForSend0);
            if (updateCellSend == 0) {
    ...
    public void registerSelectForSend(SelectInstance<?> selectInstance, Object obj) {
        Object mo1995trySendJP2dKIU = mo1995trySendJP2dKIU(obj);
        if (!(mo1995trySendJP2dKIU instanceof ChannelResult.Failed)) {
            Unit unit = (Unit) mo1995trySendJP2dKIU;
            selectInstance.selectInRegistrationPhase(Unit.INSTANCE);
        } else if (!(mo1995trySendJP2dKIU instanceof ChannelResult.Closed)) {
            throw new IllegalStateException("unreachable".toString());
        } else {
            ChannelResult.m2009exceptionOrNullimpl(mo1995trySendJP2dKIU);
