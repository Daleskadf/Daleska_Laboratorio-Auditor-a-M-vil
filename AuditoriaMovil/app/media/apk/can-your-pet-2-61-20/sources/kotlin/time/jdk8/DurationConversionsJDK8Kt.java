...
public final class DurationConversionsJDK8Kt {
    private static final long toKotlinDuration(Duration duration) {
        ...
        return kotlin.time.Duration.m1855plusLRDsOJo(duration2, DurationKt.toDuration(nano, DurationUnit.NANOSECONDS));
    }

    /* renamed from: toJavaDuration-LRDsOJo  reason: not valid java name */
    private static final Duration m1980toJavaDurationLRDsOJo(long j) {
        Duration ofSeconds;
        ofSeconds = Duration.ofSeconds(kotlin.time.Duration.m1840getInWholeSecondsimpl(j), kotlin.time.Duration.m1842getNanosecondsComponentimpl(j));
