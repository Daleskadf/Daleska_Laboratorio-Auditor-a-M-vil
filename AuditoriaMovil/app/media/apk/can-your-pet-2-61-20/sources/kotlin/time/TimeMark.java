...
public interface TimeMark {
    ...
    TimeMark mo1809minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1811plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1956plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m1955minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1811plusLRDsOJo(Duration.m1871unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1852isNegativeimpl(timeMark.mo1808elapsedNowUwyO8pc());
        }
