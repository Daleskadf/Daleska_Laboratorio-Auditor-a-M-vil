        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m984contentEqualskV0jMPg(((UByteArray) t).m499unboximpl(), ((UByteArray) t2).m499unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m981contentEqualsFGO6Aew(((UShortArray) t).m762unboximpl(), ((UShortArray) t2).m762unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m982contentEqualsKJPZfPQ(((UIntArray) t).m578unboximpl(), ((UIntArray) t2).m578unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m986contentEqualslec5QzE(((ULongArray) t).m657unboximpl(), ((ULongArray) t2).m657unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m998contentToString2csIQuQ(uByteArray != null ? uByteArray.m499unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m1002contentToStringd6D3K8(uShortArray != null ? uShortArray.m762unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m1001contentToStringXUkPCBk(uIntArray != null ? uIntArray.m578unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m1004contentToStringuLth9ew(uLongArray != null ? uLongArray.m657unboximpl() : null));
            } else {
