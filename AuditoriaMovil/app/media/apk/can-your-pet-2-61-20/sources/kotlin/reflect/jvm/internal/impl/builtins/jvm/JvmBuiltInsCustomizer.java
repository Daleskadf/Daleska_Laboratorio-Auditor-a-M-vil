...
public final class JvmBuiltInsCustomizer implements AdditionalClassPartsProvider, PlatformDependentDeclarationFilter {
    ...
    */
    ...
    public static final Iterable getJdkMethodStatus$lambda$9(JvmBuiltInsCustomizer this$0, ClassDescriptor classDescriptor) {
        ...
        Intrinsics.checkNotNullExpressionValue(mo1747getSupertypes, "it.typeConstructor.supertypes");
        ArrayList arrayList = new ArrayList();
        for (KotlinType kotlinType : mo1747getSupertypes) {
            ClassifierDescriptor mo1746getDeclarationDescriptor = kotlinType.getConstructor().mo1746getDeclarationDescriptor();
            ClassifierDescriptor original = mo1746getDeclarationDescriptor != null ? mo1746getDeclarationDescriptor.getOriginal() : null;
    ...
    private final boolean isTrivialCopyConstructorFor(ConstructorDescriptor constructorDescriptor, ClassDescriptor classDescriptor) {
        if (constructorDescriptor.getValueParameters().size() == 1) {
            ...
            ClassifierDescriptor mo1746getDeclarationDescriptor = ((ValueParameterDescriptor) CollectionsKt.single((List<? extends Object>) valueParameters)).getType().getConstructor().mo1746getDeclarationDescriptor();
            if (Intrinsics.areEqual(mo1746getDeclarationDescriptor != null ? DescriptorUtilsKt.getFqNameUnsafe(mo1746getDeclarationDescriptor) : null, DescriptorUtilsKt.getFqNameUnsafe(classDescriptor))) {
                return true;
            }
        }
        return false;
