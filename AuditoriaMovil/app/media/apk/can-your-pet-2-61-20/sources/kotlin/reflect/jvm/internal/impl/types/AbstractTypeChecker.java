            ...
            if (supertypesSet.add(current)) {
                ...
                if (lowerIfFlexible == null) {
                    ...
                    for (KotlinTypeMarker kotlinTypeMarker : typeSystemContext2.supertypes(typeSystemContext2.typeConstructor(current))) {
                        SimpleTypeMarker mo1750transformType = lowerIfFlexible.mo1750transformType(typeCheckerState, kotlinTypeMarker);
                        if (typeSystemContext.isNothingConstructor(typeSystemContext.typeConstructor(mo1750transformType))) {
            ...
            while (!supertypesDeque.isEmpty()) {
                ...
                if (supertypesSet.add(current)) {
                    ...
                    if (substitutionSupertypePolicy != null) {
                        TypeSystemContext typeSystemContext2 = typeCheckerState.getTypeSystemContext();
                        for (KotlinTypeMarker kotlinTypeMarker : typeSystemContext2.supertypes(typeSystemContext2.typeConstructor(current))) {
                            supertypesDeque.add(substitutionSupertypePolicy.mo1750transformType(typeCheckerState, kotlinTypeMarker));
                        }
                    }
                }
            }
        ...
        while (!supertypesDeque.isEmpty()) {
            ...
            if (supertypesSet.add(current)) {
                ...
                if (lowerIfFlexible != null) {
                    ...
                    for (KotlinTypeMarker kotlinTypeMarker : typeSystemContext2.supertypes(typeSystemContext2.typeConstructor(current))) {
                        supertypesDeque.add(lowerIfFlexible.mo1750transformType(state, kotlinTypeMarker));
                    }
                }
            }
        }
