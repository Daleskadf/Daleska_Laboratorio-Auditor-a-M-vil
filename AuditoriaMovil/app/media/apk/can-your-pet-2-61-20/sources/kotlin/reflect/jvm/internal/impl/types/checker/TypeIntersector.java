    ...
    public final SimpleType intersectTypes$descriptors(List<? extends SimpleType> types) {
        ...
        for (SimpleType simpleType : types) {
            if (simpleType.getConstructor() instanceof IntersectionTypeConstructor) {
                Collection<KotlinType> mo1747getSupertypes = simpleType.getConstructor().mo1747getSupertypes();
                Intrinsics.checkNotNullExpressionValue(mo1747getSupertypes, "type.constructor.supertypes");
                Collection<KotlinType> collection = mo1747getSupertypes;
        ...
        for (SimpleType simpleType2 : list) {
            arrayList4.add(simpleType2.getAttributes());
        }
