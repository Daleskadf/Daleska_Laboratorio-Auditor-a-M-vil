    ...
    private final SimpleType transformToNewType(SimpleType simpleType) {
        ...
        if (constructor instanceof CapturedTypeConstructorImpl) {
            ...
            if (capturedTypeConstructorImpl.getNewTypeConstructor() == null) {
                ...
                Collection<KotlinType> mo1747getSupertypes = capturedTypeConstructorImpl.mo1747getSupertypes();
                ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo1747getSupertypes, 10));
            ...
            Collection<KotlinType> mo1747getSupertypes2 = ((IntegerValueTypeConstructor) constructor).mo1747getSupertypes();
            ArrayList arrayList2 = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo1747getSupertypes2, 10));
            for (KotlinType kotlinType2 : mo1747getSupertypes2) {
            ...
            Collection<KotlinType> mo1747getSupertypes3 = intersectionTypeConstructor2.mo1747getSupertypes();
            ArrayList arrayList3 = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo1747getSupertypes3, 10));
            for (KotlinType kotlinType3 : mo1747getSupertypes3) {
