...
public final class FunctionInvokeDescriptor extends SimpleFunctionDescriptorImpl {
    ...
    private final FunctionDescriptor replaceParameterNames(List<Name> list) {
        ...
        z3 = false;
        ?? original = newCopyBuilder.setHasSynthesizedParameterNames(z3).setValueParameters2((List<ValueParameterDescriptor>) arrayList2).setOriginal((CallableMemberDescriptor) getOriginal());
