...
public final class DescriptorRendererImpl extends DescriptorRenderer implements DescriptorRendererOptions {
    ...
    */
    ...
    public String renderTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassifierDescriptor mo1746getDeclarationDescriptor = typeConstructor.mo1746getDeclarationDescriptor();
        if (mo1746getDeclarationDescriptor instanceof TypeParameterDescriptor ? true : mo1746getDeclarationDescriptor instanceof ClassDescriptor ? true : mo1746getDeclarationDescriptor instanceof TypeAliasDescriptor) {
            return renderClassifierName(mo1746getDeclarationDescriptor);
        }
        ...
        throw new IllegalStateException(("Unexpected classifier: " + mo1746getDeclarationDescriptor.getClass()).toString());
    }
    ...
    public String renderAnnotation(AnnotationDescriptor annotation, AnnotationUseSiteTarget annotationUseSiteTarget) {
        ...
        if (getVerbose() && (KotlinTypeKt.isError(type) || (type.getConstructor().mo1746getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor))) {
    ...
    private final List<String> renderAndSortAnnotationArguments(AnnotationDescriptor annotationDescriptor) {
        ClassConstructorDescriptor mo1740getUnsubstitutedPrimaryConstructor;
        ...
        if (annotationClass != null && (mo1740getUnsubstitutedPrimaryConstructor = annotationClass.mo1740getUnsubstitutedPrimaryConstructor()) != null && (valueParameters = mo1740getUnsubstitutedPrimaryConstructor.getValueParameters()) != null) {
    ...
    */
    ...
    private final void renderInitializer(VariableDescriptor variableDescriptor, StringBuilder sb) {
        ConstantValue<?> mo1742getCompileTimeInitializer;
        if (!getIncludePropertyConstant() || (mo1742getCompileTimeInitializer = variableDescriptor.mo1742getCompileTimeInitializer()) == null) {
            return;
        }
        sb.append(" = ");
        sb.append(escape(renderConstant(mo1742getCompileTimeInitializer)));
    }
    ...
    public final void renderClass(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        if (!classDescriptor.getKind().isSingleton() && getClassWithPrimaryConstructor() && (mo1740getUnsubstitutedPrimaryConstructor = classDescriptor.mo1740getUnsubstitutedPrimaryConstructor()) != null) {
            sb.append(" ");
            renderAnnotations$default(this, sb, mo1740getUnsubstitutedPrimaryConstructor, null, 2, null);
            DescriptorVisibility visibility2 = mo1740getUnsubstitutedPrimaryConstructor.getVisibility();
            ...
            renderValueParameters(valueParameters, mo1740getUnsubstitutedPrimaryConstructor.hasSynthesizedParameterNames(), sb);
        }
    ...
    private final void renderSuperTypes(ClassDescriptor classDescriptor, StringBuilder sb) {
        ...
        Collection<KotlinType> mo1747getSupertypes = classDescriptor.getTypeConstructor().mo1747getSupertypes();
        Intrinsics.checkNotNullExpressionValue(mo1747getSupertypes, "klass.typeConstructor.supertypes");
        if (mo1747getSupertypes.isEmpty()) {
            return;
        }
        if (mo1747getSupertypes.size() == 1 && KotlinBuiltIns.isAnyOrNullableAny(mo1747getSupertypes.iterator().next())) {
            return;
        }
        renderSpaceIfNeeded(sb);
        sb.append(": ");
        CollectionsKt.joinTo(mo1747getSupertypes, sb, (r14 & 2) != 0 ? ", " : ", ", (r14 & 4) != 0 ? "" : null, (r14 & 8) != 0 ? "" : null, (r14 & 16) != 0 ? -1 : 0, (r14 & 32) != 0 ? "..." : null, (r14 & 64) != 0 ? null : new Function1<KotlinType, CharSequence>() { // from class: kotlin.reflect.jvm.internal.impl.renderer.DescriptorRendererImpl$renderSuperTypes$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
