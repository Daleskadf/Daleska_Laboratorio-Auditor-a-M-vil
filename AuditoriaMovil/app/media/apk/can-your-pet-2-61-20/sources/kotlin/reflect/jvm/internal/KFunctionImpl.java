...
public final class KFunctionImpl extends KCallableImpl<Object> implements FunctionBase<Object>, KFunction<Object>, FunctionWithAllInvokes {
    ...
    private KFunctionImpl(KDeclarationContainerImpl kDeclarationContainerImpl, final String str, String str2, FunctionDescriptor functionDescriptor, Object obj) {
        ...
        this.caller$delegate = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Function0) new Function0<Caller<? extends Executable>>() { // from class: kotlin.reflect.jvm.internal.KFunctionImpl$caller$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
            ...
            public final Caller<? extends Executable> invoke() {
                ...
                if (constructor instanceof Constructor) {
                    ...
                    if (!Modifier.isStatic(method3.getModifiers())) {
                        ...
                        createJvmStaticInObjectCaller = KFunctionImpl.this.getDescriptor().getAnnotations().mo1741findAnnotation(UtilKt.getJVM_STATIC()) != null ? KFunctionImpl.this.createJvmStaticInObjectCaller(method3) : KFunctionImpl.this.createStaticMethodCaller(method3);
                    }
        ...
        this.defaultCaller$delegate = LazyKt.lazy(LazyThreadSafetyMode.PUBLICATION, (Function0) new Function0<Caller<? extends Executable>>() { // from class: kotlin.reflect.jvm.internal.KFunctionImpl$defaultCaller$2
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
            ...
            public final Caller<? extends Executable> invoke() {
                ...
                if (mapSignature instanceof JvmFunctionSignature.KotlinFunction) {
                    ...
                    Intrinsics.checkNotNull(KFunctionImpl.this.getCaller().mo1738getMember());
                    constructor = container.findDefaultMethod(methodName, methodDesc, !Modifier.isStatic(mo1738getMember.getModifiers()));
                ...
                if (constructor instanceof Constructor) {
                    ...
                    if (KFunctionImpl.this.getDescriptor().getAnnotations().mo1741findAnnotation(UtilKt.getJVM_STATIC()) != null) {
