...
public final class InlineClassAwareCallerKt {
    ...
    public static final Class<?> toInlineClass(KotlinType kotlinType) {
        ...
        Class<?> inlineClass = toInlineClass(kotlinType.getConstructor().mo1746getDeclarationDescriptor());
        if (inlineClass == null) {
            return null;
        }
