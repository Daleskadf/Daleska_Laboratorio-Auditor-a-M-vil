...
public final class NewCapturedTypeConstructor implements CapturedTypeConstructor {
    ...
    public ClassifierDescriptor mo1746getDeclarationDescriptor() {
        return null;
    }
    ...
    public List<UnwrappedType> mo1747getSupertypes() {
    ...
    public NewCapturedTypeConstructor refine(final KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        Function0<List<? extends UnwrappedType>> function0 = this.supertypesComputation != null ? new Function0<List<? extends UnwrappedType>>() { // from class: kotlin.reflect.jvm.internal.impl.types.checker.NewCapturedTypeConstructor$refine$1$1
            ...
            @Override // kotlin.jvm.functions.Function0
            public final List<? extends UnwrappedType> invoke() {
                List<UnwrappedType> mo1747getSupertypes = NewCapturedTypeConstructor.this.mo1747getSupertypes();
                KotlinTypeRefiner kotlinTypeRefiner2 = kotlinTypeRefiner;
                ArrayList arrayList = new ArrayList(CollectionsKt.collectionSizeOrDefault(mo1747getSupertypes, 10));
                for (UnwrappedType unwrappedType : mo1747getSupertypes) {
