    ...
    public Collection<ClassDescriptor> getSealedSubclasses() {
        if (this.modality == Modality.SEALED) {
            ...
            for (JavaClassifierType javaClassifierType : this.jClass.getPermittedTypes()) {
                ClassifierDescriptor mo1746getDeclarationDescriptor = this.c.getTypeResolver().transformJavaType(javaClassifierType, attributes$default).getConstructor().mo1746getDeclarationDescriptor();
    ...
    public final class LazyJavaClassTypeConstructor extends AbstractClassTypeConstructor {
        ...
        public Collection<KotlinType> computeSupertypes() {
            ...
            while (true) {
                ...
                if (enhanceSuperType.getConstructor().mo1746getDeclarationDescriptor() instanceof NotFoundClasses.MockClassDescriptor) {
                    arrayList2.add(next);
                }
            ...
            if (!arrayList2.isEmpty()) {
                ...
                ClassDescriptor mo1746getDeclarationDescriptor = mo1746getDeclarationDescriptor();
                ...
                errorReporter.reportIncompleteHierarchy(mo1746getDeclarationDescriptor, arrayList5);
            }
        ...
        */
        ...
        private final FqName getPurelyImplementsFqNameFromAnnotation() {
            ...
            AnnotationDescriptor mo1741findAnnotation = annotations.mo1741findAnnotation(PURELY_IMPLEMENTS_ANNOTATION);
        ...
        public ClassDescriptor mo1746getDeclarationDescriptor() {
