...
public abstract class ClassifierBasedTypeConstructor implements TypeConstructor {
    ...
    public abstract ClassifierDescriptor mo1746getDeclarationDescriptor();
    ...
    public int hashCode() {
        ...
        ClassifierDescriptor mo1746getDeclarationDescriptor = mo1746getDeclarationDescriptor();
        if (hasMeaningfulFqName(mo1746getDeclarationDescriptor)) {
            identityHashCode = DescriptorUtils.getFqName(mo1746getDeclarationDescriptor).hashCode();
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof TypeConstructor) && obj.hashCode() == hashCode()) {
            ...
            ClassifierDescriptor mo1746getDeclarationDescriptor = mo1746getDeclarationDescriptor();
            ClassifierDescriptor mo1746getDeclarationDescriptor2 = typeConstructor.mo1746getDeclarationDescriptor();
            if (mo1746getDeclarationDescriptor2 != null && hasMeaningfulFqName(mo1746getDeclarationDescriptor) && hasMeaningfulFqName(mo1746getDeclarationDescriptor2)) {
                return isSameClassifier(mo1746getDeclarationDescriptor2);
            }
            return false;
        }
        return false;
