...
public final class UtilsKt {
    public static final KotlinType findCorrespondingSupertype(KotlinType subtype, KotlinType supertype, TypeCheckingProcedureCallbacks typeCheckingProcedureCallbacks) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            for (KotlinType immediateSupertype : constructor2.mo1747getSupertypes()) {
    ...
    private static final String debugInfo(TypeConstructor typeConstructor) {
        ...
        for (ClassifierDescriptor mo1746getDeclarationDescriptor = typeConstructor.mo1746getDeclarationDescriptor(); mo1746getDeclarationDescriptor != null; mo1746getDeclarationDescriptor = mo1746getDeclarationDescriptor.getContainingDeclaration()) {
            debugInfo$lambda$1$unaryPlus("fqName: " + DescriptorRenderer.FQ_NAMES_IN_TYPES.render(mo1746getDeclarationDescriptor), sb);
            debugInfo$lambda$1$unaryPlus("javaClass: " + mo1746getDeclarationDescriptor.getClass().getCanonicalName(), sb);
        }
