...
public final class InlineClassManglingRulesKt {
    ...
    public static final boolean isInlineClassThatRequiresMangling(KotlinType kotlinType) {
        ...
        return mo1746getDeclarationDescriptor != null && isInlineClassThatRequiresMangling(mo1746getDeclarationDescriptor);
    }
    ...
    private static final boolean isTypeParameterWithUpperBoundThatRequiresMangling(KotlinType kotlinType) {
        ClassifierDescriptor mo1746getDeclarationDescriptor = kotlinType.getConstructor().mo1746getDeclarationDescriptor();
        TypeParameterDescriptor typeParameterDescriptor = mo1746getDeclarationDescriptor instanceof TypeParameterDescriptor ? (TypeParameterDescriptor) mo1746getDeclarationDescriptor : null;
