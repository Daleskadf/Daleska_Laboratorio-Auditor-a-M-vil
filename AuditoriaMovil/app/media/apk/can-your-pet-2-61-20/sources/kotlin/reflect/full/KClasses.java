...
public final class KClasses {
    ...
    public static final boolean isSubclassOf(KClass<?> kClass, final KClass<?> base) {
        ...
        if (!Intrinsics.areEqual(kClass, base)) {
            ...
            Boolean ifAny = DFS.ifAny(CollectionsKt.listOf(kClass), new DFS.Neighbors(kClasses$isSubclassOf$1) { // from class: kotlin.reflect.full.KClasses$$Lambda$1
