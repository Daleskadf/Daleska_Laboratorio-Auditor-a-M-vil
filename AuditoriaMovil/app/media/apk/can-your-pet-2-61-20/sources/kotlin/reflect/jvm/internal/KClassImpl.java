        ...
        public Data() {
            ...
            this.supertypes$delegate = ReflectProperties.lazySoft(new Function0<List<? extends KTypeImpl>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2
                ...
                public final List<? extends KTypeImpl> invoke() {
                    boolean z;
                    Collection<KotlinType> mo1747getSupertypes = this.this$0.getDescriptor().getTypeConstructor().mo1747getSupertypes();
                    Intrinsics.checkNotNullExpressionValue(mo1747getSupertypes, "descriptor.typeConstructor.supertypes");
                    ArrayList arrayList = new ArrayList(mo1747getSupertypes.size());
                    final KClassImpl<T>.Data data = this.this$0;
                    final KClassImpl<T> kClassImpl = r2;
                    for (final KotlinType kotlinType : mo1747getSupertypes) {
                        ...
                        arrayList.add(new KTypeImpl(kotlinType, new Function0<Type>() { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2$1$1
                            ...
                            public final Type invoke() {
                                ClassifierDescriptor mo1746getDeclarationDescriptor = KotlinType.this.getConstructor().mo1746getDeclarationDescriptor();
                                if (!(mo1746getDeclarationDescriptor instanceof ClassDescriptor)) {
                                    throw new KotlinReflectionInternalError("Supertype not a class: " + mo1746getDeclarationDescriptor);
                                }
                                Class<?> javaClass = UtilKt.toJavaClass((ClassDescriptor) mo1746getDeclarationDescriptor);
                                if (javaClass == null) {
                                    throw new KotlinReflectionInternalError("Unsupported superclass of " + data + ": " + mo1746getDeclarationDescriptor);
                                    ...
                                    if (indexOf < 0) {
                                        throw new KotlinReflectionInternalError("No superclass of " + data + " in Java reflection for " + mo1746getDeclarationDescriptor);
                                    }
