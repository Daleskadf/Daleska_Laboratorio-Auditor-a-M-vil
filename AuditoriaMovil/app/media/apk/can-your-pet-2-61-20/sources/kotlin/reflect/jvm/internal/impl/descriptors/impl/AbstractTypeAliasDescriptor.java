...
public abstract class AbstractTypeAliasDescriptor extends DeclarationDescriptorNonRootImpl implements TypeAliasDescriptor {
    ...
    public AbstractTypeAliasDescriptor(DeclarationDescriptor containingDeclaration, Annotations annotations, Name name, SourceElement sourceElement, DescriptorVisibility visibilityImpl) {
        ...
        this.typeConstructor = new TypeConstructor() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$typeConstructor$1
            ...
            public TypeAliasDescriptor mo1746getDeclarationDescriptor() {
            ...
            public Collection<KotlinType> mo1747getSupertypes() {
                Collection<KotlinType> mo1747getSupertypes = mo1746getDeclarationDescriptor().getUnderlyingType().getConstructor().mo1747getSupertypes();
                Intrinsics.checkNotNullExpressionValue(mo1747getSupertypes, "declarationDescriptor.un…pe.constructor.supertypes");
                return mo1747getSupertypes;
            }

            @Override // kotlin.reflect.jvm.internal.impl.types.TypeConstructor
            public KotlinBuiltIns getBuiltIns() {
                return DescriptorUtilsKt.getBuiltIns(mo1746getDeclarationDescriptor());
            }

            public String toString() {
                return "[typealias " + mo1746getDeclarationDescriptor().getName().asString() + ']';
            }
        ...
        return TypeUtils.contains(getUnderlyingType(), new Function1<UnwrappedType, Boolean>() { // from class: kotlin.reflect.jvm.internal.impl.descriptors.impl.AbstractTypeAliasDescriptor$isInner$1
            ...
            public final Boolean invoke(UnwrappedType type) {
                ...
                if (!KotlinTypeKt.isError(type)) {
                    ...
                    ClassifierDescriptor mo1746getDeclarationDescriptor = type.getConstructor().mo1746getDeclarationDescriptor();
                    if ((mo1746getDeclarationDescriptor instanceof TypeParameterDescriptor) && !Intrinsics.areEqual(((TypeParameterDescriptor) mo1746getDeclarationDescriptor).getContainingDeclaration(), abstractTypeAliasDescriptor)) {
                        z = true;
                    }
                }
