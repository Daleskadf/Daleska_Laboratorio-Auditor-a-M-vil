...
public final class JvmPackageScope implements MemberScope {
    ...
    public ClassifierDescriptor mo1748getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassDescriptor mo1748getContributedClassifier = this.javaScope.mo1748getContributedClassifier(name, location);
        if (mo1748getContributedClassifier != null) {
            return mo1748getContributedClassifier;
        }
        ClassifierDescriptor classifierDescriptor = null;
        for (MemberScope memberScope : getKotlinScopes()) {
            ClassifierDescriptor contributedClassifier = memberScope.mo1748getContributedClassifier(name, location);
