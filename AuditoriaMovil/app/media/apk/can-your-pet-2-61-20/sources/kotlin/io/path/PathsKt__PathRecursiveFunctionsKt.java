        ...
        if ((i & 2) != 0) {
            function3 = new Function3() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$copyToRecursively$1
                ...
                public /* bridge */ /* synthetic */ Object invoke(Object obj2, Object obj3, Object obj4) {
                    return invoke(PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1650m(obj2), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1650m(obj3), (Exception) obj4);
                }
        ...
        if (z2) {
            return PathsKt.copyToRecursively(path, target, onError, z, new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$copyToRecursively$2
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path2, Path path3) {
                    return invoke2(copyActionContext, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1650m((Object) path2), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1650m((Object) path3));
                }
        ...
        if ((i & 8) != 0) {
            function32 = new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$copyToRecursively$4
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path3, Path path4) {
                    return invoke2(copyActionContext, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1650m((Object) path3), PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1650m((Object) path4));
                }
    ...
    */
    public static final java.nio.file.Path copyToRecursively(final java.nio.file.Path r6, final java.nio.file.Path r7, final kotlin.jvm.functions.Function3<? super java.nio.file.Path, ? super java.nio.file.Path, ? super java.lang.Exception, ? extends kotlin.io.path.OnErrorResult> r8, boolean r9, final kotlin.jvm.functions.Function3<? super kotlin.io.path.CopyActionContext, ? super java.nio.file.Path, ? super java.nio.file.Path, ? extends kotlin.io.path.CopyActionResult> r10) {
        /*
            ...
            if (r1 == 0) goto Lc3
            if (r9 != 0) goto L45
            boolean r1 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1663m(r6)
            if (r1 != 0) goto Lc3
        L45:
            java.nio.file.LinkOption[] r1 = new java.nio.file.LinkOption[r0]
            java.lang.Object[] r1 = java.util.Arrays.copyOf(r1, r0)
            ...
            r2 = 1
            if (r1 == 0) goto L5c
            boolean r1 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1663m(r7)
            if (r1 != 0) goto L5c
            r1 = 1
            goto L5d
        L5c:
        ...
        L5d:
            if (r1 == 0) goto L65
            boolean r3 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1664m(r6, r7)
            if (r3 != 0) goto Lc3
        L65:
            java.nio.file.FileSystem r3 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1641m(r6)
            java.nio.file.FileSystem r4 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1641m(r7)
        ...
        L74:
            ...
            boolean r0 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1672m$1(r1, r0)
            goto Lae
        L87:
            ...
            boolean r1 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1672m$1(r1, r3)
            if (r1 == 0) goto Lae
            r0 = 1
        Lae:
            if (r0 != 0) goto Lb1
            goto Lc3
        Lb1:
            kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1673m$2()
        ...
        Lc3:
            ...
            return r7
        Ld4:
            kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m$4()
            java.lang.String r6 = r6.toString()
            java.lang.String r7 = r7.toString()
            java.lang.String r8 = "The source file doesn't exist."
            java.nio.file.NoSuchFileException r6 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1649m(r6, r7, r8)
            throw r6
        */
        ...
        if (parent != null) {
            ...
            if (directoryStream != null) {
                ...
                try {
                    ...
                    if (PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1662m((Object) m)) {
                        exceptionsCollector.setPath(parent);
                        SecureDirectoryStream m1653m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1653m((Object) m);
                        fileName = path.getFileName();
                        Intrinsics.checkNotNullExpressionValue(fileName, "this.fileName");
                        handleEntry$PathsKt__PathRecursiveFunctionsKt(m1653m, fileName, exceptionsCollector);
                    } else {
                        z = true;
                    }
    ...
    private static final void enterDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, ExceptionsCollector exceptionsCollector) {
        ...
        if (secureDirectoryStream2 != null) {
            ...
            SecureDirectoryStream<Object> m1653m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1653m((Object) secureDirectoryStream3);
            for (Object obj : m1653m) {
                fileName = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1650m(obj).getFileName();
    ...
    private static final boolean isDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, LinkOption... linkOptionArr) {
        ...
        try {
            ...
            readAttributes = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1656m((Object) fileAttributeView).readAttributes();
    ...
    private static final void insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(Path path, ExceptionsCollector exceptionsCollector) {
        ...
        if (directoryStream != null) {
            ...
            for (Object obj : PathTreeWalk$$ExternalSyntheticApiModelOutline0.m((Object) directoryStream2)) {
                Path entry = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1650m(obj);
