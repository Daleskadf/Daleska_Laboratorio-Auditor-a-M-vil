...
public final class PathTreeWalkKt {
    ...
    public static final Object keyOf(Path path, LinkOption[] linkOptionArr) {
        ...
        try {
            ...
            readAttributes = Files.readAttributes(path, PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1638m(), (LinkOption[]) Arrays.copyOf(linkOptionArr2, linkOptionArr2.length));
