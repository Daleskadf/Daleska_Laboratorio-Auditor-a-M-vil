...
public final class ExceptionsCollector {
    ...
    public final void collect(Exception exception) {
        ...
        if (this.collectedExceptions.size() < this.limit) {
            if (this.path != null) {
                PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1673m$2();
                ...
                exception = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m1642m((Object) initCause);
            }
