...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    private static int resolveGravity(int i) {
        ...
        return (i & ModuleDescriptor.MODULE_VERSION) == 0 ? i | 48 : i;
    }
    ...
    */
    ...
    private void getDesiredAnchoredChildRectWithoutConstraints(int i, Rect rect, Rect rect2, LayoutParams layoutParams, int i2, int i3) {
        ...
        int i5 = absoluteGravity & ModuleDescriptor.MODULE_VERSION;
        int i6 = absoluteGravity2 & 7;
        int i7 = absoluteGravity2 & ModuleDescriptor.MODULE_VERSION;
        if (i6 == 1) {
    ...
    private void layoutChildWithKeyline(View view, int i, int i2) {
        ...
        int i4 = absoluteGravity & ModuleDescriptor.MODULE_VERSION;
        int width = getWidth();
        int height = getHeight();
        int measuredWidth = view.getMeasuredWidth();
        int measuredHeight = view.getMeasuredHeight();
