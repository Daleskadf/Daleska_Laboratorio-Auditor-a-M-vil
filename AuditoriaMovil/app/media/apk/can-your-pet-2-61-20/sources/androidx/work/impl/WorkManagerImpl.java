...
public class WorkManagerImpl extends WorkManager {
    ...
    */
    ...
    public PendingIntent createCancelPendingIntent(UUID id) {
        return PendingIntent.getService(this.mContext, 0, SystemForegroundDispatcher.createCancelWorkIntent(this.mContext, id.toString()), Build.VERSION.SDK_INT >= 31 ? 167772160 : CompanionView.kTouchMetaStateSideButton1);
    }
