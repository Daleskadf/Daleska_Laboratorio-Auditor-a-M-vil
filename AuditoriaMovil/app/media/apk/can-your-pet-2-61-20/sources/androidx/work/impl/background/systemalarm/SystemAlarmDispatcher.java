                ...
                public void run() {
                    ...
                    if (SystemAlarmDispatcher.this.mCurrentIntent != null) {
                        ...
                        try {
                            ...
                            logger2.debug(str2, "Acquiring operation wake lock (" + action + ") " + newWakeLock2);
                            ...
                            logger3.debug(str3, "Releasing operation wake lock (" + action + ") " + newWakeLock2);
                            ...
                            try {
                                ...
                                logger4.debug(str4, "Releasing operation wake lock (" + action + ") " + newWakeLock2);
                                newWakeLock2.release();
                                mainThreadExecutor = SystemAlarmDispatcher.this.mTaskExecutor.getMainThreadExecutor();
                                dequeueAndCheckForCompletion = new DequeueAndCheckForCompletion(SystemAlarmDispatcher.this);
                            } catch (Throwable th2) {
                                ...
                                logger5.debug(str5, "Releasing operation wake lock (" + action + ") " + newWakeLock2);
                                newWakeLock2.release();
