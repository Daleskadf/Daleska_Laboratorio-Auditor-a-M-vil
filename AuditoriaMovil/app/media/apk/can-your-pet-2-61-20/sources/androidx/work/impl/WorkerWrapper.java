...
public class WorkerWrapper implements Runnable {
                    ...
                    if (!trySetRunning()) {
                        ...
                        this.mWorkerResultFuture.addListener(new Runnable() { // from class: androidx.work.impl.WorkerWrapper$$ExternalSyntheticLambda0
                            ...
                            public final void run() {
                                WorkerWrapper.this.m187lambda$runWorker$0$androidxworkimplWorkerWrapper(future);
                            }
    ...
    public /* synthetic */ void m187lambda$runWorker$0$androidxworkimplWorkerWrapper(ListenableFuture listenableFuture) {
