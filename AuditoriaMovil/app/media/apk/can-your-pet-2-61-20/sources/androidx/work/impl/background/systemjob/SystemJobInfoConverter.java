...
class SystemJobInfoConverter {
    ...
    private static JobInfo.TriggerContentUri convertContentUriTrigger(Constraints.ContentUriTrigger trigger) {
        boolean isTriggeredForDescendants = trigger.isTriggeredForDescendants();
        PrintHelper$$ExternalSyntheticApiModelOutline0.m166m();
        return PrintHelper$$ExternalSyntheticApiModelOutline0.m(trigger.getUri(), isTriggeredForDescendants ? 1 : 0);
    }
