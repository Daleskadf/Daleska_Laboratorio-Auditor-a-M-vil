...
public interface WorkTagDao {
    ...
    public static final class DefaultImpls {
        public static void insertTags(WorkTagDao workTagDao, String id, Set<String> tags) {
            ...
            for (String str : tags) {
                workTagDao.insert(new WorkTag(str, id));
            }
        }
    }
}
