...
public class WorkForegroundRunnable implements Runnable {
    ...
    public void run() {
        ...
        this.mTaskExecutor.getMainThreadExecutor().execute(new Runnable() { // from class: androidx.work.impl.utils.WorkForegroundRunnable$$ExternalSyntheticLambda0
            ...
            public final void run() {
                WorkForegroundRunnable.this.m188lambda$run$0$androidxworkimplutilsWorkForegroundRunnable(create);
            }
        });
    ...
    public /* synthetic */ void m188lambda$run$0$androidxworkimplutilsWorkForegroundRunnable(SettableFuture settableFuture) {
