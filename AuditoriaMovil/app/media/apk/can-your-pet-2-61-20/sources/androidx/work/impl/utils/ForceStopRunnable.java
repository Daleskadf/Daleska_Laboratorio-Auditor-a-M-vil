...
public class ForceStopRunnable implements Runnable {
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (i >= 3) {
                                ...
                                String str2 = TAG;
                                logger2.debug(str2, "Retrying after " + j, e);
                        ...
                        String str22 = TAG;
                        logger22.debug(str22, "Retrying after " + j2, e);
                        sleep(((long) this.mRetryCount) * BACKOFF_DURATION_MS);
            ...
            if (Build.VERSION.SDK_INT >= 30) {
                ...
                if (historicalProcessExitReasons != null && !historicalProcessExitReasons.isEmpty()) {
                    ...
                    for (int i = 0; i < historicalProcessExitReasons.size(); i++) {
                        ApplicationExitInfo m = PrintHelper$$ExternalSyntheticApiModelOutline0.m(historicalProcessExitReasons.get(i));
                        reason = m.getReason();
                        if (reason == 10) {
    ...
    static void setAlarm(Context context) {
        ...
        PendingIntent pendingIntent = getPendingIntent(context, Build.VERSION.SDK_INT >= 31 ? 167772160 : CompanionView.kTouchMetaStateSideButton1);
