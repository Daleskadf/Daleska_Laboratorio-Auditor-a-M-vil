...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            generateDefaultLayoutParams.gravity = (this.mButtonGravity & ModuleDescriptor.MODULE_VERSION) | GravityCompat.END;
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            ...
            LayoutParams generateDefaultLayoutParams = generateDefaultLayoutParams();
            generateDefaultLayoutParams.gravity = (this.mButtonGravity & ModuleDescriptor.MODULE_VERSION) | GravityCompat.START;
    ...
    */
    ...
    private int getChildVerticalGravity(int i) {
        ...
        return (i2 == 16 || i2 == 48 || i2 == 80) ? i2 : this.mGravity & ModuleDescriptor.MODULE_VERSION;
    }
    ...
    public class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
            ...
            if (parent2 != toolbar3) {
                ...
                generateDefaultLayoutParams.gravity = (Toolbar.this.mButtonGravity & ModuleDescriptor.MODULE_VERSION) | GravityCompat.START;
                generateDefaultLayoutParams.mViewType = 2;
