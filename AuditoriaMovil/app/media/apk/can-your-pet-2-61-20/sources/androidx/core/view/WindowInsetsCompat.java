...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m113m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            super(windowInsetsCompat);
            WindowInsets.Builder m113m;
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                m113m = HalfKt$$ExternalSyntheticApiModelOutline0.m114m(windowInsets);
            } else {
                m113m = HalfKt$$ExternalSyntheticApiModelOutline0.m113m();
            }
            this.mPlatBuilder = m113m;
        }
