...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        ...
        shortLabel = ComponentDialog$$ExternalSyntheticApiModelOutline0.m10m(this.mContext, this.mId).setShortLabel(this.mLabel);
    ...
    public static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        for (ShortcutInfo shortcutInfo : list) {
            arrayList.add(new Builder(context, ComponentDialog$$ExternalSyntheticApiModelOutline0.m11m((Object) shortcutInfo)).build());
        }
        return arrayList;
    }
