...
public class d implements Serializable {
    ...
    public b a(k3.f fVar, c4.f fVar2, Class cls, e eVar) {
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                ...
                if (fVar.j0(k3.h.ACCEPT_FLOAT_AS_INT)) {
                    return b.TryConvert;
                }
                return b.Fail;
            }
            ...
            if (eVar == e.EmptyString) {
                if (!z10 && !fVar.j0(k3.h.ACCEPT_EMPTY_STRING_AS_NULL_OBJECT)) {
                    if (fVar2 == c4.f.OtherScalar) {
                        return b.TryConvert;
                    }
                    return b.Fail;
                }
            ...
            return this.f16638a;
        } else if (fVar.j0(k3.h.ACCEPT_EMPTY_ARRAY_AS_NULL_OBJECT)) {
            return b.AsNull;
        } else {
            return b.Fail;
        }
    ...
    public b b(k3.f fVar, c4.f fVar2, Class cls, b bVar) {
        ...
        if (fVar.j0(k3.h.ACCEPT_EMPTY_STRING_AS_NULL_OBJECT)) {
            return b.AsNull;
        }
        return b.Fail;
    }
