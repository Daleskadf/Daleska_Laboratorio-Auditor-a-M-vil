...
public final class b extends b6.e<q> implements j6.b {
    ...
    /* loaded from: classes3.dex */
    public static final class View$OnClickListenerC0226b implements View.OnClickListener {
        public View$OnClickListenerC0226b() {
        }
    ...
    public static final class c implements ICommonAlertCallback {
        ...
        public void onConfirm(Dialog dialog) {
            ...
            i.d(context);
            context.startActivity(new Intent(b.this.getContext(), AccountBindAty.class));
            dialog.dismiss();
        }
    }
    ...
    public void Y2() {
        ...
        j3().e(new a());
        ((AutoRelativeLayout) g3(R$id.mCouponAvailableLayout)).setOnClickListener(new View$OnClickListenerC0226b());
    }
