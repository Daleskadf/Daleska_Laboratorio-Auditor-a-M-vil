...
public abstract class x1 implements z8.q {
    ...
    public final class a0 implements z8.r {
        ...
        public final v f(y8.k1 k1Var, y8.v0 v0Var) {
            ...
            Integer e10 = e(v0Var);
            boolean z11 = true;
            boolean z12 = !x1.this.f21042g.f20915c.contains(k1Var.n());
            if (x1.this.f21048m != null && (!z12 || (e10 != null && e10.intValue() < 0))) {
                z10 = !x1.this.f21048m.b();
            } else {
                z10 = false;
            }
            return new v((z12 || z10) ? false : false, e10);
        }
        ...
        public final x g(y8.k1 k1Var, y8.v0 v0Var) {
            ...
            Integer e10 = e(v0Var);
            if (x1.this.f21048m != null && (contains || (e10 != null && e10.intValue() < 0))) {
                z10 = !x1.this.f21048m.b();
            } else {
                z10 = false;
            }
            if (x1.this.f21041f.f21141a > this.f21063a.f21080d + 1 && !z10) {
                if (e10 == null) {
                    if (contains) {
    ...
    public static final class c0 {
        ...
        public boolean a() {
            if (this.f21089d.get() > this.f21087b) {
                return true;
            }
            return false;
        }
        ...
        public boolean equals(Object obj) {
            ...
            c0 c0Var = (c0) obj;
            if (this.f21086a == c0Var.f21086a && this.f21088c == c0Var.f21088c) {
                return true;
            }
            return false;
        }
    ...
    public final class w implements Runnable {
        ...
        public class a implements Runnable {
            ...
            public void run() {
                ...
                if (uVar != null) {
                    uVar.c(x1.this.f21039d.schedule(new w(uVar), x1.this.f21042g.f20914b, TimeUnit.NANOSECONDS));
                }
    ...
    public static final class z {
        ...
        public z(List list, Collection collection, Collection collection2, b0 b0Var, boolean z10, boolean z11, boolean z12, int i10) {
            ...
            if (z11 && ((collection.size() != 1 || !collection.contains(b0Var)) && (collection.size() != 0 || !b0Var.f21078b))) {
                z15 = false;
            } else {
                z15 = true;
            }
            Preconditions.checkState(z15, "passThrough should imply winningSubstream is drained");
            Preconditions.checkState((z10 && b0Var == null) ? true : true, "cancelled should imply committed");
        }
        ...
        public z c(b0 b0Var) {
            ...
            return new z(list, emptyList, this.f21135d, b0Var, this.f21138g, z11, this.f21139h, this.f21136e);
        }
        ...
        public z d() {
            ...
            return new z(this.f21133b, this.f21134c, this.f21135d, this.f21137f, this.f21138g, this.f21132a, true, this.f21136e);
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:28:0x0043, code lost:
        if (r8.f21050o.f21137f != r9) goto L22;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:46:0x0090, code lost:
        if ((r4 instanceof z8.x1.y) == false) goto L42;
     */
    ...
    */
    public final void f0(z8.x1.b0 r9) {
        /*
            ...
            r2 = 0
        L4:
            java.lang.Object r4 = r8.f21044i
            monitor-enter(r4)
            z8.x1$z r5 = r8.f21050o     // Catch: java.lang.Throwable -> La5
            if (r0 == 0) goto L19
            z8.x1$b0 r6 = r5.f21137f     // Catch: java.lang.Throwable -> La5
            if (r6 == 0) goto L13
            if (r6 == r9) goto L13
            monitor-exit(r4)     // Catch: java.lang.Throwable -> La5
            goto L35
        L13:
            boolean r6 = r5.f21138g     // Catch: java.lang.Throwable -> La5
            if (r6 == 0) goto L19
            monitor-exit(r4)     // Catch: java.lang.Throwable -> La5
            goto L35
        L19:
            java.util.List r6 = r5.f21133b     // Catch: java.lang.Throwable -> La5
            int r6 = r6.size()     // Catch: java.lang.Throwable -> La5
            if (r2 != r6) goto L4e
            z8.x1$z r0 = r5.h(r9)     // Catch: java.lang.Throwable -> La5
            r8.f21050o = r0     // Catch: java.lang.Throwable -> La5
            boolean r0 = r8.m()     // Catch: java.lang.Throwable -> La5
            if (r0 != 0) goto L2f
            monitor-exit(r4)     // Catch: java.lang.Throwable -> La5
            return
        L2f:
            z8.x1$p r1 = new z8.x1$p     // Catch: java.lang.Throwable -> La5
            r1.<init>()     // Catch: java.lang.Throwable -> La5
            monitor-exit(r4)     // Catch: java.lang.Throwable -> La5
        L35:
            if (r1 == 0) goto L3d
            java.util.concurrent.Executor r9 = r8.f21038c
            r9.execute(r1)
            return
        L3d:
            z8.q r0 = r9.f21077a
            z8.x1$z r1 = r8.f21050o
            z8.x1$b0 r1 = r1.f21137f
            if (r1 != r9) goto L48
            y8.k1 r9 = r8.f21060y
            goto L4a
        L48:
        ...
        L4a:
            ...
            return
        L4e:
            boolean r6 = r9.f21078b     // Catch: java.lang.Throwable -> La5
            if (r6 == 0) goto L54
            monitor-exit(r4)     // Catch: java.lang.Throwable -> La5
            return
        L54:
            int r6 = r2 + 128
            java.util.List r7 = r5.f21133b     // Catch: java.lang.Throwable -> La5
            int r7 = r7.size()     // Catch: java.lang.Throwable -> La5
            int r6 = java.lang.Math.min(r6, r7)     // Catch: java.lang.Throwable -> La5
            if (r3 != 0) goto L6e
            java.util.ArrayList r3 = new java.util.ArrayList     // Catch: java.lang.Throwable -> La5
            java.util.List r5 = r5.f21133b     // Catch: java.lang.Throwable -> La5
        ...
        L93:
            if (r0 == 0) goto L7f
            z8.x1$z r4 = r8.f21050o
            z8.x1$b0 r5 = r4.f21137f
            if (r5 == 0) goto L9e
            if (r5 == r9) goto L9e
            goto La2
        L9e:
            boolean r4 = r4.f21138g
            if (r4 == 0) goto L7f
        La2:
            r2 = r6
            goto L4
    ...
    public final boolean h0(z zVar) {
        if (zVar.f21137f == null && zVar.f21136e < this.f21042g.f20913a && !zVar.f21139h) {
            return true;
        }
        return false;
    }
    ...
    public final boolean m() {
        for (b0 b0Var : this.f21050o.f21134c) {
            if (b0Var.f21077a.m()) {
                return true;
            }
        }
