...
public final class y1 {
    ...
    public boolean equals(Object obj) {
        ...
        y1 y1Var = (y1) obj;
        if (this.f21141a != y1Var.f21141a || this.f21142b != y1Var.f21142b || this.f21143c != y1Var.f21143c || Double.compare(this.f21144d, y1Var.f21144d) != 0 || !Objects.equal(this.f21145e, y1Var.f21145e) || !Objects.equal(this.f21146f, y1Var.f21146f)) {
            return false;
        }
        return true;
    }
