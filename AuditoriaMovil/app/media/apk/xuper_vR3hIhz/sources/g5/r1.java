...
public final class r1 extends j5.b {
    ...
    public static final void C(p2 p2Var, r1 r1Var, View view) {
        ...
        HomeRecommend homeRecommend = new HomeRecommend(str, str2, Integer.valueOf(i10), "", "", "", "", null, null, null, null);
    ...
    public static final void D(r1 r1Var, p2 p2Var, BaseQuickAdapter baseQuickAdapter, View view, int i10) {
        ...
        sb.append(str6);
        com.mobile.brasiltv.utils.b0.r(cVar, str2, str3, str4, enterType, str5, false, false, i11, sb.toString(), str);
    }
    ...
    public static final void I(r1 r1Var, o2 o2Var, View view) {
        ...
        Intent intent = new Intent(r1Var.f13857a, TopTenActivity.class);
    ...
    public static final void r(r1 r1Var, BGABanner bGABanner, View view, Object obj, int i10) {
        ...
        if (obj instanceof RecommendContentList) {
            ...
            s1.m.h0(mVar, activity, imageView, adInfo.getMedia_type(), adInfo, Integer.valueOf((int) R.drawable.column_image_placeholder), null, null, false, 0, 480, null);
    ...
    public static final void u(r1 r1Var, s1 s1Var, String str, BGABanner bGABanner, View view, Object obj, int i10) {
        ...
        if (obj instanceof RecommendContentList) {
            ...
            if (t9.i.b("4", recommendContentList.getType())) {
                ...
                if (!((url == null || url.length() == 0) ? true : true)) {
                    r1Var.O(s1Var.a(), i10);
            ...
            sb.append(str4);
            com.mobile.brasiltv.utils.b0.r(cVar, type, programType, contentId, enterType, str5, false, false, b10, sb.toString(), str2);
        } else if (obj instanceof AdInfo) {
            AdInfo adInfo = (AdInfo) obj;
            String action = adInfo.getAction();
            if (!((action == null || action.length() == 0) ? true : true) && t9.i.b(adInfo.getAction_type(), "1")) {
                a6.a.u(a6.a.f228a, r1Var.f13857a, adInfo.getAction(), false, 4, null);
                s1.q qVar = s1.q.f18727a;
                Activity activity2 = r1Var.f13857a;
                qVar.h(activity2, d6.b.f12660a.m(activity2), adInfo.getMedia_type(), adInfo);
    ...
    public final void N(boolean z10) {
        boolean z11;
        for (IAdView iAdView : this.f13861e) {
            if (this.f13859c && this.f13860d) {
                z11 = true;
            } else {
                z11 = false;
            }
    ...
    public final void p(BaseViewHolder baseViewHolder, final s1 s1Var) {
        ...
        if (s1Var.c().isEmpty()) {
            ...
            BGABanner bGABanner3 = this.f13862f;
            t9.i.d(bGABanner3);
            bGABanner3.setData(i9.i.b(Integer.valueOf((int) R.drawable.column_image_placeholder)), null);
            return;
        }
    ...
    public final void y(BaseViewHolder baseViewHolder, final t1 t1Var) {
        ...
        sb.append(str);
        y1 y1Var = new y1(activity, i10, false, true, false, sb.toString(), 16, null);
