...
public final class b {
    ...
    public static final class d {
        ...
        public final void a() {
            ...
            if (!this.f18031f) {
                ...
                if (e10 != -1) {
                    ...
                    m10 = r.a.m(RoundedDrawable.DEFAULT_BORDER_COLOR, e12);
                }
                this.f18033h = m10;
                if (e11 != -1) {
                    m11 = r.a.m(-1, e11);
                } else {
                    m11 = r.a.m(RoundedDrawable.DEFAULT_BORDER_COLOR, e13);
                }
                this.f18032g = m11;
                this.f18031f = true;
            }
        ...
        public boolean equals(Object obj) {
            ...
            d dVar = (d) obj;
            if (this.f18030e == dVar.f18030e && this.f18029d == dVar.f18029d) {
                return true;
            }
            return false;
        }
    ...
    public final boolean g(d dVar, p0.c cVar) {
        float[] c10 = dVar.c();
        if (c10[1] >= cVar.e() && c10[1] <= cVar.c() && c10[2] >= cVar.d() && c10[2] <= cVar.b() && !this.f18016d.get(dVar.e())) {
            return true;
        }
        return false;
    }
