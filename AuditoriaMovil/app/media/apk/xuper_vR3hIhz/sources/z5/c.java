    ...
    public static final class g extends RemoteMediaClient.Callback {
        ...
        public void onStatusUpdated() {
            ...
            if (playerState != 0) {
                ...
                if (dVar5 != null) {
                    dVar5.L1(((RemoteMediaClient) this.f20231a.f18961a).getIdleReason());
                }
                if (((RemoteMediaClient) this.f20231a.f18961a).getIdleReason() == 4) {
                    ...
                    i1.h(a10, H, "CHROME_CAST", str, this.f20234d, "4", this.f20235e, this.f20236f, this.f20237g, this.f20238h, this.f20239i, this.f20240j);
                    return;
                }
                return;
            }
