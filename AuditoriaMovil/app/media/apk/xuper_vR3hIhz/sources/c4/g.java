...
public abstract class g extends m {
    ...
    public k3.j U(k3.j jVar) {
        ...
        k3.j k10 = jVar.k();
        if (k10 != null && (U = this.f5550m.U(k10)) != this.f5550m) {
            return U3.R(U);
        }
        return U3;
    }
    ...
    public boolean equals(Object obj) {
        ...
        g gVar = (g) obj;
        if (this.f14918a == gVar.f14918a && this.f5549l.equals(gVar.f5549l) && this.f5550m.equals(gVar.f5550m)) {
            return true;
        }
        return false;
    }
    ...
    @Override // k3.j
    public boolean x() {
        if (!super.x() && !this.f5550m.x() && !this.f5549l.x()) {
            return false;
        }
        return true;
    }
