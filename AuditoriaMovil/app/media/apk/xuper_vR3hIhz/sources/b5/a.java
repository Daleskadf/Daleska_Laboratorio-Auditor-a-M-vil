...
public final class a {
    ...
    public class C0070a extends s4.a {
        ...
        public class b implements Callable {
            ...
            public d5.b call() {
                ...
                b10 = (b10 == null || b10.isEmpty()) ? "apkMd5 is empty" : "apkMd5 is empty";
                String h10 = a.this.f4648b.h();
                return new d5.b(b10, (h10 == null || h10.trim().isEmpty()) ? "pathMd5 is empty" : "pathMd5 is empty");
            }
        }
        ...
        public void e(z4.a aVar) {
            super.e(aVar);
            a.this.k(aVar);
            for (c cVar : new ArrayList(a.this.f4647a)) {
                cVar.onFailure(aVar);
            }
            a.this.f4648b = null;
        }
    ...
    public final void l(String str, String str2) {
        ...
        h.c(Uri.parse(m10).getHost(), (System.currentTimeMillis() - this.f4648b.c()) / 1000, this.f4648b.b(), str3 + str2, this.f4648b.j(), str);
    }
    ...
    public void m(Context context, d5.c cVar) {
        ...
        this.f4648b = f10;
        if (f10.n()) {
            for (c cVar2 : new ArrayList(this.f4647a)) {
                cVar2.onSuccess();
            }
            this.f4648b = null;
            return;
