...
public class g0 extends p0 {
        ...
        public void onTransfer(MediaRouter2.RoutingController routingController, MediaRouter2.RoutingController routingController2) {
            ...
            if (routingController2 != systemController) {
                ...
                if (!selectedRoutes.isEmpty()) {
                    ...
                    g0.this.f16883k.put(routingController2, new c(routingController2, id));
    ...
    */
    ...
    public MediaRoute2Info B(String str) {
        ...
        for (Object obj : this.f16889q) {
            MediaRoute2Info a10 = n0.b.a(obj);
            id = a10.getId();
    ...
    public void E() {
        ...
        map = stream2.map(new Function() { // from class: n0.d0
            ...
            public final Object apply(Object obj2) {
                return i1.c((MediaRoute2Info) obj2);
            }
        });
        ...
        if (cVar != null) {
            ...
            if (!b10.isEmpty()) {
                for (n0 n0Var2 : b10) {
                    ...
                    arrayList.add(aVar.e(i10).b(a11.contains(l10)).d(a12.contains(l10)).c(true).a());
                }
            }
    ...
    public final o0 H(o0 o0Var, boolean z10) {
        ...
        List e10 = o0Var.c().e();
        if (z10) {
            if (!e10.contains("android.media.intent.category.LIVE_AUDIO")) {
    ...
    public p0.b r(String str) {
        for (Map.Entry entry : this.f16883k.entrySet()) {
