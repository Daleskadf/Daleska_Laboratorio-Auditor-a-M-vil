...
public final class k1 {
    ...
    public static final v0.g f19906w = v0.g.g("grpc-status", false, new c());
    ...
    public static List g() {
        ...
        for (b bVar : b.values()) {
            if (((k1) treeMap.put(Integer.valueOf(bVar.c()), new k1(bVar))) != null) {
    ...
    public k1 f(String str) {
        ...
        b bVar = this.f19909a;
        return new k1(bVar, this.f19910b + "\n" + str, this.f19911c);
    }
    ...
    public k1 q(Throwable th) {
        if (Objects.equal(this.f19911c, th)) {
            return this;
        }
        return new k1(this.f19909a, this.f19910b, th);
    }

    public k1 r(String str) {
        if (Objects.equal(this.f19910b, str)) {
            return this;
        }
        return new k1(this.f19909a, str, this.f19911c);
    }
