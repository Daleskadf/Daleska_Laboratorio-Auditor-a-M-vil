...
public abstract class y0 {
    ...
    public static final class e {
        ...
        public boolean equals(Object obj) {
            ...
            e eVar = (e) obj;
            if (!Objects.equal(this.f20089a, eVar.f20089a) || !Objects.equal(this.f20090b, eVar.f20090b) || !Objects.equal(this.f20091c, eVar.f20091c)) {
                return false;
            }
            return true;
        }
    ...
    public static final class b {
        ...
        public boolean equals(Object obj) {
            ...
            b bVar = (b) obj;
            if (Objects.equal(this.f20087a, bVar.f20087a) && Objects.equal(this.f20088b, bVar.f20088b)) {
                return true;
            }
            return false;
        }
        ...
        public String toString() {
            if (this.f20088b != null) {
                return MoreObjects.toStringHelper(this).add("config", this.f20088b).toString();
            }
            return MoreObjects.toStringHelper(this).add("error", this.f20087a).toString();
        }
