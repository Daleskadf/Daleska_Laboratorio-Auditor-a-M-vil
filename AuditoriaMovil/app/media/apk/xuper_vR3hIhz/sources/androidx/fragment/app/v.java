...
public class v {
    ...
    public int d() {
        ...
        if (o.P && (viewGroup = (fragment = this.f2418c).mContainer) != null) {
            bVar = j0.n(viewGroup, fragment.getParentFragmentManager()).l(this);
        } else {
            bVar = null;
        }
    ...
    public void g() {
        ...
        if (z11) {
            ...
            if (str != null) {
                fragment2.mTarget = this.f2417b.f(str);
            }
            this.f2417b.q(this);
            return;
        }
        String str2 = this.f2418c.mTargetWho;
        if (str2 != null && (f10 = this.f2417b.f(str2)) != null && f10.mRetainInstance) {
                        ...
                        switch (i10 - 1) {
                            ...
                            case 3:
                                ...
                                if (fragment3.mView != null && (viewGroup3 = fragment3.mContainer) != null) {
                                    j0.n(viewGroup3, fragment3.getParentFragmentManager()).d(this);
                                }
