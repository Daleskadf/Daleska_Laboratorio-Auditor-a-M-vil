...
public final class r extends androidx.lifecycle.v {
    ...
    public boolean equals(Object obj) {
        ...
        r rVar = (r) obj;
        if (this.f2396c.equals(rVar.f2396c) && this.f2397d.equals(rVar.f2397d) && this.f2398e.equals(rVar.f2398e)) {
            return true;
        }
        return false;
    }
    ...
    public void f(Fragment fragment) {
        if (this.f2402i) {
            o.F0(2);
        } else if (this.f2396c.containsKey(fragment.mWho)) {
        } else {
    ...
    public void n(Fragment fragment) {
        ...
        if (this.f2396c.remove(fragment.mWho) != null) {
            z10 = true;
        } else {
            z10 = false;
        }
