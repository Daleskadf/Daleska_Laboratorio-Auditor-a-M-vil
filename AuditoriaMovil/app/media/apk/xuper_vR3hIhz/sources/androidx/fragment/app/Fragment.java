...
public abstract class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, androidx.lifecycle.g, androidx.lifecycle.y, androidx.savedstate.b {
    ...
    public class e implements j.a {
        ...
        public ActivityResultRegistry apply(Void r32) {
            ...
            androidx.fragment.app.l lVar = fragment.mHost;
    ...
    public class g extends k {
        ...
        public void a() {
            this.f2139b.set(((ActivityResultRegistry) this.f2138a.apply(null)).i(Fragment.this.generateActivityResultKey(), Fragment.this, this.f2140c, this.f2141d));
        }
    }
    ...
    public ArrayList<String> getSharedElementSourceNames() {
        ...
        i iVar = this.mAnimationInfo;
        if (iVar != null && (arrayList = iVar.f2154i) != null) {
            return arrayList;
        }
    ...
    public ArrayList<String> getSharedElementTargetNames() {
        ArrayList<String> arrayList;
        i iVar = this.mAnimationInfo;
        if (iVar != null && (arrayList = iVar.f2155j) != null) {
            return arrayList;
        }
        return new ArrayList<>();
    }
    ...
    public void setInitialSavedState(m mVar) {
        if (this.mFragmentManager == null) {
            this.mSavedFragmentState = (mVar == null || (r2 = mVar.f2169a) == null) ? null : null;
            return;
        }
