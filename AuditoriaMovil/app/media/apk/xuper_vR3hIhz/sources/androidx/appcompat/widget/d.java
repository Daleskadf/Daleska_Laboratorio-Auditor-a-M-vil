...
public class d extends androidx.appcompat.view.menu.b implements b.a {
    ...
    public boolean flagActionItems() {
        ...
        if (dVar.f1440n && (z12 || i18 + i17 > i15)) {
            i15--;
        }
        int i20 = i15 - i17;
        ...
        while (i22 < i10) {
            ...
            if (iVar2.o()) {
                ...
                if ((i20 > 0 || z13) && i16 > 0 && (!dVar.f1446t || i12 > 0)) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                ...
                if (z10) {
                    ...
                    if (!dVar.f1446t ? i16 + i23 > 0 : i16 >= 0) {
                        z11 = true;
                    } else {
                        z11 = false;
                    }
    ...
    public boolean s() {
        ...
        c cVar = this.A;
        if (cVar != null && (nVar = this.f1135i) != null) {
    ...
    public void updateMenuView(boolean z10) {
        ...
        if (z11) {
            ...
            C0019d c0019d = this.f1437k;
            if (c0019d != null) {
                ViewParent parent = c0019d.getParent();
                androidx.appcompat.view.menu.n nVar = this.f1135i;
                if (parent == nVar) {
                    ((ViewGroup) nVar).removeView(this.f1437k);
                }
            }
        }
