...
public class g implements u.a {
    ...
    public void findItemsWithShortcutForKey(List<i> list, int i10, KeyEvent keyEvent) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            ...
            if (z10 && numericShortcut != 0) {
                char[] cArr = keyData.meta;
                if ((numericShortcut == cArr[0] || numericShortcut == cArr[2] || (isQwertyMode && numericShortcut == '\b' && i10 == 67)) && iVar.isEnabled()) {
                    list.add(iVar);
                }
            }
        }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:6:0x0019, code lost:
        if (b0.p1.f(android.view.ViewConfiguration.get(r2.mContext), r2.mContext) != false) goto L6;
     */
    /*
