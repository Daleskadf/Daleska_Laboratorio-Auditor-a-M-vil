...
public class ActionBarOverlayLayout extends ViewGroup implements h1, b0.z, b0.x, b0.y {
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.f1301f != null && !this.f1302g) {
            if (this.f1299d.getVisibility() == 0) {
                i10 = (int) (this.f1299d.getBottom() + this.f1299d.getTranslationY() + 0.5f);
            } else {
                i10 = 0;
            }
            this.f1301f.setBounds(0, i10, getWidth(), this.f1301f.getIntrinsicHeight() + i10);
    ...
    */
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (!this.f1303h && !z10) {
            Rect rect = this.f1311p;
            rect.top += measuredHeight;
            rect.bottom += 0;
        } else {
            Rect rect2 = this.f1314s;
    ...
    public final boolean v(float f10, float f11) {
        ...
        if (this.f1317v.getFinalY() > this.f1299d.getHeight()) {
            return true;
        }
        return false;
    }
