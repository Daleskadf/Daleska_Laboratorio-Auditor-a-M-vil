...
public class w2 {
    ...
    public final void a(View view, int i10, int i11, boolean z10, WindowManager.LayoutParams layoutParams) {
        ...
        if (rect.left < 0 && rect.top < 0) {
            Resources resources2 = this.f1677a.getResources();
            ...
            this.f1681e.set(0, i14, displayMetrics.widthPixels, displayMetrics.heightPixels);
        }
        ...
        } else if (measuredHeight + i19 <= this.f1681e.height()) {
            layoutParams.y = i19;
        } else {
            layoutParams.y = i18;
        }
