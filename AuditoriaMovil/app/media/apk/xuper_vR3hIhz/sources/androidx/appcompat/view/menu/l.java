...
public class l {
    ...
    public final k a() {
        ...
        if (Math.min(point.x, point.y) >= this.f1236a.getResources().getDimensionPixelSize(R$dimen.abc_cascading_menus_min_smallest_width)) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (z10) {
            qVar = new d(this.f1236a, this.f1241f, this.f1239d, this.f1240e, this.f1238c);
        } else {
            qVar = new q(this.f1236a, this.f1237b, this.f1241f, this.f1239d, this.f1240e, this.f1238c);
        }
        qVar.a(this.f1237b);
        qVar.j(this.f1247l);
        qVar.e(this.f1241f);
        qVar.setCallback(this.f1244i);
        qVar.g(this.f1243h);
        qVar.h(this.f1242g);
        return qVar;
    }
