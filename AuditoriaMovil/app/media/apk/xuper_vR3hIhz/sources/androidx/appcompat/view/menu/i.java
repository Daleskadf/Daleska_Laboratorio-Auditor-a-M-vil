...
public final class i implements u.b {
    ...
    public boolean A() {
        if (this.f1210n.isShortcutsVisible() && g() != 0) {
            return true;
        }
        return false;
    }
    ...
    public boolean isVisible() {
        b0.b bVar = this.B;
        if (bVar != null && bVar.h()) {
            if ((this.f1221y & 8) == 0 && this.B.c()) {
                return true;
            }
            return false;
        } else if ((this.f1221y & 8) == 0) {
            return true;
        } else {
            return false;
        }
