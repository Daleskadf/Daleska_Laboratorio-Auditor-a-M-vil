...
public class SearchView extends u1 implements g.c {
    ...
    public static class SearchAutoComplete extends androidx.appcompat.widget.e {
        ...
        public boolean enoughToFilter() {
            if (this.f1387d > 0 && !super.enoughToFilter()) {
                return false;
            }
            return true;
        }
    ...
    public class f implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (view == searchView.f1363e) {
                searchView.A();
            } else if (view == searchView.f1366g) {
                searchView.w();
            } else if (view == searchView.f1364f) {
                searchView.B();
            ...
            if (i10 != 66 && i10 != 84 && i10 != 61) {
                if (i10 != 21 && i10 != 22) {
                    ...
                    if (i10 == 21) {
                        ...
                        length = this.f1359a.length();
                    }
                    this.f1359a.setSelection(length);
    ...
    public final void N() {
        int i10;
        if (s() && (this.f1364f.getVisibility() == 0 || this.f1368h.getVisibility() == 0)) {
            i10 = 0;
        } else {
            i10 = 8;
        }
        this.f1362d.setVisibility(i10);
    }
    ...
    public final void P(boolean z10) {
        ...
        this.f1375o.setVisibility((this.f1375o.getDrawable() == null || this.f1384x) ? 8 : 8);
        J();
        Q(!z11);
        N();
    }
    ...
    public void g() {
        ...
        if (this.f1369i.getWidth() > 1) {
            ...
            this.f1359a.setDropDownHorizontalOffset(i11);
            this.f1359a.setDropDownWidth((((this.f1369i.getWidth() + rect.left) + rect.right) + i10) - paddingLeft);
        }
    }
    ...
    public final Intent i(Cursor cursor, int i10, String str) {
        ...
        try {
            try {
                ...
                return h(str2, parse, l2.o(cursor, "suggest_intent_extra_data"), l2.o(cursor, "suggest_intent_query"), i10, str);
