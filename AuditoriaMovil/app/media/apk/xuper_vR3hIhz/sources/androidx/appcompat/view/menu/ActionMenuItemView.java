...
public class ActionMenuItemView extends q0 implements n.a, View.OnClickListener, ActionMenuView.a {
    ...
    public class a extends t1 {
        ...
        public boolean c() {
            ...
            if (bVar == null || !bVar.b(actionMenuItemView.f1072a) || (b10 = b()) == null || !b10.isShowing()) {
                return false;
            }
            return true;
        }
    ...
    public final void f() {
        ...
        if (TextUtils.isEmpty(tooltipText)) {
            if (!z12) {
                charSequence2 = this.f1072a.getTitle();
            }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (mode == Integer.MIN_VALUE) {
            i12 = Math.min(size, this.f1080i);
        } else {
            i12 = this.f1080i;
        }
        if (mode != 1073741824 && this.f1080i > 0 && measuredWidth < i12) {
