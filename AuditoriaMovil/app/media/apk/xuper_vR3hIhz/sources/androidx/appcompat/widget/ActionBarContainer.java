...
public class ActionBarContainer extends FrameLayout {
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        if (!this.f1273a && !super.onInterceptTouchEvent(motionEvent)) {
            return false;
        }
        return true;
    }
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (this.f1280h) {
            ...
            this.f1281i = z11;
            if (z11 && (drawable = this.f1278f) != null) {
    ...
    public void onMeasure(int i10, int i11) {
        ...
        int i13;
        int i14;
        if (this.f1275c == null && View.MeasureSpec.getMode(i11) == Integer.MIN_VALUE && (i14 = this.f1282j) >= 0) {
        ...
        if (view != null && view.getVisibility() != 8 && mode != 1073741824) {
            ...
            setMeasuredDimension(getMeasuredWidth(), Math.min(i12 + a(this.f1274b), i13));
        }
    }
    ...
    public boolean verifyDrawable(Drawable drawable) {
        if ((drawable == this.f1277e && !this.f1280h) || ((drawable == this.f1278f && this.f1281i) || ((drawable == this.f1279g && this.f1280h) || super.verifyDrawable(drawable)))) {
            return true;
        }
        return false;
    }
