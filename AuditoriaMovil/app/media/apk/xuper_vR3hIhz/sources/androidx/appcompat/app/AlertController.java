...
public class AlertController {
    ...
    public class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (view == alertController.f843o && (message4 = alertController.f845q) != null) {
                message = Message.obtain(message4);
            } else if (view == alertController.f847s && (message3 = alertController.f849u) != null) {
                message = Message.obtain(message3);
            } else if (view == alertController.f851w && (message2 = alertController.f853y) != null) {
    ...
    public static class f {
        ...
        public class b extends CursorAdapter {
            ...
            public void bindView(View view, Context context, Cursor cursor) {
                ((CheckedTextView) view.findViewById(16908308)).setText(cursor.getString(this.f898a));
                RecycleListView recycleListView = this.f900c;
                int position = cursor.getPosition();
                boolean z10 = true;
                if (cursor.getInt(this.f899b) != 1) {
                    z10 = false;
                }
        ...
        public final void b(AlertController alertController) {
            ...
            if (this.G) {
                if (this.K == null) {
                    listAdapter = new a(this.f870a, alertController.M, 16908308, this.f891v, recycleListView);
                } else {
                    listAdapter = new b(this.f870a, this.K, false, recycleListView, alertController);
                }
            } else {
                if (this.H) {
                ...
                int i11 = i10;
                if (this.K != null) {
                    listAdapter = new SimpleCursorAdapter(this.f870a, i11, this.K, new String[]{this.L}, new int[]{16908308});
                } else {
                    listAdapter = this.f892w;
                    if (listAdapter == null) {
                        listAdapter = new h(this.f870a, i11, 16908308, this.f891v);
                    }
                }
            }
    ...
    public final void A() {
        ...
        View findViewById2;
        View findViewById3;
        View findViewById4 = this.f831c.findViewById(R$id.parentPanel);
    ...
    public final void y(ViewGroup viewGroup) {
        ...
        if (view == null) {
            if (this.f837i != 0) {
                view = LayoutInflater.from(this.f829a).inflate(this.f837i, viewGroup, false);
            } else {
                view = null;
            }
        }
    ...
    public final void z(ViewGroup viewGroup) {
        ...
        this.D = (ImageView) this.f831c.findViewById(16908294);
