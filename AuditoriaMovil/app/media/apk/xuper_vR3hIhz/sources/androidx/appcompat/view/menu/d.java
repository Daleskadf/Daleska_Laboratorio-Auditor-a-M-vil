...
public final class d extends k implements View.OnKeyListener, PopupWindow.OnDismissListener {
        ...
        public void onGlobalLayout() {
            if (d.this.isShowing() && d.this.f1147i.size() > 0 && !((C0017d) d.this.f1147i.get(0)).f1172a.u()) {
                ...
                if (view != null && view.isShown()) {
                    for (C0017d c0017d : d.this.f1147i) {
                        c0017d.f1172a.show();
                    }
                    return;
                }
    ...
    public class c implements z1 {
        ...
        public void b(g gVar, MenuItem menuItem) {
            ...
            while (true) {
                if (i10 < size) {
                    if (gVar == ((C0017d) d.this.f1147i.get(i10)).f1173b) {
                        break;
                    }
                    i10++;
                } else {
            ...
            int i11 = i10 + 1;
            if (i11 < d.this.f1147i.size()) {
                c0017d = (C0017d) d.this.f1147i.get(i11);
            }
            d.this.f1145g.postAtTime(new a(c0017d, menuItem, gVar), gVar, SystemClock.uptimeMillis() + 200);
        }
    ...
    public boolean isShowing() {
        if (this.f1147i.size() <= 0 || !((C0017d) this.f1147i.get(0)).f1172a.isShowing()) {
            return false;
        }
        return true;
    }
    ...
    public ListView m() {
        ...
        return ((C0017d) list.get(list.size() - 1)).a();
    }
    ...
    public void updateMenuView(boolean z10) {
        for (C0017d c0017d : this.f1147i) {
            k.o(c0017d.a().getAdapter()).notifyDataSetChanged();
        }
    }
