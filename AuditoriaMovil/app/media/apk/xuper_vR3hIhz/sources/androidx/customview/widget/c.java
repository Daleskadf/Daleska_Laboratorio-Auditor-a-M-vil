...
public class c {
    ...
    public void A(MotionEvent motionEvent) {
            ...
            if (actionMasked != 1) {
                if (actionMasked != 2) {
                    if (actionMasked != 3) {
                        ...
                        D(x10, y10, pointerId3);
                        if (this.f2094a == 0) {
                            J(r((int) x10, (int) y10), pointerId3);
                            int i12 = this.f2101h[pointerId3];
                            int i13 = this.f2109p;
                            if ((i12 & i13) != 0) {
                                this.f2111r.onEdgeTouched(i12 & i13, pointerId3);
                                return;
                            }
                            return;
                        } else if (w((int) x10, (int) y10)) {
                    ...
                    while (i11 < pointerCount2) {
                        ...
                        if (y(pointerId4)) {
                            ...
                            float f10 = x12 - this.f2097d[pointerId4];
                            float f11 = y12 - this.f2098e[pointerId4];
                            C(f10, f11, pointerId4);
                            if (this.f2094a != 1) {
                                View r11 = r((int) x12, (int) y12);
                                if (d(r11, f10, f11) && J(r11, pointerId4)) {
                                    break;
                                }
                            } else {
                                break;
        ...
        View r12 = r((int) x13, (int) y13);
        D(x13, y13, pointerId5);
        J(r12, pointerId5);
        int i17 = this.f2101h[pointerId5];
        int i18 = this.f2109p;
        if ((i17 & i18) != 0) {
            this.f2111r.onEdgeTouched(i17 & i18, pointerId5);
        }
    }
    ...
    */
    ...
    public final boolean c(float f10, float f11, int i10, int i11) {
        ...
        if (abs < abs2 * 0.5f && this.f2111r.onEdgeLock(i11)) {
            ...
            return false;
        } else if ((this.f2102i[i10] & i11) != 0 || abs <= this.f2095b) {
            return false;
        } else {
            return true;
        }
    ...
    public final boolean d(View view, float f10, float f11) {
        ...
        if (this.f2111r.getViewHorizontalDragRange(view) > 0) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (this.f2111r.getViewVerticalDragRange(view) > 0) {
            z11 = true;
        } else {
            z11 = false;
        }
        if (z10 && z11) {
            ...
            if (Math.abs(f10) <= this.f2095b) {
                return false;
            }
            return true;
        } else if (!z11 || Math.abs(f11) <= this.f2095b) {
            return false;
        } else {
            return true;
        }
    ...
    public final int t(int i10, int i11) {
        int i12;
        if (i10 < this.f2114u.getLeft() + this.f2108o) {
            i12 = 1;
        } else {
            i12 = 0;
        }
        ...
        if (i11 > this.f2114u.getBottom() - this.f2108o) {
            return i12 | 8;
        }
        return i12;
    }
