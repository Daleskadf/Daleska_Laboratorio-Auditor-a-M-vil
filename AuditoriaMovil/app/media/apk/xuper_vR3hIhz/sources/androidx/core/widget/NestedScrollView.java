                ...
                if (actionMasked != 2) {
                    ...
                    if (findPointerIndex == -1) {
                        ...
                        if (this.mIsBeingDragged) {
                            ...
                            if (overScrollByCompat(0, i12, 0, getScrollY(), 0, scrollRange, 0, 0, true) && !hasNestedScrollingParent(0)) {
                            ...
                            if (z10) {
                                int i15 = i12 - this.mScrollConsumed[1];
                                f();
                                int i16 = scrollY + i15;
                                if (i16 < 0) {
                                    i.d(this.mEdgeGlowTop, i15 / getHeight(), motionEvent.getX(findPointerIndex) / getWidth());
                                    if (!this.mEdgeGlowBottom.isFinished()) {
                                        this.mEdgeGlowBottom.onRelease();
                                    }
                                } else if (i16 > scrollRange) {
                                    i.d(this.mEdgeGlowBottom, i15 / getHeight(), 1.0f - (motionEvent.getX(findPointerIndex) / getWidth()));
                                    if (!this.mEdgeGlowTop.isFinished()) {
