...
public class c extends q {
    ...
    public void j(RecyclerView.d0 d0Var) {
        ...
        while (true) {
            ...
            if (size < 0) {
                break;
            } else if (((j) this.f3155j.get(size)).f3198a == d0Var) {
        ...
        for (int size3 = this.f3158m.size() - 1; size3 >= 0; size3--) {
            ...
            while (true) {
                if (size4 < 0) {
                    break;
                } else if (((j) arrayList2.get(size4)).f3198a == d0Var) {
                    view.setTranslationY(0.0f);
                    view.setTranslationX(0.0f);
                    E(d0Var);
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.l
    public boolean p() {
        if (this.f3154i.isEmpty() && this.f3156k.isEmpty() && this.f3155j.isEmpty() && this.f3153h.isEmpty() && this.f3161p.isEmpty() && this.f3162q.isEmpty() && this.f3160o.isEmpty() && this.f3163r.isEmpty() && this.f3158m.isEmpty() && this.f3157l.isEmpty() && this.f3159n.isEmpty()) {
            return false;
        }
        return true;
    }
    ...
    public void u() {
        ...
        if (z13) {
            ...
            c1.d0(((RecyclerView.d0) arrayList3.get(0)).itemView, runnableC0045c, j10 + Math.max(j11, j12));
        }
    }
