...
public class LinearLayoutManager extends RecyclerView.o implements f.b, RecyclerView.z.b {
    ...
    public final boolean C(RecyclerView.v vVar, RecyclerView.a0 a0Var, a aVar) {
        ...
        if (focusedChild != null && aVar.d(focusedChild, a0Var)) {
            ...
            if (!a0Var.e() && supportsPredictiveItemAnimations()) {
                if ((this.mOrientationHelper.g(q10) >= this.mOrientationHelper.i() || this.mOrientationHelper.d(q10) < this.mOrientationHelper.m()) ? true : true) {
                    if (aVar.f2984d) {
                        m10 = this.mOrientationHelper.i();
                    } else {
                        m10 = this.mOrientationHelper.m();
                    }
                    aVar.f2983c = m10;
                }
            }
    ...
    public final boolean D(RecyclerView.a0 a0Var, a aVar) {
        ...
        if (!a0Var.e() && (i10 = this.mPendingScrollPosition) != -1) {
            if (i10 >= 0 && i10 < a0Var.b()) {
                ...
                if (dVar != null && dVar.a()) {
                    boolean z12 = this.mPendingSavedState.f3005c;
                    aVar.f2984d = z12;
                    if (z12) {
    ...
    public void onLayoutChildren(RecyclerView.v vVar, RecyclerView.a0 a0Var) {
        ...
        if (a0Var.e() && (i15 = this.mPendingScrollPosition) != -1 && this.mPendingScrollPositionOffset != Integer.MIN_VALUE && (findViewByPosition = findViewByPosition(i15)) != null) {
            if (this.mShouldReverseLayout) {
        ...
        onAnchorReady(vVar, a0Var, aVar3, i17);
        ...
        if (aVar4.f2984d) {
            ...
            c cVar3 = this.mLayoutState;
            i12 = cVar3.f2991b;
            int i19 = cVar3.f2993d;
            int i20 = cVar3.f2992c;
            if (i20 > 0) {
                max2 += i20;
            }
            H(this.mAnchorInfo);
            ...
            c cVar5 = this.mLayoutState;
            i11 = cVar5.f2991b;
            int i21 = cVar5.f2992c;
            if (i21 > 0) {
                I(i19, i12);
                c cVar6 = this.mLayoutState;
                cVar6.f2997h = i21;
                fill(vVar, cVar6, a0Var, false);
                i12 = this.mLayoutState.f2991b;
            }
        } else {
            H(aVar4);
            ...
            i11 = cVar8.f2991b;
            int i22 = cVar8.f2993d;
            int i23 = cVar8.f2992c;
            if (i23 > 0) {
                max += i23;
            }
            J(this.mAnchorInfo);
        ...
        if (getChildCount() > 0) {
            if (this.mShouldReverseLayout ^ this.mStackFromEnd) {
                int r11 = r(i11, vVar, a0Var, true);
                i13 = i12 + r11;
                i14 = i11 + r11;
                r10 = s(i13, vVar, a0Var, false);
            } else {
                int s10 = s(i12, vVar, a0Var, true);
                i13 = i12 + s10;
                i14 = i11 + s10;
                r10 = r(i14, vVar, a0Var, false);
            }
            i12 = i13 + r10;
            i11 = i14 + r10;
        }
