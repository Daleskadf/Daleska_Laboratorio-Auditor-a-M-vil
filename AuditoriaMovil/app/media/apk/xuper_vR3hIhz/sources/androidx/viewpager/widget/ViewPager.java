...
public class ViewPager extends ViewGroup {
    ...
    public static class o implements Comparator {
        ...
        public int compare(View view, View view2) {
            ...
            return gVar.f3571e - gVar2.f3571e;
        }
    }
    ...
    public final void a(f fVar, int i10, f fVar2) {
        ...
        if (fVar2 != null) {
            ...
            int i14 = fVar.f3563b;
            if (i13 < i14) {
                float f13 = fVar2.f3566e + fVar2.f3565d + f10;
                int i15 = i13 + 1;
                int i16 = 0;
                while (i15 <= fVar.f3563b && i16 < this.mItems.size()) {
                    ...
                    fVar4.f3566e = f13;
                    f13 += fVar4.f3565d + f10;
                    i15++;
                }
            } else if (i13 > i14) {
                int size = this.mItems.size() - 1;
                float f14 = fVar2.f3566e;
                while (true) {
                    i13--;
                    ...
                    f14 -= fVar3.f3565d + f10;
                    fVar3.f3566e = f14;
                }
            }
        }
        int size2 = this.mItems.size();
        float f15 = fVar.f3566e;
        int i17 = fVar.f3563b;
        int i18 = i17 - 1;
        if (i17 == 0) {
            f11 = f15;
        ...
        float f16 = fVar.f3566e + fVar.f3565d + f10;
        ...
        while (i22 < size2) {
            ...
            if (i11 == i19) {
                this.mLastOffset = (fVar8.f3565d + f16) - 1.0f;
            }
            fVar8.f3566e = f16;
            f16 += fVar8.f3565d + f10;
            i22++;
            i21++;
        }
        this.mNeedCalculatePageOffsets = false;
    ...
    */
    ...
    public final int c(int i10, float f10, int i11, int i12) {
        ...
        if (this.mItems.size() > 0) {
            ...
            return Math.max(this.mItems.get(0).f3563b, Math.min(i10, arrayList.get(arrayList.size() - 1).f3563b));
        }
        return i10;
    }
            ...
            if (action != 0) {
                if (action != 2) {
                    ...
                    if (i10 != -1) {
                        ...
                        if (f11 != 0.0f && !l(this.mLastMotionX, f11) && canScroll(this, false, (int) f11, (int) x10, (int) y10)) {
    ...
    */
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action != 0) {
            if (action != 1) {
                ...
                setCurrentItemInternal(c(j10.f3563b, ((scrollX / f12) - j10.f3566e) / (j10.f3565d + (this.mPageMargin / f12)), xVelocity, (int) (motionEvent.getX(motionEvent.findPointerIndex(this.mActivePointerId)) - this.mInitialMotionX)), true, true, xVelocity);
                z10 = s();
            }
        } else {
            this.mScroller.abortAnimation();
    ...
    public final void p(int i10, int i11, int i12, int i13) {
        ...
        if (infoForPosition != null) {
            f10 = Math.min(infoForPosition.f3566e, this.mLastOffset);
        } else {
            f10 = 0.0f;
        }
    ...
    public final void t(int i10, boolean z10, int i11, boolean z11) {
        ...
        if (infoForPosition != null) {
            i12 = (int) (getClientWidth() * Math.max(this.mFirstOffset, Math.min(infoForPosition.f3566e, this.mLastOffset)));
        } else {
            i12 = 0;
        }
        if (z10) {
