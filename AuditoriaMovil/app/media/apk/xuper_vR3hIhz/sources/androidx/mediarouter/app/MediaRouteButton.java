...
public class MediaRouteButton extends View {
    ...
    public static final int[] f2695r = {16842912};

    /* renamed from: s  reason: collision with root package name */
    public static final int[] f2696s = {16842911};
    ...
    public static final class a extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("android.net.conn.CONNECTIVITY_CHANGE".equals(intent.getAction()) && this.f2713b != (!intent.getBooleanExtra("noConnectivity", false))) {
                this.f2713b = z10;
                for (MediaRouteButton mediaRouteButton : this.f2714c) {
                    mediaRouteButton.c();
                }
            }
        }
    ...
    public void b() {
        ...
        if (this.f2701e) {
            setEnabled((this.f2710n || this.f2697a.o(this.f2699c, 1)) ? true : true);
        }
    ...
    public void c() {
        int i10;
        boolean z10;
        if (this.f2702f == 0 && !this.f2710n && !f2693p.a()) {
            i10 = 4;
        } else {
            i10 = this.f2702f;
        }
    ...
    public final boolean e(int i10) {
        ...
        if (fragmentManager != null) {
            ...
            if (!m10.w() && m10.E(this.f2699c)) {
                ...
                m11.i();
            } else if (fragmentManager.h0("android.support.v7.mediarouter:MediaRouteChooserDialogFragment") != null) {
                return false;
            } else {
                ...
                m12.e(b10, "android.support.v7.mediarouter:MediaRouteChooserDialogFragment");
                m12.i();
            }
            return true;
        }
    ...
    public final void g() {
        ...
        u2.a(this, (!this.f2711o || TextUtils.isEmpty(string)) ? null : null);
    }
    ...
    public boolean verifyDrawable(Drawable drawable) {
        if (!super.verifyDrawable(drawable) && drawable != this.f2704h) {
            return false;
        }
        return true;
    }
