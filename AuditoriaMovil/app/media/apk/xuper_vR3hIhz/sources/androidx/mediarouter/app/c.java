...
public class c extends androidx.appcompat.app.c {
    ...
    /* loaded from: classes.dex */
    public class animation.Animation$AnimationListenerC0040c implements Animation.AnimationListener {
        public animation.Animation$AnimationListenerC0040c() {
        }
    ...
    public class j extends Animation {
        ...
        public void applyTransformation(float f10, Transformation transformation) {
            int i10 = this.f2821a;
            c.u(this.f2823c, i10 - ((int) ((i10 - this.f2822b) * f10)));
        }
    }
                ...
                if (id == R$id.mr_control_playback_ctrl) {
                    ...
                    if (cVar.O != null && (playbackStateCompat = cVar.S) != null) {
                        ...
                        if (accessibilityManager != null && accessibilityManager.isEnabled() && i11 != 0) {
                            ...
                            obtain.getText().add(c.this.f2771d.getString(i11));
        ...
        */
        ...
        public void onPostExecute(Bitmap bitmap) {
            ...
            if (!a0.c.a(cVar.X, this.f2830a) || !a0.c.a(c.this.Y, this.f2831b)) {
                ...
                boolean z10 = true;
                cVar2.Z = true;
                long uptimeMillis = SystemClock.uptimeMillis() - this.f2833d;
                c cVar3 = c.this;
                if (uptimeMillis <= 120) {
                    z10 = false;
                }
    ...
    public void C(boolean z10) {
        ...
        if (this.f2777h == null && (this.f2797r.getDrawable() instanceof BitmapDrawable) && (bitmap = ((BitmapDrawable) this.f2797r.getDrawable()).getBitmap()) != null) {
            ...
            ImageView imageView = this.f2797r;
        ...
        if (this.f2807x.getVisibility() == 0) {
            z11 = true;
        } else {
            z11 = false;
        }
    ...
    public final void D(boolean z10) {
        ...
        int i11 = 0;
        if (this.f2808y.getVisibility() == 0 && z10) {
            i10 = 0;
        } else {
            i10 = 8;
        }
    ...
    */
    ...
    public final void F() {
        int i10 = 8;
        if (q(this.f2770c)) {
            if (this.f2808y.getVisibility() == 8) {
                this.f2808y.setVisibility(0);
                this.G.setMax(this.f2770c.u());
                this.G.setProgress(this.f2770c.s());
                MediaRouteExpandCollapseButton mediaRouteExpandCollapseButton = this.f2787m;
                if (this.f2770c.y()) {
                    i10 = 0;
                }
    ...
    public void b(Map map, Map map2) {
        ...
        if (set != null && this.E != null) {
            ...
            for (int i11 = 0; i11 < this.A.getChildCount(); i11++) {
                ...
                Object obj = (t0.i) this.B.getItem(firstVisiblePosition + i11);
    ...
    public final boolean d() {
        if (this.f2777h == null && (this.V != null || this.S != null)) {
            return true;
        }
        return false;
    }
    ...
    public final void g() {
        animation.Animation$AnimationListenerC0040c animation_animation_animationlistenerc0040c = new animation.Animation$AnimationListenerC0040c();
        int firstVisiblePosition = this.A.getFirstVisiblePosition();
        boolean z10 = false;
        for (int i10 = 0; i10 < this.A.getChildCount(); i10++) {
            View childAt = this.A.getChildAt(i10);
            ...
            if (this.D.contains((t0.i) rVar.getItem(firstVisiblePosition + i10))) {
                ...
                alphaAnimation.setFillAfter(true);
                if (!z10) {
                    alphaAnimation.setAnimationListener(animation_animation_animationlistenerc0040c);
                    z10 = true;
                }
                childAt.clearAnimation();
    ...
    public int i(int i10, int i11) {
        if (i10 >= i11) {
            return (int) (((this.f2775g * i11) / i10) + 0.5f);
        }
        return (int) (((this.f2775g * 9.0f) / 16.0f) + 0.5f);
    }
    ...
    public final int k(boolean z10) {
        ...
        if (z10 && this.f2808y.getVisibility() == 0) {
            return paddingTop + this.f2809z.getMeasuredHeight();
        }
        return paddingTop;
    }
    ...
    public void r() {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            if (this.f2782j0) {
                interpolator = this.f2796q0;
            } else {
                interpolator = this.f2798r0;
            }
            this.f2794p0 = interpolator;
            return;
        }
    ...
    public final void t(boolean z10) {
        ...
        if (l10.isEmpty()) {
        ...
        } else if (androidx.mediarouter.app.f.i(this.C, l10)) {
            this.B.notifyDataSetChanged();
        } else {
            if (z10) {
            ...
            if (z10) {
                hashMap2 = androidx.mediarouter.app.f.d(this.f2771d, this.A, this.B);
            } else {
                hashMap2 = null;
            }
