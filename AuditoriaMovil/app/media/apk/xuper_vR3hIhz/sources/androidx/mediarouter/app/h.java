...
public class h extends androidx.appcompat.app.j {
    ...
    public final class C0041h extends RecyclerView.g {
        ...
        public class a extends Animation {
            ...
            public void applyTransformation(float f10, Transformation transformation) {
                int i10 = this.f2932a;
                int i11 = this.f2933b;
                h.h(this.f2934c, i11 + ((int) ((i10 - i11) * f10)));
            }
        }
        ...
        public class g extends f {
            ...
            public void f(f fVar) {
                ...
                ImageButton imageButton = this.f2917b;
                if (!g10 && !h10) {
                    z10 = false;
                } else {
                    z10 = true;
                ...
                this.f2918c.setEnabled((g10 || h10) ? true : true);
        ...
        public f d(int i10) {
            ...
            return (f) this.f2922a.get(i10 - 1);
        }

        public boolean e() {
            if (h.this.f2885d.l().size() > 1) {
                return true;
            }
            return false;
        }
        ...
        public void h() {
            ...
            if (!h.this.f2887f.isEmpty()) {
                boolean z11 = false;
                for (t0.i iVar2 : h.this.f2887f) {
                    if (!h.this.f2886e.contains(iVar2)) {
                        if (!z11) {
                            ...
                            if (TextUtils.isEmpty(str2)) {
                                str2 = h.this.f2890i.getString(R$string.mr_dialog_groupable_header);
                            }
                            this.f2922a.add(new f(str2, 2));
                            z11 = true;
                        }
                        this.f2922a.add(new f(iVar2, 3));
                    }
                }
            }
            if (!h.this.f2888g.isEmpty()) {
                for (t0.i iVar3 : h.this.f2888g) {
                    t0.i iVar4 = h.this.f2885d;
                    if (iVar4 != iVar3) {
                        if (!z10) {
                            p0.b g11 = iVar4.g();
                            if (g11 != null) {
                            ...
                            if (TextUtils.isEmpty(str)) {
                                str = h.this.f2890i.getString(R$string.mr_dialog_transferable_header);
                            }
                            this.f2922a.add(new f(str, 2));
                            z10 = true;
                        }
                        this.f2922a.add(new f(iVar3, 4));
                    }
                }
            }
            g();
    ...
    public boolean e(t0.i iVar) {
        if (!iVar.w() && iVar.x() && iVar.E(this.f2884c) && this.f2885d != iVar) {
            return true;
        }
        return false;
    }
    ...
    public void g() {
        ...
        if (b11 == b10 && (b11 != null || a0.c.a(c10, uri))) {
            return;
        }
        d dVar3 = this.I;
        if (dVar3 != null) {
