...
public class CoordinatorLayout extends ViewGroup implements x, y {
    ...
    */
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i10) {
        ...
        if (i10 == 0) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R$styleable.f1975b, 0, R$style.Widget_Support_CoordinatorLayout);
        } else {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R$styleable.f1975b, i10, 0);
        }
    ...
    public static class h extends f0.a {
        ...
        public void writeToParcel(Parcel parcel, int i10) {
            ...
            for (int i12 = 0; i12 < i11; i12++) {
                iArr[i12] = this.f2002a.keyAt(i12);
                parcelableArr[i12] = (Parcelable) this.f2002a.valueAt(i12);
            }
    ...
    public static class f extends ViewGroup.MarginLayoutParams {
        ...
        public boolean a() {
            if (this.f1993k == null && this.f1988f != -1) {
                return true;
            }
            return false;
        }
        ...
        public boolean b(CoordinatorLayout coordinatorLayout, View view, View view2) {
            c cVar;
            if (view2 != this.f1994l && !s(view2, c1.z(coordinatorLayout)) && ((cVar = this.f1983a) == null || !cVar.layoutDependsOn(coordinatorLayout, view, view2))) {
                return false;
            }
            return true;
        }
        ...
        public final boolean s(View view, int i10) {
            ...
            if (b10 != 0 && (j.b(this.f1990h, i10) & b10) == b10) {
                return true;
            }
            return false;
        }
