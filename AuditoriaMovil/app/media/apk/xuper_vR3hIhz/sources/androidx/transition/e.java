...
public class e extends androidx.fragment.app.g0 {
    ...
    public static boolean C(n nVar) {
        if (androidx.fragment.app.g0.l(nVar.getTargetIds()) && androidx.fragment.app.g0.l(nVar.getTargetNames()) && androidx.fragment.app.g0.l(nVar.getTargetTypes())) {
            return false;
        }
        return true;
    }
    ...
    public void b(Object obj, ArrayList arrayList) {
        ...
        } else if (!C(nVar) && androidx.fragment.app.g0.l(nVar.getTargets())) {
