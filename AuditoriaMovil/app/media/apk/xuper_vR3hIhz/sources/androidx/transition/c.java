        ...
        if (uVar != null && uVar2 != null) {
            ...
            if (viewGroup2 != null && viewGroup3 != null) {
                ...
                if (r(viewGroup2, viewGroup3)) {
                    Rect rect3 = (Rect) uVar.f3534a.get("android:changeBounds:bounds");
                    Rect rect4 = (Rect) uVar2.f3534a.get("android:changeBounds:bounds");
                    int i12 = rect3.left;
                    int i13 = rect4.left;
                    int i14 = rect3.top;
                    int i15 = rect4.top;
                    ...
                    int i22 = i17 - i13;
                    int i23 = i19 - i15;
                    Rect rect5 = (Rect) uVar.f3534a.get("android:changeBounds:clip");
                    Rect rect6 = (Rect) uVar2.f3534a.get("android:changeBounds:clip");
                    ...
                    if (i10 > 0) {
                        if (!this.f3424b) {
                            ...
                            if (i10 == 2) {
                                if (i20 == i22 && i21 == i23) {
                                    c10 = androidx.transition.g.a(view, f3421j, getPathMotion().a(i12, i14, i13, i15));
                                } else {
                                    k kVar = new k(view);
                                    ObjectAnimator a11 = androidx.transition.g.a(kVar, f3417f, getPathMotion().a(i12, i14, i13, i15));
                                    ObjectAnimator a12 = androidx.transition.g.a(kVar, f3418g, getPathMotion().a(i16, i18, i17, i19));
                                ...
                                c10 = androidx.transition.g.a(view, f3419h, getPathMotion().a(i16, i18, i17, i19));
                            } else {
                                c10 = androidx.transition.g.a(view, f3420i, getPathMotion().a(i12, i14, i13, i15));
                            }
                        } else {
                            view = view2;
                            ...
                            if (i12 == i13 && i14 == i15) {
                                ...
                                a10 = androidx.transition.g.a(view, f3421j, getPathMotion().a(i12, i14, i13, i15));
                            }
                            if (rect5 == null) {
                                i11 = 0;
                ...
                int i24 = iArr[0];
                int i25 = iArr[1];
                ObjectAnimator ofPropertyValuesHolder = ObjectAnimator.ofPropertyValuesHolder(bitmapDrawable, androidx.transition.k.a(f3416e, pathMotion.a(intValue - i24, intValue2 - i25, intValue3 - i24, intValue4 - i25)));
