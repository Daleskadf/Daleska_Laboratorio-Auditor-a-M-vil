...
public final class z1 implements l5.a {
    ...
    public static final class a extends t9.j implements s9.l {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:5:0x001a, code lost:
            if (com.mobile.brasiltv.utils.b0.I(r0.getChildColumnList()) == false) goto L11;
         */
        @Override // s9.l
        /* renamed from: b */
        /*
    ...
    public static final void g0(z1 z1Var, int i10, List list, ObservableEmitter observableEmitter) {
        ...
        for (Object obj : z1Var.f16225e) {
            ...
            if (multiItemEntity instanceof g5.f1) {
                ...
                if (z10) {
                    Object obj2 = z1Var.f16225e.get(i11);
                    t9.i.e(obj2, "null cannot be cast to non-null type com.mobile.brasiltv.adapter.RecommenFragmentNormal");
                    ((g5.f1) obj2).c(list);
    ...
    public final void S(ChildColumnList childColumnList) {
        ...
        if (t9.i.b(code, w6.i.f19214g.v() + "_movies") && RootColumnId.specialColumn != null) {
        ...
        if (com.mobile.brasiltv.utils.b0.I(list)) {
            for (Object obj : list) {
                ...
                if (i10 == 4) {
                    ...
                    if (t9.i.b(code2, w6.i.f19214g.v() + "_movies")) {
