...
public class e1 implements r {
    ...
    public e1(s.e eVar) {
        ...
        Notification.Builder lights = this.f17349b.setWhen(notification.when).setSmallIcon(notification.icon, notification.iconLevel).setContent(notification.contentView).setTicker(notification.tickerText, eVar.f17421i).setVibrate(notification.vibrate).setLights(notification.ledARGB, notification.ledOnMS, notification.ledOffMS);
        ...
        Notification.Builder deleteIntent = onlyAlertOnce.setAutoCancel(z12).setDefaults(notification.defaults).setContentTitle(eVar.f17417e).setContentText(eVar.f17418f).setContentInfo(eVar.f17423k).setContentIntent(eVar.f17419g).setDeleteIntent(notification.deleteIntent);
        PendingIntent pendingIntent = eVar.f17420h;
        if ((notification.flags & 128) != 0) {
            z13 = true;
        } else {
            z13 = false;
        }
        deleteIntent.setFullScreenIntent(pendingIntent, z13).setLargeIcon(eVar.f17422j).setNumber(eVar.f17424l).setProgress(eVar.f17433u, eVar.f17434v, eVar.f17435w);
        if (i10 < 21) {
        ...
        if (i11 >= 21) {
            ...
            if (i11 < 28) {
                list = e(g(eVar.f17415c), eVar.U);
            } else {
                list = eVar.U;
            }
            if (list != null && !list.isEmpty()) {
                for (String str3 : list) {
                    this.f17349b.addPerson(str3);
                }
            }
            this.f17356i = eVar.K;
        ...
        if (i13 >= 28) {
            Iterator it2 = eVar.f17415c.iterator();
            if (it2.hasNext()) {
    ...
    public Notification c() {
        ...
        if (remoteViews != null) {
            ...
            RemoteViews remoteViews2 = this.f17350c.I;
            if (remoteViews2 != null) {
    ...
    public Notification d() {
        ...
        if (i10 >= 24) {
            ...
            if (this.f17355h != 0) {
                ...
                if (group != null && (build3.flags & 512) != 0 && this.f17355h == 2) {
                    h(build3);
                }
                group2 = build3.getGroup();
                if (group2 != null && (build3.flags & 512) == 0 && this.f17355h == 1) {
                    h(build3);
                }
            }
            return build3;
