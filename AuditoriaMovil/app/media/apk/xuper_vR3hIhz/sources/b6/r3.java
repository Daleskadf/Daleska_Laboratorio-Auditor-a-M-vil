...
public final class r3 extends b6.e<l6.p2> implements j6.m {
    ...
    public static final class b implements ViewPager.j {
        ...
        public void onPageScrolled(int i10, float f10, int i11) {
            ...
            if (!((list == null || list.isEmpty()) ? true : true) && this.f4998b <= r3.this.f4991l.size() - 1) {
                ...
                } else if (r3.this.f4991l.get(this.f4998b) instanceof i3) {
    ...
    public final void A3() {
        if (Q2()) {
            for (Fragment fragment : this.f4991l) {
    ...
    public final void n3(List list, boolean z10) {
        if (z10) {
            if (t9.i.b(w6.i.f19214g.A(), "1")) {
                ...
                while (true) {
                    ...
                    if (t9.i.b(childColumnList.getRestricted(), "1")) {
                        if (!r3().isStateSaved()) {
                            B3(r3(), childColumnList);
                        }
                        String c10 = com.mobile.brasiltv.utils.b0.c(childColumnList.getAlias(), childColumnList.getName());
                        this.f4994o = c10;
                        if (!this.f4992m.contains(c10)) {
            ...
            int i10 = -1;
            while (it2.hasNext()) {
                ChildColumnList childColumnList2 = (ChildColumnList) it2.next();
                if (t9.i.b(childColumnList2.getRestricted(), "1")) {
                    i10 = list.indexOf(childColumnList2);
                } else {
                    String code = childColumnList2.getCode();
                    if (t9.i.b(code, w6.i.f19214g.v() + "_short")) {
                        i3 i3Var = new i3();
                        B3(i3Var, childColumnList2);
                        this.f4992m.add(com.mobile.brasiltv.utils.b0.e(childColumnList2.getAlias(), childColumnList2.getName()));
                        this.f4991l.add(i3Var);
                    } else {
                        g3 g3Var = new g3();
                        B3(g3Var, childColumnList2);
                        this.f4992m.add(com.mobile.brasiltv.utils.b0.e(childColumnList2.getAlias(), childColumnList2.getName()));
            ...
            if (i10 != -1 && t9.i.b(w6.i.f19214g.A(), "1")) {
                ChildColumnList childColumnList3 = (ChildColumnList) list.get(i10);
