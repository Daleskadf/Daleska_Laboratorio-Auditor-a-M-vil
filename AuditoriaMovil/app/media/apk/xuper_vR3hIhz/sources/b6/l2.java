...
public final class l2 extends b6.f {
            ...
            for (Program program : (Iterable) obj) {
                ...
                if (l2Var.f4779i.contains(wVar3.f18961a)) {
                    if (t9.i.b(wVar3.f18961a, wVar4.f18961a)) {
                        if (!y6.a.b((String) wVar5.f18961a, (String) wVar2.f18961a)) {
                            Program o32 = l2Var.o3(program.getProgramName(), (String) wVar.f18961a, (String) wVar2.f18961a, program.getType(), program.getRemark());
                            Object obj2 = l2Var.f4777g.get(wVar3.f18961a);
                            t9.i.d(obj2);
                            ((ArrayList) obj2).add(o32);
                        }
                    } else {
                        Object obj3 = l2Var.f4777g.get(wVar3.f18961a);
                        t9.i.d(obj3);
                        String programName = program.getProgramName();
                        String str = (String) wVar.f18961a;
                        ((ArrayList) obj3).add(new Program(programName, str, ((String) wVar3.f18961a) + " 23:59", program.getType(), program.getRemark(), false, 32, null));
                        if (l2Var.f4779i.contains(wVar4.f18961a) && !ba.t.o((CharSequence) wVar2.f18961a, "00:00", false, 2, null)) {
                            ...
                            Program o33 = l2Var.o3(programName2, ((String) wVar4.f18961a) + " 00:00", (String) wVar2.f18961a, program.getType(), program.getRemark());
                            Object obj4 = l2Var.f4777g.get(wVar4.f18961a);
                            t9.i.d(obj4);
    ...
    public final void A3(final int i10) {
        ...
        g5.v0 p32 = p3();
        final RecyclerView.o oVar = null;
        if (p32 != null) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        for (int i10 = 0; i10 < 7; i10++) {
            ...
            list2.add(new LiveTabEntity(str, z10, 0, 4, null));
        }
    }
    ...
    public final void v3(List list) {
        ...
        for (Fragment fragment : s02) {
            if (fragment instanceof g5.g0) {
                ((g5.g0) fragment).P0(list);
            }
        }
    }
