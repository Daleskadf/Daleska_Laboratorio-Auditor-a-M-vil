...
public final class o2 extends e<l6.d1> implements i6.r {
    ...
    */
    ...
    public final boolean j3() {
        ...
        if (context != null) {
            bool = Boolean.valueOf(com.mobile.brasiltv.utils.n0.c(com.mobile.brasiltv.utils.n0.f8733a, context, "live_first_play_free_column", false, 4, null));
        } else {
            bool = null;
        }
    ...
    public final void readyHighLightItem(UpdateHighLightEvent updateHighLightEvent) {
        ...
        if (activity != null) {
            i10 = com.mobile.brasiltv.utils.n0.f8733a.d(activity, "live_last_play_column_index", 0);
        } else {
            i10 = 0;
        }
        k7.f.e("从全屏返回 channelCode：" + updateHighLightEvent.getCode() + ", columnPosition: " + i10, new Object[0]);
        if (i10 >= 0) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:40:0x00cd, code lost:
        if (r11.contains(r1) == false) goto L41;
     */
    ...
    */
    ...
    public final void userIdentityChange(UserIdentityChangeEvent userIdentityChangeEvent) {
        ...
        t9.i.f(s02, "childFragmentManager.fragments");
        for (Fragment fragment : s02) {
            if (fragment instanceof g5.h0) {
                ((g5.h0) fragment).S0(Boolean.TRUE);
            }
        }
