...
public abstract class f {
    ...
    public static final class a {
        ...
        public final boolean i(int i10) {
            if (i10 >= 0 && i10 <= f.f5682b.length - 1) {
                return true;
            }
            return false;
        }
        ...
        public ByteString k() {
            ...
            int n10 = n(j10, 127);
            if (z10) {
                return ByteString.of(h.f().c(this.f5685b.readByteArray(n10)));
            }
            return this.f5685b.readByteString(n10);
        }
                ...
                if (i10 == -1) {
                    ...
                    while (true) {
                        ...
                        if (i14 >= dVarArr.length) {
                            break;
                        } else if (dVarArr[i14].f5673a.equals(asciiLowercase)) {
