...
public class w implements Comparable, Serializable {
        ...
        if (compareTo == 0) {
            ...
            if (compareTo2 == 0) {
                ...
                if (i10 == 0) {
                    ...
                    if (i11 == 0) {
                        return this.f5522c - wVar.f5522c;
                    }
                    return i11;
                }
                return i10;
    ...
    public boolean equals(Object obj) {
        ...
        w wVar = (w) obj;
        if (wVar.f5520a == this.f5520a && wVar.f5521b == this.f5521b && wVar.f5522c == this.f5522c && wVar.f5524e.equals(this.f5524e) && wVar.f5523d.equals(this.f5523d)) {
            return true;
        }
        return false;
    }
