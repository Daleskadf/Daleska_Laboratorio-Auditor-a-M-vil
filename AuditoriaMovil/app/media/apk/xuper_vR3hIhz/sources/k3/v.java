...
public class v implements Serializable {
    ...
    public static final class a implements Serializable {
        ...
        public a b(c3.p pVar) {
            ...
            if (pVar == this.f14988a) {
                return this;
            }
            return new a(pVar, null, null, this.f14989b);
        }
    }
    ...
    public v c(a aVar, b bVar) {
        if (this.f14985e == aVar && this.f14986f == bVar) {
            return this;
        }
        return new v(this, this.f14981a, aVar, bVar);
    }

    public v d(v vVar, a0 a0Var) {
        if (a0Var == this.f14981a) {
            return this;
        }
