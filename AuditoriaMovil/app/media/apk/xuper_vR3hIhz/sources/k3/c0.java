...
public abstract class c0 extends e {
    ...
    public o G(Class cls, d dVar) {
        ...
        if (e10 == null && (e10 = this.f14853d.i(cls)) == null && (e10 = this.f14853d.j(this.f14850a.e(cls))) == null && (e10 = s(cls)) == null) {
            return g0(cls);
        }
        return i0(e10, dVar);
    }
    ...
    public o H(j jVar, d dVar) {
        ...
        if (f10 == null && (f10 = this.f14853d.j(jVar)) == null && (f10 = t(jVar)) == null) {
            return g0(jVar.q());
        }
        return i0(f10, dVar);
    }
    ...
    public o h0(o oVar, d dVar) {
        if (oVar != null && (oVar instanceof a4.i)) {
            return ((a4.i) oVar).b(this, dVar);
        }
        return oVar;
    }
    ...
    public Object p0(c cVar, r3.s sVar, String str, Object... objArr) {
        ...
        throw p3.b.s(d0(), String.format("Invalid definition for property %s (of type %s): %s", str2, str3, b10), cVar, sVar);
    }
    ...
    public Object q0(c cVar, String str, Object... objArr) {
        ...
        throw p3.b.s(d0(), String.format("Invalid type definition for type %s: %s", str2, b(str, objArr)), cVar, null);
    }
