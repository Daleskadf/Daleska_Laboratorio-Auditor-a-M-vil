...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback {
    ...
    public void begin() {
        ...
        synchronized (this.requestLock) {
            ...
            if (obj == null) {
                ...
                onLoadFailed(new GlideException("Received null model"), i10);
                return;
            }
    ...
    public boolean isEquivalentTo(Request request) {
        ...
        if (i10 == i13 && i11 == i14 && Util.bothModelsNullEquivalentOrEquals(obj, obj2) && cls.equals(cls2) && Util.bothBaseRequestOptionsNullEquivalentOrEquals(baseRequestOptions, baseRequestOptions2) && priority == priority2 && i12 == i15) {
            return true;
        }
        return false;
    }
    ...
    private void onLoadFailed(GlideException glideException, int i10) {
        ...
        synchronized (this.requestLock) {
            ...
            if (list != null) {
                z10 = false;
                for (RequestListener<R> requestListener : list) {
                    z10 |= requestListener.onLoadFailed(glideException, this.model, this.target, isFirstReadyResource());
                }
            } else {
                z10 = false;
            }
