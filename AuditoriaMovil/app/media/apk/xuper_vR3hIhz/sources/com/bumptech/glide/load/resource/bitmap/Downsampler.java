...
public final class Downsampler {
    ...
    private Bitmap decodeFromWrappedStreams(ImageReader imageReader, BitmapFactory.Options options, DownsampleStrategy downsampleStrategy, DecodeFormat decodeFormat, PreferredColorSpace preferredColorSpace, boolean z10, int i10, int i11, boolean z11, DecodeCallbacks decodeCallbacks) {
        ...
        if (i12 == Integer.MIN_VALUE) {
            i14 = isRotationRequired(exifOrientationDegrees) ? i15 : i16;
        } else {
            i14 = i12;
        }
        ImageHeaderParser.ImageType imageType = imageReader.getImageType();
        calculateScaling(imageType, imageReader, decodeCallbacks, this.bitmapPool, downsampleStrategy, exifOrientationDegrees, i15, i16, i13, i14, options);
        ...
        if (shouldUsePool(imageType)) {
            if (i15 < 0 || i16 < 0 || !z11) {
                ...
                float f11 = i19;
                round = Math.round(((int) Math.ceil(i15 / f11)) * f10);
                round2 = Math.round(((int) Math.ceil(i16 / f11)) * f10);
                str = TAG;
    ...
    private static Bitmap decodeStream(ImageReader imageReader, BitmapFactory.Options options, DecodeCallbacks decodeCallbacks, BitmapPool bitmapPool) {
        ...
        try {
            try {
                ...
                IOException newIoExceptionForInBitmapAssertion = newIoExceptionForInBitmapAssertion(e10, i10, i11, str, options);
