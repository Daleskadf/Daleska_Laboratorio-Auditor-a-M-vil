    ...
    */
    ...
    public Maybe<CampaignProto.ThickContent> lambda$createFirebaseInAppMessageStream$12(String str, final CampaignProto.ThickContent thickContent) {
        if (!thickContent.getIsTestCampaign() && isAppForegroundEvent(str)) {
            return this.rateLimiterClient.isRateLimited(this.appForegroundRateLimit).doOnSuccess(new Consumer() { // from class: com.google.firebase.inappmessaging.internal.o0
    ...
    public /* synthetic */ Maybe lambda$createFirebaseInAppMessageStream$11(final CampaignProto.ThickContent thickContent) {
        ...
        return this.impressionStorageClient.isImpressed(thickContent).doOnError(new Consumer() { // from class: com.google.firebase.inappmessaging.internal.h1
            @Override // io.reactivex.functions.Consumer
            public final void accept(Object obj) {
