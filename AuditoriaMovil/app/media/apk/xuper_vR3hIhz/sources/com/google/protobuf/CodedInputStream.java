    ...
    public static final class IterableDirectByteBufferDecoder extends CodedInputStream {
        ...
        public long readRawLittleEndian64() {
            if (currentRemaining() >= 8) {
                ...
                long j11 = ((UnsafeUtil.getByte(4 + j10) & 255) << 32) | ((UnsafeUtil.getByte(2 + j10) & 255) << 16) | (UnsafeUtil.getByte(j10) & 255) | ((UnsafeUtil.getByte(1 + j10) & 255) << 8) | ((UnsafeUtil.getByte(3 + j10) & 255) << 24) | ((UnsafeUtil.getByte(5 + j10) & 255) << 40);
                return ((UnsafeUtil.getByte(j10 + 7) & 255) << 56) | ((UnsafeUtil.getByte(6 + j10) & 255) << 48) | j11;
            }
