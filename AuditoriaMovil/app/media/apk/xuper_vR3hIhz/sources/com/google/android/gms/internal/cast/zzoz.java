...
final class zzoz extends zzns<Integer> implements RandomAccess, zzpd, zzql {
    ...
    static {
        zzoz zzozVar = new zzoz(new int[0], 0);
        zza = zzozVar;
        zzozVar.zzb();
    }
    ...
    public final boolean addAll(Collection<? extends Integer> collection) {
        ...
        if (Integer.MAX_VALUE - i11 >= i10) {
            ...
            System.arraycopy(zzozVar.zzb, 0, this.zzb, this.zzc, zzozVar.zzc);
            this.zzc = i12;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzozVar.zzc) {
            return false;
        }
        int[] iArr = zzozVar.zzb;
    ...
    @Override // com.google.android.gms.internal.cast.zzpd
