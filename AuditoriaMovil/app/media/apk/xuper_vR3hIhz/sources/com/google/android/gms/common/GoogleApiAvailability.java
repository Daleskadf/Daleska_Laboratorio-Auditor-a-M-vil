    ...
    public final void zae(Context context, int i10, String str, PendingIntent pendingIntent) {
        ...
        if (i10 == 18) {
            ...
            if (DeviceProperties.isWearable(context)) {
                ...
                D.B(17301642).E(resources.getString(com.google.android.gms.base.R.string.common_google_play_services_notification_ticker)).H(System.currentTimeMillis()).n(pendingIntent).o(zae);
            }
            if (PlatformVersion.isAtLeastO()) {
