...
public class AdBreakStatus extends AbstractSafeParcelable {
    ...
    public static AdBreakStatus zza(JSONObject jSONObject) {
        ...
        if (jSONObject != null && jSONObject.has("currentBreakTime") && jSONObject.has("currentBreakClipTime")) {
            try {
                ...
                if (optLong != -1) {
                    j10 = CastUtils.secToMillisec(optLong);
                } else {
                    j10 = optLong;
                }
                return new AdBreakStatus(secToMillisec, secToMillisec2, optStringOrNull, optStringOrNull2, j10);
    ...
    public boolean equals(Object obj) {
        ...
        if (this.zzb == adBreakStatus.zzb && this.zzc == adBreakStatus.zzc && CastUtils.zzh(this.zzd, adBreakStatus.zzd) && CastUtils.zzh(this.zze, adBreakStatus.zze) && this.zzf == adBreakStatus.zzf) {
            return true;
        }
        return false;
    }
