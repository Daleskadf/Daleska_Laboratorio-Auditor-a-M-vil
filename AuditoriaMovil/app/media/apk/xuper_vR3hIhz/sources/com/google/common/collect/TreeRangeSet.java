...
public class TreeRangeSet<C extends Comparable<?>> extends AbstractRangeSet<C> implements Serializable {
    ...
    public static final class ComplementRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        public Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            PeekingIterator peekingIterator = Iterators.peekingIterator(this.positiveRangesByUpperBound.headMap(aboveAll, z10).descendingMap().values().iterator());
        ...
        public /* bridge */ /* synthetic */ NavigableMap headMap(Object obj, boolean z10) {
            return headMap((Cut) ((Cut) obj), z10);
        }
        ...
        public /* bridge */ /* synthetic */ NavigableMap subMap(Object obj, boolean z10, Object obj2, boolean z11) {
            return subMap((Cut) ((Cut) obj), z10, (Cut) ((Cut) obj2), z11);
        }

        @Override // java.util.NavigableMap
        public /* bridge */ /* synthetic */ NavigableMap tailMap(Object obj, boolean z10) {
            return tailMap((Cut) ((Cut) obj), z10);
        }
    ...
    public final class SubRangeSet extends TreeRangeSet<C> {
        ...
        @Override // com.google.common.collect.TreeRangeSet, com.google.common.collect.AbstractRangeSet, com.google.common.collect.RangeSet
        public boolean contains(C c10) {
            if (this.restriction.contains(c10) && TreeRangeSet.this.contains(c10)) {
                return true;
            }
            return false;
        }
    ...
    public static final class SubRangeSetRangesByLowerBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>> {
        ...
        public Iterator<Map.Entry<Cut<C>, Range<C>>> descendingEntryIterator() {
            ...
            final Iterator<Range<C>> it = navigableMap.headMap(cut2, z10).descendingMap().values().iterator();
        ...
        public Iterator<Map.Entry<Cut<C>, Range<C>>> entryIterator() {
            ...
            if (this.lowerBoundWindow.lowerBound.isLessThan(this.restriction.lowerBound)) {
                ...
                it = navigableMap.tailMap(endpoint, z10).values().iterator();
            }
