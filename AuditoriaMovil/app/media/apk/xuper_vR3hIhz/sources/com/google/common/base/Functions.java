...
public final class Functions {
    ...
    public static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        public C apply(@ParametricNullness A a10) {
            return this.f6834g.apply(this.f6833f.apply(a10));
        }
        ...
        public boolean equals(@CheckForNull Object obj) {
            ...
            if (!this.f6833f.equals(functionComposition.f6833f) || !this.f6834g.equals(functionComposition.f6834g)) {
                return false;
            }
            return true;
        }
    ...
    public static class FunctionForMapNoDefault<K, V> implements Function<K, V>, Serializable {
        ...
        public V apply(@ParametricNullness K k10) {
            ...
            Preconditions.checkArgument(z10, "Key '%s' not present in map", k10);
            return (V) NullnessCasts.uncheckedCastNullableTToT(v10);
        }
