    ...
    public static final class ScaleAndIndexes {
        ...
        public Map<Integer, Double> computeInPlace(double... dArr) {
            ...
            while (true) {
                ...
                long length2 = iArr6[i12] * (dArr.length - i11);
            ...
            while (true) {
                ...
                if (i10 < iArr7.length) {
                    ...
                    int i17 = iArr4[i10];
                    if (i17 == 0) {
                        linkedHashMap2.put(Integer.valueOf(iArr7[i10]), Double.valueOf(dArr[i16]));
                    } else {
                        linkedHashMap2.put(Integer.valueOf(iArr7[i10]), Double.valueOf(Quantiles.interpolate(dArr[i16], dArr[i16 + 1], i17, this.scale)));
                    }
                    i10++;
                } else {
