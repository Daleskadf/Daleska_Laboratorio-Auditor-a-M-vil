            ...
            if (narrowWidePattern >= 0) {
                ...
                if (patternToChar == '*') {
                    ...
                    if (this.usingCheckDigit) {
                        ...
                        if (sb2.charAt(length) == CHECK_DIGIT_STRING.charAt(i16 % 43)) {
                    ...
                    if (sb2.length() != 0) {
                        ...
                        float f10 = i10;
                        return new Result(sb, null, new ResultPoint[]{new ResultPoint((findAsteriskPattern[1] + findAsteriskPattern[0]) / 2.0f, f10), new ResultPoint(nextSet + (i13 / 2.0f), f10)}, BarcodeFormat.CODE_39);
                    }
                    throw NotFoundException.getNotFoundInstance();
                }
                nextSet = nextSet2;
