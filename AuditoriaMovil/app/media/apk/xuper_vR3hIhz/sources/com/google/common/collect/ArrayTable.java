...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    public class ColumnMap extends ArrayMap<C, Map<R, V>> {
        ...
        @Override // com.google.common.collect.ArrayTable.ArrayMap
        public /* bridge */ /* synthetic */ Object setValue(int i10, Object obj) {
            return setValue(i10, (Map) ((Map) obj));
        }
    ...
    public V put(R r10, C c10, @CheckForNull V v10) {
        ...
        Preconditions.checkArgument(z10, "Row %s not in %s", r10, this.rowList);
        Integer num2 = this.columnKeyToIndex.get(c10);
        if (num2 == null) {
            z11 = false;
        }
        Preconditions.checkArgument(z11, "Column %s not in %s", c10, this.columnList);
