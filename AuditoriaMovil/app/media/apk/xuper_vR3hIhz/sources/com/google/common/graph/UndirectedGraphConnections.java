...
final class UndirectedGraphConnections<N, V> implements GraphConnections<N, V> {
    ...
    public static <N, V> UndirectedGraphConnections<N, V> of(ElementOrder<N> elementOrder) {
        int i10 = AnonymousClass1.$SwitchMap$com$google$common$graph$ElementOrder$Type[elementOrder.type().ordinal()];
        if (i10 != 1) {
            if (i10 == 2) {
    ...
    public Iterator<EndpointPair<N>> incidentEdgeIterator(final N n10) {
        return Iterators.transform(this.adjacentNodeValues.keySet().iterator(), new Function() { // from class: com.google.common.graph.n
