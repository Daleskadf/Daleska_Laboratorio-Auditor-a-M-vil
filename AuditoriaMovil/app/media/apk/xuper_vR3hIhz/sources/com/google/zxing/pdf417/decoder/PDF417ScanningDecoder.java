    ...
    */
    ...
    public static DecoderResult decode(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4, int i10, int i11) {
        ...
        for (int i16 = 0; i16 < 2; i16++) {
            if (resultPoint != null) {
                detectionResultRowIndicatorColumn2 = getRowIndicatorColumn(bitMatrix, boundingBox, resultPoint, true, i10, i11);
            }
            if (resultPoint3 != null) {
                detectionResultRowIndicatorColumn3 = getRowIndicatorColumn(bitMatrix, boundingBox, resultPoint3, false, i10, i11);
            }
        ...
        for (int i19 = 1; i19 <= barcodeColumnCount; i19++) {
            if (z10) {
                ...
                i12 = barcodeColumnCount - i19;
            }
            if (detectionResult.getDetectionResultColumn(i12) == null) {
                if (i12 != 0 && i12 != barcodeColumnCount) {
                    ...
                    detectionResultRowIndicatorColumn = new DetectionResultRowIndicatorColumn(boundingBox, z11);
                }
                detectionResult.setDetectionResultColumn(i12, detectionResultRowIndicatorColumn);
                int i20 = -1;
                int minY = boundingBox.getMinY();
                int i21 = -1;
                while (minY <= boundingBox.getMaxY()) {
                    int startColumn = getStartColumn(detectionResult, i12, minY, z10);
                    ...
                    i13 = i21;
                    int i22 = minY;
                    Codeword detectCodeword = detectCodeword(bitMatrix, boundingBox.getMinX(), boundingBox.getMaxX(), z10, i15, i22, i17, i18);
                    i14 = i22;
                    if (detectCodeword != null) {
                        detectionResultRowIndicatorColumn.setCodeword(i14, detectCodeword);
    ...
    */
    ...
    private static int getStartColumn(DetectionResult detectionResult, int i10, int i11, boolean z10) {
        ...
        if (isValidBarcodeColumn(detectionResult, i13)) {
            codeword = detectionResult.getDetectionResultColumn(i13).getCodeword(i11);
        } else {
            codeword = null;
        }
        if (codeword != null) {
            ...
            if (isValidBarcodeColumn(detectionResult, i10)) {
                for (Codeword codeword2 : detectionResult.getDetectionResultColumn(i10).getCodewords()) {
                    if (codeword2 != null) {
                        ...
                        return startX + (i12 * i14 * (codeword2.getEndX() - codeword2.getStartX()));
                    }
                }
                i14++;
            } else {
    ...
    private static boolean isValidBarcodeColumn(DetectionResult detectionResult, int i10) {
        if (i10 >= 0 && i10 <= detectionResult.getBarcodeColumnCount() + 1) {
            return true;
        }
        return false;
    }
