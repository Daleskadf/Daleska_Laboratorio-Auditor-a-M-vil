...
final class FieldParser {
    ...
    static {
        ...
        VARIABLE_LENGTH = obj;
        TWO_DIGIT_DATA_LENGTH = new Object[][]{new Object[]{"00", 18}, new Object[]{ErrorCode.MODULE_BROWSE, 14}, new Object[]{"02", 14}, new Object[]{AgooConstants.ACK_REMOVE_PACKAGE, obj, 20}, new Object[]{AgooConstants.ACK_BODY_NULL, 6}, new Object[]{AgooConstants.ACK_PACK_NULL, 6}, new Object[]{AgooConstants.ACK_FLAG_NULL, 6}, new Object[]{AgooConstants.ACK_PACK_ERROR, 6}, new Object[]{"17", 6}, new Object[]{"20", 2}, new Object[]{AgooConstants.REPORT_MESSAGE_NULL, obj, 20}, new Object[]{AgooConstants.REPORT_ENCRYPT_FAIL, obj, 29}, new Object[]{"30", obj, 8}, new Object[]{"37", obj, 8}, new Object[]{"90", obj, 30}, new Object[]{"91", obj, 30}, new Object[]{"92", obj, 30}, new Object[]{"93", obj, 30}, new Object[]{"94", obj, 30}, new Object[]{"95", obj, 30}, new Object[]{"96", obj, 30}, new Object[]{"97", obj, 30}, new Object[]{"98", obj, 30}, new Object[]{"99", obj, 30}};
        THREE_DIGIT_DATA_LENGTH = new Object[][]{new Object[]{"240", obj, 30}, new Object[]{"241", obj, 30}, new Object[]{"242", obj, 6}, new Object[]{"250", obj, 30}, new Object[]{"251", obj, 30}, new Object[]{"253", obj, 17}, new Object[]{"254", obj, 20}, new Object[]{"400", obj, 30}, new Object[]{ProtocolBuilder.LELINK_STATE_SCREENCODE, obj, 30}, new Object[]{"402", 17}, new Object[]{ProtocolBuilder.LELINK_UNSUPPORT_FORBIDDEN, obj, 30}, new Object[]{"410", 13}, new Object[]{"411", 13}, new Object[]{"412", 13}, new Object[]{"413", 13}, new Object[]{"414", 13}, new Object[]{"420", obj, 20}, new Object[]{"421", obj, 15}, new Object[]{"422", 3}, new Object[]{"423", obj, 15}, new Object[]{"424", 3}, new Object[]{"425", 3}, new Object[]{"426", 3}};
    ...
    private static String processFixedAI(int i10, int i11, String str) {
        if (str.length() >= i10) {
            String substring = str.substring(0, i10);
            int i12 = i11 + i10;
            if (str.length() >= i12) {
                String substring2 = str.substring(i10, i12);
                String str2 = "(" + substring + ASCIIPropertyListParser.ARRAY_END_TOKEN + substring2;
                String parseFieldsInGeneralPurpose = parseFieldsInGeneralPurpose(str.substring(i12));
    ...
    private static String processVariableAI(int i10, int i11, String str) {
        String substring = str.substring(0, i10);
        int i12 = i11 + i10;
        if (str.length() < i12) {
            i12 = str.length();
