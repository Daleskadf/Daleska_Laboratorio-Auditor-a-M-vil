...
public final class zzot {
    ...
    public static final zzot zzS;
    public static final zzot zzT;
    public static final zzot zzU;
    public static final zzot zzV;
    public static final zzot zzW;
    public static final zzot zzX;
    public static final zzot zzY;
    private static final zzot[] zzZ;
    public static final zzot zza;
    private static final /* synthetic */ zzot[] zzaa;
    public static final zzot zzb;
    public static final zzot zzc;
    public static final zzot zzd;
    public static final zzot zze;
    ...
    static {
        ...
        zzW = zzotVar49;
        zzot zzotVar50 = new zzot("GROUP_LIST", 49, 49, 2, zzpkVar7);
        zzX = zzotVar50;
        zzot zzotVar51 = new zzot("MAP", 50, 50, 4, zzpk.zza);
        zzY = zzotVar51;
        zzaa = new zzot[]{zzotVar, zzotVar2, zzotVar3, zzotVar4, zzotVar5, zzotVar6, zzotVar7, zzotVar8, zzotVar9, zzotVar10, zzotVar11, zzotVar12, zzotVar13, zzotVar14, zzotVar15, zzotVar16, zzotVar17, zzotVar18, zzotVar19, zzotVar20, zzotVar21, zzotVar22, zzotVar23, zzotVar24, zzotVar25, zzotVar26, zzotVar27, zzotVar28, zzotVar29, zzotVar30, zzotVar31, zzotVar32, zzotVar33, zzotVar34, zzotVar35, zzotVar36, zzotVar37, zzotVar38, zzotVar39, zzotVar40, zzotVar41, zzotVar42, zzotVar43, zzotVar44, zzotVar45, zzotVar46, zzotVar47, zzotVar48, zzotVar49, zzotVar50, zzotVar51};
        zzot[] values = values();
        zzZ = new zzot[values.length];
        for (zzot zzotVar52 : values) {
            zzZ[zzotVar52.zzac] = zzotVar52;
        }
    }

    private zzot(String str, int i10, int i11, int i12, zzpk zzpkVar) {
        this.zzac = i11;
        this.zzab = zzpkVar;
        zzpk zzpkVar2 = zzpk.zza;
        int i13 = i12 - 1;
        if (i13 != 1) {
            if (i13 != 3) {
                this.zzad = null;
            } else {
                this.zzad = zzpkVar.zza();
            }
        } else {
            this.zzad = zzpkVar.zza();
        }
