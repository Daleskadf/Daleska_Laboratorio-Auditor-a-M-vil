...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    ...
    public final class AsSet extends ImmutableSortedSet<C> {
        ...
        public /* bridge */ /* synthetic */ ImmutableSortedSet headSetImpl(Object obj, boolean z10) {
            return headSetImpl((AsSet) ((Comparable) obj), z10);
        }
            ...
            if (contains(obj)) {
                ...
                while (it.hasNext()) {
                    ...
                    if (range.contains(comparable)) {
                        return Ints.saturatedCast(j10 + ContiguousSet.create(range, this.domain).indexOf(comparable));
                    }
        ...
        public /* bridge */ /* synthetic */ ImmutableSortedSet tailSetImpl(Object obj, boolean z10) {
            return tailSetImpl((AsSet) ((Comparable) obj), z10);
        }
        ...
        if (!this.ranges.isEmpty() && !range.isEmpty()) {
            ...
            return (ImmutableList<Range<C>>) new ImmutableList<Range<C>>() { // from class: com.google.common.collect.ImmutableRangeSet.1
                ...
                public Range<C> get(int i12) {
                    Preconditions.checkElementIndex(i12, i11);
                    return (i12 == 0 || i12 == i11 + (-1)) ? ((Range) ImmutableRangeSet.this.ranges.get(i12 + i10)).intersection(range) : (Range) ImmutableRangeSet.this.ranges.get(i12 + i10);
                }
            };
        }
        return ImmutableList.of();
