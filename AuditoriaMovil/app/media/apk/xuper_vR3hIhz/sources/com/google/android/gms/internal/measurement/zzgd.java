...
public final class zzgd extends zzkf implements zzln {
    ...
    public static /* synthetic */ void zzQ(zzgd zzgdVar, int i10) {
        zzgdVar.zzf |= 2;
        zzgdVar.zzQ = i10;
    }

    public static /* synthetic */ void zzR(zzgd zzgdVar, int i10, zzft zzftVar) {
        zzftVar.getClass();
        zzgdVar.zzbP();
    ...
    public static /* synthetic */ void zzW(zzgd zzgdVar, long j10) {
        zzgdVar.zzf |= 16;
        zzgdVar.zzU = j10;
    }
    ...
    public static /* synthetic */ void zzaB(zzgd zzgdVar, long j10) {
        zzgdVar.zze |= 16384;
        zzgdVar.zzw = j10;
    }

    public static /* synthetic */ void zzaC(zzgd zzgdVar, long j10) {
        zzgdVar.zze |= 32768;
        zzgdVar.zzx = 74029L;
    }
    ...
    public static /* synthetic */ void zzaF(zzgd zzgdVar, boolean z10) {
        zzgdVar.zze |= 131072;
        zzgdVar.zzz = z10;
    }
    ...
    public static /* synthetic */ void zzaJ(zzgd zzgdVar, long j10) {
        zzgdVar.zze |= 524288;
        zzgdVar.zzB = j10;
    }

    public static /* synthetic */ void zzaK(zzgd zzgdVar, int i10) {
        zzgdVar.zze |= LogType.ANR;
        zzgdVar.zzC = i10;
    }

    public static /* synthetic */ void zzaL(zzgd zzgdVar, String str) {
        zzgdVar.zze |= AutoStrategy.BITRATE_LOW4;
        zzgdVar.zzD = str;
    }
    ...
    public static /* synthetic */ void zzaN(zzgd zzgdVar, String str) {
        str.getClass();
        zzgdVar.zze |= AutoStrategy.BITRATE_LOW;
        zzgdVar.zzE = str;
    }

    public static /* synthetic */ void zzaO(zzgd zzgdVar, boolean z10) {
        zzgdVar.zze |= AutoStrategy.BITRATE_HIGH;
        zzgdVar.zzF = z10;
    }
    ...
    public static /* synthetic */ void zzaS(zzgd zzgdVar, int i10) {
        zzgdVar.zze |= 33554432;
        zzgdVar.zzI = i10;
    }

    public static /* synthetic */ void zzaT(zzgd zzgdVar, int i10) {
        zzgdVar.zze |= 1;
        zzgdVar.zzg = 1;
    }
    ...
    public static /* synthetic */ void zzaV(zzgd zzgdVar, long j10) {
    ...
    public static /* synthetic */ void zzaf(zzgd zzgdVar, int i10) {
        zzgdVar.zzbP();
        zzgdVar.zzh.remove(i10);
    }

    public static /* synthetic */ void zzag(zzgd zzgdVar, int i10, zzgm zzgmVar) {
        zzgmVar.getClass();
        zzgdVar.zzbQ();
    ...
    public static /* synthetic */ void zzaj(zzgd zzgdVar, int i10) {
        zzgdVar.zzbQ();
        zzgdVar.zzi.remove(i10);
    }

    public static /* synthetic */ void zzak(zzgd zzgdVar, long j10) {
        zzgdVar.zze |= 2;
        zzgdVar.zzj = j10;
    }
    ...
    public static /* synthetic */ void zzax(zzgd zzgdVar, int i10) {
        zzgdVar.zze |= 1024;
        zzgdVar.zzs = i10;
    }
