...
final class zzqh<T> implements zzqp<T> {
    ...
    private final boolean zzA(T t10, int i10) {
            ...
            switch (zzp(zzq)) {
                ...
                case 8:
                    ...
                    if (zzf instanceof String) {
                        ...
                        return true;
                    } else if (zzf instanceof zzoe) {
                        if (zzoe.zzb.equals(zzf)) {
                            return false;
                        }
                        return true;
                    } else {
        ...
        } else if ((zzrn.zzc(t10, j10) & (1 << (zzo >>> 20))) == 0) {
            return false;
        } else {
            return true;
        }
    ...
    private final boolean zzD(T t10, int i10, int i11) {
        if (zzrn.zzc(t10, zzo(i11) & 1048575) == i10) {
            return true;
        }
        return false;
    }
    ...
    */
        ...
        for (int i15 = 0; i15 < this.zzc.length; i15 += 3) {
            ...
            switch (zzp) {
                ...
                case 10:
                    if ((i13 & i10) != 0) {
                        zzA6 = zzol.zzA(i16 << 3);
                        zzd = ((zzoe) unsafe.getObject(t10, j10)).zzd();
                        zzA7 = zzol.zzA(zzd);
                        i11 = zzA6 + zzA7 + zzd;
                        i12 += i11;
                    } else {
    ...
    private final void zzw(T t10, T t11, int i10) {
        ...
        Object zzf = zzrn.zzf(t11, j10);
        if (obj != null && zzf != null) {
            zzrn.zzs(t10, j10, zzph.zzg(obj, zzf));
            zzy(t10, i11, i10);
        } else if (zzf != null) {
            zzrn.zzs(t10, j10, zzf);
            zzy(t10, i11, i10);
        }
    }
                    ...
                    if (zzp != 60 && zzp != 68) {
                        if (zzp != 49) {
                            if (zzp == 50 && !((zzpy) zzrn.zzf(t10, zzq & 1048575)).isEmpty()) {
                                zzpx zzpxVar = (zzpx) zzt(i15);
                                throw null;
                            }
                        }
                    } else if (zzD(t10, i16, i15) && !zzC(t10, zzq, zzs(i15))) {
                        return false;
                    }
                }
