...
public final class CastStatusCodes extends CommonStatusCodes {
    ...
    public static String getStatusCodeString(int i10) {
        if (i10 >= -999 && i10 <= 999) {
            ...
            return String.format(Locale.ROOT, "%s %d", "Media control channel status code", Integer.valueOf(i10));
        } else {
            if (i10 >= 2105 && i10 <= 2169) {
                return String.format(Locale.ROOT, "%s %d", "Cast session status code", Integer.valueOf(i10));
            }
            if (i10 >= 2200 && i10 <= 2219) {
                return String.format(Locale.ROOT, "%s %d", "Cast remote display status code", Integer.valueOf(i10));
            }
            if (i10 >= 2250 && i10 <= 2289) {
                return String.format(Locale.ROOT, "%s %d", "Cast socket status code", Integer.valueOf(i10));
            }
            if (i10 >= 2300 && i10 <= 2309) {
                return String.format(Locale.ROOT, "%s %d", "Cast service status code", Integer.valueOf(i10));
            }
            if (i10 >= 2310 && i10 <= 2319) {
                return String.format(Locale.ROOT, "%s %d", "Endpoint switch status code", Integer.valueOf(i10));
            }
            if (i10 >= 2350 && i10 <= 2359) {
                return String.format(Locale.ROOT, "%s %d", "Cast multizone device status code", Integer.valueOf(i10));
            }
            if (i10 >= 2400 && i10 <= 2419) {
                return String.format(Locale.ROOT, "%s %d", "Cast relay casting status code", Integer.valueOf(i10));
            }
            if (i10 >= 2450 && i10 <= 2469) {
                return String.format(Locale.ROOT, "%s %d", "Cast nearby casting status code", Integer.valueOf(i10));
            }
            if (i10 >= 2470 && i10 <= 2479) {
                return String.format(Locale.ROOT, "%s %d", "Cast application status code", Integer.valueOf(i10));
            }
            if (i10 >= 2490 && i10 <= 2499) {
                return String.format(Locale.ROOT, "%s %d", "Cast media loading status code", Integer.valueOf(i10));
            }
            return String.format(Locale.ROOT, "Unknown cast status code %d", Integer.valueOf(i10));
        }
    }
}
