    ...
    public final void zzW(String str, String str2, String str3, Bundle bundle, List list, boolean z10) {
        ...
        for (String str6 : new TreeSet(bundle.keySet())) {
            ...
            if (i11 != 0) {
                ...
                zzJ(bundle, i11, str6, str6, str4);
                bundle.remove(str6);
            } else {
                if (zzaf(bundle.get(str6))) {
                    this.zzt.zzay().zzl().zzd("Nested Bundle parameters are not allowed; discarded. event name, param name, child param name", str2, str3, str6);
                    str5 = str6;
                    zza2 = 22;
                } else {
                    str5 = str6;
                    zza2 = zza(str, str2, str6, bundle.get(str6), bundle, list, z10, false);
                }
                if (zza2 != 0 && !"_ev".equals(str5)) {
                    zzJ(bundle, zza2, str5, str5, bundle.get(str5));
                    bundle.remove(str5);
                } else if (zzai(str5) && !zzas(str5, zzgp.zzd) && (i12 = i12 + 1) > 0) {
