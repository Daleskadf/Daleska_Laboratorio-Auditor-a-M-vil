...
public final class HighLevelEncoder {
    ...
    public static void illegalCharacter(char c10) {
        String hexString;
        throw new IllegalArgumentException("Illegal character: " + c10 + " (0x" + ("0000".substring(0, 4 - hexString.length()) + Integer.toHexString(c10)) + ASCIIPropertyListParser.ARRAY_END_TOKEN);
    }
