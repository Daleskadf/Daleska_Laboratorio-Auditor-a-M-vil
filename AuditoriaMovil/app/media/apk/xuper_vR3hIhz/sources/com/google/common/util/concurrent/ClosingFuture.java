...
public final class ClosingFuture<V> {
    ...
    private boolean compareAndUpdateState(State state, State state2) {
        return h3.b.a(this.state, state, state2);
    }
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this).add(IPushHandler.STATE, this.state.get()).addValue(this.future).toString();
    }
