...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.c {
    ...
    public BottomSheetBehavior() {
        ...
        this.dragCallback = new c.AbstractC0030c() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.3
            ...
            public int clampViewPositionVertical(View view, int i10, int i11) {
                ...
                return v.a.b(i10, expandedOffset, i12);
            }
    ...
    private void updateAccessibilityActions() {
        ...
        if (i10 != 3) {
            ...
            addAccessibilityActionForState(v10, g0.a.f5279w, i11);
            return;
        }
        if (this.fitToContents) {
            i11 = 4;
        }
        addAccessibilityActionForState(v10, g0.a.f5280x, i11);
    }
    ...
    public boolean onInterceptTouchEvent(CoordinatorLayout coordinatorLayout, V v10, MotionEvent motionEvent) {
        ...
        if (actionMasked != 2 || view2 == null || this.ignoreEvents || this.state == 1 || coordinatorLayout.isPointInChildBounds(view2, (int) motionEvent.getX(), (int) motionEvent.getY()) || this.viewDragHelper == null || Math.abs(this.initialY - motionEvent.getY()) <= this.viewDragHelper.u()) {
            return false;
        }
        return true;
    }
    ...
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, V v10, int i10) {
        ...
        if (this.viewRef == null) {
            ...
            if (materialShapeDrawable2 != null) {
                ...
                materialShapeDrawable3.setInterpolation(f10);
            }
    ...
    public boolean shouldHide(View view, float f10) {
        ...
        if (view.getTop() >= this.collapsedOffset && Math.abs((view.getTop() + (f10 * 0.1f)) - this.collapsedOffset) / this.peekHeight > 0.5f) {
            return true;
        }
        return false;
    }
    ...
    public void startSettlingAnimation(View view, int i10, int i11, boolean z10) {
        boolean I;
        if (z10) {
            I = this.viewDragHelper.G(view.getLeft(), i11);
        } else {
            I = this.viewDragHelper.I(view, view.getLeft(), i11);
        }
        if (I) {
            setStateInternal(2);
            updateDrawableForTargetState(i10);
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        this.dragCallback = new c.AbstractC0030c() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.3
            ...
            public int clampViewPositionVertical(View view, int i102, int i11) {
                ...
                return v.a.b(i102, expandedOffset, i12);
            }
