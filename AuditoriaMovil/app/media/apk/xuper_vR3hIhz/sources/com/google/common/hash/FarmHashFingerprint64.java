    ...
    private static long hashLength65Plus(byte[] bArr, int i10, int i11) {
        ...
        while (true) {
            ...
            if (i17 == i13) {
                ...
                jArr[0] = j15;
                jArr2[0] = jArr2[0] + j15;
                long rotateRight4 = (Long.rotateRight(((rotateRight3 + load642) + jArr[0]) + LittleEndianByteArray.load64(bArr, i15 + 8), 37) * j13) ^ (jArr2[1] * 9);
                long rotateRight5 = (Long.rotateRight(load642 + jArr[1] + LittleEndianByteArray.load64(bArr, i15 + 48), 42) * j13) + (jArr[0] * 9) + LittleEndianByteArray.load64(bArr, i15 + 40);
                long rotateRight6 = Long.rotateRight(j12 + jArr2[0], 33) * j13;
                weakHashLength32WithSeeds(bArr, i15, jArr[1] * j13, rotateRight4 + jArr2[0], jArr);
                weakHashLength32WithSeeds(bArr, i15 + 32, rotateRight6 + jArr2[1], rotateRight5 + LittleEndianByteArray.load64(bArr, i15 + 16), jArr2);
                return hashLength16(hashLength16(jArr[0], jArr2[0], j13) + (shiftMix(rotateRight5) * K0) + rotateRight4, hashLength16(jArr[1], jArr2[1], j13) + rotateRight6, j13);
            }
            i16 = i17;
            shiftMix = j12;
            j11 = load642;
