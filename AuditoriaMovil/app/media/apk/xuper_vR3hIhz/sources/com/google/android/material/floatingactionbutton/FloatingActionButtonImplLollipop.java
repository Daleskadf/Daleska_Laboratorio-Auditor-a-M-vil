...
public class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    private Animator createElevationAnimator(float f10, float f11) {
        ...
        play.with(ObjectAnimator.ofFloat(floatingActionButton, property, f11).setDuration(100L));
    ...
    public void onElevationsChanged(float f10, float f11, float f12) {
        ...
        if (i10 == 21) {
            ...
            if (i10 >= 22 && i10 <= 24) {
                ...
                arrayList.add(ObjectAnimator.ofFloat(floatingActionButton, property2, d.a(this.view)).setDuration(100L));
            }
            FloatingActionButton floatingActionButton2 = this.view;
            property = View.TRANSLATION_Z;
            arrayList.add(ObjectAnimator.ofFloat(floatingActionButton2, property, 0.0f).setDuration(100L));
            ...
            e.a(this.view, stateListAnimator);
        }
        if (shouldAddPadding()) {
            updatePadding();
        }
