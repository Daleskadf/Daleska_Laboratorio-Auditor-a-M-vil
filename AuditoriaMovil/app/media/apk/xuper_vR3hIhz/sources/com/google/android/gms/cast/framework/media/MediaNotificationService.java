...
public class MediaNotificationService extends Service {
    ...
    public static boolean isNotificationOptionsValid(@RecentlyNonNull CastOptions castOptions) {
        ...
        if (zzg != null && !zzg.isEmpty()) {
            ...
            } else if (zzk != null && (r2 = zzk.length) != 0) {
                for (int i10 : zzk) {
                    if (i10 < 0 || i10 >= size) {
    ...
    public final void zzj() {
        ...
        s.e G = new s.e(this, "cast_media_notification").u(bitmap).B(this.zzc.getSmallIconDrawableResId()).p(this.zzm.zzd).o(this.zzl.getString(this.zzc.getCastingToDeviceStringResId(), this.zzm.zze)).y(true).A(false).G(1);
    ...
    public int onStartCommand(@RecentlyNonNull Intent intent, int i10, final int i11) {
        ...
        zzn zznVar2 = new zzn(z10, mediaInfo.getStreamType(), mediaMetadata.getString(MediaMetadata.KEY_TITLE), castDevice.getFriendlyName(), (MediaSessionCompat.Token) intent.getParcelableExtra("extra_media_session_token"), intent.getBooleanExtra("extra_can_skip_next", false), intent.getBooleanExtra("extra_can_skip_prev", false));
