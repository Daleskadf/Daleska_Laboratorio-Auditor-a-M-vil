    ...
    public final void zzA(int i10, List<Integer> list, boolean z10) {
        ...
        if (z10) {
            ...
            while (i11 < list.size()) {
                ...
                zzolVar.zzq((intValue2 >> 31) ^ (intValue2 + intValue2));
                i11++;
            }
            return;
        }
        while (i11 < list.size()) {
            ...
            zzolVar2.zzp(i10, (intValue3 >> 31) ^ (intValue3 + intValue3));
            i11++;
        }
    }
    ...
    public final void zzC(int i10, List<Long> list, boolean z10) {
        ...
        if (z10) {
            ...
            while (i11 < list.size()) {
                ...
                zzolVar.zzs((longValue2 >> 63) ^ (longValue2 + longValue2));
                i11++;
            }
            return;
        }
        while (i11 < list.size()) {
            ...
            zzolVar2.zzr(i10, (longValue3 >> 63) ^ (longValue3 + longValue3));
            i11++;
        }
    }
