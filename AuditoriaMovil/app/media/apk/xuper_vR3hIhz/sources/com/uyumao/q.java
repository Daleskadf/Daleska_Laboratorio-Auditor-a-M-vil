...
public final class q implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        if (1 == this.f12441b) {
                            Object a11 = t.a(jSONObject.optString("m"), jSONObject.optString("q"), new Class[]{t.a(jSONObject.optString(bt.aI)), Integer.TYPE}, a10, new Object[]{t.a(jSONObject.optString(bt.aI), new Class[]{String.class}, new Object[]{jSONObject.optString("a")}), 0});
                            if (a11 instanceof List) {
                                ...
                                for (Object obj : (List) a11) {
                                    Object a14 = t.a(a13, t.a(a12, obj));
                                    if (a14 != null) {
                            ...
                            if (a15 instanceof List) {
                                ...
                                for (Object obj2 : (List) a15) {
                                    Object a17 = t.a(a16, obj2);
                                    if (a17 != null) {
                        ...
                        if (treeSet.isEmpty()) {
                            ...
                            int i10 = 0;
                            while (it.hasNext()) {
                                Object a18 = n.a(a10, (String) it.next(), 0);
                                if (a18 != null) {
                            ...
                            while (it2.hasNext()) {
                                ...
                                jSONObject3.put("data", (JSONArray) it2.next());
                                try {
    ...
    public void run() {
        ...
        o.a aVar2 = oVar.f12432c;
        String str = aVar2.f12433a + "smart_lt";
        ...
        try {
            ...
            oVar.f12432c.a(aVar.f12433a + "smart_lt", String.valueOf(optInt));
            if (oVar.a() < optInt) {
                return;
            }
