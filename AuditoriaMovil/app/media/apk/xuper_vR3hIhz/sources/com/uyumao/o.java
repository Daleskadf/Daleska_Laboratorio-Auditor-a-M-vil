...
public class o {
    ...
    public void a(long j10) {
        a aVar = this.f12432c;
        aVar.b("smart_" + bt.f10040ba, j10);
        a aVar2 = this.f12432c;
        aVar2.b("smart_ts", System.currentTimeMillis());
    }

    public final boolean a(String str) {
        a aVar = this.f12432c;
        long a10 = aVar.a(str + bt.f10040ba, 0L);
        if (a10 > 0) {
            a aVar2 = this.f12432c;
            StringBuilder sb = new StringBuilder();
            sb.append(str);
            sb.append("ts");
            return Math.abs(System.currentTimeMillis() - aVar2.a(sb.toString(), 0L)) / 1000 >= a10;
        }
        return true;
    }
