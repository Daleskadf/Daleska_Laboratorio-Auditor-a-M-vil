...
public class h extends i implements n3.i {
    ...
    public static class b {
        ...
        public void a(Object obj) {
            ...
            List list = this.f6545c;
            ((a) list.get(list.size() - 1)).f6542d.add(obj);
        }
    ...
    */
    ...
    public Collection deserialize(c3.k kVar, k3.g gVar) {
        ...
        if (kVar2 != null) {
            return (Collection) this.f6539g.y(gVar, kVar2.deserialize(kVar, gVar));
        }
        if (kVar.n0()) {
    ...
    public boolean isCachable() {
        if (this.f6537e == null && this.f6538f == null && this.f6540h == null) {
            return true;
        }
        return false;
    }
