...
public class f0 extends n3.w implements Serializable {
    ...
    public Object n(k3.g gVar, BigDecimal bigDecimal) {
        ...
        } else if (this.f6528p != null && (S = S(bigDecimal)) != null) {
            try {
    ...
    public Object w(k3.g gVar, Object obj) {
        ...
        if (nVar == null && this.f6519g != null) {
            return y(gVar, obj);
        }
        return G(nVar, this.f6523k, gVar, obj);
    }
    ...
    public Object y(k3.g gVar, Object obj) {
        ...
        if (nVar2 == null && (nVar = this.f6522j) != null) {
            return G(nVar, this.f6523k, gVar, obj);
        }
        return G(nVar2, this.f6520h, gVar, obj);
    }
