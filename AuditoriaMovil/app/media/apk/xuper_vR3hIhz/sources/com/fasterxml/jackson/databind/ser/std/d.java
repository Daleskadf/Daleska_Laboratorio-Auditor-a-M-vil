...
public abstract class d extends i0 implements a4.i, a4.o {
        ...
        for (int i10 = 0; i10 < length2; i10++) {
            ...
            if (!cVar3.v()) {
                ...
                if (h10 == null) {
                    ...
                    if (q10.D() && (hVar = (w3.h) q10.k().t()) != null && (U instanceof a4.h)) {
                        h10 = ((a4.h) U).d(hVar);
                    } else {
                        h10 = U;
                    }
    ...
    public k3.o b(k3.c0 c0Var, k3.d dVar) {
        ...
        b4.i iVar2 = this.f6679g;
        if (iVar != null) {
            set2 = W.K(k10, iVar).h();
            set = W.N(k10, iVar).e();
            r3.b0 B = W.B(iVar);
            if (B == null) {
                if (iVar2 != null && (C = W.C(iVar, null)) != null) {
                    iVar2 = this.f6679g.b(C.b());
                }
                cVarArr = null;
            } else {
                r3.b0 C2 = W.C(iVar, B);
                ...
                if (c11 == b3.n0.class) {
                    ...
                    cVarArr = null;
                    iVar2 = b4.i.a(cVar2.getType(), null, new b4.j(C2, cVar2), C2.b());
                    obj = W.p(iVar);
                    ...
                    cVarArr = null;
                    iVar2 = b4.i.a(jVar, C2.d(), c0Var.n(iVar, C2), C2.b());
                }
            }
            i10 = 0;
            obj = W.p(iVar);
        ...
        if (iVar2 != null && (c10 = iVar2.c(c0Var.U(iVar2.f4605a, dVar))) != this.f6679g) {
            dVar2 = dVar2.n(c10);
        }
    ...
    public void j(Object obj, c3.h hVar, k3.c0 c0Var) {
        ...
        if (this.f6675c != null && c0Var.V() != null) {
            cVarArr = this.f6675c;
        } else {
            cVarArr = this.f6674b;
        }
        ...
        try {
            ...
            wrapAndThrow(c0Var, e10, obj, str);
