...
public abstract class z extends i0 implements a4.i {
    ...
    public k3.o b(k3.c0 c0Var, k3.d dVar) {
        ...
        if (this.f6749b == dVar && this.f6750c == hVar && this.f6751d == findAnnotatedContentSerializer) {
            j10 = this;
        } else {
            j10 = j(dVar, hVar, findAnnotatedContentSerializer, this.f6752e);
        }
        if (dVar != null && (b10 = dVar.b(c0Var.k(), handledType())) != null && (f10 = b10.f()) != r.a.USE_DEFAULTS) {
            ...
            if (this.f6754g != b11 || this.f6755h != z10) {
                return j10.i(b11, z10);
            }
            return j10;
        }
        return j10;
    ...
    public final k3.o c(k3.c0 c0Var, Class cls) {
        ...
        if (j10 == null) {
            if (this.f6748a.w()) {
                N = c0Var.O(c0Var.A(this.f6748a, cls), this.f6749b);
            } else {
                N = c0Var.N(cls, this.f6749b);
            }
            d4.q qVar = this.f6752e;
            if (qVar != null) {
    ...
    public k3.o unwrappingSerializer(d4.q qVar) {
        ...
        if (this.f6751d == oVar && this.f6752e == qVar) {
            return this;
        }
        return j(this.f6749b, this.f6750c, oVar, qVar);
    }
