...
public class AuthSDK {
    ...
    private void connectIM() {
        ...
        } else if (!PublicCastClient.getInstance().isConnectedServer()) {
    ...
    public void saveRepeatInfoToLocal(AuthRepeatInfoBean authRepeatInfoBean) {
        ...
        if (!file.exists()) {
            ...
            SourceLog.i(TAG, "make dir status =" + mkdirs);
        }
        try {
    ...
    public void startAuth(final String str) {
        ...
        hashMap.put("sign", EncryptUtil.md5EncryData((((String) hashMap.get(ParamsMap.DeviceParams.KEY_UID)) + ((String) hashMap.get(ParamsMap.DeviceParams.KEY_APPID)) + ((String) hashMap.get(Constants.KEY_PACKAGE)) + ((String) hashMap.get(UMCrash.SP_KEY_TIMESTAMP))) + str5));
        ...
        this.mAuthTask = AsyncManager.getInstance().exeHttpTask(asyncHttpParameter, new AsyncHttpRequestListener() { // from class: com.hpplay.sdk.source.business.cloud.AuthSDK.1
            ...
            public void onRequestResult(AsyncHttpParameter asyncHttpParameter2) {
                ...
                if (out.resultType == 2) {
                ...
                } else if (out.result == null || (i10 = out.responseCode) == -1 || i10 == 500 || i10 == 404) {
                    ...
                    try {
                        ...
                        if (out2.resultType != 0) {
                            ...
                            authSDK.reportAuthFailedInfo(AuthSDK.AUTH_NETWORK_ERROR + String.valueOf(asyncHttpParameter2.out.responseCode));
                        } else {
                            String str6 = out2.result;
                            try {
                                decode = httpEncrypt.decode(out2);
                            ...
                            if (authSDKBean != null && authSDKBean.data != null) {
                                if (AuthSDK.this.mAuthStatusCode = authSDKBean.status == 200) {
                                    ...
                                    Preference.getInstance().put(Preference.KEY_SDK_VERIFY, decode);
                                    ...
                                    if (AuthSDK.this.mAuthListeners != null && !AuthSDK.this.mAuthListeners.isEmpty()) {
                                        while (i11 < AuthSDK.this.mAuthListeners.size()) {
                                            ((AuthListener) AuthSDK.this.mAuthListeners.get(i11)).onAuthSuccess(a.a(), decode);
                                            i11++;
                                        }
                                    }
                            ...
                            if (authSDKBean == null || authSDKBean.data == null || AuthSDK.this.mAuthStatusCode != AuthSDK.CODE_AUTH_SER_ERROR) {
                                ...
                                if (AuthSDK.access$1004(AuthSDK.this) < 3) {
                                    ...
                                    AuthSDK authSDK3 = AuthSDK.this;
                                    authSDK3.authFailed(String.valueOf(authSDK3.mAuthStatusCode));
                                }
                            }
                        }
    ...
    public boolean checkSdkUsable() {
        ...
        if (!z10 && !Feature.isAuthFailedBrowse()) {
            if (this.mAuthStatusCode == 402 || getInstance().isUseDone(i10) || z11 || (this.mAuthStatusCode == -100 && getInstance().isUseDone(i10))) {
                return false;
            }
            return true;
        }
