...
public class SDKConfig {
    ...
    public int getQualityInterval() {
        ...
        int i10;
        SDKConfigBean sDKConfigBean = this.mConfigBean;
        if (sDKConfigBean == null || (data = sDKConfigBean.data) == null || (data_transfer = data.data_transfer) == null || (i10 = data_transfer.videoquality_time) <= 0) {
            return d.SOCKET_READ_TIMEOUT;
        }
        return i10 * 1000;
    }
