...
public class DatagramProcessor extends NetworkProcessor {
    ...
    public DatagramProcessor(InetAddress inetAddress, InetAddress inetAddress2, int i10, PacketListener packetListener) {
        ...
        if (this.isMulticast) {
            ...
            if (value != null && value.length() > 0) {
                this.loopbackModeDisabled = ("true".equalsIgnoreCase(value) || "t".equalsIgnoreCase(value) || "yes".equalsIgnoreCase(value) || "y".equalsIgnoreCase(value)) ? true : true;
            }
    ...
    public boolean isOperational() {
        if (super.isOperational() && this.socket.isBound() && !this.socket.isClosed() && this.lastPacket <= System.currentTimeMillis() + 120000) {
            return true;
        }
        return false;
    }
