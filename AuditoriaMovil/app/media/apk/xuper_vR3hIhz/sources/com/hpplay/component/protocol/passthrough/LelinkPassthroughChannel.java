...
public class LelinkPassthroughChannel {
    ...
    public String buildHeader(NLProtocolBuiler nLProtocolBuiler, int i10) {
        NLProtocolBuiler newSessionId = nLProtocolBuiler.setPlatfrom().setUserAgent("HappyCast5,0/500.0").setContentType(NLProtocolBuiler.CONTENT_TYPE_PLIST).setNewSessionId(ProtocolUtils.createSessionId(this.mMap.getCuid()));
        return newSessionId.setContentLength(i10 + "").getString(true);
    }
    ...
    public String buildPlistProtocol(String str, String str2) {
        ...
        String buildHeader = buildHeader(new NLProtocolBuiler().getStreamCmd(), potocol.length());
        return buildHeader + potocol;
    }

    public void connect() {
        String str = TAG;
        CLog.d(str, "connect state : " + this.isConnect + "   ");
        this.isConnect = true;
    ...
    public void startPassthroughChannel() {
        ...
        this.mProtocolReceiver.setRecevelistenerAndProtocol(new ProtocolListener() { // from class: com.hpplay.component.protocol.passthrough.LelinkPassthroughChannel.1
            ...
            public void onResult(int i10, String... strArr) {
                try {
                    String str = LelinkPassthroughChannel.TAG;
                    CLog.i(str, "---------> cmd :" + i10 + " result : " + Base64.encodeBytes(strArr[0].getBytes()));
                } catch (Exception e10) {
                    ...
                    try {
                        ...
                        if (nSDictionary.containsKey("data")) {
                            ...
                            if (!TextUtils.isEmpty(obj) && LelinkPassthroughChannel.this.mProtocolListener != null) {
                                ...
                                String str2 = LelinkPassthroughChannel.TAG;
                                CLog.i(str2, "---------> cmd :" + i10 + " result : " + Base64.encodeBytes(parsePassthroughData[0].getBytes()));
                            }
                        }
                    } catch (Exception e11) {
