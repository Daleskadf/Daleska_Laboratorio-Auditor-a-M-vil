        ...
        for (int i12 = 0; i12 < strArr.length; i12++) {
            ...
            if (str != null) {
                if (HostInterface.isIPv6Address(str)) {
                    sSDPSearchSocket = new SSDPSearchSocket(strArr[i12], this.port, this.multicastIPv6);
                } else {
                    sSDPSearchSocket = new SSDPSearchSocket(strArr[i12], this.port, this.multicastIPv4);
                }
