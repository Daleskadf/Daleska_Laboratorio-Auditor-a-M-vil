...
public class CacheMonitors implements MulticastDNSCache.CacheMonitor {
    ...
    public boolean isAboutToExpire(long j10, int i10) {
        ...
        Double.isNaN(d11);
        double d12 = d10 / d11;
        if (d12 > 0.07000000029802322d && ((d12 < 0.10000000149011612d || d12 > 0.11999999731779099d) && ((d12 < 0.15000000596046448d || d12 > 0.17000000178813934d) && (d12 < 0.20000000298023224d || d12 > 0.2199999988079071d)))) {
            return false;
        }
        return true;
    }
    ...
    public boolean isOperational() {
        if (System.currentTimeMillis() < this.lastPoll + NotificationOptions.SKIP_STEP_TEN_SECONDS_IN_MS) {
            return true;
        }
        return false;
    }
