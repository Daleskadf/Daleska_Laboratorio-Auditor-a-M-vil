...
public class MulticastDNSCache extends Cache implements Closeable {
    ...
    public synchronized void updateRRset(Record record, int i10) {
        ...
        if (findElementCopy != null) {
            if (findElementCopy.compareCredibility(i10) <= 0) {
    ...
    public Message queryCache(Message message, int i10) {
        Record[] queryCacheForAdditionalRecords;
        Record[] extractRecords;
        int i11 = 255;
        int i12 = 1;
        ...
        if (extractRecords2 != null && extractRecords2.length > 0) {
            ...
            int i13 = 0;
            while (i13 < length) {
                Record record3 = extractRecords2[i13];
                ...
                if (lookupRecords2.isSuccessful()) {
                    ...
                    if (extractRecords3 != null && extractRecords3.length > 0) {
                        int length2 = extractRecords3.length;
                        int i14 = 0;
                        while (i14 < length2) {
                            Record record4 = extractRecords3[i14];
