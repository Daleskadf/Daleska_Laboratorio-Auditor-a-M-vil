...
public class SourceDataReport {
    ...
    private void onPushRender(OutParameter outParameter) {
        ...
        AsyncHttpParameter asyncHttpParameter = new AsyncHttpParameter(CloudAPI.sReportPush, getPreParameter() + sb.toString());
        reportBean.httpParameter = asyncHttpParameter;
        asyncHttpParameter.in.requestMethod = 1;
        addTask(reportBean);
    }
    ...
    public void logout() {
        ReportBean reportBean = new ReportBean();
        String str = CloudAPI.sReportLogOut;
        reportBean.httpParameter = new AsyncHttpParameter(str, getPreParameter() + "&st=5&sn=3");
        addTask(reportBean);
    }
