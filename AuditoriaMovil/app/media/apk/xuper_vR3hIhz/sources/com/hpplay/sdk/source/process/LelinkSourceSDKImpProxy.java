...
public class LelinkSourceSDKImpProxy implements ILelinkSourceSDK {
        ...
        if (this.isMultiProcessBind) {
            try {
                ...
                for (SinkParameterBean sinkParameterBean : list) {
                    jSONArray.put(sinkParameterBean.toJson());
                }
    ...
    /* JADX WARN: Removed duplicated region for block: B:156:0x02d6 A[Catch: Exception -> 0x02e6, TryCatch #2 {Exception -> 0x02e6, blocks: (B:5:0x000a, B:150:0x02a4, B:152:0x02a9, B:154:0x02b6, B:156:0x02d6, B:158:0x02da, B:159:0x02de, B:161:0x02e2, B:153:0x02b4), top: B:171:0x000a, outer: #0 }] */
    /* JADX WARN: Removed duplicated region for block: B:159:0x02de A[Catch: Exception -> 0x02e6, TryCatch #2 {Exception -> 0x02e6, blocks: (B:5:0x000a, B:150:0x02a4, B:152:0x02a9, B:154:0x02b6, B:156:0x02d6, B:158:0x02da, B:159:0x02de, B:161:0x02e2, B:153:0x02b4), top: B:171:0x000a, outer: #0 }] */
    @Override // com.hpplay.sdk.source.api.ILelinkSourceSDK
    /*
