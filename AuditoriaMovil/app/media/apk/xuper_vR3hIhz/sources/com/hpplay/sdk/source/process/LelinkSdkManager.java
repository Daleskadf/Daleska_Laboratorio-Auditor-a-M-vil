...
public class LelinkSdkManager {
    ...
    private Handler mHandler = new Handler(Looper.getMainLooper(), new Handler.Callback() { // from class: com.hpplay.sdk.source.process.LelinkSdkManager.1
        ...
        public boolean handleMessage(Message message) {
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 3) {
                        if (i10 == 4 && BusinessEntity.getInstance().getListenerDispatcher() != null) {
    ...
    private void checkDevice(LelinkServiceInfo lelinkServiceInfo, final ConnectCallback connectCallback, final boolean z10) {
        ...
        if (!z10) {
            z11 = ConnectManager.getInstance().checkOnline(findSameServiceInfo, new OnlineManager.OnlineListener() { // from class: com.hpplay.sdk.source.process.LelinkSdkManager.14
                @Override // com.hpplay.sdk.source.process.OnlineManager.OnlineListener
                public void OnLineCheckResult(LelinkServiceInfo lelinkServiceInfo2, boolean z12) {
                    if (z12) {
            ...
            public void onQueryResult(String str) {
                try {
                    ...
                    if (optInt == 200 && optInt2 != 0) {
                        ...
                        LogUpload.uploadLogFile(context, optInt3 + "", null, "", "", null);
                    }
                } catch (Exception e10) {
                    SourceLog.w(LelinkSdkManager.TAG, e10);
                }
    ...
    */
    ...
    public void connect(LelinkServiceInfo lelinkServiceInfo) {
        ...
        if (!CastUtil.isSupportMultiChannel(lelinkServiceInfo)) {
            z10 = ConnectManager.getInstance().checkOnline(findSameServiceInfo, new OnlineManager.OnlineListener() { // from class: com.hpplay.sdk.source.process.LelinkSdkManager.10
                @Override // com.hpplay.sdk.source.process.OnlineManager.OnlineListener
    ...
    public void notifyBrowseList() {
        ...
        try {
            for (LelinkServiceInfo lelinkServiceInfo : getBrowserList()) {
    ...
    public void setOption(int i10, Object... objArr) {
        ...
        switch (i10) {
                ...
                if (objArr != null && objArr[0] != null) {
                    try {
                        ...
                        if (obj4 instanceof String) {
                            ...
                            str2 = ((DanmakuBean) obj4).toJson(lastPlayInfo.urlID, 1);
                        }
            ...
            case 1179654:
                ...
                SourceLog.i(TAG, "OPTION_SUPER_DEVICE_ID " + str6);
                Preference.getInstance().put(Constant.KEY_SUPER_DEVICE_ID, str6);
            ...
            case IAPI.OPTION_OVERLAY_PERMISSION /* 2097170 */:
                ...
                preference.put(Constant.KEY_REQUEST_SYSTEM_WINDOW_PERMISS, z10);
                return;
            ...
            case IAPI.OPTION_CREATE_LELINK_SERVICE_LIST /* 2097221 */:
                ...
                try {
                    ...
                    while (i12 < jSONArray.length()) {
                        String str7 = (String) jSONArray.get(i12);
                        SourceLog.i(TAG, "createLelinkServiceInfoList OPTION_CREATE_LELINK_SERVICE_LIST :" + str7);
                        arrayList.add(SinkParameterBean.formJson(str7));
                        i12++;
                    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:29:0x009a, code lost:
        if (r6.isUseSystemMirrorCapture() == false) goto L33;
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public void startMirror(final com.hpplay.sdk.source.api.LelinkPlayerInfo r6, final boolean r7) {
        ...
        L9d:
            ...
            return
        La3:
            com.hpplay.sdk.source.process.LelinkSdkManager$11 r0 = new com.hpplay.sdk.source.process.LelinkSdkManager$11     // Catch: java.lang.Exception -> Ld1
            ...
            android.content.Context r0 = r5.mContext     // Catch: java.lang.Exception -> Ld1
        ...
        Lc5:
            ...
            android.content.Context r6 = r5.mContext     // Catch: java.lang.Exception -> Ld1
