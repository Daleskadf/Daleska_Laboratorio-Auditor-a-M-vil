...
public class LelinkV2PushHandler extends IPushHandler {
    ...
    private String buildActionContent(ParamsMap paramsMap, int i10) {
        ...
        if (paramsMap != null) {
            str3 = paramsMap.getStringParam("category");
        }
        if (i10 != 2 && i10 != 1) {
            if (i10 == 6) {
                String stringParam = paramsMap.getStringParam(ParamsMap.PushParams.KEY_MEDIA_ASSET_NAME);
                String stringParam2 = paramsMap.getStringParam("curplayid");
                String stringParam3 = paramsMap.getStringParam("url");
                try {
            ...
            plistBuilder.addStringToRoot("curplayid", paramsMap.getStringParam("curplayid")).addIntagerToRoot("period", paramsMap.getIntParam("period")).addStringToRoot("category", str3).addIntagerToRoot(ParamsMap.PushParams.KEY_HEAD_DURATION, paramsMap.getIntParam(ParamsMap.PushParams.KEY_HEAD_DURATION)).addIntagerToRoot(ParamsMap.PushParams.KEY_TAIL_DURATION, paramsMap.getIntParam(ParamsMap.PushParams.KEY_TAIL_DURATION)).addStringToRoot("uuid", this.mPushUri);
            if (paramsMap.getStringParam(ParamsMap.PushParams.KEY_MEDIA_TYPE).equals(ParamsMap.PushParams.MEDIA_TYPE_AUDIO)) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:76:0x0164, code lost:
        if (r4.equals("stopped") == false) goto L56;
     */
    @Override // com.hpplay.component.protocol.push.IPushHandler
    /*
