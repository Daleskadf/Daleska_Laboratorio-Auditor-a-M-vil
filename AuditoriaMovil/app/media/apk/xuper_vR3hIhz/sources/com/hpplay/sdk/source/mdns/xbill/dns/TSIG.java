...
public class TSIG {
    ...
    public TSIGRecord generate(Message message, byte[] bArr, int i10, TSIGRecord tSIGRecord) {
        ...
        return new TSIGRecord(this.name, 255, 0L, this.alg, date, i11, bArr4, message.getHeader().getID(), i10, bArr3);
    }
    ...
    */
    public TSIG(java.lang.String r2, java.lang.String r3, java.lang.String r4) {
        /*
            r1 = this;
            com.hpplay.sdk.source.mdns.xbill.dns.Name r0 = com.hpplay.sdk.source.mdns.xbill.dns.TSIG.HMAC_MD5
            r1.<init>(r0, r3, r4)
        ...
        L10:
            ...
            boolean r3 = r2.equalsIgnoreCase(r3)
            if (r3 == 0) goto L1d
            com.hpplay.sdk.source.mdns.xbill.dns.Name r2 = com.hpplay.sdk.source.mdns.xbill.dns.TSIG.HMAC_SHA1
            r1.alg = r2
            goto L50
        L1d:
            ...
            boolean r3 = r2.equalsIgnoreCase(r3)
            if (r3 == 0) goto L2a
            com.hpplay.sdk.source.mdns.xbill.dns.Name r2 = com.hpplay.sdk.source.mdns.xbill.dns.TSIG.HMAC_SHA224
            r1.alg = r2
            goto L50
        L2a:
            ...
            boolean r3 = r2.equalsIgnoreCase(r3)
            if (r3 == 0) goto L37
            com.hpplay.sdk.source.mdns.xbill.dns.Name r2 = com.hpplay.sdk.source.mdns.xbill.dns.TSIG.HMAC_SHA256
            r1.alg = r2
            goto L50
        L37:
            ...
            boolean r3 = r2.equalsIgnoreCase(r3)
            if (r3 == 0) goto L44
            com.hpplay.sdk.source.mdns.xbill.dns.Name r2 = com.hpplay.sdk.source.mdns.xbill.dns.TSIG.HMAC_SHA384
            r1.alg = r2
            goto L50
        L44:
            ...
            if (r2 == 0) goto L54
            com.hpplay.sdk.source.mdns.xbill.dns.Name r2 = com.hpplay.sdk.source.mdns.xbill.dns.TSIG.HMAC_SHA512
            r1.alg = r2
        L50:
            r1.getDigest()
            return
