...
public interface PlayerListenerConstant {
    @Deprecated
    ...
    @Deprecated
    public static final int EXTRA_ERROR_CLOUD_MIRROR_UNSUPPORTED = 211053;
    public static final int EXTRA_ERROR_LICENSE_FORBID = 213002;
    public static final int EXTRA_ERROR_LICENSE_NOT_SUPPORT = 213001;
    public static final int EXTRA_ERROR_LICENSE_OUT_OF_TIME = 213004;
    public static final int EXTRA_ERROR_LICENSE_QUANTITY_OVER_LIMIT = 213003;
    public static final int EXTRA_ERROR_LICENSE_REQUEST = 213005;
    public static final int EXTRA_ERROR_MIRROR_CLOUD_NO_RIGHT = 211053;
    public static final int EXTRA_ERROR_MIRROR_DEVICE_UNSUPPORTED = 211004;
    public static final int EXTRA_ERROR_MIRROR_INVALID_INPUT = 211054;
    ...
    public static final int EXTRA_ERROR_MIRROR_SINK_CLOUD_UNSUPPORTED = 211055;
    ...
    public static final int EXTRA_ERROR_PUSH_DEVICE_OFFLINE = 210014;
    public static final int EXTRA_ERROR_PUSH_INVALID_INPUT = 100000;
    public static final int EXTRA_ERROR_PUSH_IO = 210011;
    public static final int EXTRA_NEED_SCREEN_CODE = 211026;
    public static final int HARASS_RECEIVE_CODE = 46;
    public static final int HARASS_SEND_CODE_WRONG = 47;
    @Deprecated
    ...
    public static final int MIRROR_INFO_CODE = 211040;
    @Deprecated
    ...
    public static final int RELEVANCE_RATE_UPDATE = 37;
    @Deprecated
    ...
    public static final int WHAT_ERROR_LICENSE_INVALID = 213000;
