...
public class IMConnection extends IConnection {
    ...
    public IMConnection(ParamsMap paramsMap, ProtocolListener protocolListener) {
        ...
        this.protocolListener = new ProtocolListener() { // from class: com.hpplay.component.protocol.connection.IMConnection.1
            ...
            public void onResult(int i10, String... strArr) {
                ...
                } else if (ParamsMap.IMParams.KEY_RECEIVE_CONNECT_IM == i10) {
    ...
    public boolean startConnect() {
        ...
        if (!booleanValue) {
            ...
            this.mModuleLinker.callMethod(ModuleIds.METHOD_IMCONTROLLER_SETIMMSGRECEIVER, Integer.valueOf((int) ParamsMap.IMParams.KEY_RECEIVE_CONNECT_STATE), this.protocolListener);
            this.mModuleLinker.callMethod(ModuleIds.METHOD_IMCONTROLLER_CONNECTTV, new Object[0]);
            waitState(20000L);
        }
        if (this.isConnectServ) {
            this.mModuleLinker.callMethod(ModuleIds.METHOD_IMCONTROLLER_SETIMMSGRECEIVER, Long.valueOf((long) ParamsMap.IMParams.KEY_RECEIVE_CONNECT_IM), this.protocolListener);
