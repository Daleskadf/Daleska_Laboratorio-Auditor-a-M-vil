...
public class CreateUtil {
    ...
    public static String createPassMsgID() {
        ...
        return EncryptUtil.md5EncryData(uid) + Operator.Operation.MINUS + String.valueOf(System.currentTimeMillis());
    }

    public static String createPushUri(String str) {
        String valueOf = String.valueOf(System.currentTimeMillis());
        return EncryptUtil.md5EncryData(str + valueOf).toUpperCase();
    }
