...
public class AnimatedGifEncoder {
    ...
    private void getImagePixels() {
        ...
        Double.isNaN(d11);
        double d12 = d10 / d11;
        if (d12 > MIN_TRANSPARENT_PERCENTAGE) {
            z10 = true;
        }
        this.hasTransparentPixels = z10;
    ...
    public boolean addFrame(android.graphics.Bitmap r4) {
        ...
        L43:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.hpplay.glide.gifencoder.AnimatedGifEncoder.addFrame(android.graphics.Bitmap):boolean");
    }
