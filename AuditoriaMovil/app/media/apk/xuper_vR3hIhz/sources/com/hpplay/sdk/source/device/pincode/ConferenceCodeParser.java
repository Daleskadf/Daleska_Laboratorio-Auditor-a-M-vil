...
public class ConferenceCodeParser implements CodeParser {
    ...
    private String createToken(String str, String str2) {
        ...
        if (!TextUtils.isEmpty(codeEncrypt)) {
            return codeEncrypt.toLowerCase();
        }
        return "";
    }
                ...
                try {
                    ...
                    if (optJSONObject != null && optJSONObject.length() > 0) {
                        ...
                        if (conferenceInfo == null) {
                            ...
                            return;
                        } else if (ConferenceCodeParser.this.mListener != null) {
            ...
            public void onRequestResult(AsyncHttpParameter asyncHttpParameter2) {
                ...
                try {
                    ...
                    if (optJSONObject != null && optJSONObject.length() > 0) {
                        ...
                        int optInt4 = optJSONObject.optInt(f.f10338t);
                        SourceLog.i(ConferenceCodeParser.TAG, "parseFuzzyMatchingPinCode total:" + optInt + " pageNum:" + optInt2 + " pageSize:" + optInt3 + " pages:" + optInt4);
                        ...
                        if (arrayList.isEmpty()) {
                            ...
                            return;
                        } else if (ConferenceCodeParser.this.mFuzzyMatchingPinCodeListener != null) {
