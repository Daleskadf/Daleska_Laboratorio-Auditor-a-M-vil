...
public final class LazyHeaders implements Headers {
    ...
    public static final class StringHeaderFactory implements LazyHeaderFactory {
        ...
        @Override // com.hpplay.glide.load.model.LazyHeaderFactory
    ...
    private Map<String, String> generateHeaders() {
        ...
        for (Map.Entry<String, List<LazyHeaderFactory>> entry : this.headers.entrySet()) {
            ...
            for (int i10 = 0; i10 < value.size(); i10++) {
                sb.append(value.get(i10).buildHeader());
                if (i10 != value.size() - 1) {
    ...
    @Override // com.hpplay.glide.load.model.Headers
    ...
    public String toString() {
        return "LazyHeaders{headers=" + this.headers + ASCIIPropertyListParser.DICTIONARY_END_TOKEN;
    }
}
