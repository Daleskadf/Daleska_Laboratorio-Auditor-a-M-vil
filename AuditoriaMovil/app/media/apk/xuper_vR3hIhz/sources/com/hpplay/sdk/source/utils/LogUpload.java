...
public class LogUpload {
    ...
    public static void uploadErrorLogFile(String str, String str2, String str3) {
        ...
        try {
            ...
            String str5 = str4 + b.f7381d;
            final String str6 = str4 + b.f7382e;
            FileUtil.string2File(str3, str5);
            e.a(str5, str6);
            SourceLog.i(TAG, "uploadErrorLogFile: " + str6);
            uploadLogFile(Session.getInstance().getContext(), null, CreateUtil.createEid(), str, "", str2, str6, new UploadLogCallback() { // from class: com.hpplay.sdk.source.utils.LogUpload.1
                ...
                public void onRequestResult(AsyncHttpParameter asyncHttpParameter2) {
                    ...
                    if (out.resultType == 0) {
                        ...
                        if (iUploadLogQueryListener2 != null) {
                            iUploadLogQueryListener2.onQueryResult(str);
                            return;
                        }
                        return;
                    }
                    ...
                    if (iUploadLogQueryListener3 != null) {
                        iUploadLogQueryListener3.onError();
                    }
                }
            });
        } catch (Exception e10) {
