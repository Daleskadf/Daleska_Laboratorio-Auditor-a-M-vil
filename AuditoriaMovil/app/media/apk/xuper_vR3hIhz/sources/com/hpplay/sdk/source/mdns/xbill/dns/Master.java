    ...
    private void startGenerate() {
        ...
        if (indexOf >= 0) {
            ...
            if (parseUInt32 >= 0 && parseUInt322 >= 0 && parseUInt32 <= parseUInt322 && j11 > 0) {
                ...
                Tokenizer tokenizer = this.st;
                throw tokenizer.exception("$GENERATE does not support " + Type.string(this.currentType) + " records");
            }
            Tokenizer tokenizer2 = this.st;
            throw tokenizer2.exception("Invalid $GENERATE range specifier: " + identifier);
        }
