...
public class HpplayUtil {
    ...
    public static boolean isDigitsOnly(String str) {
        ...
        if (!TextUtils.isDigitsOnly(str) && !TextUtils.isDigitsOnly(str.replaceFirst(Operator.Operation.MINUS, ""))) {
            return false;
        }
        return true;
    }
    ...
    public static String secToTime(long j10) {
        ...
        if (i10 < 60) {
            int i11 = (int) (j10 % 60);
            return "00:" + unitFormat(i10) + SOAP.DELIM + unitFormat(i11);
        }
        int i12 = i10 / 60;
        if (i12 > 99) {
            return "99:59:59";
        ...
        int i13 = i10 % 60;
        int i14 = (int) ((j10 - (i12 * 3600)) - (i13 * 60));
        return unitFormat(i12) + SOAP.DELIM + unitFormat(i13) + SOAP.DELIM + unitFormat(i14);
    }
