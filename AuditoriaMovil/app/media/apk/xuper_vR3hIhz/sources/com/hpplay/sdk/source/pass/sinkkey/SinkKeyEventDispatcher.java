...
public class SinkKeyEventDispatcher {
    ...
    public void handleEvent(int i10, int i11) {
        ...
        if (this.mSinkKeyEventListener != null && z10) {
            ...
            if (i11 == 1) {
                keyEvent = new KeyEvent(i11, i10);
            } else {
                keyEvent = new KeyEvent(this.mDownTime, uptimeMillis, i11, i10, this.mRepeat);
            }
            this.mSinkKeyEventListener.onKeyEvent(keyEvent);
        }
        this.mPreAction = i11;
    }
