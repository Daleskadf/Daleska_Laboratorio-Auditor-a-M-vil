...
public class GifDecoder {
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:56:0x009a A[EDGE_INSN: B:56:0x009a->B:45:0x009a ?: BREAK  , SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    public synchronized Bitmap getNextFrame() {
        ...
        if (i10 != 1 && i10 != 2) {
            ...
            if (i12 >= 0) {
                gifFrame = this.header.frames.get(i12);
            } else {
                gifFrame = null;
            }
            ...
            if (iArr == null) {
                ...
                this.act = iArr;
                GifHeader gifHeader = this.header;
                if (gifHeader.bgIndex == gifFrame2.transIndex) {
                    gifHeader.bgColor = 0;
                }
            }
            if (gifFrame2.transparency) {
                int[] iArr2 = this.act;
                int i13 = gifFrame2.transIndex;
                int i14 = iArr2[i13];
                iArr2[i13] = 0;
                i11 = i14;
            }
            ...
            if (gifFrame2.transparency) {
                this.act[gifFrame2.transIndex] = i11;
            }
            return pixels;
        }
        if (Log.isLoggable(TAG, 3)) {
