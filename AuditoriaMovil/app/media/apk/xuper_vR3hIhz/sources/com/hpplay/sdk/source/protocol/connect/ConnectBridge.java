...
public class ConnectBridge {
    ...
    private IConnectListener mConnectListener = new IConnectListener() { // from class: com.hpplay.sdk.source.protocol.connect.ConnectBridge.1
        ...
        public void onDisconnect(LelinkServiceInfo lelinkServiceInfo, int i10, int i11) {
            ...
            } else if (CheckDisconnect.disableRetry(i10, i11)) {
            ...
            } else if ((ConnectBridge.this.mConnectBridge instanceof LocalConnectBridge) && CastUtil.getBrowserInfo(lelinkServiceInfo, 4) != null) {
    ...
    public boolean isSupportPassthrough() {
        AbsConnectBridge absConnectBridge = this.mConnectBridge;
        if (absConnectBridge != null && (CastUtil.isSupportLelinkV2(absConnectBridge.getServiceInfo()) || CastUtil.isSupportIM(this.mConnectBridge.getServiceInfo()))) {
            return true;
        }
        return false;
    }
