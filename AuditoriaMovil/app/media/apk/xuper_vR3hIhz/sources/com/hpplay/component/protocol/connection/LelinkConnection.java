...
public class LelinkConnection extends IConnection {
    ...
    public boolean checkConnection() {
        try {
            ...
            String str = new String(this.mProtocolSender.interactiveData(userAgent.setLelinkDeviceId("0x" + this.paramsMap.getMac()).setUserLelinkSessionId(this.sessionId).setContentLength("0").getProtocal(true)));
