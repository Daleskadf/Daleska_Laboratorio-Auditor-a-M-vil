...
public class ProtocolCore {
    ...
    public boolean checkEncrypt(LelinkEncrypt lelinkEncrypt, String str) {
        ...
        try {
            ...
            CLog.i(str + "utime", "genSetupRequest  " + (System.currentTimeMillis() - currentTimeMillis3));
            ...
            CLog.i(str + "utime", "parseSetupResponse  " + (System.currentTimeMillis() - currentTimeMillis3));
            long currentTimeMillis5 = System.currentTimeMillis();
            long currentTimeMillis6 = System.currentTimeMillis();
            byte[] genVerrifyM1Request = lelinkEncrypt.genVerrifyM1Request();
            long currentTimeMillis7 = currentTimeMillis4 + (System.currentTimeMillis() - currentTimeMillis6);
            byte[] interactiveData3 = interactiveData(genVerrifyM1Request);
            if (interactiveData3 == null) {
                return false;
            }
            CLog.i(str + "utime", "genVerrifyM1Request  " + (System.currentTimeMillis() - currentTimeMillis5));
            long currentTimeMillis8 = System.currentTimeMillis();
            long currentTimeMillis9 = System.currentTimeMillis();
            boolean parseVerifyM1Response = lelinkEncrypt.parseVerifyM1Response(interactiveData3);
            long currentTimeMillis10 = currentTimeMillis7 + (System.currentTimeMillis() - currentTimeMillis9);
            if (!parseVerifyM1Response) {
                return false;
            }
            CLog.i(str + "utime", "parseVerifyM1Response  " + (System.currentTimeMillis() - currentTimeMillis8));
            long currentTimeMillis11 = System.currentTimeMillis();
            long currentTimeMillis12 = System.currentTimeMillis();
            byte[] genVerrifyM2Request = lelinkEncrypt.genVerrifyM2Request();
            long currentTimeMillis13 = currentTimeMillis10 + (System.currentTimeMillis() - currentTimeMillis12);
            ...
            CLog.i(str + "utime", "parseVerifyM2Response   " + (System.currentTimeMillis() - currentTimeMillis11));
            String str2 = str + "utime";
            CLog.d(str2, "encrypt time -->" + (currentTimeMillis13 + (System.currentTimeMillis() - currentTimeMillis2)));
            CLog.d(str + "utime", "parseVerifyM2Response  " + (System.currentTimeMillis() - currentTimeMillis11));
            CLog.d(str + "utime", "net time " + ((System.currentTimeMillis() - currentTimeMillis2) - currentTimeMillis));
    ...
    public byte[] interactiveData(byte[]... bArr) {
        ...
        while (System.currentTimeMillis() - currentTimeMillis < NotificationOptions.SKIP_STEP_TEN_SECONDS_IN_MS) {
            if (str == null && this.mLocalAutoCloseInputStream.available() > 0) {
                i10 = this.mLocalAutoCloseInputStream.read(bArr3, 0, 1);
            } else {
                i10 = 0;
            }
            if (i10 > 0) {
                ...
                if (ProtocolUtils.getProtocolDivide(arrayList)) {
                    ...
                    for (int i12 = 0; i12 < size; i12++) {
                        bArr5[i12] = ((Byte) arrayList.get(i12)).byteValue();
                    }
                ...
                this.mLocalAutoCloseInputStream.read(bArr4, i11, available2);
                i11 += available2;
                if (i11 == bArr4.length) {
                    return bArr4;
                }
            ...
            while (true) {
                if (System.currentTimeMillis() - currentTimeMillis < NotificationOptions.SKIP_STEP_TEN_SECONDS_IN_MS) {
                    if (i10 == 0 && this.mLocalAutoCloseInputStream.available() > 4) {
                        if (this.mLocalAutoCloseInputStream.read(bArr4, 0, 4) > 0) {
                    ...
                    } else if (i10 > 0 && this.mLocalAutoCloseInputStream.available() >= i10) {
