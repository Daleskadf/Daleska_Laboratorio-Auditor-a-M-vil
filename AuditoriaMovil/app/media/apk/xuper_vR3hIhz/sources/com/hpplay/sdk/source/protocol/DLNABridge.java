...
public class DLNABridge extends LelinkPushBridge {
    ...
    private boolean isJGTP() {
        ...
        String str = browserInfo.getExtras().get(BrowserInfo.KEY_MANUFACTURER);
        if (!"QQLiveTV Render".equalsIgnoreCase(browserInfo.getExtras().get(BrowserInfo.KEY_DLNA_MODE_NAME)) || !str.contains("极光")) {
            return false;
        }
        return true;
    }
    ...
    public void play(String str) {
        ...
        String str3 = LelinkPushBridge.TAG;
        SourceLog.i(str3, "play " + this.mPlayInfo.getPlayUrl() + " to " + str2 + Operator.Operation.DIVISION + this);
        ...
        String str4 = LelinkPushBridge.TAG;
        SourceLog.i(str4, "play " + create.toString());
