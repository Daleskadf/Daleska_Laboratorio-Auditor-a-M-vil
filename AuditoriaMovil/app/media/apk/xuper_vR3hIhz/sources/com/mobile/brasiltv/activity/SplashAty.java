...
public final class SplashAty extends f5.d implements y0, OpenNotifyDialog.NotificationListener {
    ...
    public static final class b extends j implements l {
        ...
        public static final void f(SplashAty splashAty) {
            ...
            f1.a aVar = f1.f8649a;
            f1.a.p(aVar, splashAty, "EA18, " + x.f8754a.y(splashAty.Q1(), R.string.contact_seller), 0, 4, null);
        }
        ...
        public static final void h(SplashAty splashAty) {
            i.g(splashAty, "this$0");
            f1.a aVar = f1.f8649a;
            f1.a.p(aVar, splashAty, "EA31 " + x.f8754a.y(splashAty.Q1(), R.string.contact_seller), 0, 4, null);
        }
    ...
    public static final void m3(SplashAty splashAty, View view) {
        ...
        if (!z10 && (disposable = splashAty.f8191p) != null) {
            disposable.dispose();
        }
        splashAty.S2().O();
    }
    ...
    public void A1() {
        ...
        final f fVar = new f();
        compose.subscribe(new Consumer() { // from class: f5.k5
    ...
    public void f2(final AdInfo adInfo) {
        ...
        m.h0(mVar, Q1, imageView, aVar.b(), adInfo, null, null, null, false, 0, 496, null);
    ...
    public final void n3(Intent intent) {
        ...
        if (uri != null) {
            ...
            if (i.b(scheme, "sxl") && i.b(host, s6.a.f18777a.a().h())) {
    ...
    public void onRestart() {
        ...
        if (i.b(S2().y(), Boolean.FALSE)) {
            if (p.a.checkSelfPermission(Q1(), "android.permission.READ_MEDIA_IMAGES") == 0) {
                S2().J();
                return;
            }
            return;
