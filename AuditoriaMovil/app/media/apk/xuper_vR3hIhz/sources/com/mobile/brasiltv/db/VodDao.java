...
public final class VodDao implements a.b {
    ...
    public static /* synthetic */ void addRecord$default(VodDao vodDao, AssetData assetData, SimpleProgramList simpleProgramList, long j10, int i10, String str, long j11, int i11, Object obj) {
        long j12;
        long j13;
        if ((i11 & 4) != 0) {
            j12 = 0;
        ...
        vodDao.addRecord(assetData, simpleProgramList, j12, i10, str, j13);
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:11:0x003f A[Catch: RuntimeException -> 0x004f, TryCatch #0 {RuntimeException -> 0x004f, blocks: (B:3:0x0006, B:5:0x0033, B:11:0x003f, B:12:0x0047), top: B:21:0x0006 }] */
    /* JADX WARN: Removed duplicated region for block: B:12:0x0047 A[Catch: RuntimeException -> 0x004f, TRY_LEAVE, TryCatch #0 {RuntimeException -> 0x004f, blocks: (B:3:0x0006, B:5:0x0033, B:11:0x003f, B:12:0x0047), top: B:21:0x0006 }] */
    /*
    ...
    */
    ...
    public final boolean queryLiveSubByPid(String str) {
        i.g(str, "pid");
        try {
            if (getDb().m(LiveSubProgram.class, "_pid = '" + str + '\'').size() == 0) {
                return false;
            }
            return true;
        } catch (RuntimeException e10) {
