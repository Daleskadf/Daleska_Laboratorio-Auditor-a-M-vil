...
public final class CastModeAty extends f5.c implements c.b, c.InterfaceC0353c {
    ...
    public final void i3() {
        ...
        if (H != null) {
            ...
            m.h0(mVar, Q12, imageView, a11, H, null, new b(H), Integer.MIN_VALUE, false, 0, 400, null);
    ...
    public final boolean k3() {
        if (!this.f7826l && (t9.i.b(this.f7825k, "LIVE") || (t9.i.b(this.f7825k, "VOD") && !l3()))) {
            return true;
        }
        return false;
    }
    ...
    public final boolean l3() {
        if (t9.i.b(this.f7827m, IjkMediaFormat.CODEC_NAME_H264) && t9.i.b(this.f7828n, "mp4")) {
            return true;
        }
        return false;
    }
