...
public final class IntroduceAty extends c {
    ...
    public static final class b implements ViewPager.j {
        ...
        public void onPageSelected(int i10) {
            ...
            if (i10 <= ((LinearLayout) introduceAty.S2(i11)).getChildCount()) {
                ...
                ((TextView) IntroduceAty.this.S2(R$id.mTextIntroduceFirst)).setText(introduceAty2.getString(introduceAty2.f7903n[i10].intValue()));
                IntroduceAty introduceAty3 = IntroduceAty.this;
                ((TextView) IntroduceAty.this.S2(R$id.mTextIntroduceSecond)).setText(introduceAty3.getString(introduceAty3.f7904o[i10].intValue()));
                if (i10 != 0 && i10 != 1) {
                    if (i10 == 2) {
    ...
    public final void a3() {
        if (i.b(getIntent().getStringExtra(f7897r), f7898s)) {
            this.f7902m[0] = Integer.valueOf((int) R.drawable.bg_install_introduce1);
            this.f7902m[1] = Integer.valueOf((int) R.drawable.bg_install_introduce2);
            this.f7902m[2] = Integer.valueOf((int) R.drawable.bg_install_introduce3);
            this.f7903n[0] = Integer.valueOf((int) R.string.introduce_install_first_1);
            this.f7903n[1] = Integer.valueOf((int) R.string.introduce_install_second_1);
            this.f7903n[2] = Integer.valueOf((int) R.string.introduce_install_three_1);
            this.f7904o[0] = Integer.valueOf((int) R.string.introduce_install_first_2);
            this.f7904o[1] = Integer.valueOf((int) R.string.introduce_install_second_2);
            this.f7904o[2] = Integer.valueOf((int) R.string.introduce_install_three_2);
            return;
        }
        this.f7902m[0] = Integer.valueOf((int) R.drawable.bg_upgrade_introduce1);
        this.f7902m[1] = Integer.valueOf((int) R.drawable.bg_upgrade_introduce2);
        this.f7902m[2] = Integer.valueOf((int) R.drawable.bg_upgrade_introduce3);
        this.f7903n[0] = Integer.valueOf((int) R.string.introduce_upgrade_first_1);
        this.f7903n[1] = Integer.valueOf((int) R.string.introduce_upgrade_second_1);
        this.f7903n[2] = Integer.valueOf((int) R.string.introduce_upgrade_three_1);
        this.f7904o[0] = Integer.valueOf((int) R.string.introduce_upgrade_first_2);
        this.f7904o[1] = Integer.valueOf((int) R.string.introduce_upgrade_second_2);
        this.f7904o[2] = Integer.valueOf((int) R.string.introduce_upgrade_three_2);
    }
