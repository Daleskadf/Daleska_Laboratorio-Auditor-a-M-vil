...
public class KoocanNetTabLayout extends AutoFrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void updateTabSelection(int i10) {
        ...
        for (int i12 = 0; i12 < this.mTabCount; i12++) {
            ...
            MainTabEntity mainTabEntity = this.mTabEntitys.get(i12);
            if (mainTabEntity.isUseNetIcon()) {
                if (z10) {
                    unSelectedIconUrl = mainTabEntity.getSelectedIconUrl();
                } else {
                    unSelectedIconUrl = mainTabEntity.getUnSelectedIconUrl();
                }
                a7.e.f288a.b(this.mContext, unSelectedIconUrl, imageView2, -1);
                imageView2.setVisibility(0);
            } else {
                if (mainTabEntity.getSelectedDrawable() != null && mainTabEntity.getUnSelectDrawable() != null) {
                    if (z10) {
                        unSelectDrawable = mainTabEntity.getSelectedDrawable();
                    } else {
                        unSelectDrawable = mainTabEntity.getUnSelectDrawable();
                    }
                    imageView.setImageDrawable(unSelectDrawable);
                } else {
                    if (z10) {
                        tabUnselectedIcon = mainTabEntity.getTabSelectedIcon();
                    } else {
                        tabUnselectedIcon = mainTabEntity.getTabUnselectedIcon();
                    }
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i10 = 0; i10 < this.mTabCount; i10++) {
            ...
            if (i11 == 3) {
                ...
                inflate = View.inflate(this.mContext, R.layout.layout_tab_top_2, null);
            }
    ...
    public void setMsgMargin(int i10, float f10, float f11) {
        ...
        if (msgView != null) {
            ...
            if (i12 != 48 && i12 != 80) {
                ...
                if (i14 > 0) {
                    dp2px = ((((int) (((i14 - descent) - f12) - f13)) / 2) - ((int) f13)) - dp2px(f11);
                } else {
                    dp2px = dp2px(f11);
                }
    ...
    public void updateTabStyles() {
        ...
        for (int i12 = 0; i12 < this.mTabCount; i12++) {
            ...
            if (this.mIconVisible) {
                ...
                LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(i10, i14);
