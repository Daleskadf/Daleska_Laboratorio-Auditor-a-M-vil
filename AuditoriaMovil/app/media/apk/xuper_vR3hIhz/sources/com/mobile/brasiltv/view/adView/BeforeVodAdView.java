...
public final class BeforeVodAdView extends AutoFrameLayout {
    ...
    private final boolean handleVipPlayToday() {
        ...
        if (bVar.x()) {
            ...
            if (t9.i.b(na.f.f(context, this.KEY_VIP_PLAY_PREFIX + bVar.l(), ""), c10)) {
                return false;
            }
    ...
    private final void playVideo() {
        ...
        surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() { // from class: com.mobile.brasiltv.view.adView.BeforeVodAdView$playVideo$3
            ...
            public void surfaceCreated(SurfaceHolder surfaceHolder) {
                ...
                String str2 = null;
                if (adInfoWrapper != null) {
                    str = adInfoWrapper.getCachePath();
                } else {
                    str = null;
                }
                ...
                if (adInfoWrapper2 != null) {
                    str2 = adInfoWrapper2.getCachePath();
                }
    ...
    public final void showBeforeVodAd(AdInfoWrapper adInfoWrapper, String str) {
        ...
        if (t9.i.b(str3, "picture")) {
            ...
            s1.m.h0(mVar, context, imageView, str, adInfo2, null, null, null, false, 0, 496, null);
            return;
        }
