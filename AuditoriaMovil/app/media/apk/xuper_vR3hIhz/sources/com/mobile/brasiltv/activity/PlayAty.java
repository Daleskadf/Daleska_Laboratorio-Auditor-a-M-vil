...
public final class PlayAty extends f5.d implements g0, m6.a {
    ...
    public static final void D3(PlayAty playAty, boolean z10, String str) {
        ...
        if (z10) {
            a10 = playAty.getResources().getString(R.string.vod_no_media);
        } else {
            a10 = ma.j.a(playAty, str);
        }
        ...
        if (titanPlayerController != null) {
            i.f(a10, "errorMessage");
            titanPlayerController.B4(a10);
        }
    }
    ...
    public static final void F3(PlayAty playAty) {
        ...
        new BaseGuideManager(Q1, (AutoLinearLayout) ((ProgramActorInfoView) playAty.a3(i10).findViewById(R$id.mActorInfoView))._$_findCachedViewById(R$id.mShareLayout), "keyVodSharing", string, GuideDialog.Direction.TOP_RIGHT, null, false, false, null, 480, null).showGuide();
    }
    ...
    public void E3(AssetData assetData) {
        ...
        TitanPlayerController titanPlayerController = (TitanPlayerController) a3(R$id.mVodPlayer);
        if (titanPlayerController != null) {
            TitanPlayerController.u2(titanPlayerController, this.f8006l, assetData, this.f8007m, this.f8010p, this.f8011q, this.f8012r, false, 64, null);
        }
    ...
    public void d2() {
        ...
        String str2 = H;
        String str3 = e.f17342b;
        i.f(str3, "dcsMark");
        dVar.g("", str2, str3, yVar.n(), "", c10, str, "apk");
        f1.f8649a.x(c10 + ASCIIPropertyListParser.DATE_DATE_FIELD_DELIMITER + x.f8754a.y(Q1(), R.string.failed_ec5));
    }
    ...
    public final void handleRequestAuth(RequestAuthEvent requestAuthEvent) {
        ...
        if (!i.b("movie", this.f8008n) && !i.b("1", this.f8007m)) {
    ...
    public void m() {
        ...
        TitanPlayerController titanPlayerController = (TitanPlayerController) a3(i10);
        String str = "";
        String str2 = (titanPlayerController == null || (curPlayProgram = titanPlayerController.getCurPlayProgram()) == null || (str2 = curPlayProgram.getContentId()) == null) ? "" : "";
        TitanPlayerController titanPlayerController2 = (TitanPlayerController) a3(i10);
        if (titanPlayerController2 != null && (mDetailDataContentId = titanPlayerController2.getMDetailDataContentId()) != null) {
            str = mDetailDataContentId;
        }
        g2.t0(S2, a02, str2, str, 0, null, 24, null);
    }
    ...
    public void onResume() {
        ...
        if (!hVar.o() && !hVar.p()) {
            ...
            if (program == null) {
                ...
                HashMap a02 = S2().a0();
                TitanPlayerController titanPlayerController2 = (TitanPlayerController) a3(i10);
                String str2 = (titanPlayerController2 == null || (curPlayProgram = titanPlayerController2.getCurPlayProgram()) == null || (str2 = curPlayProgram.getContentId()) == null) ? "" : "";
                TitanPlayerController titanPlayerController3 = (TitanPlayerController) a3(i10);
