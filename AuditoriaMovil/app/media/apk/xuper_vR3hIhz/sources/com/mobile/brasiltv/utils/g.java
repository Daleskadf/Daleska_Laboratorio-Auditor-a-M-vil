...
public final class g implements f8.a {
    ...
    public void b(String str, String str2, int i10) {
        ...
        if (t9.i.b(str2, "StartPlay")) {
            if (ba.s.g(str, f8668r, false, 2, null)) {
                h hVar = h.f8694a;
                if (i10 == 0) {
                    z10 = true;
                } else {
    ...
    public void c(String str, String str2, String str3) {
        ...
        if (str != null) {
            ...
            CastDeviceDiscovery castDeviceDiscovery = null;
            Long l10 = null;
            if (hashCode != 497724214) {
                if (hashCode != 1100412980) {
                    if (hashCode == 1155545264 && str.equals("cast_discovery")) {
                        if (str2 != null) {
                            castDeviceDiscovery = (CastDeviceDiscovery) g8.b.f14068a.a(str2, CastDeviceDiscovery.class);
                        }
                        ...
                        if (castDeviceDiscovery != null) {
                            ...
                            c2.a.f5307a.b(castDeviceDiscovery, j11, elapsedRealtime);
                        }
                    }
                } else if (str.equals("cast_play")) {
                    if (str2 != null) {
                        castPlay = (CastPlay) g8.b.f14068a.a(str2, CastPlay.class);
                    } else {
                        castPlay = null;
                    }
                    if (castPlay != null) {
                    ...
                    if (castPlay != null) {
                        l10 = Long.valueOf(castPlay.getDuration());
                    }
                    t9.i.d(l10);
                    ...
                    c2.a.f5307a.c(castPlay, j10, elapsedRealtime);
                }
            } else if (str.equals("cast_action")) {
                if (str2 != null) {
                    castAction = (CastAction) g8.b.f14068a.a(str2, CastAction.class);
                }
                if (castAction != null) {
    ...
    public void d(Device device) {
        ...
        if (device.getAlive()) {
            if (!h.f8694a.o() || !t9.i.b(device, f8655e)) {
                f8653c.add(device);
            }
        } else {
            ...
            while (true) {
                if (i10 >= size) {
                    break;
                } else if (t9.i.b(device.getUdn(), ((Device) f8653c.get(i10)).getUdn())) {
    ...
    public final CastBean o() {
        ...
        return new CastBean("com.msandroid.mobile", "60201", H, E, (A == null || (r0 = A.getPlay_params()) == null) ? "" : "");
    }
