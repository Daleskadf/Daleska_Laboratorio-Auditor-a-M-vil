...
public final class GuideDialog extends Dialog {
    ...
    private final void getCustomViewById() {
        ...
        if (view != null) {
            if (view != null) {
                textView = (TextView) view.findViewWithTag("mTvSure");
            } else {
                textView = null;
            }
            View view2 = this.mCustomGuideView;
            if (view2 != null) {
                textView2 = (TextView) view2.findViewWithTag("mTextContent");
            } else {
                textView2 = null;
            }
            boolean z11 = true;
            if (this.mButtonText.length() > 0) {
                z10 = true;
            } else {
                z10 = false;
            }
            ...
            if (view3 != null) {
                imageView = (ImageView) view3.findViewWithTag("mThumbnailArrow");
            }
            if (imageView != null) {
