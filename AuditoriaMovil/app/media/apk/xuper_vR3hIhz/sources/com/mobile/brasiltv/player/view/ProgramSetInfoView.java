...
public final class ProgramSetInfoView extends AutoRelativeLayout {
    ...
    public static final class b extends RecyclerView.t {
        ...
        public void onScrolled(RecyclerView recyclerView, int i10, int i11) {
            ...
            if (((SeekBar) programSetInfoView._$_findCachedViewById(i12)).getVisibility() == 0) {
                ...
                int computeHorizontalScrollRange = ((RecyclerView) programSetInfoView2._$_findCachedViewById(i13)).computeHorizontalScrollRange() - ((RecyclerView) ProgramSetInfoView.this._$_findCachedViewById(i13)).getWidth();
                ((SeekBar) ProgramSetInfoView.this._$_findCachedViewById(i12)).setProgress((((SeekBar) ProgramSetInfoView.this._$_findCachedViewById(i12)).getMax() * recyclerView.computeHorizontalScrollOffset()) / computeHorizontalScrollRange);
            }
        }
    }
    ...
    public final void w() {
        ...
        if ((sameSeasonSeriesList == null || sameSeasonSeriesList.isEmpty()) ? true : true) {
