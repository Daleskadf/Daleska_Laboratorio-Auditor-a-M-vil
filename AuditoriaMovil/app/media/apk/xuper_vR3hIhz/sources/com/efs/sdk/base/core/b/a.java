...
public final class a implements d {
    ...
    public final HttpResponse a(LogDto logDto, boolean z10) {
        ...
        if (logDto.getLogBodyType() == 0) {
            httpResponse = com.efs.sdk.base.core.a.a.a().a(a11, a10, logDto.getData(), logDto.isLimitByFlow());
        } else if (1 == logDto.getLogBodyType()) {
            httpResponse = com.efs.sdk.base.core.a.a.a().a(a11, a10, logDto.getFile(), logDto.isLimitByFlow());
        } else {
