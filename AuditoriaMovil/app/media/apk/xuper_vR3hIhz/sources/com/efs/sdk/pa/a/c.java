...
public final class c implements PA {
    ...
    public final int endCalFPS(String str) {
        ...
        if (str != null && str.trim().length() != 0) {
            ...
            int currentTimeMillis = (int) (((float) aVar.f6463b) / (((float) (System.currentTimeMillis() - aVar.f6462a)) / 1000.0f));
    ...
    public final void startCalFPS(String str, View view) {
        ...
        if (str != null && str.trim().length() != 0 && view != null && bVar.f6460a.get(str) == null) {
            ...
            aVar.f6464c = onPreDrawListener;
            aVar.f6465d.getViewTreeObserver().addOnPreDrawListener(onPreDrawListener);
