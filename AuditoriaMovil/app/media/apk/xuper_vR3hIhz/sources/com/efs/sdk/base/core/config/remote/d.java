        ...
        if (this.f6164a == null) {
            synchronized (com.efs.sdk.base.core.b.c.class) {
                if (this.f6164a == null) {
                    ...
                    this.f6164a = SharedPreferencesUtils.getSharedPreferences(ControllerCenter.getGlobalEnvStruct().mAppContext, EncodeUtil.base64EncodeToStr(("config_" + appid.toLowerCase()).getBytes()));
