    ...
    public final /* synthetic */ HttpResponse a() {
        ...
        if (!str.equals("get")) {
            ...
            if (bArr != null && bArr.length > 0) {
                if (this.f6233g) {
                    return HttpEnv.getInstance().getHttpUtil().postAsFile(this.f6227a, this.f6228b, this.f6229c);
                }
                return HttpEnv.getInstance().getHttpUtil().post(this.f6227a, this.f6228b, this.f6229c);
            }
            return HttpEnv.getInstance().getHttpUtil().post(this.f6227a, this.f6228b, this.f6230d);
        }
