...
public class GlobalInfoManager {
    ...
    public static class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private static final GlobalInfoManager f6141a = new GlobalInfoManager((byte) 0);
    }
    ...
    public void initGlobalInfo() {
        ...
        if (str == null) {
            ...
            lowerCase = str.replace(" ", Operator.Operation.MINUS).replace("_", Operator.Operation.MINUS).toLowerCase();
        }
        globalInfo3.a(Constants.KEY_MODEL, lowerCase);
