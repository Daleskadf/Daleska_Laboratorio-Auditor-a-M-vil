...
public class Message implements Serializable {
    ...
    public static class Id implements Serializable {
        ...
        public boolean equals(Object obj) {
            ...
            Id id = (Id) obj;
            if (this.f9088a == id.getId() || this.f9089b.equals(id.getDataId())) {
                return true;
            }
            return false;
        }
    ...
    public byte[] build(Context context, int i10) {
        ...
        int length2 = this.f9068g + 3 + 1 + this.f9069h + 1 + bytes.length;
        byte[] bArr2 = this.D;
        if (bArr2 == null) {
            length = 0;
        } else {
        ...
        short s10 = (short) (length2 + length + a10 + 2);
        this.f9066e = s10;
        this.f9065d = (short) (s10 + 2);
        ...
        try {
            ...
            if (ALog.isPrintLog(level)) {
                String c10 = c();
                ALog.d(c10, "\tversion:2 compress:" + ((int) this.f9063b), new Object[0]);
            }
            if (i10 == 0) {
            ...
            if (ALog.isPrintLog(level)) {
                String c11 = c();
                ALog.d(c11, "\ttotalLength:" + ((int) this.f9065d), new Object[0]);
            }
            rVar.a(this.f9066e);
            if (ALog.isPrintLog(level)) {
                String c12 = c();
                ALog.d(c12, "\tdataLength:" + ((int) this.f9066e), new Object[0]);
            }
            rVar.a(this.f9067f);
            if (ALog.isPrintLog(level)) {
                String c13 = c();
                ALog.d(c13, "\tflags:" + Integer.toHexString(this.f9067f), new Object[0]);
            }
            rVar.a(this.f9068g);
            if (ALog.isPrintLog(level)) {
                String c14 = c();
                ALog.d(c14, "\ttargetLength:" + ((int) this.f9068g), new Object[0]);
            }
            rVar.write(this.f9070i.getBytes(XML.CHARSET_UTF8));
            if (ALog.isPrintLog(level)) {
                String c15 = c();
                ALog.d(c15, "\ttarget:" + this.f9070i, new Object[0]);
            }
            rVar.a(this.f9069h);
            if (ALog.isPrintLog(level)) {
                String c16 = c();
                ALog.d(c16, "\tsourceLength:" + ((int) this.f9069h), new Object[0]);
            }
            rVar.write(this.f9071j.getBytes(XML.CHARSET_UTF8));
            if (ALog.isPrintLog(level)) {
                String c17 = c();
                ALog.d(c17, "\tsource:" + this.f9071j, new Object[0]);
            }
            rVar.a((byte) bytes.length);
            if (ALog.isPrintLog(level)) {
                String c18 = c();
                ALog.d(c18, "\tdataIdLength:" + bytes.length, new Object[0]);
            }
            rVar.write(bytes);
            if (ALog.isPrintLog(level)) {
                String c19 = c();
                ALog.d(c19, "\tdataId:" + new String(bytes), new Object[0]);
            }
            rVar.a(a10);
            if (ALog.isPrintLog(level)) {
                String c20 = c();
                ALog.d(c20, "\textHeader len:" + ((int) a10), new Object[0]);
            }
                ...
                for (Integer num : map.keySet()) {
                    ...
                    if (!TextUtils.isEmpty(str4)) {
                        ...
                        if (ALog.isPrintLog(ALog.Level.D)) {
                            String c21 = c();
                            ALog.d(c21, "\textHeader key:" + intValue + " value:" + str4, new Object[0]);
                        }
                    }
                }
            }
    ...
    public static Message buildUnbindApp(String str, String str2) {
        ...
        try {
            ...
            try {
                ...
                message2.command = 2;
                message2.f9074m = str2;
                message2.f9083v = Integer.valueOf((int) Constants.SDK_VERSION_CODE);
    ...
    public static Message buildUnbindUser(String str) {
        ...
        message.f9070i = Constants.TARGET_CONTROL;
        message.command = 4;
        message.f9083v = Integer.valueOf((int) Constants.SDK_VERSION_CODE);
