...
public class v extends com.taobao.accs.net.a implements SessionCb, Spdycb {
    ...
    public class a extends Thread {
        ...
        private void a(boolean z10) {
            ...
            } else if (v.this.f9234t == 1 && System.currentTimeMillis() - this.f9242b > 5000) {
                this.f9241a = 0;
            }
        }
    ...
    private void s() {
        ...
        try {
            ...
            SpdyRequest spdyRequest = new SpdyRequest(new URL(c10), "GET", RequestPriority.DEFAULT_PRIORITY, (int) HTTPServer.DEFAULT_TIMEOUT, (int) com.taobao.accs.net.a.ACCS_RECEIVE_TIMEOUT);
    ...
    public void spdyOnStreamResponse(SpdySession spdySession, long j10, Map<String, List<String>> map, Object obj) {
        ...
        try {
            ...
            if (parseInt == 200) {
                ...
                uTMini.commitEvent(66001, "CONNECTED 200 " + str, this.f9239y, this.L, Integer.valueOf((int) Constants.SDK_VERSION_CODE), "0");
    ...
    public void spdySessionCloseCallback(SpdySession spdySession, Object obj, SuperviseConnectInfo superviseConnectInfo, int i10) {
        ...
        sb.append(str);
        uTMini.commitEvent(66001, sb.toString(), Integer.valueOf(i10), Long.valueOf(this.I.live_time), Integer.valueOf((int) Constants.SDK_VERSION_CODE), this.f9239y, this.L);
    }
    ...
    public void spdySessionConnectCB(SpdySession spdySession, SuperviseConnectInfo superviseConnectInfo) {
        ...
        UTMini uTMini = UTMini.getInstance();
        uTMini.commitEvent(66001, "CONNECTED " + str + " " + superviseConnectInfo.sessionTicketReused, String.valueOf(this.G), String.valueOf(i10), Integer.valueOf((int) Constants.SDK_VERSION_CODE), String.valueOf(superviseConnectInfo.sessionTicketReused), this.f9239y, this.L);
    ...
    public void spdySessionFailedError(SpdySession spdySession, int i10, Object obj) {
        ...
        UTMini.getInstance().commitEvent(66001, "DISCONNECT " + str, Integer.valueOf(i10), Integer.valueOf(i11), Integer.valueOf((int) Constants.SDK_VERSION_CODE), this.f9239y, this.L);
                    ...
                    try {
                        try {
                            if (!TextUtils.isEmpty(this.f9232r) && this.f9233s >= 0 && this.K) {
                                ...
                                String str2 = this.f9230p;
                                int i12 = this.f9231q;
                                sessionInfo = new SessionInfo(str2, i12, p() + "_" + this.f9158b, this.f9232r, this.f9233s, this.O, this, 4226);
                                this.L = this.f9232r + SOAP.DELIM + this.f9233s;
                            } else {
                                ALog.e(d(), "connect normal", new Object[0]);
                                String str3 = this.f9230p;
                                int i13 = this.f9231q;
                                sessionInfo = new SessionInfo(str3, i13, p() + "_" + this.f9158b, null, 0, this.O, this, 4226);
                                this.L = "";
                            }
    ...
    private void e(int i10) {
        ...
        UTMini uTMini = UTMini.getInstance();
        uTMini.commitEvent(66001, "CONNECTED NO 200 " + str, Integer.valueOf(i10), Integer.valueOf(i11), Integer.valueOf((int) Constants.SDK_VERSION_CODE), this.f9239y, this.L);
    ...
    public void a(Message message, boolean z10) {
        if (this.f9237w && message != null) {
            try {
                ...
                String d10 = d();
                ALog.e(d10, "send queue full count:" + ThreadPoolExecutorFactory.getScheduledExecutor().getQueue().size(), new Object[0]);
                return;
            } catch (Throwable th) {
        ...
        String d11 = d();
        ALog.e(d11, "not running or msg null! " + this.f9237w, new Object[0]);
    }
    ...
    private boolean a(String str, String str2, String str3) {
        ...
        if (TextUtils.isEmpty(str) || TextUtils.isEmpty(str2) || TextUtils.isEmpty(str3)) {
            ...
            a aVar = this.f9236v;
            int i11 = aVar != null ? aVar.f9241a : 0;
            UTMini.getInstance().commitEvent(66001, "DISCONNECT " + str4, Integer.valueOf(i10), Integer.valueOf(i11), Integer.valueOf((int) Constants.SDK_VERSION_CODE), this.f9239y, this.L);
            com.taobao.accs.utl.k.a("accs", BaseMonitor.ALARM_POINT_CONNECT, "retrytimes:" + i11, i10 + "", "");
            return false;
        }
        return true;
