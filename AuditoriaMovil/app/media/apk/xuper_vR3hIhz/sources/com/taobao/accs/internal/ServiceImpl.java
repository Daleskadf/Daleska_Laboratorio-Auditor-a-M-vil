...
public class ServiceImpl extends d {
    ...
    private void b(Intent intent) {
        ...
        } else if (!stringExtra.equals(this.f9143c.getPackageName())) {
    ...
    private void d() {
        ...
        if (concurrentHashMap != null && concurrentHashMap.size() != 0) {
            for (Map.Entry<String, com.taobao.accs.net.a> entry : d.f9151a.entrySet()) {
                com.taobao.accs.ut.a.c c10 = entry.getValue().c();
                if (c10 != null) {
    ...
    private void a() {
        ...
        if (ALog.isPrintLog(ALog.Level.I)) {
            ALog.i("ServiceImpl", "init", Constants.KEY_SDK_VERSION, Integer.valueOf((int) Constants.SDK_VERSION_CODE), "procStart", Integer.valueOf(com.taobao.accs.client.a.f9050f.intValue()));
        }
