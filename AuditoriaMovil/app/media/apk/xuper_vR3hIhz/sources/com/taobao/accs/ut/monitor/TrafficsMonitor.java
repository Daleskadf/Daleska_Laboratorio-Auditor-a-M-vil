...
public class TrafficsMonitor {
    ...
    private void b() {
        ...
        synchronized (this.f9303a) {
            ...
            for (String str2 : this.f9303a.keySet()) {
                for (a aVar : this.f9303a.get(str2)) {
                    if (aVar != null) {
                        com.taobao.accs.b.a a11 = com.taobao.accs.b.a.a(this.f9306d);
                        String str3 = aVar.f9313e;
                        String str4 = aVar.f9311c;
                        a11.a(str3, str4, this.f9304b.get(str4), aVar.f9312d, aVar.f9314f, str);
                    }
                }
            }
