...
public class d {
    ...
    private void i() {
        try {
            File dir = this.f9111i.getDir("accs", 0);
            File file = new File(dir, Constants.SHARED_MESSAGE_ID_FILE + this.f9114l.i());
            if (!file.exists()) {
    ...
    private void j() {
        try {
            File dir = this.f9111i.getDir("accs", 0);
            FileWriter fileWriter = new FileWriter(new File(dir, Constants.SHARED_MESSAGE_ID_FILE + this.f9114l.i()));
            fileWriter.write("");
            for (String str : this.f9116n.keySet()) {
    ...
    public void b(Message message) {
        if (this.f9109g.keySet().size() > 0) {
            for (Message.Id id : this.f9109g.keySet()) {
                Message message2 = this.f9109g.get(id);
    ...
    /* JADX WARN: Removed duplicated region for block: B:188:0x05f1 A[Catch: Exception -> 0x0669, TRY_LEAVE, TryCatch #3 {Exception -> 0x0669, blocks: (B:188:0x05f1, B:192:0x05fb, B:195:0x0602, B:197:0x0621, B:196:0x0613, B:160:0x046f, B:163:0x0479, B:167:0x04b8, B:169:0x04d0, B:170:0x04d6, B:172:0x04da, B:174:0x04e5, B:176:0x0535, B:178:0x0543, B:182:0x05a3, B:186:0x05e6, B:181:0x05a2, B:164:0x0495, B:166:0x049d), top: B:222:0x046f }] */
    /* JADX WARN: Removed duplicated region for block: B:201:0x065b A[Catch: Exception -> 0x069f, TryCatch #1 {Exception -> 0x069f, blocks: (B:199:0x064b, B:201:0x065b, B:206:0x0672), top: B:218:0x03d1 }] */
            ...
            if (!message.isCancel) {
                if (b(i10) && message.command.intValue() != 100 && message.retryTimes <= Message.CONTROL_MAX_RETRY_TIMES) {
                    ...
                    if (!TextUtils.isEmpty(message.serviceId)) {
                        UTMini.getInstance().commitEvent(66001, "MsgToBuss0", "commandId=" + message.command, "serviceId=" + message.serviceId + " errorCode=" + i10 + " dataId=" + message.dataId, Integer.valueOf((int) Constants.SDK_VERSION_CODE));
        ...
        try {
            ...
            if (i10 == 200) {
                ...
                if (message.retryTimes > 0) {
                    ...
                    com.taobao.accs.utl.k.a("accs", BaseMonitor.ALARM_POINT_REQUEST, url2, a10, this.f9104b + message.serviceId + message.timeout);
                }
