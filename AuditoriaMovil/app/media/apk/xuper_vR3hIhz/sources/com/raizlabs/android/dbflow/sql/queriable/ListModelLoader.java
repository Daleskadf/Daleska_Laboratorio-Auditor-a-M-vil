...
public class ListModelLoader<TModel> extends ModelLoader<TModel, List<TModel>> {
    ...
    public /* bridge */ /* synthetic */ Object convertToData(FlowCursor flowCursor, Object obj) {
        return convertToData(flowCursor, (List) ((List) obj));
    }
    ...
    @Override // com.raizlabs.android.dbflow.sql.queriable.ModelLoader
    public /* bridge */ /* synthetic */ Object load(DatabaseWrapper databaseWrapper, String str, Object obj) {
        return load(databaseWrapper, str, (List) ((List) obj));
    }

    @Override // com.raizlabs.android.dbflow.sql.queriable.ModelLoader
    public /* bridge */ /* synthetic */ Object load(FlowCursor flowCursor, Object obj) {
        return load(flowCursor, (List) ((List) obj));
    }

    @Override // com.raizlabs.android.dbflow.sql.queriable.ModelLoader
    public /* bridge */ /* synthetic */ Object load(String str, Object obj) {
        return load(str, (List) ((List) obj));
    }
