...
public class AsyncHttpClient {
    ...
    public static String getUrlWithQueryString(boolean z10, String str, RequestParams requestParams) {
        ...
        if (requestParams != null) {
            ...
            if (!trim.equals("")) {
                ...
                if (!trim.equals(Operator.Operation.EMPTY_PARAM)) {
    ...
    public static boolean isInputStreamGZIPCompressed(PushbackInputStream pushbackInputStream) {
        ...
        int i10 = (bArr[0] & UnsignedBytes.MAX_VALUE) | ((bArr[1] << 8) & 65280);
        if (read != 2 || 35615 != i10) {
            return false;
        }
        return true;
    ...
    public void cancelRequests(Context context, final boolean z10) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            this.threadPool.submit(new Runnable() { // from class: com.loopj.android.http.AsyncHttpClient.4
                ...
                public void run() {
                    AsyncHttpClient.this.cancelRequests(list, z10);
                }
            });
            return;
        }
    ...
    public void setSSLSocketFactory(SSLSocketFactory sSLSocketFactory) {
        this.httpClient.getConnectionManager().getSchemeRegistry().register(new Scheme("https", sSLSocketFactory, (int) Constants.PORT));
    }
