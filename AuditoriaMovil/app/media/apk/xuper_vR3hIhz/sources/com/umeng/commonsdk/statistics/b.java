        ...
        try {
            ...
            if (!TextUtils.isEmpty(f11017i)) {
                ...
                if (resolutionArray != null) {
                    String a10 = a(bt.f10065z);
                    jSONObject2.put(a10, resolutionArray[1] + Operator.Operation.MULTIPLY + resolutionArray[0]);
                }
            ...
            try {
                ...
                String a11 = at.a(str2);
                String b11 = at.b(str2);
                jSONObject.put(bt.bf, a11);
                jSONObject.put(bt.bg, b11);
            } catch (Throwable unused17) {
            }
            byte[] a12 = ImprintHandler.getImprintService(context).a();
            if (a12 != null && a12.length > 0) {
                try {
                    jSONObject.put(a(bt.X), Base64.encodeToString(a12, 0));
