...
public class MessageSharedPrefs {
    ...
    public final void b(String str) {
        ...
        bdVar.a(str + bt.f10040ba);
        bd bdVar2 = this.f11344b;
        bdVar2.a(str + "ts");
    }
    ...
    */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:48:0x0115 -> B:62:0x0119). Please submit an issue!!! */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    public final boolean a(String str) {
        bd bdVar = this.f11344b;
        long b10 = bdVar.b(str + bt.f10040ba, 0L);
        if (b10 > 0) {
            bd bdVar2 = this.f11344b;
            StringBuilder sb = new StringBuilder();
            sb.append(str);
            sb.append("ts");
            return Math.abs(System.currentTimeMillis() - bdVar2.b(sb.toString(), 0L)) / 1000 >= b10;
        }
        return true;
    }
