...
public class q {
    ...
    private boolean s() {
        ...
        try {
            ...
            if (context != null && (sharedPreferences = PreferenceWrapper.getDefault(context)) != null) {
                if (sharedPreferences.getLong(f10497m, -1L) != 0) {
                    return true;
                }
                return false;
            }
        ...
        public void b() {
            ...
            if (!service.isOpen()) {
                ...
                if (!((reportStrategy instanceof ReportPolicy.DefconPolicy) && reportStrategy.isValid())) {
                    defconPolicy = new ReportPolicy.DefconPolicy(StatTracer.getInstance(q.f10495a), service);
                } else {
                    defconPolicy = this.f10548a;
                }
                this.f10548a = defconPolicy;
            }
            if (UMConfigure.isDebugLog()) {
                try {
    ...
    public long f() {
        ...
        try {
            ...
            long j10 = sharedPreferences.getLong(f10496l, 0L);
            if (j10 == 0) {
                try {
                    long currentTimeMillis = System.currentTimeMillis();
                    sharedPreferences.edit().putLong(f10496l, currentTimeMillis).commit();
    ...
    public JSONObject b(boolean z10) {
        ...
        try {
                        ...
                        while (i10 < jSONArray3.length()) {
                            ...
                            if (jSONObject2.has(f.f10338t)) {
                                ...
                                while (i13 < optJSONArray3.length()) {
                                    ...
                                    if (jSONObject4.has(f.f10342x)) {
                                        jSONArray2 = jSONArray3;
                                        jSONObject4.put("ts", jSONObject4.getLong(f.f10342x));
                                        jSONObject4.remove(f.f10342x);
                                    } else {
                                        jSONArray2 = jSONArray3;
                                    }
                                    i13++;
            ...
            if (a10 != null && !TextUtils.isEmpty(a10[0]) && !TextUtils.isEmpty(a10[1])) {
                ...
                jSONObject5.put(f.M, a10[0]);
                jSONObject5.put(f.N, a10[1]);
                if (jSONObject5.length() > 0) {
                    JSONObject jSONObject6 = new JSONObject();
                    String a11 = com.umeng.analytics.c.a();
                    if (a11 != null) {
                        jSONObject6.put(f.O, a11);
                    }
                    String b10 = com.umeng.analytics.c.b();
                    if (b10 != null) {
                        jSONObject6.put(f.P, b10);
                    }
                    Map<String, Object> c10 = com.umeng.analytics.c.c(f10495a);
                    if (c10 != null && c10.size() > 0) {
                        for (String str : c10.keySet()) {
                            jSONObject6.put(str, c10.get(str));
                        }
                    }
                    if (jSONObject6.length() > 0) {
                        jSONObject5.put(f.R, jSONObject6);
                    }
            ...
            if (ABTest.getService(f10495a).isInTest()) {
                ...
                jSONObject7.put(ABTest.getService(f10495a).getTestName(), ABTest.getService(f10495a).getGroupInfo());
    ...
    public void a(boolean z10) {
        if (c(z10)) {
            ...
            } else if (UMEnvelopeBuild.isReadyBuild(f10495a, UMLogDataProtocol.UMBusinessType.U_APP)) {
