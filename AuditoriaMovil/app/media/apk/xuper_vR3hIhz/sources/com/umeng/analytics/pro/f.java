...
public class f {
    ...
    public static final String f10317a = "appkey";
    ...
    public static final String f10318aa = "id";

    /* renamed from: ab  reason: collision with root package name */
    public static final String f10319ab = "ts";
    ...
    public static final String f10320b = "channel";

    /* renamed from: c  reason: collision with root package name */
    public static final String f10321c = "secret";

    /* renamed from: d  reason: collision with root package name */
    public static final String f10322d = "app_version";

    /* renamed from: e  reason: collision with root package name */
    public static final String f10323e = "version_code";

    /* renamed from: f  reason: collision with root package name */
    public static final String f10324f = "wrapper_type";

    /* renamed from: g  reason: collision with root package name */
    public static final String f10325g = "wrapper_version";

    /* renamed from: h  reason: collision with root package name */
    public static final String f10326h = "sdk_version";

    /* renamed from: i  reason: collision with root package name */
    public static final String f10327i = "vertical_type";

    /* renamed from: j  reason: collision with root package name */
    public static final String f10328j = "device_id";

    /* renamed from: k  reason: collision with root package name */
    public static final String f10329k = "device_model";

    /* renamed from: l  reason: collision with root package name */
    public static final String f10330l = "$pr_ve";

    /* renamed from: m  reason: collision with root package name */
    public static final String f10331m = "$ud_da";

    /* renamed from: n  reason: collision with root package name */
    public static final String f10332n = "sessions";

    /* renamed from: o  reason: collision with root package name */
    public static final String f10333o = "id";

    /* renamed from: p  reason: collision with root package name */
    public static final String f10334p = "start_time";

    /* renamed from: q  reason: collision with root package name */
    public static final String f10335q = "end_time";

    /* renamed from: r  reason: collision with root package name */
    public static final String f10336r = "duration";

    /* renamed from: s  reason: collision with root package name */
    public static final String f10337s = "duration_old";

    /* renamed from: t  reason: collision with root package name */
    public static final String f10338t = "pages";

    /* renamed from: u  reason: collision with root package name */
    public static final String f10339u = "autopages";

    /* renamed from: v  reason: collision with root package name */
    public static final String f10340v = "page_name";

    /* renamed from: w  reason: collision with root package name */
    public static final String f10341w = "duration";

    /* renamed from: x  reason: collision with root package name */
    public static final String f10342x = "page_start";

    /* renamed from: y  reason: collision with root package name */
    public static final String f10343y = "type";

    /* renamed from: z  reason: collision with root package name */
    public static final String f10344z = "$page_num";
    public static final String ar = bd.b().b(bd.f9993t);
    public static final String as = bd.b().b(bd.f9994u);
    ...
    public static final String[] aN = {ay, az, "_$!du", "_$!c", ae, "_$!sp", "event_name", ParamsMap.DeviceParams.KEY_AUTH_TOKEN, AgooConstants.MESSAGE_TIME, "ip", bt.O, "region", "city", "browser", "os", bt.F, "device_version", bt.ai, "screen_width", "screen_height", "referrer", "referrer_domain", "initial_referrer", "initial_referrer_domain", "initial_view_time", "search_engine", "keyword", "ali_lib", "utm_source", "utm_medium", DynamicLink.GoogleAnalyticsParameters.KEY_UTM_TERM, DynamicLink.GoogleAnalyticsParameters.KEY_UTM_CONTENT, "utm_campaign", "date", "hour", "minute", "app_version", "sp"};
}
