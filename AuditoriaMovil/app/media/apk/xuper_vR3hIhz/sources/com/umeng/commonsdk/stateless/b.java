        ...
        do {
            ...
            if (!TextUtils.isEmpty(pollFirst)) {
                ...
                if (!file.exists()) {
                    ...
                    if (com.umeng.commonsdk.vchannel.a.f11281c.equalsIgnoreCase(c10)) {
                        str2 = com.umeng.commonsdk.vchannel.a.f11279a;
                    } else {
                        str2 = com.umeng.commonsdk.stateless.a.f10984h;
                    }
            ...
            do {
                try {
                    ...
                    if (a10 != null && a10.getParentFile() != null && !TextUtils.isEmpty(a10.getParentFile().getName())) {
                        ...
                        if (!com.umeng.commonsdk.internal.a.f10883a.equalsIgnoreCase(str2) && !com.umeng.commonsdk.internal.a.f10884b.equalsIgnoreCase(str2) && !com.umeng.commonsdk.internal.a.H.equalsIgnoreCase(str2)) {
                            ...
                            if (com.umeng.commonsdk.vchannel.a.f11281c.equalsIgnoreCase(str2)) {
                                str = com.umeng.commonsdk.vchannel.a.f11279a;
                            } else {
                                str = com.umeng.commonsdk.stateless.a.f10984h;
                            }
