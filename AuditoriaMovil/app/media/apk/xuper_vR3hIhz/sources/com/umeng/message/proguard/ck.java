...
public final class ck {
    ...
    public final boolean g() {
        if (this.f11740b.optInt("h5_in_app", 1) == 1) {
            return true;
        }
        return false;
    }
    ...
    public final int h() {
        return Math.max((int) com.hpplay.a.a.a.d.SOCKET_READ_TIMEOUT, this.f11740b.optInt("imp_jg", com.hpplay.a.a.a.d.SOCKET_READ_TIMEOUT));
    }
