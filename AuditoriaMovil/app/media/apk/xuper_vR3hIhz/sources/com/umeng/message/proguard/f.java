...
public final class f {
    ...
    public static boolean c(Context context) {
        Boolean bool = null;
        try {
            bool = (Boolean) bn.a(bn.a(UTDevice.class.getName(), "isNewDid", Context.class), (Object) null, new Object[]{context});
        } catch (Throwable th) {
            UPLog.e("Helper", th);
        }
    ...
    public static String d(Context context) {
        try {
            return (String) bn.a(bn.a(UTDevice.class.getName(), "getTid", Context.class), (Object) null, new Object[]{context});
        } catch (Throwable th) {
            UPLog.e("Helper", th);
            return null;
        }
    ...
    public static void e(Context context) {
        try {
            bn.a(bn.a(UTDevice.class.getName(), "removeTid", Context.class), (Object) null, new Object[]{context});
        } catch (Throwable th) {
            UPLog.e("Helper", th);
        }
    }
    ...
    public static boolean b() {
        ...
        Boolean bool2 = null;
        try {
            bool2 = (Boolean) bn.a(bn.a(UMConfigure.class.getName(), "isSilentMode", new Class[0]), (Object) null, (Object[]) null);
        } catch (Throwable unused) {
        }
    ...
    public static void a(Context context, String str, long j10) {
        try {
            bn.a(bn.a(UTDevice.class.getName(), "resetDid", Context.class, String.class, Long.TYPE), (Object) null, new Object[]{context, str, Long.valueOf(j10)});
        } catch (Throwable th) {
            UPLog.e("Helper", th);
        }
    }
    ...
    public static void a(boolean z10) {
        f12083a = z10;
        try {
            bn.a(bn.a(UMConfigure.class.getName(), "enableAplCollection", Boolean.TYPE), (Object) null, new Object[]{Boolean.valueOf(z10)});
        } catch (Throwable unused) {
        }
    }
}
