...
public class UMessage {
    ...
    public boolean hasBackgroundImage() {
        if (!TextUtils.isEmpty(getBackgroundImageUrl())) {
            return true;
        }
        return false;
    }
    ...
    public boolean hasResourceFromInternet() {
        if (!isLargeIconFromInternet() && !isSoundFromInternet() && TextUtils.isEmpty(getBarImageUrl()) && TextUtils.isEmpty(getBigImage()) && !hasBackgroundImage()) {
            return false;
        }
        return true;
    }
    ...
    public boolean isSoundFromInternet() {
        if (!TextUtils.isEmpty(getSoundUri())) {
            if (getSoundUri().startsWith("http://") || getSoundUri().startsWith("https://")) {
                return true;
            }
            return false;
        }
