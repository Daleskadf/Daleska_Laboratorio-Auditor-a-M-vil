...
public class NativeJni {
    ...
    public class n implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            String res = ((RangerResult) m8.a.a().fromJson(NativeJni.this.a("GetVersion", "{}"), (Class<Object>) RangerResult.class)).getRes();
    ...
    public void e(int i10, String str, com.titan.ranger.b bVar) {
        ...
        Gson a11 = m8.a.a();
        Status status = (Status) a11.fromJson(((RangerResult) a11.fromJson(a10, (Class<Object>) RangerResult.class)).getRes(), (Class<Object>) Status.class);
        if (bVar != null) {
            bVar.a(status);
        }
    }
