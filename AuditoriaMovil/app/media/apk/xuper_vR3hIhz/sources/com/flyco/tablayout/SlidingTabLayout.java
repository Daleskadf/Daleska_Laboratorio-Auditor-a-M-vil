...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.j {
    ...
    private void calcIndicatorRect() {
        ...
        if (this.mIndicatorWidth >= 0.0f) {
            ...
            if (this.mCurrentTab < this.mTabCount - 1) {
                left3 += this.mCurrentPositionOffset * ((childAt.getWidth() / 2) + (this.mTabsContainer.getChildAt(i10 + 1).getWidth() / 2));
            }
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i10 = 0; i10 < this.mTabCount; i10++) {
            ...
            ArrayList<String> arrayList2 = this.mTitles;
            if (arrayList2 == null) {
                str = this.mViewPager.getAdapter().getPageTitle(i10);
            } else {
                str = arrayList2.get(i10);
            }
            addTab(i10, str.toString(), inflate);
        }
        updateTabStyles();
    }
    ...
    public void setMsgMargin(int i10, float f10, float f11) {
        ...
        if (msgView != null) {
            ...
            if (i13 > 0) {
                i11 = (((int) (i13 - descent)) / 2) - dp2px(f11);
            } else {
                i11 = 0;
            }
