...
public class SegmentTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (!isInEditMode() && this.mTabCount > 0) {
            ...
            Rect rect = this.mIndicatorRect;
            int i11 = ((int) this.mIndicatorMarginLeft) + paddingLeft + rect.left;
            float f12 = this.mIndicatorMarginTop;
            gradientDrawable.setBounds(i11, (int) f12, (int) ((paddingLeft + rect.right) - this.mIndicatorMarginRight), (int) (f12 + this.mIndicatorHeight));
    ...
    public void setMsgMargin(int i10, float f10, float f11) {
        ...
        if (msgView != null) {
            ...
            if (i12 > 0) {
                dp2px = (((int) (i12 - descent)) / 2) - dp2px(f11);
            } else {
                dp2px = dp2px(f11);
            }
