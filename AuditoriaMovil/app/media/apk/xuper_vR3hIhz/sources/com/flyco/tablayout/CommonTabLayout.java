...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attributeSet) {
        ...
        this.mIndicatorColor = obtainStyledAttributes.getColor(i12, Color.parseColor(str));
        ...
        this.mIndicatorHeight = obtainStyledAttributes.getDimension(i13, dp2px(f10));
        ...
        this.mIndicatorWidth = obtainStyledAttributes.getDimension(i15, dp2px(f11));
        ...
        this.mIndicatorCornerRadius = obtainStyledAttributes.getDimension(i16, dp2px(f12));
        ...
        this.mIndicatorMarginTop = obtainStyledAttributes.getDimension(i17, dp2px(f13));
        ...
        this.mIndicatorMarginBottom = obtainStyledAttributes.getDimension(i18, dp2px(f14));
        ...
        this.mTabPadding = obtainStyledAttributes.getDimension(i19, dp2px);
