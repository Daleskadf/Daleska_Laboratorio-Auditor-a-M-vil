    ...
    */
    ...
    public static class b {
        ...
        public static void c(Path path, float f10, float f11, float f12, float f13, float f14, float f15, float f16, boolean z10, boolean z11) {
            ...
            double d18 = f15;
            Double.isNaN(d18);
            double d19 = ((d17 * sin) + (d14 * cos)) / d18;
            double d20 = f12;
            Double.isNaN(d20);
            double d21 = f13;
            Double.isNaN(d21);
            Double.isNaN(d15);
            double d22 = ((d20 * cos) + (d21 * sin)) / d15;
            double d23 = -f12;
            Double.isNaN(d23);
            Double.isNaN(d21);
            Double.isNaN(d18);
            double d24 = ((d23 * sin) + (d21 * cos)) / d18;
            double d25 = d16 - d22;
            double d26 = d19 - d24;
            double d27 = (d16 + d22) / 2.0d;
            double d28 = (d19 + d24) / 2.0d;
            ...
            double d31 = d25 * sqrt2;
            double d32 = sqrt2 * d26;
            if (z10 == z11) {
                d10 = d27 - d32;
                d11 = d28 + d31;
            } else {
            ...
            double atan22 = Math.atan2(d24 - d11, d22 - d10) - atan2;
            if (atan22 >= 0.0d) {
                z12 = true;
            } else {
                z12 = false;
