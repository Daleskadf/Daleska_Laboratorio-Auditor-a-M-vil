...
public class x extends k3.b {
    ...
    public final boolean H0(Class cls, Class cls2) {
        if (cls.isPrimitive()) {
            ...
            return false;
        } else if (cls2.isPrimitive() && cls2 == d4.h.b0(cls)) {
            return true;
        } else {
            return false;
        }
    ...
    public final boolean I0(k3.j jVar, Class cls) {
        if (jVar.K()) {
            return jVar.y(d4.h.b0(cls));
        }
        if (!cls.isPrimitive() || cls != d4.h.b0(jVar.q())) {
            return false;
        }
        return true;
    }
    ...
    public k3.j u0(m3.m mVar, b bVar, k3.j jVar) {
        ...
        if (jVar.J()) {
            ...
            if (x04 != null && !I0(p10, x04)) {
                try {
                    jVar = ((c4.g) jVar).b0(z10.F(p10, x04));
                } catch (IllegalArgumentException e11) {
                    throw new k3.l((Closeable) null, String.format("Failed to narrow key type of %s with concrete-type annotation (value %s), from '%s': %s", jVar, x04.getName(), bVar.d(), e11.getMessage()), e11);
                }
            }
        }
        k3.j k10 = jVar.k();
        if (k10 != null) {
            if (cVar == null) {
                ...
                x03 = x0(cVar.contentAs());
            }
            if (x03 != null && !I0(k10, x03)) {
                try {
                    return jVar.R(z10.F(k10, x03));
                } catch (IllegalArgumentException e12) {
                    throw new k3.l((Closeable) null, String.format("Failed to narrow value type of %s with concrete-type annotation (value %s), from '%s': %s", jVar, x03.getName(), bVar.d(), e12.getMessage()), e12);
                }
            }
            return jVar;
        }
                ...
                if (p10.y(x04)) {
                    ...
                    try {
                        if (x04.isAssignableFrom(q11)) {
                            ...
                            throw new k3.l(null, String.format("Cannot refine serialization key type %s into %s; types not related", p10, x04.getName()));
                        }
                    } catch (IllegalArgumentException e11) {
                        throw new k3.l((Closeable) null, String.format("Failed to widen key type of %s with concrete-type annotation (value %s), from '%s': %s", jVar, x04.getName(), bVar.d(), e11.getMessage()), e11);
                    }
                }
                jVar = ((c4.g) jVar).b0(V2);
            }
        }
        k3.j k10 = jVar.k();
        if (k10 != null) {
                ...
                if (k10.y(x03)) {
                    ...
                    try {
                        if (x03.isAssignableFrom(q12)) {
                            ...
                            throw new k3.l(null, String.format("Cannot refine serialization content type %s into %s; types not related", k10, x03.getName()));
                        }
                    } catch (IllegalArgumentException e12) {
                        throw new k3.l((Closeable) null, String.format("Internal error: failed to refine value type of %s with concrete-type annotation (value %s), from '%s': %s", jVar, x03.getName(), bVar.d(), e12.getMessage()), e12);
                    }
                }
                return jVar.R(V);
            }
