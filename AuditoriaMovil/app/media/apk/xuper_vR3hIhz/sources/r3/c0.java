...
public class c0 {
    ...
    public b0 G() {
        ...
        if (B != null) {
            return this.f18361g.C(this.f18359e, B);
        }
        return B;
    }
    ...
    public void c(Map map) {
        ...
        if (!this.f18357c && !this.f18355a.D(k3.q.ALLOW_FINAL_FIELDS_AS_MUTATORS)) {
            z10 = true;
        } else {
            z10 = false;
        }
            ...
            if (bool.equals(bVar.l0(gVar))) {
                ...
                if (!equals && !equals2) {
                    ...
                    if (d10 != null) {
                        ...
                        if (!z10 || xVar != null || z14 || !Modifier.isFinal(gVar.r())) {
                            n(map, d10).W(gVar, xVar, z12, z15, z14);
                        }
                    }
                } else {
                    if (equals) {
    ...
    public void d(Map map, j jVar, k3.b bVar) {
        ...
        if (D != Void.TYPE) {
            if (D != Void.class || this.f18355a.D(k3.q.ALLOW_VOID_VALUED_PROPERTIES)) {
                ...
                if (bool.equals(bVar.h0(jVar))) {
                ...
                } else if (bool.equals(bVar.k0(this.f18355a, jVar))) {
                    if (this.f18371q == null) {
                        this.f18371q = new LinkedList();
                    }
                    ...
                    n(map, i(str)).X(jVar, xVar, z11, z12, bVar.o0(jVar));
                }
            }
        }
    }
    ...
    public void g(Map map, j jVar, k3.b bVar) {
        ...
        String i10 = i(str);
        n(map, i10).Y(jVar, xVar, z11, z12, bVar.o0(jVar));
    }
    ...
    public final String i(String str) {
        ...
        if (map != null && (xVar = (k3.x) map.get(m(str))) != null) {
            return xVar.c();
        }
        return str;
    }
    ...
    public void u(Map map) {
        ...
        if (W == null) {
            booleanValue = this.f18355a.E();
        } else {
            booleanValue = W.booleanValue();
        }
        boolean h10 = h(map.values());
        String[] V = bVar.V(this.f18359e);
        if (!booleanValue && !h10 && this.f18365k == null && V == null) {
            return;
        }
        int size = map.size();
        if (booleanValue) {
        ...
        if (V != null) {
            for (String str : V) {
                d0 d0Var2 = (d0) linkedHashMap.remove(str);
                if (d0Var2 == null) {
                    Iterator it = map.values().iterator();
                    while (true) {
                        if (!it.hasNext()) {
        ...
        if (h10) {
            ...
            for (d0 d0Var5 : treeMap.values()) {
                linkedHashMap2.put(d0Var5.getName(), d0Var5);
            }
        }
        if (this.f18365k != null && (!booleanValue || this.f18355a.D(k3.q.SORT_CREATOR_PROPERTIES_FIRST))) {
            if (booleanValue) {
            ...
            for (d0 d0Var7 : collection) {
                ...
                if (linkedHashMap.containsKey(name)) {
                    linkedHashMap2.put(name, d0Var7);
                }
            }
        }
