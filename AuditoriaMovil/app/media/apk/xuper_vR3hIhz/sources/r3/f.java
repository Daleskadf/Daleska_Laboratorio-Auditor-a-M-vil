...
public final class f extends u {
    ...
    public static c.a p(k3.b bVar, c4.o oVar, f0 f0Var, k3.j jVar, Class cls, boolean z10) {
        ...
        return new f(bVar, f0Var, z10 | z11).l(oVar, jVar, cls);
    }
    ...
    public c.a l(c4.o oVar, k3.j jVar, Class cls) {
        ...
        if (this.f18419e) {
            ...
            while (true) {
                ...
                if (size < 0) {
                    break;
                } else if (this.f18486a.o0((i) i10.get(size))) {
                    i10.remove(size);
                }
            }
            int size2 = j10.size();
            while (true) {
                ...
                if (size2 < 0) {
                    break;
                } else if (this.f18486a.o0((i) j10.get(size2))) {
                    j10.remove(size2);
                }
            }
        }
    ...
    public j r(Method method, f0 f0Var, Method method2) {
        ...
        return new j(f0Var, method, n10, o(parameterAnnotations2, parameterAnnotations));
    }
