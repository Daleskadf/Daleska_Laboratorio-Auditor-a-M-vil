...
public class w extends r3.a {
    ...
    public static class b extends a.AbstractC0314a {
        ...
        public r3.a a(m3.m mVar, r3.c cVar, k3.c cVar2) {
            ...
            return new w(mVar, cVar, str, this.f18497c, this.f18498d, null);
        }
    ...
    public static class c extends w {
        ...
        public String c(j jVar, String str) {
            if (this.f18499g.contains(str)) {
                return str;
            }
            return super.c(jVar, str);
        }
    }
    ...
    public String b(j jVar, String str) {
        ...
        if (str2 != null && str.startsWith(str2)) {
            if (this.f18491c) {
                return h(str, this.f18494f.length());
            }
            return g(str, this.f18494f.length());
        }
        return null;
    }
    ...
    public String c(j jVar, String str) {
        ...
        if (this.f18491c) {
            return h(str, this.f18492d.length());
        }
        return g(str, this.f18492d.length());
    }
