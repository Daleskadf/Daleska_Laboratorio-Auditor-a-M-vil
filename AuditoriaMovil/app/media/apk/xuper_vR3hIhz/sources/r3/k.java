...
public class k extends u {
            ...
            if (k(method)) {
                ...
                if (aVar == null) {
                    if (this.f18486a == null) {
                        ...
                        e10 = e(method.getDeclaredAnnotations());
                    }
                    map.put(yVar, new a(f0Var, method, e10));
                } else {
                    if (this.f18444e) {
    ...
    public void j(f0 f0Var, Class cls, Map map, Class cls2) {
        ...
        for (Class cls3 : d4.h.w(cls2, cls, true)) {
    ...
    public l l(c4.o oVar, f0 f0Var, k3.j jVar, List list, Class cls) {
        ...
        while (it.hasNext()) {
            ...
            i(new f0.a(oVar, jVar2.j()), jVar2.q(), linkedHashMap, a11);
        }
