...
public class a0 extends y {
    ...
    public boolean c() {
        ...
        if (!(drawable instanceof GradientDrawable) && !(drawable instanceof DrawableContainer) && !(drawable instanceof InsetDrawable) && !androidx.appcompat.widget.o.a(drawable)) {
            return false;
        }
        return true;
    }
