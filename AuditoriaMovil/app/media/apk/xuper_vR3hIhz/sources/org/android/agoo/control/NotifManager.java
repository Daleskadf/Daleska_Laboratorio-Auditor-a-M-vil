...
public class NotifManager {
    ...
    public void handlerACKMessage(MsgDO msgDO, TaoBaseService.ExtraInfo extraInfo) {
        ...
        if (TextUtils.isEmpty(msgDO.msgIds) && TextUtils.isEmpty(msgDO.removePacks) && TextUtils.isEmpty(msgDO.errorCode)) {
            ...
            String b10 = com.taobao.accs.utl.j.b(this.mContext);
            uTMini.commitEvent(AgooConstants.AGOO_EVENT_ID, ACK_MESSAGE, b10, "handlerACKMessageRetuen", "msgids=" + msgDO.msgIds + ",removePacks=" + msgDO.removePacks + ",errorCode=" + msgDO.errorCode);
            return;
        }
        try {
            HashMap hashMap = new HashMap();
