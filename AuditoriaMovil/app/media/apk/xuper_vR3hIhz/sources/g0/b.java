...
public class b {
                ...
                try {
                    ...
                    switch (this.f13541a) {
                        ...
                        case 6:
                            ...
                            String str2 = new String(bArr2, b.f13499o0);
                            try {
                                c0220b.close();
    ...
    static {
        d[] dVarArr;
        d[] dVarArr2 = {new d("NewSubfileType", 254, 4), new d("SubfileType", 255, 4), new d("ImageWidth", 256, 3, 4), new d("ImageLength", 257, 3, 4), new d("BitsPerSample", 258, 3), new d("Compression", 259, 3), new d("PhotometricInterpretation", 262, 3), new d("ImageDescription", 270, 2), new d("Make", 271, 2), new d("Model", 272, 2), new d("StripOffsets", 273, 3, 4), new d("Orientation", 274, 3), new d("SamplesPerPixel", 277, 3), new d("RowsPerStrip", 278, 3, 4), new d("StripByteCounts", 279, 3, 4), new d("XResolution", 282, 5), new d("YResolution", 283, 5), new d("PlanarConfiguration", 284, 3), new d("ResolutionUnit", 296, 3), new d("TransferFunction", 301, 3), new d("Software", com.umeng.ccg.c.f10692s, 2), new d("DateTime", 306, 2), new d("Artist", MediaError.DetailedErrorCode.HLS_NETWORK_INVALID_SEGMENT, 2), new d("WhitePoint", 318, 5), new d("PrimaryChromaticities", 319, 5), new d("SubIFDPointer", 330, 4), new d("JPEGInterchangeFormat", 513, 4), new d("JPEGInterchangeFormatLength", 514, 4), new d("YCbCrCoefficients", 529, 5), new d("YCbCrSubSampling", 530, 3), new d("YCbCrPositioning", 531, 3), new d("ReferenceBlackWhite", 532, 5), new d("Copyright", 33432, 2), new d("ExifIFDPointer", 34665, 4), new d("GPSInfoIFDPointer", 34853, 4), new d("SensorTopBorder", 4, 4), new d("SensorLeftBorder", 5, 4), new d("SensorBottomBorder", 6, 4), new d("SensorRightBorder", 7, 4), new d("ISO", 23, 3), new d("JpgFromRaw", 46, 7), new d("Xmp", 700, 1)};
        Y = dVarArr2;
        ...
        f13486b0 = dVarArr5;
        d[] dVarArr6 = {new d("NewSubfileType", 254, 4), new d("SubfileType", 255, 4), new d("ThumbnailImageWidth", 256, 3, 4), new d("ThumbnailImageLength", 257, 3, 4), new d("BitsPerSample", 258, 3), new d("Compression", 259, 3), new d("PhotometricInterpretation", 262, 3), new d("ImageDescription", 270, 2), new d("Make", 271, 2), new d("Model", 272, 2), new d("StripOffsets", 273, 3, 4), new d("ThumbnailOrientation", 274, 3), new d("SamplesPerPixel", 277, 3), new d("RowsPerStrip", 278, 3, 4), new d("StripByteCounts", 279, 3, 4), new d("XResolution", 282, 5), new d("YResolution", 283, 5), new d("PlanarConfiguration", 284, 3), new d("ResolutionUnit", 296, 3), new d("TransferFunction", 301, 3), new d("Software", com.umeng.ccg.c.f10692s, 2), new d("DateTime", 306, 2), new d("Artist", MediaError.DetailedErrorCode.HLS_NETWORK_INVALID_SEGMENT, 2), new d("WhitePoint", 318, 5), new d("PrimaryChromaticities", 319, 5), new d("SubIFDPointer", 330, 4), new d("JPEGInterchangeFormat", 513, 4), new d("JPEGInterchangeFormatLength", 514, 4), new d("YCbCrCoefficients", 529, 5), new d("YCbCrSubSampling", 530, 3), new d("YCbCrPositioning", 531, 3), new d("ReferenceBlackWhite", 532, 5), new d("Copyright", 33432, 2), new d("ExifIFDPointer", 34665, 4), new d("GPSInfoIFDPointer", 34853, 4), new d("DNGVersion", 50706, 1), new d("DefaultCropSize", 50720, 3, 4)};
        f13487c0 = dVarArr6;
        ...
        f13495k0 = new HashMap[dVarArr11.length];
        f13496l0 = new HashMap[dVarArr11.length];
        ...
        while (true) {
            ...
            if (i10 < dVarArr12.length) {
                ...
                d[] dVarArr13 = f13494j0;
                hashMap.put(Integer.valueOf(dVarArr13[0].f13545a), 5);
                hashMap.put(Integer.valueOf(dVarArr13[1].f13545a), 1);
                hashMap.put(Integer.valueOf(dVarArr13[2].f13545a), 2);
                hashMap.put(Integer.valueOf(dVarArr13[3].f13545a), 3);
                hashMap.put(Integer.valueOf(dVarArr13[4].f13545a), 7);
                hashMap.put(Integer.valueOf(dVarArr13[5].f13545a), 8);
    ...
    */
            ...
            if (d10 != null) {
                ...
                if (str.equals("GPSTimeStamp")) {
                    ...
                    if (eVarArr != null && eVarArr.length == 3) {
                        ...
                        e eVar2 = eVarArr[1];
                        e eVar3 = eVarArr[2];
                        return String.format("%02d:%02d:%02d", Integer.valueOf((int) (((float) eVar.f13549a) / ((float) eVar.f13550b))), Integer.valueOf((int) (((float) eVar2.f13549a) / ((float) eVar2.f13550b))), Integer.valueOf((int) (((float) eVar3.f13549a) / ((float) eVar3.f13550b))));
                    }
                    StringBuilder sb2 = new StringBuilder();
            ...
            try {
                try {
                    ...
                    if (str3 != null) {
                        ...
                        this.f13517f[0].put("Orientation", c.f(i10, this.f13519h));
                    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final void f(g0.b.C0220b r20, int r21, int r22) {
        /*
    ...
    public final boolean y(HashMap hashMap) {
        ...
        if (cVar2 != null) {
            ...
            if (this.f13515d == 3 && (cVar = (c) hashMap.get("PhotometricInterpretation")) != null) {
                int i10 = cVar.i(this.f13519h);
                if ((i10 == 1 && Arrays.equals(iArr, f13511z)) || (i10 == 6 && Arrays.equals(iArr, iArr2))) {
                    return true;
                }
                return false;
            }
