...
public class e {
    ...
    public int d() {
        ...
        if (this.f16486f > -1 && (eVar = this.f16484d) != null && eVar.f16482b.C() == 8) {
            return this.f16486f;
        }
        return this.f16485e;
    }
    ...
    public boolean l(e eVar) {
        ...
        d dVar = this.f16483c;
        if (j10 == dVar) {
            if (dVar == d.BASELINE && (!eVar.e().I() || !e().I())) {
                return false;
            }
            return true;
        }
        switch (a.f16491a[dVar.ordinal()]) {
            ...
            case 3:
                ...
                if (eVar.e() instanceof i) {
                    return (z10 || j10 == d.CENTER_X) ? true : true;
                }
                return z10;
            case 4:
            case 5:
                ...
                if (eVar.e() instanceof i) {
                    return (z11 || j10 == d.CENTER_Y) ? true : true;
                }
                return z11;
            case 6:
            case 7:
