...
public class g extends MenuInflater {
    ...
    public class b {
        ...
        public void g(AttributeSet attributeSet) {
            ...
            if (z10 && this.f13471w == 0 && this.f13472x == null) {
        ...
        public final void i(MenuItem menuItem) {
            boolean z10;
            MenuItem enabled = menuItem.setChecked(this.f13467s).setVisible(this.f13468t).setEnabled(this.f13469u);
            boolean z11 = false;
            if (this.f13466r >= 1) {
                z10 = true;
            } else {
            ...
            enabled.setCheckable(z10).setTitleCondensed(this.f13460l).setIcon(this.f13461m);
            ...
            boolean z12 = menuItem instanceof androidx.appcompat.view.menu.i;
            if (z12) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:47:0x00a3, code lost:
        if (r15.equals(com.hpplay.component.protocol.PlistBuilder.KEY_ITEM) == false) goto L53;
     */
