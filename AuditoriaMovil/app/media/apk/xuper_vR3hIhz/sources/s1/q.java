...
public final class q {
    ...
    public final void c() {
        ...
        List<ReportWrapperBean> list = f18729c;
        f18729c = new ArrayList();
        for (ReportWrapperBean reportWrapperBean : list) {
            f18727a.k(reportWrapperBean);
        }
    }
    ...
    public final void h(Context context, String str, String str2, AdInfo adInfo) {
        ...
        int b10 = y1.f.f19726a.b(context);
        if (str == null) {
            str3 = "unknown";
        } else {
            str3 = str;
        }
        k(new ReportWrapperBean(true, elapsedRealtime, packageName, b10, str3, str2, adInfo, 0L, 128, null));
    }
    ...
    public final void j(Context context, String str, String str2, AdInfo adInfo) {
        ...
        k(new ReportWrapperBean(false, elapsedRealtime, packageName, b10, str3, str2, adInfo, 0L, 128, null));
    }
    ...
    public final void m(Context context, String str, String str2, AdInfo adInfo) {
        ...
        k(new ReportWrapperBean(true, elapsedRealtime, packageName, b10, str3, str, adInfo, 0L, 128, null));
    }
}
