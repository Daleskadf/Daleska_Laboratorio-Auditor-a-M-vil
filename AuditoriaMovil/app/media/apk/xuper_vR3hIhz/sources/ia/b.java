...
public final class b implements Converter {
    ...
    public Object convert(ResponseBody responseBody) {
        ...
        try {
            if (i.h()) {
                EncryptJsonBean encryptJsonBean = (EncryptJsonBean) this.f14408b.fromJson(string, (Class<Object>) EncryptJsonBean.class);
                String a10 = i.a(encryptJsonBean.getData(), this.f14411e);
                return this.f14408b.fromJson(string.replace("\"" + encryptJsonBean.getData() + "\"", a10), this.f14410d);
            }
