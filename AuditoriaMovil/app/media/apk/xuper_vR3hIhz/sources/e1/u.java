...
public class u {
    ...
    public u(Context context) {
        this.f12851a = new ComponentName(context.getApplicationContext(), SystemJobService.class);
    }
    ...
    public JobInfo a(j1.p pVar, int i10) {
        ...
        boolean z10 = false;
        if (!bVar.h()) {
            if (pVar.f14594l == a1.a.LINEAR) {
                i11 = 0;
            } else {
                i11 = 1;
            }
            extras.setBackoffCriteria(pVar.f14595m, i11);
        }
