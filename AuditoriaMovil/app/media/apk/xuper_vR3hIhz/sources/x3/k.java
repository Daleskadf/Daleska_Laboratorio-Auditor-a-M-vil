...
public class k extends r {
    ...
    public String g(Object obj, Class cls, c4.o oVar) {
        ...
        if (name.startsWith("java.util.")) {
            if (obj instanceof EnumSet) {
                return oVar.y(EnumSet.class, d4.h.u((EnumSet) obj)).c();
            }
            if (obj instanceof EnumMap) {
                return oVar.C(EnumMap.class, d4.h.t((EnumMap) obj), Object.class).c();
            }
            return name;
        } else if (name.indexOf(36) >= 0 && d4.h.E(cls) != null && d4.h.E(this.f19449b.q()) == null) {
            return this.f19449b.q().getName();
        } else {
            return name;
        }
    }
    ...
    public k3.j h(String str, k3.e eVar) {
        ...
        if (r10 == null && (eVar instanceof k3.g)) {
            return ((k3.g) eVar).f0(this.f19449b, str, this, "no such class found");
        }
        return r10;
    }
}
