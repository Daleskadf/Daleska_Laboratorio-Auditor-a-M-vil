    ...
    public void run() {
        ...
        if (currentTimeMillis < this.f3996b - 1000) {
            ...
            if (ALog.isPrintLog(1)) {
                ...
                ALog.d("awcn.DefaultHeartbeatImpl", "heartbeat", session.f3827p, "session", session);
            }
            this.f3995a.ping(true);
            a(this.f3998d);
        } else {
            Session session2 = this.f3995a;
            ALog.e("awcn.DefaultHeartbeatImpl", "close session in background", session2.f3827p, "session", session2);
