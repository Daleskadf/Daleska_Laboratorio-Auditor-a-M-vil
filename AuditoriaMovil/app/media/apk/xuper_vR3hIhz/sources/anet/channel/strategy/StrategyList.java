...
class StrategyList implements Serializable {
    ...
    public void update(l.b bVar) {
        int i10;
        for (IPConnStrategy iPConnStrategy : this.f4164a) {
            iPConnStrategy.f4146c = true;
        }
        int i11 = 0;
        for (int i12 = 0; i12 < bVar.f4229h.length; i12++) {
            int i13 = 0;
            while (true) {
                ...
                a(strArr[i13], 1, bVar.f4229h[i12]);
                i13++;
            }
            if (bVar.f4228g != null) {
                this.f4166c = true;
                ...
                while (true) {
                    ...
                    if (i14 < strArr2.length) {
                        a(strArr2[i14], 0, bVar.f4229h[i12]);
                        i14++;
                    }
                }
            } else {
        ...
        if (bVar.f4230i != null) {
            while (true) {
                ...
                if (anet.channel.strategy.utils.d.c(str)) {
                    i10 = -1;
                } else {
                    i10 = 1;
                }
                a(str, i10, eVar.f4245b);
                i11++;
            }
        }
