...
public class SessionCenter {
    ...
    public static void checkAndStartAccsSession() {
        for (SessionCenter sessionCenter : f3838a.values()) {
            sessionCenter.f3846h.checkAndStartSession();
        }
    }
        ...
        if (!f3839j) {
            ...
            if (sessionGetCallback != null) {
                ...
                if (a11 != null) {
                    ...
                    return;
                } else if (this.f3842d == Config.DEFAULT_CONFIG && i10 != anet.channel.entity.c.f3973b) {
                    sessionGetCallback.onSessionGetFail();
                    return;
                } else if (GlobalAppRuntimeInfo.isAppBackground() && i10 == anet.channel.entity.c.f3972a && AwcnConfig.isAccsSessionCreateForbiddenInBg() && (b10 = this.f3845g.b(httpUrl.host())) != null && b10.isAccs) {
            ...
            if (!session.getConnType().isHttpType()) {
                ...
                while (true) {
                    if (i10 >= strArr.length) {
                        z10 = false;
                        break;
                    } else if (session.getIp().equals(strArr[i10])) {
                        z10 = true;
                        break;
                    } else {
                        i10++;
                ...
                if (z10) {
                    ...
                    while (true) {
                        if (i11 >= aVarArr.length) {
                            z11 = false;
                            break;
                        } else if (session.getPort() == aVarArr[i11].f4214a && session.getConnType().equals(ConnType.valueOf(ConnProtocol.valueOf(aVarArr[i11])))) {
                            z11 = true;
                            break;
                        } else {
                            i11++;
