...
public class c extends n {
    ...
    public boolean E(x xVar) {
        ...
        if (xVar.f(this.f184c.getValue()) && !xVar.d()) {
            return true;
        }
        return false;
    }
    ...
    public k3.o h(b4.k kVar, Class cls, c0 c0Var) {
        ...
        if (jVar != null) {
            e10 = kVar.f(c0Var.A(jVar, cls), c0Var, this);
        } else {
            e10 = kVar.e(cls, c0Var, this);
        }
        b4.k kVar2 = e10.f4620b;
        if (kVar != kVar2) {
            this.f196o = kVar2;
        }
        return e10.f4619a;
    ...
    public void n(z3.r rVar, c0 c0Var) {
        ...
        if (r10 instanceof v3.c) {
            a10 = ((v3.c) r10).getSchema(c0Var, q10, z10);
        } else {
            a10 = v3.a.a();
        }
        g(rVar, a10);
    ...
    public c w(d4.q qVar) {
        ...
        if (c10.equals(this.f184c.toString())) {
            return this;
        }
        return j(x.a(c10));
    }
