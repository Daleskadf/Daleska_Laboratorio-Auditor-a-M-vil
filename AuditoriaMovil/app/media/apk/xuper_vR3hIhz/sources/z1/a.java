...
public final class a {
    ...
    public static final class C0351a implements b {
        ...
        public void a(d dVar, g2.a aVar) {
            ...
            if (aVar.d() && !TextUtils.isEmpty(aVar.b())) {
                try {
                    ServerTime serverTime = (ServerTime) new Gson().fromJson(aVar.b(), (Class<Object>) ServerTime.class);
                    if (serverTime != null) {
    ...
    public final void a(Dns dns, Interceptor interceptor) {
        ...
        i2.a.f14261a.k(true);
        e2.a.f12853b.a().c(new f2.a().i(str + b2.a.f4466e + b2.a.f4464c + b2.a.f4463b, str + b2.a.f4467f + b2.a.f4464c + b2.a.f4463b).h(e.GET).b(dns).f(interceptor).a(new C0351a()));
    }
}
