...
public class h extends b {
    ...
    public final char[] L0() {
        char[] cArr = {ASCIIPropertyListParser.QUOTEDSTRING_ESCAPE_TOKEN, 0, ASCIIPropertyListParser.QUOTEDSTRING_ESCAPE_TOKEN, 'u', '0', '0', 0, 0, ASCIIPropertyListParser.QUOTEDSTRING_ESCAPE_TOKEN, 'u'};
        this.f13627x = cArr;
        return cArr;
    }
    ...
    public final int O0(char[] cArr, int i10, int i11, char c10, int i12) {
        ...
        if (i12 >= 0) {
            ...
            if (i10 > 5 && i10 < i11) {
                int i15 = i10 - 6;
                int i16 = i15 + 1;
                cArr[i15] = ASCIIPropertyListParser.QUOTEDSTRING_ESCAPE_TOKEN;
                int i17 = i16 + 1;
                cArr[i16] = 'u';
                if (c10 > 255) {
                    int i18 = (c10 >> '\b') & 255;
                ...
                int i21 = i13 + 1;
                char[] cArr4 = A;
                cArr[i13] = cArr4[c10 >> 4];
                cArr[i21] = cArr4[c10 & 15];
                return i21 - 5;
            }
            char[] cArr5 = this.f13627x;
            if (cArr5 == null) {
                cArr5 = L0();
            }
            ...
            if (c10 > 255) {
                ...
                this.f13621r.write(cArr5, 8, 6);
                return i10;
            }
            char[] cArr7 = A;
            cArr5[6] = cArr7[c10 >> 4];
            cArr5[7] = cArr7[c10 & 15];
            this.f13621r.write(cArr5, 2, 6);
            return i10;
        } else {
            q qVar = this.f13628y;
            qVar.getClass();
            ...
            if (i10 >= length && i10 < i11) {
                int i24 = i10 - length;
                value.getChars(0, length, cArr, i24);
                return i24;
            }
            this.f13621r.write(value);
            return i10;
    ...
    public final void P0(char c10, int i10) {
        ...
        if (i10 >= 0) {
            ...
            if (c10 > 255) {
                ...
                cArr6[12] = cArr7[i22 >> 4];
                cArr6[13] = cArr7[i22 & 15];
                this.f13621r.write(cArr6, 8, 6);
                return;
            }
            char[] cArr8 = A;
            cArr6[6] = cArr8[c10 >> 4];
            cArr6[7] = cArr8[c10 & 15];
            this.f13621r.write(cArr6, 2, 6);
        } else {
            q qVar = this.f13628y;
            qVar.getClass();
            String value = qVar.getValue();
            this.f13628y = null;
            int length = value.length();
            int i23 = this.f13625v;
            if (i23 >= length) {
                int i24 = i23 - length;
                this.f13624u = i24;
                value.getChars(0, length, this.f13623t, i24);
                return;
            }
            this.f13624u = i23;
            this.f13621r.write(value);
    ...
    public final int S0(c3.a aVar, InputStream inputStream, byte[] bArr) {
        ...
        while (true) {
            ...
            i13 = i17 + 1;
            i15 += 3;
            int k10 = aVar.k((((bArr[i16] & UnsignedBytes.MAX_VALUE) | (bArr[i13] << 8)) << 8) | (bArr[i17] & UnsignedBytes.MAX_VALUE), this.f13623t, this.f13625v);
            this.f13625v = k10;
            p10--;
            if (p10 <= 0) {
                char[] cArr = this.f13623t;
        ...
        if (i14 > 0) {
            ...
            int i20 = i15 + i11;
            this.f13625v = aVar.n(i19, i11, this.f13623t, this.f13625v);
            return i20;
        }
        return i15;
    }
    ...
    public final int T0(c3.a aVar, InputStream inputStream, byte[] bArr, int i10) {
        ...
        while (true) {
            ...
            i14 = i17 + 1;
            i10 -= 3;
            int k10 = aVar.k((((bArr[i16] & UnsignedBytes.MAX_VALUE) | (bArr[i14] << 8)) << 8) | (bArr[i17] & UnsignedBytes.MAX_VALUE), this.f13623t, this.f13625v);
            this.f13625v = k10;
            p10--;
            if (p10 <= 0) {
                char[] cArr = this.f13623t;
        ...
        if (i10 > 0 && (Q0 = Q0(inputStream, bArr, i14, i15, i10)) > 0) {
            ...
            this.f13625v = aVar.n(i19, i12, this.f13623t, this.f13625v);
            return i10 - i12;
        }
        return i10;
    }
    ...
    public final void U0(c3.a aVar, byte[] bArr, int i10, int i11) {
        ...
        while (i10 <= i12) {
            ...
            int i15 = i14 + 1;
            int i16 = i15 + 1;
            int k10 = aVar.k((((bArr[i10] << 8) | (bArr[i14] & UnsignedBytes.MAX_VALUE)) << 8) | (bArr[i15] & UnsignedBytes.MAX_VALUE), this.f13623t, this.f13625v);
            this.f13625v = k10;
            p10--;
            if (p10 <= 0) {
                char[] cArr = this.f13623t;
        ...
        if (i18 > 0) {
            ...
            this.f13625v = aVar.n(i20, i18, this.f13623t, this.f13625v);
        }
    }
