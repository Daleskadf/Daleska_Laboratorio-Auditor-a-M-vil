...
public class IjkMediaFormat implements IMediaFormat {
    ...
    public static final String KEY_IJK_CHANNELS_UI = "ijk-channels-ui";
    ...
    public IjkMediaFormat(IjkMediaMeta.IjkStreamMeta ijkStreamMeta) {
        ...
        map.put(KEY_IJK_CHANNELS_UI, new Formatter() { // from class: tv.danmaku.ijk.media.player.misc.IjkMediaFormat.9
            @Override // tv.danmaku.ijk.media.player.misc.IjkMediaFormat.Formatter
            public String doFormat(IjkMediaFormat ijkMediaFormat) {
                int integer = ijkMediaFormat.getInteger(IjkMediaMeta.IJKM_KEY_CHANNELS);
                if (integer <= 0) {
                    return null;
                }
                return String.format(Locale.US, "%d", Integer.valueOf(integer));
            }
        });
        map.put(KEY_IJK_CHANNEL_UI, new Formatter() { // from class: tv.danmaku.ijk.media.player.misc.IjkMediaFormat.10
            @Override // tv.danmaku.ijk.media.player.misc.IjkMediaFormat.Formatter
            public String doFormat(IjkMediaFormat ijkMediaFormat) {
