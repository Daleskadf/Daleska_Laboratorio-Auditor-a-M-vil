...
public class h extends a4.h implements a4.i {
    ...
    public k3.o b(c0 c0Var, k3.d dVar) {
        ...
        if (oVar2 == null) {
            i02 = c0Var.J(this.f4596d, dVar);
        } else {
            i02 = c0Var.i0(oVar2, dVar);
        }
        k3.o oVar4 = i02;
        ...
        return m(dVar, oVar4, oVar3, obj, z10);
    }
    ...
    public void j(Map.Entry entry, c3.h hVar, c0 c0Var) {
        ...
        if (key == null) {
            oVar = c0Var.K(this.f4596d, this.f4593a);
        } else {
            oVar = this.f4598f;
        }
        Object value = entry.getValue();
        if (value == null) {
            ...
            if (oVar2 == null) {
                ...
                if (j10 == null) {
                    if (this.f4597e.w()) {
                        oVar2 = f(this.f4601i, c0Var.A(this.f4597e, cls), c0Var);
                    } else {
                        oVar2 = e(this.f4601i, cls, c0Var);
                    }
                } else {
                    oVar2 = j10;
                }
            ...
            Object obj = this.f4602j;
            if (obj != null && ((obj == f4592l && oVar2.isEmpty(c0Var, value)) || this.f4602j.equals(value))) {
                return;
            }
        }
    ...
    public h l(Object obj, boolean z10) {
        if (this.f4602j == obj && this.f4603k == z10) {
            return this;
        }
        return new h(this, this.f4593a, this.f4600h, this.f4598f, this.f4599g, obj, z10);
    }
