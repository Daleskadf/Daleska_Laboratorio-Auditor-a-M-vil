...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public static final class UnsafeCursor implements Closeable {
        ...
        public final int next() {
            ...
            if (j10 != this.buffer.size) {
                ...
                return seek(j10 + (this.end - this.start));
            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:47:0x00b1 A[EDGE_INSN: B:47:0x00b1->B:39:0x00b1 ?: BREAK  , SYNTHETIC] */
    @Override // okio.BufferedSource
    /*
    ...
    */
    ...
    public long readLong() {
        ...
        if (j10 >= 8) {
            ...
            int i18 = i17 + 1;
            int i19 = i18 + 1;
            long j12 = j11 | ((bArr[i10] & 255) << 56) | ((bArr[i13] & 255) << 40) | ((bArr[i14] & 255) << 32) | ((bArr[i15] & 255) << 24) | ((bArr[i16] & 255) << 16) | ((bArr[i17] & 255) << 8) | (bArr[i18] & 255);
            this.size = j10 - 8;
            if (i19 == i11) {
                this.head = segment.pop();
                SegmentPool.recycle(segment);
