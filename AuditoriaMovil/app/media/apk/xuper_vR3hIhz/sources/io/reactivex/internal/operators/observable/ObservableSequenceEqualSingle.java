    ...
    public static final class EqualCoordinator<T> extends AtomicInteger implements Disposable {
        ...
        public void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (this.f14506v1 == null) {
                    this.f14506v1 = spscLinkedArrayQueue.poll();
                }
                if (this.f14506v1 == null) {
                    z10 = true;
                } else {
                ...
                if (this.f14507v2 == null) {
                    this.f14507v2 = spscLinkedArrayQueue2.poll();
                }
                T t10 = this.f14507v2;
                if (t10 == null) {
                    z11 = true;
                ...
                if (z12 && z13 && z10 && z11) {
                    ...
                    if (!z10 && !z11) {
                        try {
                            if (!this.comparer.test((T) this.f14506v1, t10)) {
                                cancel(spscLinkedArrayQueue, spscLinkedArrayQueue2);
                                this.downstream.onSuccess(Boolean.FALSE);
                                return;
                            }
