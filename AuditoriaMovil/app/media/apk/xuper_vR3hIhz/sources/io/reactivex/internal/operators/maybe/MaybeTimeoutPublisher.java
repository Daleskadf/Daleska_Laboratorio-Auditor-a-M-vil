...
public final class MaybeTimeoutPublisher<T, U> extends AbstractMaybeWithUpstream<T, T> {
    ...
    /* loaded from: classes3.dex */
    public static final class TimeoutOtherMaybeObserver<T, U> extends AtomicReference<d> implements FlowableSubscriber<Object> {
        private static final long serialVersionUID = 8663801314800248617L;
    ...
    public MaybeTimeoutPublisher(MaybeSource<T> maybeSource, b bVar, MaybeSource<? extends T> maybeSource2) {
        super(maybeSource);
        this.other = bVar;
