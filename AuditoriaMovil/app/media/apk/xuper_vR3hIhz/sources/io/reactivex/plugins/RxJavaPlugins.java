...
public final class RxJavaPlugins {
    ...
    @NonNull
    public static <T, R> R apply(@NonNull Function<T, R> function, @NonNull T t10) {
        try {
    ...
    @NonNull
    public static <T> c onSubscribe(@NonNull Flowable<T> flowable, @NonNull c cVar) {
        BiFunction<? super Flowable, ? super c, ? extends c> biFunction = onFlowableSubscribe;
        return biFunction != null ? (c) apply(biFunction, flowable, cVar) : cVar;
    }
    ...
    public static void setOnFlowableSubscribe(@Nullable BiFunction<? super Flowable, ? super c, ? extends c> biFunction) {
        if (!lockdown) {
    ...
    @NonNull
    public static <T, U, R> R apply(@NonNull BiFunction<T, U, R> biFunction, @NonNull T t10, @NonNull U u10) {
        try {
