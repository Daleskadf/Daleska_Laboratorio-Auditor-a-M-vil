...
public class DefaultJweHeader extends DefaultProtectedHeader implements JweHeader {
    ...
    public static boolean isCandidate(ParameterMap parameterMap) {
        String str = (String) parameterMap.get((Parameter<Object>) DefaultHeader.ALGORITHM);
        if (Strings.hasText(str) && !str.equalsIgnoreCase(Jwts.SIG.NONE.getId()) && Strings.hasText((String) parameterMap.get((Parameter<Object>) ENCRYPTION_ALGORITHM))) {
            return true;
        }
        return false;
    }
    ...
    public byte[] getAgreementPartyUInfo() {
        return (byte[]) get((Parameter<Object>) APU);
    }

    @Override // io.jsonwebtoken.JweHeader
    public byte[] getAgreementPartyVInfo() {
        return (byte[]) get((Parameter<Object>) APV);
    }

    @Override // io.jsonwebtoken.JweHeader
    public byte[] getAuthenticationTag() {
        return (byte[]) get((Parameter<Object>) TAG);
    }

    @Override // io.jsonwebtoken.JweHeader
    public String getEncryptionAlgorithm() {
        return (String) get((Parameter<Object>) ENCRYPTION_ALGORITHM);
    }

    @Override // io.jsonwebtoken.JweHeader
    public PublicJwk<?> getEphemeralPublicKey() {
        return (PublicJwk) get((Parameter<Object>) EPK);
    }

    @Override // io.jsonwebtoken.JweHeader
    public byte[] getInitializationVector() {
        return (byte[]) get((Parameter<Object>) IV);
    }
    ...
    public Integer getPbes2Count() {
        return (Integer) get((Parameter<Object>) P2C);
    }

    @Override // io.jsonwebtoken.JweHeader
    public byte[] getPbes2Salt() {
        return (byte[]) get((Parameter<Object>) P2S);
    }
}
