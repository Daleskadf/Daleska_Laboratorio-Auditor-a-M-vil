...
public final class EcSignatureAlgorithm extends AbstractSignatureAlgorithm {
    ...
    private static byte[] concatToDER(byte[] bArr) {
        ...
        if (i16 <= 255) {
            int i17 = 1;
            if (i16 < 128) {
                bArr2 = new byte[i10 + 4 + 2 + i11];
            } else {
                bArr2 = new byte[i10 + 5 + 2 + i11];
                bArr2[1] = -127;
                i17 = 2;
            }
            bArr2[0] = 48;
            ...
            bArr2[i19] = (byte) i10;
            int i20 = i19 + 1 + i10;
            System.arraycopy(bArr, i13, bArr2, i20 - i12, i12);
            int i21 = i20 + 1;
            bArr2[i20] = 2;
            bArr2[i21] = (byte) i11;
            System.arraycopy(bArr, i15, bArr2, ((i21 + 1) + i11) - i14, i14);
            return bArr2;
        }
        ...
        return ((Boolean) jca(verifySecureDigestRequest).withSignature(new CheckedFunction<Signature, Boolean>() { // from class: io.jsonwebtoken.impl.security.EcSignatureAlgorithm.2
            ...
            public Boolean apply(Signature signature) {
                ...
                try {
                    ...
                    } else if (!EcSignatureAlgorithm.this.isValidRAndS(key, digest)) {
