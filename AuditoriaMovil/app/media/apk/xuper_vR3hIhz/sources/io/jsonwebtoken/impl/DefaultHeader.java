...
public class DefaultHeader extends ParameterMap implements Header {
    ...
    static {
        ...
        PARAMS = Parameters.registry(string, parameter, string2, string3, string4);
    }
    ...
    public String getAlgorithm() {
        return (String) get((Parameter<Object>) ALGORITHM);
    }

    @Override // io.jsonwebtoken.Header
    public String getCompressionAlgorithm() {
        String str = (String) get((Parameter<Object>) COMPRESSION_ALGORITHM);
        if (!Strings.hasText(str)) {
            return (String) get((Parameter<Object>) DEPRECATED_COMPRESSION_ALGORITHM);
        }
        return str;
    }
    ...
    public String getContentType() {
        return (String) get((Parameter<Object>) CONTENT_TYPE);
    }
    ...
    public String getType() {
        return (String) get((Parameter<Object>) TYPE);
    }
