...
class DefaultRsaPublicJwk extends AbstractPublicJwk<RSAPublicKey> implements RsaPublicJwk {
    ...
    public static boolean equalsPublic(ParameterReadable parameterReadable, Object obj) {
        if (Parameters.equals(parameterReadable, obj, (Parameter) MODULUS) && Parameters.equals(parameterReadable, obj, (Parameter) PUBLIC_EXPONENT)) {
            return true;
        }
        return false;
    }
    ...
    public boolean equals(PublicJwk<?> publicJwk) {
        if ((publicJwk instanceof RsaPublicJwk) && equalsPublic(this, publicJwk)) {
            return true;
        }
        return false;
    }
