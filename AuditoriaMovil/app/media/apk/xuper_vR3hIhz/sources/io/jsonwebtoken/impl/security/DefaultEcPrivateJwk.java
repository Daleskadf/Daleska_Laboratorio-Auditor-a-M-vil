...
class DefaultEcPrivateJwk extends AbstractPrivateJwk<ECPrivateKey, ECPublicKey, EcPublicJwk> implements EcPrivateJwk {
    ...
    public boolean equals(PrivateJwk<?, ?, ?> privateJwk) {
        if ((privateJwk instanceof EcPrivateJwk) && DefaultEcPublicJwk.equalsPublic(this, privateJwk) && Parameters.equals((ParameterReadable) this, (Object) privateJwk, (Parameter) D)) {
            return true;
        }
        return false;
    }
