...
public class DefaultJweHeaderMutator<T extends JweHeaderMutator<T>> extends DelegatingMapMutator<String, Object, ParameterMap, T> implements JweHeaderMutator<T> {
    ...
    public NestedCollection<String, T> critical() {
        return new DefaultNestedCollection<String, T>((JweHeaderMutator) self(), (Collection) ((ParameterMap) this.DELEGATE).get((Parameter<Object>) DefaultProtectedHeader.CRIT)) { // from class: io.jsonwebtoken.impl.DefaultJweHeaderMutator.1
