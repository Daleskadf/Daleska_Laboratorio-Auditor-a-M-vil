...
class DispatchingJwkFactory implements JwkFactory<Key, Jwk<Key>> {
    ...
    /* JADX WARN: Type inference failed for: r6v2, types: [io.jsonwebtoken.security.Jwk<java.security.Key>, io.jsonwebtoken.security.Jwk] */
    ...
    */
    public io.jsonwebtoken.impl.security.JwkContext<java.security.Key> newContext(io.jsonwebtoken.impl.security.JwkContext<?> r5, java.security.Key r6) {
        ...
        L12:
            ...
            boolean r3 = r2.supports(r6)
            if (r3 != 0) goto L2a
            boolean r3 = r2.supports(r5)
            if (r3 == 0) goto L12
        L2a:
