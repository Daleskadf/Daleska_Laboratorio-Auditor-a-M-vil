...
public abstract class AbstractJwk<K extends Key> implements Jwk<K>, ParameterReadable, Nameable {
    ...
    private int computeHashCode() {
        ...
        while (it.hasNext()) {
            arrayList.add(Assert.notNull(get((Parameter<Object>) it.next()), "computeHashCode: Parameter idiomatic value cannot be null."));
        }
    ...
    public <T> T get(Parameter<T> parameter) {
        return (T) this.context.get((Parameter<Object>) parameter);
    }
}
