...
public class XMPContentHandler extends SafeContentHandler {
    ...
    private void description(Metadata metadata, String str, String str2) {
        ...
        for (Property property : Property.getProperties(str)) {
            ...
            if (str3 != null) {
                int i8 = i7 + 1;
                if (i7 == 0) {
                    startDescription(StringUtils.EMPTY, str, str2);
                }
    ...
    public void property(String str, String str2) {
        String A7 = AbstractC0059i.A(this.prefix, TikaCoreProperties.NAMESPACE_PREFIX_DELIMITER, str);
        startElement(this.uri, str, A7, EMPTY_ATTRIBUTES);
        characters(str2.toCharArray(), 0, str2.length());
        endElement(this.uri, str, A7);
    }
