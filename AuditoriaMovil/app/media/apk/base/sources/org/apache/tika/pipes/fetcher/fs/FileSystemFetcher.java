...
public class FileSystemFetcher extends AbstractFetcher implements Initializable {
    ...
    private void updateFileSystemMetadata(Path path, Metadata metadata) {
        ...
        if (this.extractFileSystemMetadata) {
            readAttributes = Files.readAttributes(path, com.dexterous.flutterlocalnotifications.b.k(), new LinkOption[0]);
    ...
    public void checkInitialization(InitializableProblemHandler initializableProblemHandler) {
        ...
        if (path6 != null) {
            ...
            int i7 = 0;
            while (i7 < length) {
                int codePointAt = path.codePointAt(i7);
        ...
        LOG.l("'basePath' has not been set. This means that client code or clients can read from any file that this process has permissions to read. If you are running tika-server, make absolutely certain that you've locked down access to tika-server and file-permissions for the tika-server process.");
    }
    ...
    @Field
    public void setExtractFileSystemMetadata(boolean z7) {
        this.extractFileSystemMetadata = z7;
    }
