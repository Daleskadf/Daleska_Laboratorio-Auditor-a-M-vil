...
public class NetworkParser implements Parser {
    ...
    public static class MetaHandler extends DefaultHandler {
        ...
        public void startElement(String str, String str2, String str3, Attributes attributes) {
            if (XHTMLContentHandler.XHTML.equals(str) && Office.PREFIX_DOC_META.equals(str2)) {
                String value = attributes.getValue(StringUtils.EMPTY, "name");
                String value2 = attributes.getValue(StringUtils.EMPTY, "content");
            ...
            try {
                try {
                    try {
                        ...
                        taggedContentHandler.throwIfCauseOf(e8);
                        throw new TikaException("Invalid network parser output", e8);
                    }
                } catch (IOException e9) {
                    throw new TikaException("Unable to read network parser output", e9);
                }
            } catch (Throwable th) {
                try {
                    thread.join(1000L);
    ...
    private void parse(TikaInputStream tikaInputStream, ContentHandler contentHandler, Metadata metadata, ParseContext parseContext) {
        ...
        try {
            new ParsingTask(tikaInputStream, openConnection.getOutputStream()).parse(new W6.c(inputStream), contentHandler, metadata, parseContext);
            if (inputStream != null) {
                inputStream.close();
            }
        } catch (Throwable th3) {
