...
class ForkServer implements Runnable {
    ...
    public ForkServer(InputStream inputStream, OutputStream outputStream, long j, long j8, long j9) {
        ...
        this.serverParserTimeoutMillis = j8;
    ...
    private void call(ClassLoader classLoader, Object obj) {
        ...
        try {
            ...
            for (int i7 = 0; i7 < length; i7++) {
                objArr[i7] = readObject(classLoader);
            }
            try {
        ...
        while (true) {
            try {
                synchronized (this.lock) {
                    ...
                    boolean z7 = this.parsing;
                    if (!z7 || currentTimeMillis <= this.serverParserTimeoutMillis) {
                        if (!z7) {
