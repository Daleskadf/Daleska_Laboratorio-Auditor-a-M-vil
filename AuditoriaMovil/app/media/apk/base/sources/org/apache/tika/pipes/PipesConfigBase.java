...
public class PipesConfigBase extends ConfigBase {
    ...
    public void setForkedJvmArgs(List<String> list) {
        this.forkedJvmArgs = DesugarCollections.unmodifiableList(list);
    }
    ...
    public void setMaxFilesProcessedPerProcess(int i7) {
        this.maxFilesProcessedPerProcess = i7;
    }
    ...
    public void setNumClients(int i7) {
        this.numClients = i7;
    }
    ...
    public void setStaleFetcherDelaySeconds(int i7) {
        this.staleFetcherDelaySeconds = i7;
    }

    public void setStaleFetcherTimeoutSeconds(int i7) {
        this.staleFetcherTimeoutSeconds = i7;
    }
