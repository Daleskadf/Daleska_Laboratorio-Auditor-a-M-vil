...
public class AlertDialogLayout extends Z {
    ...
    */
    public final void onLayout(boolean r11, int r12, int r13, int r14, int r15) {
        ...
        L51:
            ...
            r8 = r3
        L74:
            java.lang.reflect.Field r9 = h0.AbstractC1066z.f11214a
        ...
        if (mode2 != 1073741824) {
            ...
            for (int i18 = 0; i18 < childCount; i18++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) y2).width == -1) {
                        int i19 = ((LinearLayout.LayoutParams) y2).height;
                        ((LinearLayout.LayoutParams) y2).height = childAt3.getMeasuredHeight();
                        measureChildWithMargins(childAt3, makeMeasureSpec2, 0, i8, 0);
                        ((LinearLayout.LayoutParams) y2).height = i19;
                    }
                }
            }
        }
