...
final class zzof implements InterfaceC1084d {
    ...
    static {
        ...
        zzb = new C1083c("xMin", Y.n(hashMap));
        zzfe g4 = Y.g(2);
        HashMap hashMap2 = new HashMap();
        hashMap2.put(g4.annotationType(), g4);
        zzc = new C1083c("yMin", Y.n(hashMap2));
        zzfe g8 = Y.g(3);
        HashMap hashMap3 = new HashMap();
        hashMap3.put(g8.annotationType(), g8);
        zzd = new C1083c("xMax", Y.n(hashMap3));
        zzfe g9 = Y.g(4);
        HashMap hashMap4 = new HashMap();
        hashMap4.put(g9.annotationType(), g9);
        zze = new C1083c("yMax", Y.n(hashMap4));
        zzfe g10 = Y.g(5);
        HashMap hashMap5 = new HashMap();
        hashMap5.put(g10.annotationType(), g10);
        zzf = new C1083c("confidenceScore", Y.n(hashMap5));
    }
    ...
    public final /* bridge */ /* synthetic */ void encode(Object obj, Object obj2) {
        ...
        interfaceC1085e.add(zzb, zzurVar.zzc());
        interfaceC1085e.add(zzc, zzurVar.zze());
        interfaceC1085e.add(zzd, zzurVar.zzb());
        interfaceC1085e.add(zze, zzurVar.zzd());
        interfaceC1085e.add(zzf, zzurVar.zza());
    }
}
