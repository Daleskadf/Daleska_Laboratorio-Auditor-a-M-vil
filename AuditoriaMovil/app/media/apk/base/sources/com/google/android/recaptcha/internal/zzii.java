...
public final class zzii implements zzih {
    ...
    private final Map zzb = s.Q(new d(2, Context.ACTIVITY_SERVICE), new d(3, Context.TELEPHONY_SERVICE), new d(4, Context.INPUT_METHOD_SERVICE), new d(5, Context.AUDIO_SERVICE));
