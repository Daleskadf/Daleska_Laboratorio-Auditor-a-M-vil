    ...
    public static void zza(long[] jArr, byte[] bArr, byte[] bArr2) {
        ...
        if (bArr2.length == 32) {
            ...
            while (true) {
                byte[][] bArr3 = zza;
                if (i9 < bArr3.length) {
                    if (MessageDigest.isEqual(bArr3[i9], copyOf)) {
                        throw new InvalidKeyException(b.h("Banned public key: ", zzza.zza(bArr3[i9])));
                    }
                    i9++;
                } else {
                    ...
                    int i11 = 0;
                    while (i11 < i7) {
                        int i12 = bArr[31 - i11] & ForkServer.ERROR;
                        while (i8 < 8) {
                            int i13 = (i12 >> (7 - i8)) & 1;
                            zza(jArr4, jArr2, i13);
                            zza(jArr5, jArr3, i13);
                            long[] copyOf2 = Arrays.copyOf(jArr4, i10);
                            int i14 = i12;
                    ...
                    if (!MessageDigest.isEqual(zzmw.zzc(jArr24), zzmw.zzc(jArr25))) {
                        throw new IllegalStateException(b.h("Arithmetic error in curve multiplication with the public key: ", zzza.zza(bArr2)));
                    }
                    return;
                }
            }
