...
final class zzea implements InterfaceC1084d {
    ...
    static {
        ...
        zzb = new C1083c("landmarkMode", Y.n(hashMap));
        zzai i8 = Y.i(2);
        HashMap hashMap2 = new HashMap();
        hashMap2.put(i8.annotationType(), i8);
        zzc = new C1083c("classificationMode", Y.n(hashMap2));
        zzai i9 = Y.i(3);
        HashMap hashMap3 = new HashMap();
        hashMap3.put(i9.annotationType(), i9);
        zzd = new C1083c("performanceMode", Y.n(hashMap3));
        zzai i10 = Y.i(4);
        HashMap hashMap4 = new HashMap();
        hashMap4.put(i10.annotationType(), i10);
        zze = new C1083c("contourMode", Y.n(hashMap4));
        zzai i11 = Y.i(5);
        HashMap hashMap5 = new HashMap();
        hashMap5.put(i11.annotationType(), i11);
        zzf = new C1083c("isTrackingEnabled", Y.n(hashMap5));
        zzai i12 = Y.i(6);
        HashMap hashMap6 = new HashMap();
        hashMap6.put(i12.annotationType(), i12);
        zzg = new C1083c("minFaceSize", Y.n(hashMap6));
    }
