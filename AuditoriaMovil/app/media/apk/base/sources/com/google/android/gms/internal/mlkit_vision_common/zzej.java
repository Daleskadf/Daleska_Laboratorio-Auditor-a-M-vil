...
final class zzej implements InterfaceC1084d {
    ...
    static {
        ...
        zzc = new C1083c("imageSource", Y.n(hashMap2));
        zzai i9 = Y.i(3);
        HashMap hashMap3 = new HashMap();
        hashMap3.put(i9.annotationType(), i9);
        zzd = new C1083c("imageFormat", Y.n(hashMap3));
        zzai i10 = Y.i(4);
        HashMap hashMap4 = new HashMap();
        hashMap4.put(i10.annotationType(), i10);
        zze = new C1083c("imageByteSize", Y.n(hashMap4));
        zzai i11 = Y.i(5);
        HashMap hashMap5 = new HashMap();
        hashMap5.put(i11.annotationType(), i11);
        zzf = new C1083c("imageWidth", Y.n(hashMap5));
        zzai i12 = Y.i(6);
        HashMap hashMap6 = new HashMap();
        hashMap6.put(i12.annotationType(), i12);
        zzg = new C1083c("imageHeight", Y.n(hashMap6));
        zzai i13 = Y.i(7);
        HashMap hashMap7 = new HashMap();
        hashMap7.put(i13.annotationType(), i13);
        zzh = new C1083c("rotationDegrees", Y.n(hashMap7));
    }
    ...
    public final /* bridge */ /* synthetic */ void encode(Object obj, Object obj2) {
        ...
        interfaceC1085e.add(zzb, zziqVar.zzg());
        interfaceC1085e.add(zzc, zziqVar.zzb());
        interfaceC1085e.add(zzd, zziqVar.zza());
        interfaceC1085e.add(zze, zziqVar.zzc());
        interfaceC1085e.add(zzf, zziqVar.zze());
        interfaceC1085e.add(zzg, zziqVar.zzd());
        interfaceC1085e.add(zzh, zziqVar.zzf());
    }
}
