...
final class zzdq implements InterfaceC1084d {
    ...
    static {
        ...
        zzd = new C1083c("inputsFormats", Y.n(hashMap3));
        zzai i10 = Y.i(4);
        HashMap hashMap4 = new HashMap();
        hashMap4.put(i10.annotationType(), i10);
        zze = new C1083c("outputFormats", Y.n(hashMap4));
        zzai i11 = Y.i(5);
        HashMap hashMap5 = new HashMap();
        hashMap5.put(i11.annotationType(), i11);
        zzf = new C1083c("modelInitializationMs", Y.n(hashMap5));
    }
