...
public final class zzadr {
    ...
    */
    public static U3.i zza(com.google.android.gms.common.api.Status r4) {
        /*
            Method dump skipped, instructions count: 508
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzadr.zza(com.google.android.gms.common.api.Status):U3.i");
    }
    ...
    public static boolean zzc(Exception exc) {
        if (exc instanceof C0462k) {
            return ((C0462k) exc).f7038a.endsWith("INVALID_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzd(Exception exc) {
        if (exc instanceof C0462k) {
            return ((C0462k) exc).f7038a.endsWith("MISSING_RECAPTCHA_TOKEN");
        }
        return false;
    }
    ...
    public static boolean zzb(Exception exc) {
        if (exc instanceof C0462k) {
            return ((C0462k) exc).f7038a.endsWith("APP_NOT_AUTHORIZED");
        }
        return false;
    }

    /* JADX WARN: Type inference failed for: r0v2, types: [a4.k, U3.i, a4.n] */
    public static i zza(Status status, AbstractC0456e abstractC0456e, String str, String str2) {
        int i7 = status.f9153a;
        if (i7 != 17012 && i7 != 17007 && i7 != 17025) {
            return zza(status);
        }
        ?? c0462k = new C0462k(zza(i7), zza(zzb(i7), status));
        c0462k.f7040b = abstractC0456e;
        c0462k.f7041c = str;
        return c0462k;
    }

    private static String zza(String str, Status status) {
        return TextUtils.isEmpty(status.f9154b) ? str : String.format(AbstractC0059i.z(str, " [ %s ]"), status.f9154b);
    }

    /* JADX WARN: Type inference failed for: r1v1, types: [a4.k, a4.m] */
    /* JADX WARN: Type inference failed for: r6v0, types: [b4.k, java.lang.Object] */
    public static C0464m zza(FirebaseAuth firebaseAuth, zzzs zzzsVar, AbstractC0467p abstractC0467p) {
        zzw.zza(firebaseAuth);
        zzw.zza(zzzsVar);
        Pair<String, String> pair = zza.get(17078);
        String str = (String) pair.first;
        String str2 = (String) pair.second;
        List<u> zzc = zzzsVar.zzc();
        ArrayList arrayList = new ArrayList();
        for (u uVar : zzc) {
            if (uVar instanceof C0448A) {
                arrayList.add((C0448A) uVar);
            }
        }
        List<u> zzc2 = zzzsVar.zzc();
        ArrayList arrayList2 = new ArrayList();
        for (u uVar2 : zzc2) {
            if (uVar2 instanceof C0451D) {
                arrayList2.add((C0451D) uVar2);
            }
        }
        List<u> zzc3 = zzzsVar.zzc();
        String zzb = zzzsVar.zzb();
        I.i(zzc3);
        I.e(zzb);
        ?? obj = new Object();
        obj.f8272c = new ArrayList();
        obj.f8273d = new ArrayList();
        for (u uVar3 : zzc3) {
            if (uVar3 instanceof C0448A) {
                obj.f8272c.add((C0448A) uVar3);
            } else if (uVar3 instanceof C0451D) {
                obj.f8273d.add((C0451D) uVar3);
            } else {
                throw new IllegalArgumentException("MultiFactorInfo must be either PhoneMultiFactorInfo or TotpMultiFactorInfo. The factorId of this MultiFactorInfo: ".concat(uVar3.l()));
            }
        }
        obj.f8271b = zzb;
        h hVar = firebaseAuth.f9703a;
        hVar.a();
        C0602j c0602j = new C0602j(arrayList, obj, hVar.f5750b, zzzsVar.zza(), (C0599g) abstractC0467p, arrayList2);
        ?? c0462k = new C0462k(str, str2);
        c0462k.f7039b = c0602j;
        return c0462k;
    }
    ...
    public static boolean zza(Exception exc) {
        if (exc instanceof C0462k) {
            return ((C0462k) exc).f7038a.endsWith("ALTERNATE_CLIENT_IDENTIFIER_REQUIRED");
        }
        return false;
    }
}
