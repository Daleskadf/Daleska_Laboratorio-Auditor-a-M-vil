...
final class zzoe implements InterfaceC1084d {
    ...
    static {
        ...
        zzb = new C1083c("appName", Y.n(hashMap));
        zzfe g4 = Y.g(2);
        HashMap hashMap2 = new HashMap();
        hashMap2.put(g4.annotationType(), g4);
        zzc = new C1083c("sessionId", Y.n(hashMap2));
        zzfe g8 = Y.g(3);
        HashMap hashMap3 = new HashMap();
        hashMap3.put(g8.annotationType(), g8);
        zzd = new C1083c("startZoomLevel", Y.n(hashMap3));
        zzfe g9 = Y.g(4);
        HashMap hashMap4 = new HashMap();
        hashMap4.put(g9.annotationType(), g9);
        zze = new C1083c("endZoomLevel", Y.n(hashMap4));
        zzfe g10 = Y.g(5);
        HashMap hashMap5 = new HashMap();
        hashMap5.put(g10.annotationType(), g10);
        zzf = new C1083c("durationMs", Y.n(hashMap5));
        zzfe g11 = Y.g(6);
        HashMap hashMap6 = new HashMap();
        hashMap6.put(g11.annotationType(), g11);
        zzg = new C1083c("predictedArea", Y.n(hashMap6));
    }
    ...
    public final /* bridge */ /* synthetic */ void encode(Object obj, Object obj2) {
        ...
        interfaceC1085e.add(zzb, zzutVar.zze());
        interfaceC1085e.add(zzc, zzutVar.zzf());
        interfaceC1085e.add(zzd, zzutVar.zzc());
        interfaceC1085e.add(zze, zzutVar.zzb());
        interfaceC1085e.add(zzf, zzutVar.zzd());
        interfaceC1085e.add(zzg, zzutVar.zza());
    }
}
