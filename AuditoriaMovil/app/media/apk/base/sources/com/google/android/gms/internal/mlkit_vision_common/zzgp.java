...
final class zzgp implements InterfaceC1084d {
    ...
    static {
        ...
        zzb = new C1083c("deviceInfo", Y.n(hashMap));
        zzai i8 = Y.i(2);
        HashMap hashMap2 = new HashMap();
        hashMap2.put(i8.annotationType(), i8);
        zzc = new C1083c("nnapiInfo", Y.n(hashMap2));
        zzai i9 = Y.i(3);
        HashMap hashMap3 = new HashMap();
        hashMap3.put(i9.annotationType(), i9);
        zzd = new C1083c("gpuInfo", Y.n(hashMap3));
        zzai i10 = Y.i(4);
        HashMap hashMap4 = new HashMap();
        hashMap4.put(i10.annotationType(), i10);
        zze = new C1083c("pipelineIdentifier", Y.n(hashMap4));
        zzai i11 = Y.i(5);
        HashMap hashMap5 = new HashMap();
        hashMap5.put(i11.annotationType(), i11);
        zzf = new C1083c("acceptedConfigurations", Y.n(hashMap5));
        zzai i12 = Y.i(6);
        HashMap hashMap6 = new HashMap();
        hashMap6.put(i12.annotationType(), i12);
        zzg = new C1083c("action", Y.n(hashMap6));
        zzai i13 = Y.i(7);
        HashMap hashMap7 = new HashMap();
        hashMap7.put(i13.annotationType(), i13);
        zzh = new C1083c("status", Y.n(hashMap7));
        zzai i14 = Y.i(8);
        HashMap hashMap8 = new HashMap();
        hashMap8.put(i14.annotationType(), i14);
        zzi = new C1083c("customErrors", Y.n(hashMap8));
        zzai i15 = Y.i(9);
        HashMap hashMap9 = new HashMap();
        hashMap9.put(i15.annotationType(), i15);
        zzj = new C1083c("benchmarkStatus", Y.n(hashMap9));
        zzai i16 = Y.i(10);
        HashMap hashMap10 = new HashMap();
        hashMap10.put(i16.annotationType(), i16);
        zzk = new C1083c("validationTestResult", Y.n(hashMap10));
        zzai i17 = Y.i(11);
        HashMap hashMap11 = new HashMap();
        hashMap11.put(i17.annotationType(), i17);
        zzl = new C1083c("timestampUs", Y.n(hashMap11));
        zzai i18 = Y.i(12);
        HashMap hashMap12 = new HashMap();
        hashMap12.put(i18.annotationType(), i18);
        zzm = new C1083c("elapsedUs", Y.n(hashMap12));
    }
