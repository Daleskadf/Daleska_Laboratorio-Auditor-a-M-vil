...
public final class zzei extends zzcs implements RandomAccess, zzen {
    ...
    public final /* synthetic */ void add(int i7, Object obj) {
        ...
        if (i7 >= 0 && i7 <= (i8 = this.zzc)) {
            ...
            if (i8 < iArr.length) {
                ...
                int[] iArr2 = new int[Y.d(i8, 3, 2, 1)];
    ...
    public final /* bridge */ /* synthetic */ zzeo zzd(int i7) {
        if (i7 >= this.zzc) {
            return new zzei(Arrays.copyOf(this.zzb, i7), this.zzc, true);
        }
    ...
    private zzei(int[] iArr, int i7, boolean z7) {
        super(z7);
        this.zzb = iArr;
        this.zzc = i7;
    }
