...
public final class zzajm implements zzamd {
    ...
    private final <T> void zzd(T t7, zzamc<T> zzamcVar, zzajv zzajvVar) {
        zzaji zzajiVar;
    ...
    @Override // com.google.android.gms.internal.p002firebaseauthapi.zzamd
    public final <T> void zzb(T t7, zzamc<T> zzamcVar, zzajv zzajvVar) {
        zzb(2);
    ...
    @Override // com.google.android.gms.internal.p002firebaseauthapi.zzamd
    public final <T> void zza(T t7, zzamc<T> zzamcVar, zzajv zzajvVar) {
        zzb(3);
    ...
    */
    ...
    private final void zza(List<String> list, boolean z7) {
        int zzi;
        int zzi2;
        if ((this.zzb & 7) == 2) {
