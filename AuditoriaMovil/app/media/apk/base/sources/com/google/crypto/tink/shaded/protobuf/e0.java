...
public final class e0 extends AbstractC0775b implements RandomAccess {

    /* renamed from: d  reason: collision with root package name */
    public static final e0 f9639d;
    ...
    public final C a(int i7) {
        if (i7 >= this.f9641c) {
            return new e0(Arrays.copyOf(this.f9640b, i7), this.f9641c);
        }
    ...
    public final boolean add(Object obj) {
        ...
        if (i7 == objArr.length) {
            this.f9640b = Arrays.copyOf(objArr, ((i7 * 3) / 2) + 1);
        }
        Object[] objArr2 = this.f9640b;
        int i8 = this.f9641c;
        this.f9641c = i8 + 1;
        objArr2[i8] = obj;
    ...
    public final void add(int i7, Object obj) {
        ...
        if (i7 >= 0 && i7 <= (i8 = this.f9641c)) {
            ...
            if (i8 < objArr.length) {
                ...
                System.arraycopy(this.f9640b, i7, objArr2, i7 + 1, this.f9641c - i7);
                this.f9640b = objArr2;
            }
            this.f9640b[i7] = obj;
            this.f9641c++;
