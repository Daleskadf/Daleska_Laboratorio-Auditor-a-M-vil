...
final class zzdm implements InterfaceC1084d {
    ...
    static {
        ...
        zzb = new C1083c("supportedFormats", Y.n(hashMap));
        zzai i8 = Y.i(2);
        HashMap hashMap2 = new HashMap();
        hashMap2.put(i8.annotationType(), i8);
        zzc = new C1083c("durationMs", Y.n(hashMap2));
        zzai i9 = Y.i(3);
        ...
        zze = new C1083c("allowManualInput", Y.n(hashMap4));
    }
