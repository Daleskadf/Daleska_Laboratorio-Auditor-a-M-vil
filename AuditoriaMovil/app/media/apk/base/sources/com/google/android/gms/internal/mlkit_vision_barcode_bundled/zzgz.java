...
final class zzgz {
    ...
    public static void zzD(Object obj, long j, byte b5) {
        zzgy zzgyVar = zzf;
        long j8 = (-4) & j;
        int i7 = zzgyVar.zza.getInt(obj, j8);
        int i8 = ((~((int) j)) & 3) << 3;
        zzgyVar.zza.putInt(obj, j8, ((255 & b5) << i8) | (i7 & (~(255 << i8))));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static void zzE(Object obj, long j, byte b5) {
        zzgy zzgyVar = zzf;
        long j8 = (-4) & j;
        int i7 = (((int) j) & 3) << 3;
        zzgyVar.zza.putInt(obj, j8, ((255 & b5) << i7) | (zzgyVar.zza.getInt(obj, j8) & (~(255 << i7))));
    }
    ...
    public static void zzm(Object obj, long j, boolean z7) {
        zzf.zzc(obj, j, z7);
    }

    public static void zzn(byte[] bArr, long j, byte b5) {
        zzf.zzd(bArr, zza + j, b5);
    }
    ...
    public static void zzr(Object obj, long j, long j8) {
        zzf.zza.putLong(obj, j, j8);
    }
