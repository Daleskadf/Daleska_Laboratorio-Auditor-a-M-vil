...
public class NotificationDetails implements Serializable {
    ...
    private static ArrayList<MessageDetails> readMessages(ArrayList<Map<String, Object>> arrayList) {
        ...
        if (arrayList != null) {
            ...
            while (it.hasNext()) {
                ...
                arrayList2.add(new MessageDetails((String) next.get(TEXT), AbstractC0412a.M(next.get(TIMESTAMP)), readPersonDetails((Map) next.get(PERSON)), (String) next.get(DATA_MIME_TYPE), (String) next.get(DATA_URI)));
            }
        }
        return arrayList2;
    }
    ...
    private static void readPlatformSpecifics(Map<String, Object> map, NotificationDetails notificationDetails) {
        ...
        if (map2 != null) {
            ...
            notificationDetails.when = AbstractC0412a.M(map2.get(WHEN));
            ...
            notificationDetails.timeoutAfter = AbstractC0412a.M(map2.get(TIMEOUT_AFTER));
            ...
            if (map2.containsKey(ACTIONS) && (list = (List) map2.get(ACTIONS)) != null && !list.isEmpty()) {
                ...
                for (Map map3 : list) {
                    notificationDetails.actions.add(new NotificationAction(map3));
                }
            }
        }
    }
