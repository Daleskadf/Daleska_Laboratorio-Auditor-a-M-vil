...
public final class p extends AbstractC1194a implements Serializable {

    /* renamed from: o  reason: collision with root package name */
    public static final p f12625o;
    private static final long serialVersionUID = 3127340209035924785L;

    /* renamed from: d  reason: collision with root package name */
    private final transient String f12626d = "Hijrah-umalqura";

    /* renamed from: e  reason: collision with root package name */
    private final transient String f12627e = "islamic-umalqura";
    private volatile transient boolean f;

    /* renamed from: g  reason: collision with root package name */
    private transient int[] f12628g;

    /* renamed from: h  reason: collision with root package name */
    private transient int f12629h;

    /* renamed from: i  reason: collision with root package name */
    private transient int f12630i;
    private transient int j;

    /* renamed from: k  reason: collision with root package name */
    private transient int f12631k;

    /* renamed from: l  reason: collision with root package name */
    private transient int f12632l;

    /* renamed from: m  reason: collision with root package name */
    private transient int f12633m;

    /* renamed from: n  reason: collision with root package name */
    private transient int f12634n;

    static {
        p pVar = new p();
        f12625o = pVar;
        AbstractC1194a.t(pVar, "Hijrah");
        AbstractC1194a.t(pVar, "islamic");
    }
    ...
    private void S() {
        ...
        try {
            ...
            int[][] a02 = a0();
            int x7 = (int) j$.time.h.g0(1882, 11, 12).x();
            for (int i7 = 1300; i7 <= 1600; i7++) {
                int[] iArr = a02[i7 - 1300];
                if (iArr.length != 12) {
            ...
            if (!this.f12627e.equals("islamic-umalqura")) {
            ...
            int[] U7 = U(x7, hashMap);
            this.f12628g = U7;
            this.f12630i = U7[3612];
            for (int i8 = 1300; i8 < 1600; i8++) {
                int i9 = (i8 * 12) - this.j;
                int[] iArr2 = this.f12628g;
                int i10 = iArr2[i9 + 12] - iArr2[i9];
                this.f12633m = Math.min(this.f12633m, i10);
                this.f12634n = Math.max(this.f12634n, i10);
            }
            this.f = true;
        } catch (Exception e7) {
            throw new RuntimeException("Unable to initialize HijrahCalendar: " + str, e7);
        }
    }
    ...
    public final InterfaceC1195b H(int i7, int i8, int i9) {
        return r.Y(this, i7, i8, i9);
    }

    @Override // j$.time.chrono.m
    public final InterfaceC1195b y(int i7, int i8) {
        r Y3 = r.Y(this, i7, 1, 1);
        if (i8 > Y3.X()) {
            throw new RuntimeException("Invalid dayOfYear: " + i8);
        }
        return Y3.T(i8 - 1);
    }
    ...
    public final InterfaceC1195b q() {
        return r.Z(this, j$.time.h.f0(j$.time.b.b()).w(j$.time.temporal.a.EPOCH_DAY));
    }
    ...
    public final InterfaceC1195b r(TemporalAccessor temporalAccessor) {
        ...
        return r.Z(this, temporalAccessor.w(j$.time.temporal.a.EPOCH_DAY));
    }
    ...
    public final j$.time.temporal.t K(j$.time.temporal.a aVar) {
        ...
        if (aVar instanceof j$.time.temporal.a) {
            switch (o.f12624a[aVar.ordinal()]) {
                case 1:
                    return j$.time.temporal.t.k(this.f12631k, this.f12632l);
                case 2:
                    return j$.time.temporal.t.j(1L, this.f12634n);
                case 3:
                    return j$.time.temporal.t.j(1L, 5L);
                case 4:
                case 5:
                    int i7 = this.j;
                    return j$.time.temporal.t.j(i7 / 12, (((this.f12628g.length - 1) + i7) / 12) - 1);
                case 6:
    ...
    public final int[] X(int i7) {
        S();
        if (i7 < this.f12629h || i7 >= this.f12630i) {
            throw new RuntimeException("Hijrah date out of range");
        }
        int binarySearch = Arrays.binarySearch(this.f12628g, i7);
        if (binarySearch < 0) {
            binarySearch = (-binarySearch) - 2;
        }
        int i8 = this.j;
        return new int[]{(binarySearch + i8) / 12, ((i8 + binarySearch) % 12) + 1, (i7 - this.f12628g[binarySearch]) + 1};
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final long W(int i7, int i8, int i9) {
        S();
        if (i8 < 1 || i8 > 12) {
            throw new RuntimeException("Invalid Hijrah month: " + i8);
        }
        int i10 = (i8 - 1) + ((i7 * 12) - this.j);
        if (i10 < 0 || i10 >= this.f12628g.length) {
            throw new RuntimeException("Invalid Hijrah date, year: " + i7 + ", month: " + i8);
        } else if (i9 < 1 || i9 > Y(i7, i8)) {
            throw new RuntimeException("Invalid Hijrah day of month: " + i9);
        } else {
            return (i9 - 1) + this.f12628g[i10];
        }
    }
    ...
    public final int T(long j) {
        int i7 = this.j;
        if (j < i7 / 12 || j > (((this.f12628g.length - 1) + i7) / 12) - 1) {
    ...
    private int[] U(int i7, HashMap hashMap) {
        int[] iArr = new int[3613];
        this.f12631k = com.google.android.gms.common.api.f.API_PRIORITY_OTHER;
        this.f12632l = Integer.MIN_VALUE;
        int i8 = 0;
        for (int i9 = 1300; i9 <= 1600; i9++) {
            int[] iArr2 = (int[]) hashMap.get(Integer.valueOf(i9));
            int i10 = 0;
            while (i10 < 12) {
                int i11 = iArr2[i10];
                int i12 = i8 + 1;
                ...
                i7 += i11;
                this.f12631k = Math.min(this.f12631k, i11);
                this.f12632l = Math.max(this.f12632l, i11);
                i10++;
                i8 = i12;
            }
        }
