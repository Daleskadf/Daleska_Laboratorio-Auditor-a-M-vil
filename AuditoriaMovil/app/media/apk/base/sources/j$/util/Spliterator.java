...
public interface Spliterator<T> {
    ...
    public final /* synthetic */ class Wrapper implements java.util.Spliterator {
        ...
        public static /* synthetic */ java.util.Spliterator convert(Spliterator spliterator) {
            ...
            return spliterator instanceof g0 ? ((g0) spliterator).f12969a : spliterator instanceof f0 ? e0.a((f0) spliterator) : new Wrapper();
        }
        ...
        public final /* synthetic */ boolean hasCharacteristics(int i7) {
            return Spliterator.this.hasCharacteristics(i7);
        }
