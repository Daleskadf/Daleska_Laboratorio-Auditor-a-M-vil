...
public final class a extends TimerTask {
    ...
    public float f14800a = 2.14748365E9f;
    ...
    public final void run() {
        if (this.f14800a == 2.14748365E9f) {
            if (Math.abs(this.f14801b) > 2000.0f) {
                if (this.f14801b > 0.0f) {
        ...
        if (!wheelView.f6020t) {
            ...
            if (f13 <= f12) {
                ...
                wheelView2.f6021u = (int) itemsCount;
                this.f14800a = -40.0f;
            }
        }
        float f14 = this.f14800a;
        if (f14 < 0.0f) {
            this.f14800a = f14 + 20.0f;
        } else {
            this.f14800a = f14 - 20.0f;
        }
