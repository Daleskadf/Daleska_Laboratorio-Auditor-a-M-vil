...
public class i extends f {
    ...
    public void b(l.e eVar) {
        ...
        if (this.f16582z0 == 0) {
            ...
            f fVar2 = this.F;
            z10 = (fVar2 == null || fVar2.E[1] != f.b.WRAP_CONTENT) ? false : false;
        }
        if (this.f16579w0 != -1) {
    ...
    public void d(int i10) {
        ...
        if (I0() == 1) {
            ...
            if (this.f16579w0 != -1) {
                ...
                return;
            } else if (this.f16578v0 != -1.0f && u10.s() == f.b.FIXED) {
        ...
        } else if (this.f16578v0 != -1.0f && u10.B() == f.b.FIXED) {
