...
public class m extends o {
    ...
    public void f() {
        ...
        if (i10 == 1 && ((mVar7 = this.f16589e) == null || mVar7.f16602b == 1)) {
            ...
            b();
        } else if (i10 == 2 && (mVar4 = this.f16589e) != null && mVar4.f16602b == 1 && (mVar5 = this.f16594j) != null && (mVar6 = mVar5.f16589e) != null && mVar6.f16602b == 1) {
            l.e.x();
            ...
            if (z10) {
                f10 = mVar8.f16592h - mVar10.f16592h;
            } else {
                f10 = mVar10.f16592h - mVar8.f16592h;
            }
            if (dVar != e.d.LEFT && dVar != dVar2) {
                D = f10 - eVar.f16482b.r();
                f11 = this.f16587c.f16482b.f16511a0;
            } else {
                D = f10 - eVar.f16482b.D();
                f11 = this.f16587c.f16482b.Z;
            }
            ...
            float f14 = (D - f12) - f13;
            if (z10) {
                m mVar11 = this.f16594j;
                mVar11.f16592h = mVar11.f16589e.f16592h + f13 + (f14 * f11);
                this.f16592h = (this.f16589e.f16592h - f12) - (f14 * (1.0f - f11));
            } else {
                this.f16592h = this.f16589e.f16592h + f12 + (f14 * f11);
                m mVar12 = this.f16594j;
                mVar12.f16592h = (mVar12.f16589e.f16592h - f13) - (f14 * (1.0f - f11));
            }
            b();
            this.f16594j.b();
        } else if (i10 == 3 && (mVar = this.f16589e) != null && mVar.f16602b == 1 && (mVar2 = this.f16594j) != null && (mVar3 = mVar2.f16589e) != null && mVar3.f16602b == 1) {
            l.e.x();
            m mVar13 = this.f16589e;
            this.f16591g = mVar13.f16591g;
            m mVar14 = this.f16594j;
            m mVar15 = mVar14.f16589e;
            mVar14.f16591g = mVar15.f16591g;
            this.f16592h = mVar13.f16592h + this.f16590f;
            mVar14.f16592h = mVar15.f16592h + mVar14.f16590f;
            b();
            this.f16594j.b();
        } else if (i10 == 5) {
