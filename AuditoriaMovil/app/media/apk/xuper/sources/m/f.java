...
public class f {
    ...
    public final boolean K(int i10) {
        ...
        if (eVar4 != null && eVar4.f16484d != eVar3 && (eVar2 = (eVar = eVarArr[i11 + 1]).f16484d) != null && eVar2.f16484d == eVar) {
            return true;
        }
        return false;
    }
    ...
    public boolean L() {
        if (this.f16550u.f().f16602b == 1 && this.f16552w.f().f16602b == 1 && this.f16551v.f().f16602b == 1 && this.f16553x.f().f16602b == 1) {
            return true;
        }
        return false;
    }
    ...
    public boolean M() {
        ...
        if (eVar2 == null || eVar2.f16484d != eVar) {
            ...
            e eVar4 = eVar3.f16484d;
            if (eVar4 != null && eVar4.f16484d == eVar3) {
                return true;
            }
            return false;
        }
    ...
    public boolean O() {
        if (this.f16520f == 0 && this.I == 0.0f && this.f16530k == 0 && this.f16532l == 0 && this.E[1] == b.MATCH_CONSTRAINT) {
            return true;
        }
        return false;
    }
    ...
    public boolean P() {
        if (this.f16518e != 0 || this.I != 0.0f || this.f16524h != 0 || this.f16526i != 0 || this.E[0] != b.MATCH_CONSTRAINT) {
            return false;
        }
        return true;
    }
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:166:0x02c9 A[ADDED_TO_REGION] */
    /* JADX WARN: Removed duplicated region for block: B:170:0x02d6 A[ADDED_TO_REGION] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:89:0x01ab A[ADDED_TO_REGION] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
