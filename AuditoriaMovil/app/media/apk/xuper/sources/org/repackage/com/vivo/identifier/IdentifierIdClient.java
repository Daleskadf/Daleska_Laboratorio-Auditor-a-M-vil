...
public class IdentifierIdClient {
                    ...
                    try {
                        ...
                        if (i10 == 0) {
                            ...
                            if (i10 != 2) {
                                if (i10 != 3) {
                                    if (i10 == 4) {
                                        String unused2 = IdentifierIdClient.L = a10;
                                    } else if (i10 == 5) {
                                        if (a10 != null) {
                                            String unused3 = IdentifierIdClient.M = a10;
                                        } else {
                                            Log.e(IdentifierIdClient.f17943b, "get guid failed");
                                        }
                                    }
                                } else if (a10 != null) {
                                    String unused4 = IdentifierIdClient.K = a10;
                                } else {
                                    Log.e(IdentifierIdClient.f17943b, "get udid failed");
                                }
                            } else {
                                if (a10 != null) {
                                    String unused5 = IdentifierIdClient.J = a10;
                                } else {
                            ...
                            if (a10 != null) {
                                String unused6 = IdentifierIdClient.I = a10;
                            } else {
    ...
    private static void E() {
        boolean z10;
        if (!"1".equals(a(f17945d, "0")) && !"1".equals(a(f17940a, "0"))) {
            z10 = false;
        } else {
            z10 = true;
        }
