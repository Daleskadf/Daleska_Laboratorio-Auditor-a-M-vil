...
public class Persister implements Serializer {
    ...
    public <T> T read(Class<? extends T> cls, String str, boolean z10) {
        return (T) read((Class<? extends Object>) cls, (Reader) new StringReader(str), z10);
    }
    ...
    public <T> T read(Class<? extends T> cls, File file, boolean z10) {
        ...
        try {
            return (T) read((Class<? extends Object>) cls, (InputStream) fileInputStream, z10);
        } finally {
    ...
    public <T> T read(Class<? extends T> cls, InputStream inputStream, boolean z10) {
        return (T) read((Class<? extends Object>) cls, NodeBuilder.read(inputStream), z10);
    }
    ...
    public <T> T read(Class<? extends T> cls, Reader reader, boolean z10) {
        return (T) read((Class<? extends Object>) cls, NodeBuilder.read(reader), z10);
    }
    ...
    public <T> T read(Class<? extends T> cls, InputNode inputNode, boolean z10) {
        try {
            return (T) read((Class<? extends Object>) cls, inputNode, this.manager.open(z10));
        } finally {
            this.manager.close();
        }
    }
