...
public final class k2 extends RecyclerView.g {
    ...
    public static final void f(t9.w wVar, k2 k2Var, View view) {
        ...
        if (alias == null) {
            str = ((ShelveAsset) wVar.f18961a).getName();
        } else {
            str = alias;
        }
        com.mobile.brasiltv.utils.b0.r(cVar, type, programType, contentId, enterType, str, false, false, k2Var.f13750b, k2Var.f13752d, str2);
    }
    ...
    public void onBindViewHolder(a aVar, int i10) {
        ...
        com.mobile.brasiltv.utils.b0.d(h10, str, ba.t.W(((ShelveAsset) wVar.f18961a).getName()).toString());
