...
public final class q3 extends BaseAdapter {
    ...
    public static final void e(SwitchAccountBean switchAccountBean, q3 q3Var, int i10, b bVar, View view) {
        ...
        } else if (switchAccountBean.isLogged() && !q3Var.f13841c && (aVar = q3Var.f13842d) != null) {
            aVar.onBack();
        }
    }
    ...
    public static final void f(SwitchAccountBean switchAccountBean, q3 q3Var, int i10, View view) {
        ...
        } else if (!q3Var.f13841c && (aVar = q3Var.f13842d) != null) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:56:0x0195, code lost:
        if (r1.equals(com.titans.entity.CdnType.DIGITAL_TYPE_PEERSTAR) == false) goto L57;
     */
    /* JADX WARN: Code restructure failed: missing block: B:59:0x019c, code lost:
        if (r1.equals(com.titans.entity.CdnType.DIGITAL_TYPE_PCDN) == false) goto L57;
     */
