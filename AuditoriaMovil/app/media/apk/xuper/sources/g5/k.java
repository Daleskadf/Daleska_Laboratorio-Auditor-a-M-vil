...
public final class k extends j5.b {
        ...
        public void onPageSelected(int i10) {
            ...
            if (list != null) {
                ...
                if (i11 > 0 && kVar.w() && kVar.x()) {
                    ...
                    int i13 = i10 % i12;
                    if (i13 >= 0 && i13 < list.size() && t9.i.b("4", ((RecommendContentList) list.get(i13)).getType())) {
                        com.mobile.brasiltv.utils.i1.D(kVar.f13733a, "EVENT_RECOMMEND_AD_SHOW_CR", i13 + 1);
                    }
                }
            }
        }
    ...
    public static final void o(t9.w wVar, k kVar, l lVar, t9.w wVar2, BGABanner bGABanner, View view, Object obj, int i10) {
        ...
        if (com.mobile.brasiltv.utils.b0.I((Collection) wVar.f18961a)) {
            ...
            sb.append(alias);
            sb.append('/');
            String str3 = (String) wVar2.f18961a;
            if (str3 != null) {
                str2 = str3;
            }
            sb.append(str2);
    ...
    public final void y(boolean z10) {
        boolean z11;
        for (IAdView iAdView : this.f13737e) {
            if (this.f13735c && this.f13736d) {
                z11 = true;
            } else {
                z11 = false;
            }
