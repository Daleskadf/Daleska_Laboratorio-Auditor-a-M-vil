        ...
        if (f10 != null) {
            ...
            try {
                ...
                try {
                    ...
                    method2 = null;
                    if (f10.getName().equals(ProviderInstaller.PROVIDER_NAME)) {
                    }
                    enumC0076h = EnumC0076h.ALPN_AND_NPN;
                    return new d(gVar, gVar2, method, method2, gVar3, gVar4, f10, enumC0076h);
                }
            } catch (ClassNotFoundException | NoSuchMethodException unused2) {
                method = null;
            }
            if (f10.getName().equals(ProviderInstaller.PROVIDER_NAME) && !f10.getName().equals("Conscrypt") && !f10.getName().equals("Ssl_Guard")) {
                if (k()) {
                    enumC0076h = EnumC0076h.ALPN_AND_NPN;
                } else if (j()) {
                    enumC0076h = EnumC0076h.NPN;
                } else {
                    enumC0076h = EnumC0076h.NONE;
                }
            } else {
                enumC0076h = EnumC0076h.ALPN_AND_NPN;
            }
