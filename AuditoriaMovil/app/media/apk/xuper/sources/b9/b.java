...
public final class b {
    ...
    public final b e(SSLSocket sSLSocket, boolean z10) {
        ...
        return new C0075b(this).g(strArr).j((String[]) l.c(String.class, this.f5150c, enabledProtocols)).e();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (z10 && (!Arrays.equals(this.f5149b, bVar.f5149b) || !Arrays.equals(this.f5150c, bVar.f5150c) || this.f5151d != bVar.f5151d)) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        ...
        if (this.f5148a) {
            ...
            return "ConnectionSpec(cipherSuites=" + obj + ", tlsVersions=" + g() + ", supportsTlsExtensions=" + this.f5151d + ")";
        }
