        ...
        try {
            ...
            if (code != 200) {
                ...
                if (!set.contains(str3)) {
                    ...
                    str2 = path;
                    try {
                        c2.d.e(dVar, elapsedRealtime, elapsedRealtime2, path, a10, code, na.e.f17345e, null, true, 64, null);
                        ...
                        if (!(e instanceof ResultException)) {
                            ...
                            if (!z10) {
                                ...
                                if (!set2.contains(str4)) {
                                    ...
                                    c2.d.e(dVar2, elapsedRealtime, elapsedRealtime3, str2, str5, i10, na.e.f17345e, null, true, 64, null);
                                }
                            }
                        }
                        throw e;
