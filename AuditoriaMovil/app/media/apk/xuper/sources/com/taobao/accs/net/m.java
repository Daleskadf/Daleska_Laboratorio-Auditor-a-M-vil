...
public class m implements ISessionListener {
    ...
    public void onConnectionChanged(Intent intent) {
        ...
        if (intent != null) {
            ...
            String d10 = this.f9208a.d();
            ALog.e(d10, "onConnectionChanged", "currentHost", "https://" + this.f9208a.f9165i.getInappHost(), "changeHost", stringExtra, IPushHandler.STATE, Boolean.valueOf(booleanExtra));
            if (("https://" + this.f9208a.f9165i.getInappHost()).equals(stringExtra)) {
                ...
                if (booleanExtra) {
                    ...
                    connectInfo = new TaoBaseService.ConnectInfo(stringExtra, booleanExtra2, booleanExtra3, intExtra, stringExtra2);
                }
                connectInfo.connected = booleanExtra;
                Iterator<AccsConnectStateListener> it = this.f9208a.n().iterator();
                while (it.hasNext()) {
                    handler = this.f9208a.f9198r;
                    handler.post(new n(this, connectInfo, it.next()));
                }
            }
        }
    }
