...
public abstract class TaoBaseService extends Service implements AccsDataListener {
    ...
    private Messenger messenger = new Messenger(new Handler() { // from class: com.taobao.accs.base.TaoBaseService.1
        ...
        public void handleMessage(Message message) {
            if (message != null) {
                ALog.i(TaoBaseService.TAG, "handleMessage on receive msg", Constant.KEY_MSG, message.toString());
    ...
    public static class ConnectInfo implements Serializable {
        ...
        public String toString() {
            return "ConnectInfo{host='" + this.host + "', isInapp=" + this.isInapp + ", isCenterHost=" + this.isCenterHost + ", connected=" + this.connected + ", errorCode=" + this.errorCode + ", errorDetail='" + this.errordetail + '\'' + ASCIIPropertyListParser.DICTIONARY_END_TOKEN;
        }
