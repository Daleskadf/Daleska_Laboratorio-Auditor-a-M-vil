...
public class k extends com.taobao.accs.net.a implements DataFrameCb {
    ...
    /* JADX WARN: Removed duplicated region for block: B:13:0x003f A[Catch: all -> 0x0046, TRY_LEAVE, TryCatch #0 {all -> 0x0046, blocks: (B:4:0x0005, B:6:0x002a, B:11:0x0034, B:13:0x003f), top: B:18:0x0005 }] */
    ...
    */
    ...
    public void a(Message message, boolean z10) {
        if (this.f9195o && message != null) {
            try {
                ...
                String d10 = d();
                ALog.e(d10, "send queue full count:" + ThreadPoolExecutorFactory.getSendScheduledExecutor().getQueue().size(), new Object[0]);
                return;
            } catch (Throwable th) {
        ...
        String d11 = d();
        ALog.e(d11, "not running or msg null! " + this.f9195o, new Object[0]);
    }
    ...
    public void a(AccsClientConfig accsClientConfig) {
        ...
        } else if (accsClientConfig.equals(this.f9165i)) {
