...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.g {
    ...
    public int getParentPosition(T t10) {
        ...
        while (itemPosition >= 0) {
            ...
            if (t11 instanceof IExpandable) {
                ...
                if (iExpandable.getLevel() >= 0 && iExpandable.getLevel() < i10) {
                    return itemPosition;
                }
            }
            itemPosition--;
    ...
    public boolean isExpandable(T t10) {
        if (t10 != null && (t10 instanceof IExpandable)) {
            return true;
        }
        return false;
    }
            ...
            gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.c() { // from class: com.chad.library.adapter.base.BaseQuickAdapter.4
                ...
                public int getSpanSize(int i10) {
                    ...
                    if (BaseQuickAdapter.this.mSpanSizeLookup == null) {
                        ...
                        return BaseQuickAdapter.this.mSpanSizeLookup.getSpanSize(gridLayoutManager, i10 - BaseQuickAdapter.this.getHeaderLayoutCount());
                    }
                }
            });
        }
    ...
    public /* bridge */ /* synthetic */ void onBindViewHolder(RecyclerView.d0 d0Var, int i10) {
        onBindViewHolder((BaseQuickAdapter<T, K>) ((BaseViewHolder) d0Var), i10);
    }
    ...
    public void setEmptyView(View view) {
        ...
        if (z10 && getEmptyViewCount() == 1) {
            notifyItemInserted((!this.mHeadAndEmptyEnable || getHeaderLayoutCount() == 0) ? 0 : 0);
        }
    }
