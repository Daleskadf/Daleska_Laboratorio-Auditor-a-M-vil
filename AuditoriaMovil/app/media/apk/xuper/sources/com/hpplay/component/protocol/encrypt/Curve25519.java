...
public class Curve25519 {
    ...
    private static final int is_negative(long10 long10Var) {
        int i10;
        if (!is_overflow(long10Var) && long10Var._9 >= 0) {
            i10 = 0;
        } else {
            i10 = 1;
        }
        return (int) (i10 ^ (long10Var._0 & 1));
    }

    private static final boolean is_overflow(long10 long10Var) {
        if ((long10Var._0 > 67108844 && (long10Var._1 & long10Var._3 & long10Var._5 & long10Var._7 & long10Var._9) == 33554431 && (long10Var._2 & long10Var._4 & long10Var._6 & long10Var._8) == 67108863) || long10Var._9 > 33554431) {
            return true;
        }
        return false;
    }
    ...
    private static final void pack(long10 long10Var, byte[] bArr) {
        ...
        int i11 = (is_overflow ? 1 : 0) - i10;
        long j11 = (i11 * 19) + long10Var._0 + (long10Var._1 << 26);
        bArr[0] = (byte) j11;
        bArr[1] = (byte) (j11 >> 8);
        bArr[2] = (byte) (j11 >> 16);
        bArr[3] = (byte) (j11 >> 24);
        ...
        bArr[26] = (byte) (j17 >> 16);
        bArr[27] = (byte) (j17 >> 24);
        long j18 = (j17 >> 32) + ((j10 + ((-33554432) * i11)) << 6);
        bArr[28] = (byte) j18;
        bArr[29] = (byte) (j18 >> 8);
        bArr[30] = (byte) (j18 >> 16);
        bArr[31] = (byte) (j18 >> 24);
    ...
    private static final void unpack(long10 long10Var, byte[] bArr) {
        byte b10 = bArr[3];
        long10Var._0 = (bArr[0] & UnsignedBytes.MAX_VALUE) | ((bArr[1] & UnsignedBytes.MAX_VALUE) << 8) | ((bArr[2] & UnsignedBytes.MAX_VALUE) << 16) | (((b10 & UnsignedBytes.MAX_VALUE) & 3) << 24);
        int i10 = (((b10 & UnsignedBytes.MAX_VALUE) & (-4)) >> 2) | ((bArr[4] & UnsignedBytes.MAX_VALUE) << 6) | ((bArr[5] & UnsignedBytes.MAX_VALUE) << 14);
        byte b11 = bArr[6];
        long10Var._1 = i10 | (((b11 & UnsignedBytes.MAX_VALUE) & 7) << 22);
        int i11 = (((b11 & UnsignedBytes.MAX_VALUE) & (-8)) >> 3) | ((bArr[7] & UnsignedBytes.MAX_VALUE) << 5) | ((bArr[8] & UnsignedBytes.MAX_VALUE) << 13);
        byte b12 = bArr[9];
        long10Var._2 = i11 | (((b12 & UnsignedBytes.MAX_VALUE) & 31) << 21);
        byte b13 = bArr[12];
        long10Var._3 = (((b12 & UnsignedBytes.MAX_VALUE) & (-32)) >> 5) | ((bArr[10] & UnsignedBytes.MAX_VALUE) << 3) | ((bArr[11] & UnsignedBytes.MAX_VALUE) << 11) | (((b13 & UnsignedBytes.MAX_VALUE) & 63) << 19);
        ...
        int i12 = ((bArr[18] & UnsignedBytes.MAX_VALUE) << 16) | ((bArr[17] & UnsignedBytes.MAX_VALUE) << 8) | (bArr[16] & UnsignedBytes.MAX_VALUE);
        byte b14 = bArr[19];
        long10Var._5 = i12 | (((b14 & UnsignedBytes.MAX_VALUE) & 1) << 24);
        int i13 = (((b14 & UnsignedBytes.MAX_VALUE) & (-2)) >> 1) | ((bArr[20] & UnsignedBytes.MAX_VALUE) << 7) | ((bArr[21] & UnsignedBytes.MAX_VALUE) << 15);
        byte b15 = bArr[22];
        long10Var._6 = i13 | ((7 & (b15 & UnsignedBytes.MAX_VALUE)) << 23);
        int i14 = (((b15 & UnsignedBytes.MAX_VALUE) & (-8)) >> 3) | ((bArr[23] & UnsignedBytes.MAX_VALUE) << 5) | ((bArr[24] & UnsignedBytes.MAX_VALUE) << 13);
        byte b16 = bArr[25];
        long10Var._7 = i14 | (((b16 & UnsignedBytes.MAX_VALUE) & 15) << 21);
        int i15 = (((b16 & UnsignedBytes.MAX_VALUE) & (-16)) >> 4) | ((bArr[26] & UnsignedBytes.MAX_VALUE) << 4) | ((bArr[27] & UnsignedBytes.MAX_VALUE) << 12);
        byte b17 = bArr[28];
        long10Var._8 = i15 | (((b17 & UnsignedBytes.MAX_VALUE) & 63) << 20);
            ...
            if (i26 != 0) {
                ...
                while (true) {
                    ...
                    if (i30 != 0) {
                        ...
                        int i32 = ((((i27 >> 1) ^ i27) >> i31) & 1) + ((((i28 >> 1) ^ i28) >> i31) & 1);
                        mont_dbl(long10VarArr3[2], long10VarArr4[2], long10VarArr5[i32], long10VarArr6[i32], long10VarArr3[0], long10VarArr4[0]);
                        int i33 = i25 >> i31;
                        int i34 = i33 & 2;
                        int i35 = i33 & 1;
                        int i36 = i34 ^ (i35 << 1);
                        mont_add(long10VarArr5[1], long10VarArr6[1], long10VarArr5[i36], long10VarArr6[i36], long10VarArr3[1], long10VarArr4[1], long10VarArr[i35]);
                        mont_add(long10VarArr5[2], long10VarArr6[2], long10VarArr5[0], long10VarArr6[0], long10VarArr3[2], long10VarArr4[2], long10VarArr2[(((i27 ^ i28) >> i31) & 2) >> 1]);
                        i30 = i31;
                        bArr5 = bArr6;
                        c10 = 0;
                    }
                ...
                int i37 = (i27 & 1) + (i28 & 1);
                recip(long10VarArr5[0], long10VarArr4[i37], 0);
                mul(long10VarArr5[1], long10VarArr3[i37], long10VarArr5[0]);
