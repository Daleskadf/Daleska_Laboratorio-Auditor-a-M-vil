...
public class ParamsMap extends ConcurrentHashMap {
    ...
    public String getAppKey() {
        if (get(DeviceParams.KEY_APPID) == 0) {
            return "";
        }
        return String.valueOf(get(DeviceParams.KEY_APPID));
    }
    ...
    public String getAppsecret() {
        ...
        return String.valueOf(get("secret"));
    }
    ...
    public String getChannelVersion() {
        if (get(DeviceParams.KEY_CHANNEL_VERSION) == 0) {
            return "";
        }
        return String.valueOf(get(DeviceParams.KEY_CHANNEL_VERSION));
    }

    public String getCuid() {
        if (get(DeviceParams.KEY_UID) == 0) {
            return "";
        }
        return String.valueOf(get(DeviceParams.KEY_UID));
    }

    public String getHID() {
        if (get(DeviceParams.KEY_HID) == 0) {
            return "";
        }
        return String.valueOf(get(DeviceParams.KEY_HID));
    }
    ...
    public String getIMEI() {
        ...
        return String.valueOf(get("imei"));
    }
    ...
    public String getMac() {
        if (get(DeviceParams.KEY_MAC) == 0) {
            return "";
        }
        return String.valueOf(get(DeviceParams.KEY_MAC));
    }

    public String getMediaType() {
        if (get(PushParams.KEY_MEDIA_TYPE) == 0) {
            return "";
        }
        return String.valueOf(get(PushParams.KEY_MEDIA_TYPE));
    }
    ...
    public String getRuid() {
        if (get(DeviceParams.KEY_RECEIVER_UID) == 0) {
            return "";
        }
        return String.valueOf(get(DeviceParams.KEY_RECEIVER_UID));
    }
    ...
    public String getScreenCode() {
        ...
        return String.valueOf(get("screencode"));
    }
    ...
    public String getToken() {
        if (get(DeviceParams.KEY_AUTH_TOKEN) == 0) {
            return "";
        }
        return String.valueOf(get(DeviceParams.KEY_AUTH_TOKEN));
    }
