    ...
    public YimBridge(Context context, OutParameter outParameter) {
        ...
        this.mStateListener = new OnPlayStateListener() { // from class: com.hpplay.sdk.source.protocol.YimBridge.2
            ...
            public void onError(String str2, String str3) {
                if (!TextUtils.isEmpty(str2) && !TextUtils.equals(str2, YimBridge.this.mPlayInfo.urlID)) {
                    SourceLog.w(YimBridge.TAG, "onError ignore, " + str2 + Operator.Operation.DIVISION + YimBridge.this.mPlayInfo.urlID);
                    return;
                }
            ...
            public void onPause(String str2) {
                if (!TextUtils.isEmpty(str2) && !TextUtils.equals(str2, YimBridge.this.mPlayInfo.urlID)) {
                    SourceLog.w(YimBridge.TAG, "onPause ignore, " + str2 + Operator.Operation.DIVISION + YimBridge.this.mPlayInfo.urlID);
                    return;
                }
            ...
            @Override // com.hpplay.sdk.source.protocol.connect.OnPlayStateListener
            public void onPlaying(String str2, int i10, int i11) {
                if (!TextUtils.isEmpty(str2) && !TextUtils.equals(str2, YimBridge.this.mPlayInfo.urlID)) {
                    SourceLog.w(YimBridge.TAG, "onPlaying ignore, " + str2 + Operator.Operation.DIVISION + YimBridge.this.mPlayInfo.urlID);
                    return;
                }
            ...
            public void onStart(String str2) {
                if (!TextUtils.isEmpty(str2) && !TextUtils.equals(str2, YimBridge.this.mPlayInfo.urlID)) {
                    SourceLog.w(YimBridge.TAG, "onStart ignore, " + str2 + Operator.Operation.DIVISION + YimBridge.this.mPlayInfo.urlID);
            ...
            @Override // com.hpplay.sdk.source.protocol.connect.OnPlayStateListener
            public void onStop(String str2, int i10) {
                if (!TextUtils.isEmpty(str2) && !TextUtils.equals(str2, YimBridge.this.mPlayInfo.urlID)) {
                    SourceLog.w(YimBridge.TAG, "onStop ignore, " + str2 + Operator.Operation.DIVISION + YimBridge.this.mPlayInfo.urlID);
                } else if (i10 == 0) {
        ...
        this.mYimListener = new OnCloudMirrorListener() { // from class: com.hpplay.sdk.source.protocol.YimBridge.3
            /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:35:0x0101 -> B:72:0x01e1). Please submit an issue!!! */
            public void onEventCallback(int i10, Object... objArr) {
                ...
                if (i10 != 1) {
                    if (i10 != 2) {
                        ...
                        SourceLog.i(YimBridge.TAG, "EVENT_QUIT: " + parseInt);
                        if (parseInt == 3) {
                ...
                OutParameter outParameter2 = YimBridge.this.mPlayInfo;
                if (parseInt3 == 1) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                sourceDataReport.onYimInit(IMediaPlayer.MEDIA_INFO_BUFFERING_START, outParameter2, z10, null, null);
            }
        };
        this.mPushMirrorListener = new com.hpplay.sdk.source.mirror.yim.a() { // from class: com.hpplay.sdk.source.protocol.YimBridge.4
            ...
            public void result(int i10, String str2, String str3) {
                SourceLog.i(YimBridge.TAG, "IPushMirrorListener, " + i10);
                if (i10 == 200) {
                    YimBridge yimBridge = YimBridge.this;
                    yimBridge.mPlayInfo.roomID = str2;
                    yimBridge.mBean.userID = CreateUtil.createYimUserID();
                    YimBridge.this.mBean.roomID = str2;
                    ...
                    SourceDataReport.getInstance().onGetRoomSuccess(YimBridge.this.mPlayInfo, str2);
                    OnLoadingListener onLoadingListener = YimBridge.this.mLoadingListener;
                    if (onLoadingListener != null) {
                        onLoadingListener.onLoading(null, null);
                    }
                } else if (i10 == -1) {
                    YimBridge.this.callbackError(211000, PlayerListenerConstant.EXTRA_ERROR_MIRROR_IO, str3);
                } else {
                    if (i10 != 410 && i10 != 411) {
                        if (i10 == 403) {
                            OnErrorListener onErrorListener = YimBridge.this.mErrorListener;
                            if (onErrorListener != null) {
                                onErrorListener.onError(null, 211000, 210004, str3);
                            }
                        } else {
                            SourceLog.w(YimBridge.TAG, "onError " + i10);
                            OnErrorListener onErrorListener2 = YimBridge.this.mErrorListener;
                            if (onErrorListener2 != null) {
                                onErrorListener2.onError(null, 211000, PlayerListenerConstant.EXTRA_ERROR_MIRROR_IO, str3);
                            }
                        }
                    } else {
                        OnErrorListener onErrorListener3 = YimBridge.this.mErrorListener;
                        if (onErrorListener3 != null) {
                            onErrorListener3.onError(null, 211000, PlayerListenerConstant.EXTRA_ERROR_MIRROR_SINK_CLOUD_UNSUPPORTED, str3);
                        }
                    }
    ...
    private void monitorExternalAudio() {
        OptionCentral.setOnExternalAudioStateChangedListener(new OptionCentral.OnExternalAudioStateChangedListener() { // from class: com.hpplay.sdk.source.protocol.YimBridge.8
            ...
            public void onStateChanged(boolean z10) {
                int audioCaptureType;
                SourceLog.i(YimBridge.TAG, "onStateChanged: isEnable: " + z10);
                if (z10) {
                    audioCaptureType = 1;
                } else {
                    audioCaptureType = CaptureBridge.getInstance().getAudioCaptureType(YimBridge.this.mPlayInfo);
                }
