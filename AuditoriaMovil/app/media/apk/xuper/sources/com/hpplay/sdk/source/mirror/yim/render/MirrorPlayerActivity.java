...
public class MirrorPlayerActivity extends Activity {
    ...
    public void onResume() {
        ...
        if (this.f7716n == null) {
            ...
            b();
        } else if (!TextUtils.isEmpty(this.f7713k) && this.f7709g != null) {
    ...
    private void b() {
        ...
        this.f7716n.setBackground(a.a((int) RoundedDrawable.DEFAULT_BORDER_COLOR, 30));
    ...
    private void a() {
        ...
        this.f7709g.addCloudMirrorListener(new OnCloudMirrorListener() { // from class: com.hpplay.sdk.source.mirror.yim.render.MirrorPlayerActivity.4
            public void a(int i10, Object... objArr) {
                ...
                OutParameter outParameter3 = MirrorPlayerActivity.this.f7712j;
                if (intValue == 1) {
                    z10 = true;
                } else {
                    z10 = false;
                }
                sourceDataReport.onYimInit(IMediaPlayer.MEDIA_INFO_NOT_SEEKABLE, outParameter3, z10, null, null);
            }
        });
    }
}
