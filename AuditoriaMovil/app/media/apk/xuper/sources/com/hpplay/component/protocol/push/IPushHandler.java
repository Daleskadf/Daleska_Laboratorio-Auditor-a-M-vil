            ...
            if (strArr != null && strArr.length > 0) {
                if (i10 != 1) {
                    if (i10 != 8) {
                        ...
                        return;
                    } else if (!IPushHandler.this.parsePlayBackInfo(i10, strArr[0], protocolListener)) {
                        protocolListener.onResult(i10, strArr);
                        return;
                    } else {
                        return;
                    }
                } else if (!strArr[0].contains(ProtocolBuilder.LELINK_STATE_SCREENCODE) || !screenCodeCallback(i10, protocolListener, strArr[0])) {
                    if (!strArr[0].contains(ProtocolBuilder.LELINK_STATE_SUCCESS) && !strArr[0].contains("successful")) {
                        if ("failed".equals(strArr[0])) {
                            ...
                            return;
                        } else if (IPushHandler.this instanceof LelinkV2PushHandler) {
                    ...
                    protocolListener.onResult(i10, "successful", jSONObject3.toString());
                    return;
                } else {
                    return;
                }
