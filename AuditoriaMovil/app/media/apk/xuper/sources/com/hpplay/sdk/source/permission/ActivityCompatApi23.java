...
class ActivityCompatApi23 {
    ...
    public static class SharedElementCallbackImpl extends SharedElementCallback {
        ...
        public void onSharedElementsArrived(List<String> list, List<View> list2, final SharedElementCallback.OnSharedElementsReadyListener onSharedElementsReadyListener) {
            this.mCallback.onSharedElementsArrived(list, list2, new OnSharedElementsReadyListenerBridge() { // from class: com.hpplay.sdk.source.permission.ActivityCompatApi23.SharedElementCallbackImpl.1
                @Override // com.hpplay.sdk.source.permission.ActivityCompatApi23.OnSharedElementsReadyListenerBridge
