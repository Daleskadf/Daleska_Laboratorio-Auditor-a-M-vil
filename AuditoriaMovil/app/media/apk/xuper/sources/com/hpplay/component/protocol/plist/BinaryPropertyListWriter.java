...
public final class BinaryPropertyListWriter {
    ...
    private static int getMinimumRequiredVersion(NSObject nSObject) {
        ...
        if (nSObject instanceof NSDictionary) {
            for (NSObject nSObject2 : ((NSDictionary) nSObject).getHashMap().values()) {
                int minimumRequiredVersion = getMinimumRequiredVersion(nSObject2);
                if (minimumRequiredVersion > i10) {
                    i10 = minimumRequiredVersion;
                }
            }
            return i10;
            ...
            while (i12 < length) {
                int minimumRequiredVersion2 = getMinimumRequiredVersion(array[i12]);
            ...
            while (i12 < length2) {
                int minimumRequiredVersion3 = getMinimumRequiredVersion(allObjects[i12]);
                if (minimumRequiredVersion3 > i11) {
                    i11 = minimumRequiredVersion3;
                }
                i12++;
            }
            return i11;
