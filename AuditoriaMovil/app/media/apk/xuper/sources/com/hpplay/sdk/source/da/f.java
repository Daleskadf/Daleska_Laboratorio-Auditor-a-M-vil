        ...
        this.f7647h.a(new l() { // from class: com.hpplay.sdk.source.da.f.2
            ...
            public void a(String str, String str2, com.hpplay.sdk.source.da.a.a aVar) {
                ...
                if (aVar != null && aVar.f7607a == 200 && (c0129a = aVar.f7608b) != null) {
                    ...
                    z10 = true;
                } else if (f.this.f7644e < f.this.f7643d) {
                    f.this.f();
                    return;
                } else {
                    z10 = false;
                ...
                if (f.this.f7650k != null) {
                    m mVar2 = f.this.f7650k;
                    if (z10) {
                        str3 = aVar.f7608b.f7617g;
                    } else {
                        str3 = null;
                    }
                    mVar2.onDaResult(true, str3);
                }
                if (!z10) {
                    if (aVar == null) {
                ...
                if (TextUtils.isEmpty(str5)) {
                    if (aVar != null && aVar.f7608b != null) {
                        f fVar = f.this;
                        OutParameter outParameter2 = fVar.f7651l;
                        a.C0129a c0129a2 = aVar.f7608b;
                        fVar.a(outParameter2, c0129a2.f7613c, c0129a2.f7614d, true, "");
                        return;
                    }
                    f fVar2 = f.this;
                ...
                f fVar3 = f.this;
                fVar3.a(fVar3.f7651l, "0", 0, false, str5);
            }
        });
        f();
    }
