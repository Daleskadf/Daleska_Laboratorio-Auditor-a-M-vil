        ...
        if (bArr == null) {
            ...
            if (this.error == 18) {
                ...
                if (bArr2.length != 6) {
                    ...
                    stringBuffer.append(new Date((((bArr2[0] & UnsignedBytes.MAX_VALUE) << 40) + ((bArr2[1] & UnsignedBytes.MAX_VALUE) << 32) + ((bArr2[2] & UnsignedBytes.MAX_VALUE) << 24) + ((bArr2[3] & UnsignedBytes.MAX_VALUE) << 16) + ((bArr2[4] & UnsignedBytes.MAX_VALUE) << 8) + (bArr2[5] & UnsignedBytes.MAX_VALUE)) * 1000));
