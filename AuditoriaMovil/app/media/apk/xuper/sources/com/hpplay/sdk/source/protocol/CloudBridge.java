    ...
    public CloudBridge(Context context, OutParameter outParameter) {
        ...
        this.mStateListener = new OnPlayStateListener() { // from class: com.hpplay.sdk.source.protocol.CloudBridge.1
            ...
            public void onStart(String str) {
                ...
                } else if (!cloudBridge.isCallPrepared) {
    ...
    public void play(String str) {
        ...
        PublicCastClient.getInstance().play(this.mPlayInfo, "", new AsyncHttpRequestListener() { // from class: com.hpplay.sdk.source.protocol.CloudBridge.2
            ...
            public void onRequestResult(AsyncHttpParameter asyncHttpParameter) {
                ...
                if (asyncHttpParameter != null && (out2 = asyncHttpParameter.out) != null && out2.resultType == 2) {
                ...
                } else if (asyncHttpParameter != null && (out = asyncHttpParameter.out) != null && (str2 = out.result) != null) {
                    ...
                    if (optInt == 403) {
                        OnErrorListener onErrorListener = CloudBridge.this.mErrorListener;
                        if (onErrorListener != null) {
                            onErrorListener.onError(null, 210010, 210004, SourceErrorLog.getInstance().getErrorReportExtra(ErrorCode.PUSH_ERROR_CLOUD_PUSH_TV_OFFLINE, str2));
                            return;
                        }
                        return;
                    }
                    ...
                    if (onErrorListener2 != null) {
                        onErrorListener2.onError(null, 210010, 210011, SourceErrorLog.getInstance().getErrorReportExtra(ErrorCode.PUSH_ERROR_CLOUD_PUSH_FAILURE, str2));
                    }
                } else {
                    ...
                    if (onErrorListener3 != null) {
                        onErrorListener3.onError(null, 210000, 210011, SourceErrorLog.getInstance().getErrorReportExtra(ErrorCode.PUSH_ERROR_CLOUD_PUSH_FAILURE, "result is null"));
                    }
                }
            }
        });
