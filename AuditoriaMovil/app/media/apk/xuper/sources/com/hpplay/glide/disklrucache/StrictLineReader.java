    ...
    public String readLine() {
        ...
        synchronized (this.in) {
            if (this.buf != null) {
                ...
                ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream((this.end - this.pos) + 80) { // from class: com.hpplay.glide.disklrucache.StrictLineReader.1
