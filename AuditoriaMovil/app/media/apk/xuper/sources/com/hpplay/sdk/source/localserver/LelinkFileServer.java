...
public class LelinkFileServer extends d {
    ...
    private c respond(Map<String, String> map, com.hpplay.a.a.a.c cVar, String str) {
        if (a.OPTIONS.equals(cVar.e())) {
            return c.a(com.hpplay.a.a.a.c.d.OK, d.MIME_PLAINTEXT, null, 0L);
        }
    ...
    private c serveFileForStream(Uri uri, Map<String, String> map, InputStream inputStream, String str) {
        ...
        try {
            ...
            z10 = (str52 != null || "".equals(str52)) ? true : true;
            str4 = map.get("if-none-match");
        ...
        try {
            if (!z10 && str3 != null && j11 >= 0 && j11 < available) {
                ...
                a10 = c.a(com.hpplay.a.a.a.c.d.PARTIAL_CONTENT, str, inputStream, j12);
                a10.a(HttpHeaders.ACCEPT_RANGES, HTTP.CONTENT_RANGE_BYTES);
                a10.a("Content-Length", "" + j12);
    ...
    /* JADX WARN: Removed duplicated region for block: B:23:0x0088 A[Catch: Exception -> 0x018e, TryCatch #1 {Exception -> 0x018e, blocks: (B:3:0x000a, B:5:0x0041, B:7:0x0049, B:14:0x006a, B:16:0x0074, B:21:0x007e, B:23:0x0088, B:25:0x0090, B:29:0x0099, B:64:0x0173), top: B:72:0x000a }] */
