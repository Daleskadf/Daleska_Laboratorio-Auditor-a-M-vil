...
public class PushControllerImpl extends IPushController {
    ...
    public void genPushConnection(String str, ParamsMap paramsMap) {
        ...
        if (paramsMap.get(ParamsMap.DeviceParams.KEY_LELINK_PORT) != 0 && paramsMap.get(ParamsMap.DeviceParams.KEY_LELINK_PORT).toString().length() > 0) {
            i10 = Integer.parseInt(paramsMap.get(ParamsMap.DeviceParams.KEY_LELINK_PORT).toString());
        } else {
            i10 = 0;
        }
        ...
        if (i11 != 1) {
            if (i11 != 3) {
                if (i11 == 5) {
                    ...
                    this.mReverseChannel = new LelinkReverseChannel(str2, i10, stringParam);
                    this.mProtocolSender.setConnectInfo(str2, i10);
            ...
            this.mReverseChannel = new LelinkReverseChannel(str2, i10);
            this.mProtocolSender.setConnectInfo(str2, i10);
