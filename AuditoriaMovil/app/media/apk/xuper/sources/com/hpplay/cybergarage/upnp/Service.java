...
public class Service {
    ...
    private boolean isURL(String str, String str2) {
        if (str == null || str2 == null || (!str2.equals(str) && !str2.equals(HTTP.toRelativeURL(str, false)))) {
            return false;
        }
        return true;
    }
    ...
    public void addStateVariable(StateVariable stateVariable) {
        ...
        Node sCPDNode = getSCPDNode();
        if (sCPDNode != null) {
            node = sCPDNode.getNode(ServiceStateTable.ELEM_NAME);
        } else {
            node = null;
        }
        if (node == null) {
    ...
    public boolean isService(String str) {
        ...
        if (!str.endsWith(getServiceType()) && !str.endsWith(getServiceID())) {
            return false;
        }
        return true;
    }
