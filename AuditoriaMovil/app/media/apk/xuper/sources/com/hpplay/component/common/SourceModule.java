...
public interface SourceModule {
    ...
    public static final String RESULT_CONNECTION_DISCONNECT = "connection_disconnect";
    public static final String RESULT_ENCRYPT_FAILED = "encrypt_failed";
    public static final String RESULT_FAILED = "failed";
    public static final String RESULT_NEED_SCREENCODE = "need_screencode";
