...
public class LelinkPushBridge extends AbsBridge {
    ...
    public void handleMsg(Message message) {
        ...
        if (i11 == 1) {
            if (this.mLoadingListener != null) {
                ...
                this.mLoadingListener.onLoading(null, str2);
            }
            if (this.mPlayInfo.protocol == 3) {
            ...
            this.mErrorListener.onError(null, 210010, 210011, str2);
        }
    }
    ...
    private boolean isSameDlna(String... strArr) {
        ...
        if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(this.mDlnaUUID) && !TextUtils.equals(str, this.mDlnaUUID)) {
            SourceLog.w(TAG, "isSameDlna unEqual uri, " + str + " / " + this.mDlnaUUID);
            return false;
        }
        if (!TextUtils.isEmpty(str2) && !isSameUrl(str2, this.mPlayInfo.getPlayUrl())) {
            SourceLog.w(TAG, "isSameDlna unEqual url, " + str2 + " / " + this.mPlayInfo.getPlayUrl());
            this.mPreDLNAStopUrl = str2;
            return false;
        }
        return true;
    }
