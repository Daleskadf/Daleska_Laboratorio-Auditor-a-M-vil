...
public final class MessageDao implements a.b {
    ...
    /* JADX WARN: Removed duplicated region for block: B:12:0x0033 A[Catch: RuntimeException -> 0x003e, TRY_LEAVE, TryCatch #0 {RuntimeException -> 0x003e, blocks: (B:3:0x0006, B:5:0x0026, B:12:0x0033), top: B:21:0x0006 }] */
    /*
    ...
    */
    ...
    public final List<InAppMsg> queryInAppMsgByMsgType(String str, String str2) {
        ...
        try {
            a aVar = this.f8273db;
            return aVar.n(InAppMsg.class, "userId='" + str + "' and messageType='" + str2 + '\'', "id DESC");
    ...
    public final List<InAppMsg> queryInAppMsgList(String str, String str2, String str3) {
        ...
        try {
            a aVar = this.f8273db;
            return aVar.n(InAppMsg.class, "userId='" + str + "' and messageType='" + str2 + "' and type='" + str3 + '\'', "id DESC");
        } catch (RuntimeException e10) {
            e10.printStackTrace();
            String message = e10.getMessage();
            if (!TextUtils.isEmpty(message)) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:11:0x0032 A[Catch: RuntimeException -> 0x005f, TryCatch #0 {RuntimeException -> 0x005f, blocks: (B:3:0x0006, B:5:0x0026, B:11:0x0032, B:13:0x0043), top: B:22:0x0006 }] */
    /* JADX WARN: Removed duplicated region for block: B:13:0x0043 A[Catch: RuntimeException -> 0x005f, TRY_LEAVE, TryCatch #0 {RuntimeException -> 0x005f, blocks: (B:3:0x0006, B:5:0x0026, B:11:0x0032, B:13:0x0043), top: B:22:0x0006 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
