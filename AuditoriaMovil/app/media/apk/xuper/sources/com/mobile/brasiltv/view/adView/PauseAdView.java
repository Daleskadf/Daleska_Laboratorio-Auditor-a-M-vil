...
public final class PauseAdView extends LinearLayout {
    ...
    private final void loadFirstAd() {
        ...
        AdInfo H = mVar.H(context, l10, "picture", cVar.I(), true, cVar.r());
        if (H == null) {
            loadAdMob();
        } else {
            loadSelfAdOnAdmob(l10, H);
        }
    }
    ...
    private final void loadSelfAd() {
        ...
        s1.m.h0(mVar, context2, imageView, k11, H, null, new PauseAdView$loadSelfAd$1(H, this), Integer.MIN_VALUE, false, 0, 400, null);
    ...
    public static final void loadSelfAd$lambda$3(AdInfo adInfo, PauseAdView pauseAdView, View view) {
        ...
        if (t9.i.b(adInfo.getAction_type(), "1") && !TextUtils.isEmpty(adInfo.getAction())) {
            ...
            qVar.h(context2, bVar.m(context3), a6.a.f228a.k(), adInfo);
    ...
    private final void loadSelfAdOnAdmob(final String str, final AdInfo adInfo) {
        ...
        s1.m.h0(mVar, context, imageView, str, adInfo, null, new PauseAdView$loadSelfAdOnAdmob$1(this, adInfo, str), Integer.MIN_VALUE, false, 0, 400, null);
