...
public class AnimatorFrameLayout extends AutoFrameLayout {
    ...
    public void setVisibility(final int i10) {
        ...
        if (i10 == 0) {
            ...
            ObjectAnimator duration = ObjectAnimator.ofFloat(this, "translationX", -getWidth(), 0.0f).setDuration(500L);
            duration.setInterpolator(new DecelerateInterpolator());
            duration.addListener(new AnimatorListenerAdapter() { // from class: com.mobile.brasiltv.view.AnimatorFrameLayout.1
        ...
        ObjectAnimator duration2 = ObjectAnimator.ofFloat(this, "translationX", 0.0f, -getWidth()).setDuration(500L);
        duration2.setInterpolator(new DecelerateInterpolator());
        duration2.addListener(new AnimatorListenerAdapter() { // from class: com.mobile.brasiltv.view.AnimatorFrameLayout.2
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
                AnimatorFrameLayout.this.animatorEnd = true;
