...
public final class ViewfinderView extends View {
    ...
    public final void b(Canvas canvas, Rect rect) {
        ...
        int i10 = rect.left;
        int i11 = rect.top;
        canvas.drawRect(i10, i11, i10 + 8, i11 + 40, this.f8799a);
        int i12 = rect.left;
        int i13 = rect.top;
        canvas.drawRect(i12, i13, i12 + 40, i13 + 8, this.f8799a);
        int i14 = rect.right;
        int i15 = rect.top;
        canvas.drawRect(i14 - 8, i15, i14, i15 + 40, this.f8799a);
        int i16 = rect.right;
        int i17 = rect.top;
        canvas.drawRect(i16 - 40, i17, i16, i17 + 8, this.f8799a);
        int i18 = rect.left;
        int i19 = rect.bottom;
        canvas.drawRect(i18, i19 - 8, i18 + 40, i19, this.f8799a);
        int i20 = rect.left;
        int i21 = rect.bottom;
        canvas.drawRect(i20, i21 - 40, i20 + 8, i21, this.f8799a);
        int i22 = rect.right;
        int i23 = rect.bottom;
        canvas.drawRect(i22 - 8, i23 - 40, i22, i23, this.f8799a);
        int i24 = rect.right;
        int i25 = rect.bottom;
        canvas.drawRect(i24 - 40, i25 - 8, i24, i25, this.f8799a);
    }
    ...
    public final void d(Canvas canvas, Rect rect) {
        ...
        canvas.drawRect(rect.left, rect.top, rect.right + 1, i10 + 2, this.f8799a);
        canvas.drawRect(rect.left, rect.top + 2, i11 + 2, rect.bottom - 1, this.f8799a);
        int i12 = rect.right;
        canvas.drawRect(i12 - 1, rect.top, i12 + 1, rect.bottom - 1, this.f8799a);
        float f10 = rect.left;
        int i13 = rect.bottom;
        canvas.drawRect(f10, i13 - 1, rect.right + 1, i13 + 1, this.f8799a);
    }
    ...
    public final void e(Canvas canvas, Rect rect) {
        ...
        int i12 = rect.left;
        LinearGradient linearGradient = new LinearGradient(i12, f8797n, i12, i10 + 10, h(this.f8804f), this.f8804f, Shader.TileMode.MIRROR);
        float width = rect.left + (rect.width() / 2);
        float f10 = f8797n + 5;
        int i13 = this.f8804f;
        RadialGradient radialGradient = new RadialGradient(width, f10, 360.0f, i13, h(i13), Shader.TileMode.MIRROR);
        ...
        if (f8797n <= f8798o) {
            canvas.drawOval(new RectF(rect.left + 20, f8797n, rect.right - 20, i11 + 10), this.f8799a);
            f8797n += 5;
        } else {
            f8797n = rect.top;
        }
