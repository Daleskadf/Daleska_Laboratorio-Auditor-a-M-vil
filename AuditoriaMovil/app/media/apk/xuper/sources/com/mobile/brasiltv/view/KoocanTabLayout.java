...
public class KoocanTabLayout extends HorizontalScrollView implements ValueAnimator.AnimatorUpdateListener {
    ...
    public KoocanTabLayout(Context context) {
        this(context, null, 0);
    }
    ...
    private void addTab(int i10, View view) {
        ...
        view.setOnClickListener(new View.OnClickListener() { // from class: com.mobile.brasiltv.view.KoocanTabLayout.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                int intValue = ((Integer) view2.getTag()).intValue();
                if (KoocanTabLayout.this.mCurrentTab != intValue) {
                    KoocanTabLayout.this.setCurrentTab(intValue);
                    if (KoocanTabLayout.this.mListener != null) {
                        KoocanTabLayout.this.mListener.onTabSelect(intValue);
                    }
                } else if (KoocanTabLayout.this.mListener != null) {
                    KoocanTabLayout.this.mListener.onTabReselect(intValue);
                }
            }
        });
    ...
    private void calcIndicatorRect() {
        ...
        if (this.mIndicatorWidth >= 0.0f) {
            ...
            float left = childAt.getLeft() + ((childAt.getWidth() - f10) / 2.0f);
    ...
    private void obtainAttributes(Context context, AttributeSet attributeSet) {
        ...
        this.mIndicatorWidth = obtainStyledAttributes.getDimension(20, dp2px(f11));
        if (this.mIndicatorStyle == 2) {
            f12 = -1.0f;
        } else {
            f12 = 0.0f;
        }
        this.mIndicatorCornerRadius = obtainStyledAttributes.getDimension(12, dp2px(f12));
        ...
        this.mIndicatorMarginTop = obtainStyledAttributes.getDimension(18, dp2px(f13));
        this.mIndicatorMarginRight = obtainStyledAttributes.getDimension(17, dp2px(0.0f));
        if (this.mIndicatorStyle != 2) {
            f14 = 0.0f;
        }
        this.mIndicatorMarginBottom = obtainStyledAttributes.getDimension(15, dp2px(f14));
        ...
        this.mTabPadding = obtainStyledAttributes.getDimension(21, dp2px);
    ...
    private void updateTabSelection(int i10) {
        ...
        for (int i12 = 0; i12 < this.mTabCount; i12++) {
            ...
            CustomTabEntity customTabEntity = this.mTabEntitys.get(i12);
            if (z10) {
    ...
    public void onAnimationUpdate(ValueAnimator valueAnimator) {
        ...
        if (this.mIndicatorWidth >= 0.0f) {
            ...
            float width = f10 + ((childAt.getWidth() - f11) / 2.0f);
            Rect rect2 = this.mIndicatorRect;
            int i10 = (int) width;
            rect2.left = i10;
        ...
        if (!isInEditMode() && this.mTabCount > 0) {
            ...
            if (i11 == 1) {
                if (this.mIndicatorHeight > 0.0f) {
                    ...
                    Rect rect2 = this.mIndicatorRect;
                    path.lineTo((rect2.left / 2) + paddingLeft + (rect2.right / 2), f12 - this.mIndicatorHeight);
                ...
                if (f13 > 0.0f) {
                    ...
                    gradientDrawable.setBounds(i12, (int) f15, (int) ((paddingLeft + rect.right) - this.mIndicatorMarginRight), (int) (f15 + this.mIndicatorHeight));
    ...
    public void setMsgMargin(int i10, float f10, float f11) {
        ...
        if (msgView != null) {
            ...
            if (i12 != 48 && i12 != 80) {
                ...
                if (i13 > 0) {
                    dp2px2 = (((int) (i13 - Math.max(descent, f12))) / 2) - dp2px(f11);
                } else {
                    dp2px2 = dp2px(f11);
                }
                ...
                if (i14 > 0) {
                    dp2px = (((int) (((i14 - descent) - f12) - f13)) / 2) - dp2px(f11);
                } else {
                    dp2px = dp2px(f11);
                }
    ...
    public KoocanTabLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public KoocanTabLayout(Context context, AttributeSet attributeSet, int i10) {
    ...
    public void setTabData(ArrayList<CustomTabEntity> arrayList, androidx.fragment.app.e eVar, int i10, ArrayList<Fragment> arrayList2) {
