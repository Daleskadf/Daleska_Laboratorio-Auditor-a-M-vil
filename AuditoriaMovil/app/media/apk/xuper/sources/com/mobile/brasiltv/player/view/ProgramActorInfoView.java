...
public final class ProgramActorInfoView extends AutoRelativeLayout {
    ...
    public final void d(AssetData assetData) {
        ...
        if (b0.H(assetData.getOriginalCountry())) {
            z11 = assetData.getOriginalCountry();
        } else {
            z11 = b0.z(R.string.unkownInfo);
        }
        ...
        if (b0.H(assetData.getReleaseTime())) {
            if (assetData.getReleaseTime().length() >= 4) {
                z12 = assetData.getReleaseTime().substring(0, 4);
                i.f(z12, "this as java.lang.String…ing(startIndex, endIndex)");
            } else {
                z12 = assetData.getReleaseTime();
            }
        } else {
            z12 = b0.z(R.string.unkownInfo);
        }
    ...
    public final void h(VodDao vodDao, AssetData assetData, String str, boolean z10) {
        ...
        ProgramSetInfoView.s(programSetInfoView, vodDao, assetData, str, z10, false, 16, null);
    }
