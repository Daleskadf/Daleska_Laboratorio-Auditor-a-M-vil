...
public class KoocanRecyclerView extends RecyclerView {
    ...
    public void setVisibilityAnimate(final int i10) {
        ...
        if (i10 == 0) {
            super.setVisibility(i10);
            ObjectAnimator duration = ObjectAnimator.ofFloat(this, "translationY", (-getContext().getResources().getDisplayMetrics().heightPixels) / 2, 0.0f).setDuration(400L);
            duration.setInterpolator(new DecelerateInterpolator());
            duration.addListener(new AnimatorListenerAdapter() { // from class: com.mobile.brasiltv.view.KoocanRecyclerView.2
        ...
        ObjectAnimator duration2 = ObjectAnimator.ofFloat(this, "translationY", 0.0f, (-getContext().getResources().getDisplayMetrics().heightPixels) / 2).setDuration(400L);
        duration2.setInterpolator(new DecelerateInterpolator());
        duration2.addListener(new AnimatorListenerAdapter() { // from class: com.mobile.brasiltv.view.KoocanRecyclerView.3
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
                KoocanRecyclerView.this.animatorEnd = true;
