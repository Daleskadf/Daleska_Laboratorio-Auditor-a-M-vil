...
public class VerticalViewPager extends ViewGroup {
    ...
    private void calculatePageOffsets(ItemInfo itemInfo, int i10, ItemInfo itemInfo2) {
        ...
        if (clientHeight > 0) {
            f10 = this.mPageMargin / clientHeight;
        } else {
            f10 = 0.0f;
        }
        if (itemInfo2 != null) {
        ...
        while (i20 >= 0) {
            ...
            f15 -= itemInfo7.heightFactor + f10;
        ...
        while (i22 < size2) {
            ...
            if (i11 == i19) {
                this.mLastOffset = (itemInfo8.heightFactor + f16) - 1.0f;
            }
            itemInfo8.offset = f16;
            f16 += itemInfo8.heightFactor + f10;
            i22++;
            i21++;
        }
        this.mNeedCalculatePageOffsets = false;
    ...
    private ItemInfo infoForCurrentScrollPosition() {
        ...
        float f12 = 0.0f;
        if (clientHeight > 0) {
            f10 = getScrollY() / clientHeight;
        } else {
            f10 = 0.0f;
        }
        if (clientHeight > 0) {
            f11 = this.mPageMargin / clientHeight;
        } else {
            f11 = 0.0f;
        }
    ...
    private boolean isGutterDrag(float f10, float f11) {
        if ((f10 < this.mGutterSize && f11 > 0.0f) || (f10 > getHeight() - this.mGutterSize && f11 < 0.0f)) {
            return true;
        }
        return false;
    }
    ...
    private void recomputeScrollPosition(int i10, int i11, int i12, int i13) {
        ...
        int paddingTop = (int) (f10 * ((i10 - getPaddingTop()) - getPaddingBottom()));
    ...
    private void scrollToItem(int i10, boolean z10, int i11, boolean z11) {
        ...
        if (infoForPosition != null) {
            i12 = (int) (getClientHeight() * Math.max(this.mFirstOffset, Math.min(infoForPosition.offset, this.mLastOffset)));
        } else {
            i12 = 0;
        }
        if (z10) {
    ...
    */
    ...
    float distanceInfluenceForSnapDuration(float f10) {
        ...
        return (float) Math.sin((float) (d10 * 0.4712389167638204d));
    }
    ...
    public boolean internalCanScrollVertically(int i10) {
        ...
        if (i10 < 0) {
            ...
            return true;
        } else if (i10 <= 0 || scrollY >= ((int) (clientHeight * this.mLastOffset))) {
            return false;
        } else {
            return true;
        }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.mPageMargin > 0 && this.mMarginDrawable != null && this.mItems.size() > 0 && this.mAdapter != null) {
            ...
            float f12 = this.mPageMargin / height2;
            int i11 = 0;
            ItemInfo itemInfo = this.mItems.get(0);
            ...
            if (action != 0) {
                if (action != 2) {
                    ...
                    if (i10 != -1) {
                        ...
                        if (f12 != 0.0f && !isGutterDrag(this.mLastMotionY, f12) && canScroll(this, false, (int) f12, (int) e10, (int) f11)) {
                        ...
                        if (abs > i11 && abs * 0.5f > abs2) {
                            ...
                            setScrollState(1);
                            if (f12 > 0.0f) {
                                f10 = this.mInitialMotionY + this.mTouchSlop;
                            } else {
                                f10 = this.mInitialMotionY - this.mTouchSlop;
                            }
                            this.mLastMotionY = f10;
            ...
            if (action != 1) {
                if (action != 2) {
                    ...
                    if (!this.mIsBeingDragged) {
                        ...
                        float f13 = u.f(motionEvent, a10);
                        float abs = Math.abs(f13 - this.mLastMotionY);
                        float e10 = u.e(motionEvent, a10);
