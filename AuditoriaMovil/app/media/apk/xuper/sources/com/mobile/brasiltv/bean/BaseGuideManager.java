...
public class BaseGuideManager {
    ...
    public boolean isShow() {
        ...
        if (this.introVersion == null) {
            return e0.f8646a.a(App.f8263e.a(), this.key, true);
        }
        return !i.b(e0.c(e0.f8646a, App.f8263e.a(), this.key, null, 4, null), this.introVersion);
    }
    ...
    public void showGuideInner(Context context, View view) {
        ...
        if (b0.K(this.okStr)) {
            ...
            if (findNextShow() == null) {
                string = context.getString(R.string.no_update_ok);
            } else {
                string = context.getString(R.string.next_step);
            }
    ...
    public final void showNext() {
        ...
        if (guideNextClickListener != null) {
            ...
            guideNextClickListener.onGuideNextClick(str, z10);
        }
