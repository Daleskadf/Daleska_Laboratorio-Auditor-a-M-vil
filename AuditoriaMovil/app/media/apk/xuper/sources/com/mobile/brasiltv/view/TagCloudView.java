...
public class TagCloudView extends ViewGroup {
    ...
    private int getSingleTotalHeight(int i10, int i11) {
        ...
        if (imageView != null) {
            ...
            imageView.layout((i20 - this.imageWidth) - i18, (i19 - i21) / 2, i20 - i18, ((i19 - i21) / 2) + i21);
        }
        return i19;
    }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (this.mSingleLine) {
            multiTotalHeight = getSingleTotalHeight(0, i12);
        } else {
            multiTotalHeight = getMultiTotalHeight(0, i12);
        }
        int i13 = this.sizeWidth;
        if (mode == 1073741824) {
            multiTotalHeight = this.sizeHeight;
        }
        setMeasuredDimension(i13, multiTotalHeight);
    }
