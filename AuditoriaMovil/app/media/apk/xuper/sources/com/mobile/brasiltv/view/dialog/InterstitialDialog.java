...
public final class InterstitialDialog extends BaseDialog {
    ...
    public static final void onCreate$lambda$1(InterstitialDialog interstitialDialog, View view) {
        ...
        if (adInfo2 != null) {
            str2 = adInfo2.getAction_type();
        }
        if (t9.i.b(str2, CdnType.DIGITAL_TYPE_PCDN)) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        s1.m.h0(mVar, context, roundedImageView, aVar.d(), this.adInfo, null, null, null, false, 0, 496, null);
