...
public class UpgradeProgressView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(f10, f10, getMeasuredWidth() - f11, f11, this.f8999d);
        float measuredWidth = ((this.f8996a * 1.0f) * getMeasuredWidth()) / 100.0f;
        ...
        if (this.f8996a <= 10) {
            measureText = measuredWidth + this.f8997b;
        } else {
            measureText = (measuredWidth - this.f9001f.measureText(str)) - this.f8997b;
        }
        canvas.drawText(str, measureText, this.f8998c, this.f9001f);
    }
    ...
    public void setInvalid(boolean z10) {
        ...
        if (z10) {
            linearGradient = new LinearGradient(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), new int[]{Color.parseColor("#5c5c66"), Color.parseColor("#5c5c66")}, (float[]) null, Shader.TileMode.CLAMP);
        } else {
            linearGradient = new LinearGradient(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight(), new int[]{Color.parseColor("#56e3ff"), Color.parseColor("#33a7fe")}, (float[]) null, Shader.TileMode.CLAMP);
        }
        this.f9000e.setShader(linearGradient);
        invalidate();
    }
