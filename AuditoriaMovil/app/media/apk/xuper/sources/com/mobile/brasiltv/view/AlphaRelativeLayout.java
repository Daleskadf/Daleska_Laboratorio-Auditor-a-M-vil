...
public class AlphaRelativeLayout extends AutoRelativeLayout {
    ...
    public final void delayHide() {
        ...
        this.subscription = compose.subscribe(new Consumer() { // from class: com.mobile.brasiltv.view.a
    ...
    public void setVisibility(int i10) {
        ...
        ofFloat2.addListener(new AnimatorListenerAdapter() { // from class: com.mobile.brasiltv.view.AlphaRelativeLayout$setVisibility$1
