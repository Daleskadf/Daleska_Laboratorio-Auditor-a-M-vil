...
public class AutoLayoutHelper {
    ...
    private static final int[] LL = {16842901, 16842965, 16842966, 16842967, 16842968, 16842969, 16842996, 16842997, 16842998, 16842999, 16843000, 16843001, 16843002, 16843039, 16843040, 16843071, 16843072};
    ...
    public static AutoLayoutInfo getAutoLayoutInfo(Context context, AttributeSet attributeSet) {
        ...
        int i10 = obtainStyledAttributes.getInt(R.styleable.AutoLayout_Layout_layout_auto_basewidth, 0);
        int i11 = obtainStyledAttributes.getInt(R.styleable.AutoLayout_Layout_layout_auto_baseheight, 0);
