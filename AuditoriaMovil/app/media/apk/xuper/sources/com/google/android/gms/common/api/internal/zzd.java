...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    public static zzd zzc(e eVar) {
        ...
        try {
            zzd zzdVar2 = (zzd) eVar.getSupportFragmentManager().h0("SupportLifecycleFragmentImpl");
            if (zzdVar2 == null || zzdVar2.isRemoving()) {
                zzdVar2 = new zzd();
                eVar.getSupportFragmentManager().m().e(zzdVar2, "SupportLifecycleFragmentImpl").i();
            }
