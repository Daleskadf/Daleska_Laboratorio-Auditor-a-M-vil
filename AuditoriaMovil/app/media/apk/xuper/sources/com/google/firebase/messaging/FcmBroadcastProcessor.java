...
public class FcmBroadcastProcessor {
    ...
    public static /* synthetic */ Integer lambda$startMessagingService$1(Task task) {
        return Integer.valueOf((int) UPnPStatus.OUT_OF_SYNC);
    }
    ...
    public static /* synthetic */ Task lambda$startMessagingService$2(Context context, Intent intent, Task task) {
        if (PlatformVersion.isAtLeastO() && ((Integer) task.getResult()).intValue() == 402) {
            return bindToMessagingService(context, intent).continueWith(new c(), new Continuation() { // from class: com.google.firebase.messaging.g
