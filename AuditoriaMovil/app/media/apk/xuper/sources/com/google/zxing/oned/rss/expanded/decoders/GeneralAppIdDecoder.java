...
public final class GeneralAppIdDecoder {
    ...
    private boolean isStillAlpha(int i10) {
        ...
        if (i10 + 6 > this.information.getSize() || (extractNumericValueFromBitArray = extractNumericValueFromBitArray(i10, 6)) < 16 || extractNumericValueFromBitArray >= 63) {
            return false;
        }
        return true;
    }
    ...
    private boolean isStillIsoIec646(int i10) {
        ...
        if (i10 + 8 > this.information.getSize() || (extractNumericValueFromBitArray = extractNumericValueFromBitArray(i10, 8)) < 232 || extractNumericValueFromBitArray >= 253) {
            return false;
        }
        return true;
    }
    ...
    private boolean isStillNumeric(int i10) {
        if (i10 + 7 > this.information.getSize()) {
            if (i10 + 4 <= this.information.getSize()) {
                return true;
            }
            return false;
        }
    ...
    public String decodeAllCodes(StringBuilder sb, int i10) {
        ...
        String str2 = null;
        while (true) {
            DecodedInformation decodeGeneralPurposeField = decodeGeneralPurposeField(i10, str2);
