...
public final class Detector {
    ...
    private ResultPoint[] getBullsEyeCorners(Point point) {
        ...
        while (this.nbCenterLayers < 9) {
            Point firstDifferent = getFirstDifferent(point2, z11, 1, -1);
            Point firstDifferent2 = getFirstDifferent(point3, z11, 1, 1);
            Point firstDifferent3 = getFirstDifferent(point4, z11, -1, 1);
            Point firstDifferent4 = getFirstDifferent(point5, z11, -1, -1);
