...
public final class HostAndPort implements Serializable {
    ...
    */
    ...
    private static String[] getHostAndPortFromBracketedHost(String str) {
        ...
        Preconditions.checkArgument(z10, "Bracketed host-port string must start with a bracket: %s", str);
        ...
        Preconditions.checkArgument(z11, "Invalid bracketed host/port: %s", str);
        ...
        Preconditions.checkArgument(z12, "Only a colon may follow a close bracket: %s", str);
