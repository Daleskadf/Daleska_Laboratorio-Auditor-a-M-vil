    ...
    public void onDraw(@RecentlyNonNull Canvas canvas) {
        ...
        if (zzcVar == null) {
            ...
            if (zzeVar.zzf) {
                int i11 = zzeVar.zzd;
                if (i11 > 0) {
                    zzg(canvas, 0, i11, zzeVar.zzb, measuredWidth, this.zzo);
                }
                zze zzeVar2 = this.zza;
                int i12 = zzeVar2.zzd;
                if (progress > i12) {
                    zzg(canvas, i12, progress, zzeVar2.zzb, measuredWidth, this.zzm);
                }
                zze zzeVar3 = this.zza;
                int i13 = zzeVar3.zze;
                if (i13 > progress) {
                    zzg(canvas, progress, i13, zzeVar3.zzb, measuredWidth, this.zzn);
                }
            ...
            if (isEnabled() && this.zza.zzf) {
                ...
                canvas.drawCircle((int) ((d10 / d11) * d12), ((measuredHeight3 - paddingTop3) - paddingBottom3) / 2.0f, this.zzj, this.zzl);
