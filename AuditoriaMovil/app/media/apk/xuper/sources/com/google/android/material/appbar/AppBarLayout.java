...
public class AppBarLayout extends LinearLayout {
    ...
    public static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        @Override // com.google.android.material.appbar.HeaderBehavior
        public /* bridge */ /* synthetic */ int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, View view, int i10, int i11, int i12) {
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, T t10, int i10) {
            ...
            if (i11 >= 0 && (pendingAction & 8) == 0) {
                ...
                if (this.offsetToChildIndexOnLayoutIsMinHeight) {
                    round = c1.A(childAt) + t10.getTopInset();
                } else {
                ...
                if ((pendingAction & 2) != 0) {
                    ...
                    if (z10) {
                        animateOffsetTo(coordinatorLayout, t10, i13, 0.0f);
                    } else {
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet, int i10) {
        ...
        if (i11 >= 21) {
            ...
            if (obtainStyledAttributes.hasValue(i13)) {
                ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, obtainStyledAttributes.getDimensionPixelSize(i13, 0));
            }
        }
        if (i11 >= 26) {
