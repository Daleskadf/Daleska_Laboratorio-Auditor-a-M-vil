...
final class zzcy extends zzdl {
    ...
    public final void zza(com.google.android.gms.cast.internal.zzw zzwVar) {
        ...
        int i11 = this.zzb;
        if (i11 < 0) {
            setResult((zzcy) new zzdk(this, new Status((int) CastStatusCodes.INVALID_REQUEST, String.format(Locale.ROOT, "Invalid request: Invalid newIndex %d.", Integer.valueOf(this.zzb)))));
        } else if (zza == i11) {
            setResult((zzcy) new zzdk(this, new Status(0)));
        } else {
            MediaStatus mediaStatus = this.zzd.getMediaStatus();
            if (mediaStatus == null) {
                setResult((zzcy) new zzdk(this, new Status((int) CastStatusCodes.INVALID_REQUEST, String.format(Locale.ROOT, "Invalid request: Invalid MediaStatus", new Object[0]))));
                return;
            }
            int i12 = this.zzb;
            if (i12 > zza) {
            ...
            zzapVar.zzz(zzb(), new int[]{this.zza}, i10, this.zzc);
        }
    }
}
