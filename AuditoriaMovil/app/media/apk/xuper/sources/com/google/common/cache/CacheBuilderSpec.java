...
public final class CacheBuilderSpec {
    ...
    public static class MaximumSizeParser extends LongParser {
        ...
        public void parseLong(CacheBuilderSpec cacheBuilderSpec, long j10) {
            ...
            Preconditions.checkArgument(z10, "maximum size was already set to ", l10);
            Long l11 = cacheBuilderSpec.maximumWeight;
            if (l11 != null) {
                z11 = false;
            }
            Preconditions.checkArgument(z11, "maximum weight was already set to ", l11);
    ...
    public static class MaximumWeightParser extends LongParser {
        ...
        public void parseLong(CacheBuilderSpec cacheBuilderSpec, long j10) {
            ...
            Preconditions.checkArgument(z10, "maximum weight was already set to ", l10);
            Long l11 = cacheBuilderSpec.maximumSize;
            if (l11 != null) {
                z11 = false;
            }
            Preconditions.checkArgument(z11, "maximum size was already set to ", l11);
