...
final class DecodedBitStreamParser {
    ...
    private static String getMessage(byte[] bArr, int i10, int i11) {
        ...
        int i19 = 0;
        while (i16 < i10 + i11) {
            char charAt = SETS[i17].charAt(bArr[i16]);
            switch (charAt) {
                case 65520:
                case 65521:
                case 65522:
                ...
                case 65531:
                    i16 = i16 + 1 + 1 + 1 + 1 + 1;
                    sb.append(new DecimalFormat("000000000").format((bArr[i12] << Ascii.CAN) + (bArr[i13] << Ascii.DC2) + (bArr[i14] << 12) + (bArr[i15] << 6) + bArr[i16]));
                    break;
            }
            int i20 = i18 - 1;
            if (i18 == 0) {
