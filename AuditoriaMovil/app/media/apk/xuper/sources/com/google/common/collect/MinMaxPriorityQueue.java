    ...
    public class Heap {
        ...
        public int bubbleUpAlternatingLevels(int i10, E e10) {
            while (i10 > 2) {
                ...
                if (((Ordering<E>) this.ordering).compare(elementData, e10) <= 0) {
                    break;
                }
        ...
        public int compareElements(int i10, int i11) {
            return ((Ordering<E>) this.ordering).compare(MinMaxPriorityQueue.this.elementData(i10), MinMaxPriorityQueue.this.elementData(i11));
        }

        public int crossOver(int i10, E e10) {
            int findMinChild = findMinChild(i10);
            if (findMinChild > 0 && ((Ordering<E>) this.ordering).compare(MinMaxPriorityQueue.this.elementData(findMinChild), e10) < 0) {
        ...
        public MoveDesc<E> tryCrossOverAndBubbleUp(int i10, int i11, E e10) {
            ...
            if (crossOver < i10) {
                elementData = MinMaxPriorityQueue.this.elementData(i10);
            } else {
                elementData = MinMaxPriorityQueue.this.elementData(getParentIndex(i10));
            }
