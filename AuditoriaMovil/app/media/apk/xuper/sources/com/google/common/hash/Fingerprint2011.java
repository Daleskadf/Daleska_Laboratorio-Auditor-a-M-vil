...
final class Fingerprint2011 extends AbstractNonStreamingHashFunction {
    ...
    public static long fingerprint(byte[] bArr, int i10, int i11) {
        ...
        long j10;
        if (i11 <= 32) {
            fullFingerprint = murmurHash64WithSeed(bArr, i10, i11, -1397348546323613475L);
        } else if (i11 <= 64) {
            fullFingerprint = hashLength33To64(bArr, i10, i11);
        } else {
            fullFingerprint = fullFingerprint(bArr, i10, i11);
        }
        long j11 = K0;
        if (i11 >= 8) {
            j10 = LittleEndianByteArray.load64(bArr, i10);
        } else {
            j10 = -6505348102511208375L;
        }
        if (i11 >= 9) {
            j11 = LittleEndianByteArray.load64(bArr, (i10 + i11) - 8);
        }
        long hash128to64 = hash128to64(fullFingerprint + j11, j10);
    ...
    private static long hashLength33To64(byte[] bArr, int i10, int i11) {
        ...
        return shiftMix((shiftMix(((j10 + rotateRight4 + Long.rotateRight(load648, 31) + rotateRight5 + Long.rotateRight(load647, 7)) * K2) + ((load646 + load648 + rotateRight3) * K0)) * K0) + rotateRight3) * K2;
    }
