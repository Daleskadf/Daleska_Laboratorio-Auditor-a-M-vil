...
public final class ImmutableValueGraph<N, V> extends StandardValueGraph<N, V> {
    ...
    private static <N, V> GraphConnections<N, V> connectionsOf(final ValueGraph<N, V> valueGraph, final N n10) {
        ...
        if (valueGraph.isDirected()) {
            return DirectedGraphConnections.ofImmutable(n10, valueGraph.incidentEdges(n10), function);
        }
        return UndirectedGraphConnections.ofImmutable(Maps.asMap(valueGraph.adjacentNodes(n10), function));
    }
