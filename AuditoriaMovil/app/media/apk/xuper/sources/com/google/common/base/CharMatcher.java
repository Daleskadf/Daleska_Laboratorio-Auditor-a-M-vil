...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    public static final class And extends CharMatcher {
        ...
        public boolean matches(char c10) {
            if (this.first.matches(c10) && this.second.matches(c10)) {
                return true;
            }
            return false;
        }
    ...
    public static final class AnyOf extends CharMatcher {
        ...
        @Override // com.google.common.base.CharMatcher
        public boolean matches(char c10) {
            if (Arrays.binarySearch(this.chars, c10) >= 0) {
                return true;
            }
            return false;
        }
    ...
    public static final class InRange extends FastMatcher {
        ...
        @Override // com.google.common.base.CharMatcher
        public boolean matches(char c10) {
            if (this.startInclusive <= c10 && c10 <= this.endInclusive) {
                return true;
            }
            return false;
        }
    ...
    public static final class IsEither extends FastMatcher {
        ...
        @Override // com.google.common.base.CharMatcher
        public boolean matches(char c10) {
            if (c10 != this.match1 && c10 != this.match2) {
                return false;
            }
            return true;
        }
    ...
    public static class RangesMatcher extends CharMatcher {
        ...
        public boolean matches(char c10) {
            ...
            if (i10 >= 0 && c10 <= this.rangeEnds[i10]) {
                return true;
            }
            return false;
        }
    ...
    public static final class Whitespace extends NamedFastMatcher {
        ...
        @Override // com.google.common.base.CharMatcher
        public boolean matches(char c10) {
            if (TABLE.charAt((MULTIPLIER * c10) >>> SHIFT) == c10) {
                return true;
            }
            return false;
        }
    ...
    public CharMatcher precomputedInternal() {
        ...
        return new NegatedFastMatcher(this, precomputedPositive(i10, bitSet, str)) { // from class: com.google.common.base.CharMatcher.1
