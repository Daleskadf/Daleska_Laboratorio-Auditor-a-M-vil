...
public abstract class EventStoreConfig {
    ...
    public static abstract class Builder {
        ...
        public abstract Builder setCriticalSectionEnterTimeoutMs(int i10);

        public abstract Builder setEventCleanUpAge(long j10);

        public abstract Builder setLoadBatchSize(int i10);

        public abstract Builder setMaxBlobByteSizePerRow(int i10);

        public abstract Builder setMaxStorageSizeInBytes(long j10);
    }
