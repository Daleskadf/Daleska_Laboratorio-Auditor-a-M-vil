...
public enum zzju implements zzpa {
    ...
    private static final zzpb<zzju> zzX = new zzpb<zzju>() { // from class: com.google.android.gms.internal.cast.zzjs
    };
    ...
    public static zzju zzb(int i10) {
        switch (i10) {
            case 0:
