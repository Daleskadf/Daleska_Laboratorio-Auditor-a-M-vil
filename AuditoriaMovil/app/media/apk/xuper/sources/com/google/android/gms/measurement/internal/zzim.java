...
public final class zzim extends zzf {
    ...
    public final void zzA(zzie zzieVar, zzie zzieVar2, long j10, boolean z10, Bundle bundle) {
        ...
        zzg();
        boolean z12 = false;
        if (zzieVar2 != null && zzieVar2.zzc == zzieVar.zzc && zzif.zza(zzieVar2.zzb, zzieVar.zzb) && zzif.zza(zzieVar2.zza, zzieVar.zza)) {
            z11 = false;
        } else {
            z11 = true;
        }
        ...
        if (z11) {
            ...
            if (zzieVar2 != null) {
                String str2 = zzieVar2.zza;
                if (str2 != null) {
                    bundle3.putString("_pn", str2);
                }
                String str3 = zzieVar2.zzb;
                if (str3 != null) {
    ...
    public final void zzB(zzie zzieVar, boolean z10, long j10) {
        ...
        if (this.zzt.zzu().zzb.zzd(z11, z10, j10) && zzieVar != null) {
            zzieVar.zzd = false;
        }
    }
    ...
    private final void zzz(Activity activity, zzie zzieVar, boolean z10) {
        ...
        this.zzc = this.zzb;
        this.zzb = zzieVar3;
        this.zzt.zzaz().zzp(new zzih(this, zzieVar3, zzieVar4, this.zzt.zzav().elapsedRealtime(), z10));
    }
