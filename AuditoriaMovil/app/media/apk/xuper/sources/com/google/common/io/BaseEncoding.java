...
public abstract class BaseEncoding {
    ...
    public static final class Alphabet {
        ...
        public boolean canDecode(char c10) {
            if (c10 <= 127 && this.decodabet[c10] != -1) {
                return true;
            }
            return false;
        }
    ...
    public static class StandardBaseEncoding extends BaseEncoding {
        ...
        public void encodeChunkTo(Appendable appendable, byte[] bArr, int i10, int i11) {
            ...
            Preconditions.checkPositionIndexes(i10, i10 + i11, bArr.length);
            int i12 = 0;
            if (i11 <= this.alphabet.bytesPerChunk) {
                z10 = true;
            } else {
                z10 = false;
            }
        ...
        public BaseEncoding withPadChar(char c10) {
            Character ch;
            if (8 % this.alphabet.bitsPerChar != 0 && ((ch = this.paddingChar) == null || ch.charValue() != c10)) {
                return newInstance(this.alphabet, Character.valueOf(c10));
            }
            return this;
        }
