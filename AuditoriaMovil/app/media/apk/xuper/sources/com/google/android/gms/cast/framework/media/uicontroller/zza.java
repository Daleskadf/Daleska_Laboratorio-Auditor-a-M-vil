...
public final class zza {
    ...
    public final String zzl(long j10) {
        ...
        if (remoteMediaClient != null && remoteMediaClient.hasMediaSession()) {
            ...
            if (i10 - 1 != 1) {
                if (remoteMediaClient2.isLiveStream() && zzj() == null) {
                    return zzp(j10);
                }
                return zzp(j10 - zze());
            }
    ...
    public final boolean zzn(long j10) {
        RemoteMediaClient remoteMediaClient = this.zza;
        if (remoteMediaClient == null || !remoteMediaClient.hasMediaSession() || !this.zza.zzq() || (zzc() + zze()) - j10 >= NotificationOptions.SKIP_STEP_TEN_SECONDS_IN_MS) {
            return false;
        }
        return true;
    }
