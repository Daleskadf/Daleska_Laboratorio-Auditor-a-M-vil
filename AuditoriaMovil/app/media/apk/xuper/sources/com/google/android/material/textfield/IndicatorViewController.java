...
public final class IndicatorViewController {
    ...
    private void createCaptionAnimators(List<Animator> list, boolean z10, TextView textView, int i10, int i11, int i12) {
        ...
        if (textView != null && z10) {
            if (i10 == i12 || i10 == i11) {
                ...
                list.add(createCaptionOpacityAnimator(textView, z11));
                if (i12 == i10) {
    ...
    private boolean shouldAnimateCaptionView(TextView textView, CharSequence charSequence) {
        if (c1.Q(this.textInputView) && this.textInputView.isEnabled() && (this.captionToShow != this.captionDisplayed || textView == null || !TextUtils.equals(textView.getText(), charSequence))) {
            return true;
        }
        return false;
    }
