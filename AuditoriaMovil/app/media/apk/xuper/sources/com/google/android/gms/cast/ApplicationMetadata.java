...
public class ApplicationMetadata extends AbstractSafeParcelable {
    ...
    public boolean equals(Object obj) {
        ...
        if (CastUtils.zzh(this.zza, applicationMetadata.zza) && CastUtils.zzh(this.zzb, applicationMetadata.zzb) && CastUtils.zzh(this.zzc, applicationMetadata.zzc) && CastUtils.zzh(this.zzd, applicationMetadata.zzd) && CastUtils.zzh(this.zze, applicationMetadata.zze) && CastUtils.zzh(this.zzf, applicationMetadata.zzf) && CastUtils.zzh(this.zzg, applicationMetadata.zzg)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        StringBuilder sb = new StringBuilder(length + 118 + length2 + length3 + length4 + String.valueOf(str4).length() + String.valueOf(str5).length());
