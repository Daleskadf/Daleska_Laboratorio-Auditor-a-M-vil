    ...
    public final <E> void zzb(Object obj, Object obj2, long j10) {
        ...
        if (list2.isEmpty()) {
            ...
            if (zza.isAssignableFrom(list2.getClass())) {
                ...
                zzrn.zzs(obj, j10, arrayList2);
                arrayList = arrayList2;
            } else if (list2 instanceof zzri) {
                zzpn zzpnVar = new zzpn(list2.size() + size);
                zzpnVar.addAll(zzpnVar.size(), (zzri) list2);
                zzrn.zzs(obj, j10, zzpnVar);
                arrayList = zzpnVar;
            } else if ((list2 instanceof zzql) && (list2 instanceof zzpg)) {
