...
public class BorderDrawable extends Drawable {
    ...
    private Shader createGradientShader() {
        ...
        return new LinearGradient(0.0f, rect.top, 0.0f, rect.bottom, new int[]{r.a.i(this.topOuterStrokeColor, this.currentBorderTintColor), r.a.i(this.topInnerStrokeColor, this.currentBorderTintColor), r.a.i(r.a.m(this.topInnerStrokeColor, 0), this.currentBorderTintColor), r.a.i(r.a.m(this.bottomInnerStrokeColor, 0), this.currentBorderTintColor), r.a.i(this.bottomInnerStrokeColor, this.currentBorderTintColor), r.a.i(this.bottomOuterStrokeColor, this.currentBorderTintColor)}, new float[]{0.0f, height, 0.5f, 0.5f, 1.0f - height, 1.0f}, Shader.TileMode.CLAMP);
    }
