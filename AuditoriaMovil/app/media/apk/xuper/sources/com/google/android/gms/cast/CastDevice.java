    ...
    public WebImage getIcon(int i10, int i11) {
        ...
        if (i10 > 0 && i11 > 0) {
            ...
            for (WebImage webImage3 : this.zzh) {
                ...
                } else if (width < i10 && height < i11 && (webImage2 == null || (webImage2.getWidth() < width && webImage2.getHeight() < height))) {
                    webImage2 = webImage3;
                }
            }
            if (webImage == null) {
