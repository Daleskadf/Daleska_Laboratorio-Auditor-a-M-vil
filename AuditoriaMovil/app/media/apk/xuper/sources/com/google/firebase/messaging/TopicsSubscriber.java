    ...
    */
    public boolean performTopicOperation(com.google.firebase.messaging.TopicOperation r6) {
        /*
            r5 = this;
            r0 = 0
            java.lang.String r1 = r6.getOperation()     // Catch: java.io.IOException -> L8b
        ...
        L28:
            ...
            if (r1 == 0) goto L69
            if (r1 == r4) goto L47
            boolean r1 = isDebugLogEnabled()     // Catch: java.io.IOException -> L8b
            if (r1 == 0) goto L8a
            ...
            goto L8a
        L47:
            java.lang.String r1 = r6.getTopic()     // Catch: java.io.IOException -> L8b
            r5.blockingUnsubscribeFromTopic(r1)     // Catch: java.io.IOException -> L8b
            boolean r1 = isDebugLogEnabled()     // Catch: java.io.IOException -> L8b
            if (r1 == 0) goto L8a
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch: java.io.IOException -> L8b
            r1.<init>()     // Catch: java.io.IOException -> L8b
            ...
            java.lang.String r6 = r6.getTopic()     // Catch: java.io.IOException -> L8b
            r1.append(r6)     // Catch: java.io.IOException -> L8b
            r1.append(r2)     // Catch: java.io.IOException -> L8b
            goto L8a
        L69:
            java.lang.String r1 = r6.getTopic()     // Catch: java.io.IOException -> L8b
            r5.blockingSubscribeToTopic(r1)     // Catch: java.io.IOException -> L8b
            boolean r1 = isDebugLogEnabled()     // Catch: java.io.IOException -> L8b
            if (r1 == 0) goto L8a
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch: java.io.IOException -> L8b
            r1.<init>()     // Catch: java.io.IOException -> L8b
