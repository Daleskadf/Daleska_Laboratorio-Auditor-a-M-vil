...
public class MapMakerInternalMap<K, V, E extends InternalEntry<K, V, E>, S extends Segment<K, V, E, S>> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
    ...
    public Segment<K, V, E, S> createSegment(int i10, int i11) {
        return (S) this.entryHelper.newSegment(this, i10, i11);
    }
    ...
    public static abstract class Segment<K, V, E extends InternalEntry<K, V, E>, S extends Segment<K, V, E, S>> extends ReentrantLock {
        ...
        public boolean clearValueForTesting(K k10, int i10, WeakValueReference<K, V, ? extends InternalEntry<K, V, ?>> weakValueReference) {
            ...
            try {
                ...
                for (InternalEntry internalEntry = e10; internalEntry != null; internalEntry = internalEntry.getNext()) {
                    Object key = internalEntry.getKey();
                    if (internalEntry.getHash() == i10 && key != null && this.map.keyEquivalence.equivalent(k10, key)) {
                        if (((WeakValueEntry) internalEntry).getValueReference() != weakValueReference) {
                            return false;
                        }
                        atomicReferenceArray.set(length, removeFromChain(e10, internalEntry));
                        return true;
                    }
                }
                return false;
                ...
                if (e10 != null) {
                    ...
                    if (next == null) {
                        ...
                        while (e10 != internalEntry) {
                            ...
                            InternalEntry copyEntry = copyEntry(e10, (InternalEntry) atomicReferenceArray2.get(hash3));
                            if (copyEntry != null) {
        ...
        public V put(K k10, int i10, V v10, boolean z10) {
            ...
            try {
                ...
                for (InternalEntry internalEntry = e10; internalEntry != null; internalEntry = internalEntry.getNext()) {
                    Object key = internalEntry.getKey();
                    if (internalEntry.getHash() == i10 && key != null && this.map.keyEquivalence.equivalent(k10, key)) {
                        V v11 = (V) internalEntry.getValue();
                        if (v11 == null) {
                            this.modCount++;
                            setValue(internalEntry, v10);
                ...
                this.modCount++;
                E newEntry = this.map.entryHelper.newEntry(self(), k10, i10, e10);
        ...
        public boolean reclaimKey(E e10, int i10) {
            ...
            try {
                ...
                for (InternalEntry internalEntry = e11; internalEntry != null; internalEntry = internalEntry.getNext()) {
                    if (internalEntry == e10) {
                        this.modCount++;
                        atomicReferenceArray.set(length, removeFromChain(e11, internalEntry));
                        this.count--;
                        return true;
                    }
                }
        ...
        public V remove(Object obj, int i10) {
            ...
            try {
                ...
                for (InternalEntry internalEntry = e10; internalEntry != null; internalEntry = internalEntry.getNext()) {
                    Object key = internalEntry.getKey();
                    if (internalEntry.getHash() == i10 && key != null && this.map.keyEquivalence.equivalent(obj, key)) {
                        V v10 = (V) internalEntry.getValue();
                        if (v10 == null && !isCollected(internalEntry)) {
                            return null;
                        }
                        this.modCount++;
                        atomicReferenceArray.set(length, removeFromChain(e10, internalEntry));
                ...
                for (InternalEntry internalEntry = e10; internalEntry != null; internalEntry = internalEntry.getNext()) {
                    ...
                    if (internalEntry.getHash() == i10 && key != null && this.map.keyEquivalence.equivalent(k10, key)) {
                        ...
                        if (value == null) {
                            ...
                            return false;
                        } else if (this.map.valueEquivalence().equivalent(v10, value)) {
                            this.modCount++;
                            setValue(internalEntry, v11);
                            return true;
                        } else {
                            return false;
                        }
