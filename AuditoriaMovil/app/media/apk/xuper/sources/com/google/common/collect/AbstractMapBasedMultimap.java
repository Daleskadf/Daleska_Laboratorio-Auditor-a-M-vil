...
public abstract class AbstractMapBasedMultimap<K, V> extends AbstractMultimap<K, V> implements Serializable {
    ...
    public class WrappedNavigableSet extends AbstractMapBasedMultimap<K, V>.WrappedSortedSet implements NavigableSet<V> {
        ...
        private NavigableSet<V> wrap(NavigableSet<V> navigableSet) {
            ...
            return new WrappedNavigableSet(k10, navigableSet, ancestor);
        }
    ...
    public class WrappedSortedSet extends AbstractMapBasedMultimap<K, V>.WrappedCollection implements SortedSet<V> {
        ...
        public SortedSet<V> headSet(@ParametricNullness V v10) {
            ...
            AbstractMapBasedMultimap abstractMapBasedMultimap = AbstractMapBasedMultimap.this;
            Object key = getKey();
            SortedSet<V> headSet = getSortedSetDelegate().headSet(v10);
            if (getAncestor() == null) {
                ancestor = this;
            } else {
                ancestor = getAncestor();
        ...
        public SortedSet<V> subSet(@ParametricNullness V v10, @ParametricNullness V v11) {
            ...
            AbstractMapBasedMultimap abstractMapBasedMultimap = AbstractMapBasedMultimap.this;
            Object key = getKey();
            SortedSet<V> subSet = getSortedSetDelegate().subSet(v10, v11);
            if (getAncestor() == null) {
                ancestor = this;
            } else {
                ancestor = getAncestor();
        ...
        public SortedSet<V> tailSet(@ParametricNullness V v10) {
            ...
            AbstractMapBasedMultimap abstractMapBasedMultimap = AbstractMapBasedMultimap.this;
            Object key = getKey();
            SortedSet<V> tailSet = getSortedSetDelegate().tailSet(v10);
            if (getAncestor() == null) {
                ancestor = this;
            } else {
                ancestor = getAncestor();
