...
public class ModalLayoutPortrait extends BaseModalLayout {
    ...
    public void onMeasure(int i10, int i11) {
        ...
        Logging.logdNumber("Total reserved height", paddingBottom);
        ...
        for (ViewMeasure viewMeasure2 : this.vgm.getViews()) {
            ...
            paddingBottom += getDesiredHeight(viewMeasure2.getView());
        }
        Logging.logdPair("Measured dims", f10, paddingBottom);
