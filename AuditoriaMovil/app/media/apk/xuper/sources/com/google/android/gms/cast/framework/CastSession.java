...
public class CastSession extends Session {
    ...
    private final void zzm(Bundle bundle) {
        ...
        Cast.CastOptions.Builder builder = new Cast.CastOptions.Builder(castDevice, new zzn(this, null));
        builder.zzc(bundle2);
        com.google.android.gms.cast.zzr zza2 = Cast.zza(this.zzc, builder.build());
        zza2.zzk(new zzp(this, null));
        this.zzh = zza2;
        zza2.zze();
    }
    ...
    public PendingResult<Status> sendMessage(@RecentlyNonNull String str, @RecentlyNonNull String str2) {
        ...
        return com.google.android.gms.internal.cast.zzao.zza(zzrVar.zzh(str, str2), new com.google.android.gms.internal.cast.zzan() { // from class: com.google.android.gms.cast.framework.zzh
