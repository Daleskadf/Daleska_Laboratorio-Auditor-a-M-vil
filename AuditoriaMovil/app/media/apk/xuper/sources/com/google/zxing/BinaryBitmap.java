...
public final class BinaryBitmap {
    ...
    public BinaryBitmap crop(int i10, int i11, int i12, int i13) {
        return new BinaryBitmap(this.binarizer.createBinarizer(this.binarizer.getLuminanceSource().crop(i10, i11, i12, i13)));
    }
    ...
    public BitArray getBlackRow(int i10, BitArray bitArray) {
        return this.binarizer.getBlackRow(i10, bitArray);
    }
