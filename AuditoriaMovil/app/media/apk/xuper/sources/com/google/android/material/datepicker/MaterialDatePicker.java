...
public final class MaterialDatePicker<S> extends androidx.fragment.app.d {
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{16842912}, d.b.d(context, R.drawable.ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], d.b.d(context, R.drawable.ic_edit_black_24dp));
    ...
    public void startPickerFragment() {
        ...
        m10.q(R.id.mtrl_calendar_frame, this.pickerFragment);
        m10.j();
