...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    private final Drawable createDefaultItemBackground(r2 r2Var) {
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(ShapeAppearanceModel.builder(getContext(), r2Var.n(R.styleable.NavigationView_itemShapeAppearance, 0), r2Var.n(R.styleable.NavigationView_itemShapeAppearanceOverlay, 0)).build());
        materialShapeDrawable.setFillColor(MaterialResources.getColorStateList(getContext(), r2Var, R.styleable.NavigationView_itemShapeFillColor));
        return new InsetDrawable((Drawable) materialShapeDrawable, r2Var.f(R.styleable.NavigationView_itemShapeInsetStart, 0), r2Var.f(R.styleable.NavigationView_itemShapeInsetTop, 0), r2Var.f(R.styleable.NavigationView_itemShapeInsetEnd, 0), r2Var.f(R.styleable.NavigationView_itemShapeInsetBottom, 0));
    }
    ...
    private boolean hasShapeAppearance(r2 r2Var) {
        if (!r2Var.r(R.styleable.NavigationView_itemShapeAppearance) && !r2Var.r(R.styleable.NavigationView_itemShapeAppearanceOverlay)) {
            return false;
        }
        return true;
    }
        ...
        this.onGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.google.android.material.navigation.NavigationView.2
            ...
            public void onGlobalLayout() {
                ...
                if ((context instanceof Activity) && Build.VERSION.SDK_INT >= 21) {
                    ...
                    NavigationView.this.setDrawBottomInsetForeground((z11 && z12) ? false : false);
                }
            }
        };
    ...
    public NavigationView(Context context, AttributeSet attributeSet, int i10) {
        ...
        r2 obtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context, attributeSet, R.styleable.NavigationView, i10, R.style.Widget_Design_NavigationView, new int[0]);
        ...
        int i13 = R.styleable.NavigationView_elevation;
        if (obtainTintedStyledAttributes.r(i13)) {
            setElevation(obtainTintedStyledAttributes.f(i13, 0));
        }
        ...
        ColorStateList c10 = obtainTintedStyledAttributes.r(i17) ? obtainTintedStyledAttributes.c(i17) : null;
        if (!z10 && c10 == null) {
            c10 = createDefaultColorStateList(16842806);
        }
        Drawable g10 = obtainTintedStyledAttributes.g(R.styleable.NavigationView_itemBackground);
        if (g10 == null && hasShapeAppearance(obtainTintedStyledAttributes)) {
            g10 = createDefaultItemBackground(obtainTintedStyledAttributes);
        }
        int i18 = R.styleable.NavigationView_itemHorizontalPadding;
        ...
        int i19 = R.styleable.NavigationView_menu;
        if (obtainTintedStyledAttributes.r(i19)) {
            inflateMenu(obtainTintedStyledAttributes.n(i19, 0));
        }
        int i20 = R.styleable.NavigationView_headerLayout;
