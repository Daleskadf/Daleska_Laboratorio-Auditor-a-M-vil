...
public final class zzoj extends zzol {
    ...
    public final void zzb(byte b10) {
        try {
            ...
            throw new zzok(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), 1), e10);
        }
    }
    ...
    public final void zzc(byte[] bArr, int i10, int i11) {
        try {
            ...
            throw new zzok(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), Integer.valueOf(i11)), e10);
        }
    }
    ...
    @Override // com.google.android.gms.internal.cast.zzol
    public final void zze(int i10, zzoe zzoeVar) {
        zzq((i10 << 3) | 2);
        zzq(zzoeVar.zzd());
        zzoeVar.zzh(this);
    }
    ...
    public final void zzn(String str) {
        ...
        try {
            ...
            if (zzA2 == zzA) {
                int i11 = i10 + zzA2;
                this.zzd = i11;
                int zzb = zzrr.zzb(str, this.zzb, i11, this.zzc - i11);
                this.zzd = i10;
                zzq((zzb - i10) - zzA2);
                this.zzd = zzb;
                return;
    ...
    public final void zzs(long j10) {
        ...
        if (z10 && this.zzc - this.zzd >= 10) {
            while ((j10 & (-128)) != 0) {
                ...
                int i10 = this.zzd;
                this.zzd = i10 + 1;
                zzrn.zzn(bArr, i10, (byte) ((((int) j10) & 127) | 128));
                j10 >>>= 7;
            }
            byte[] bArr2 = this.zzb;
            int i11 = this.zzd;
            this.zzd = i11 + 1;
            zzrn.zzn(bArr2, i11, (byte) j10);
            return;
        }
        while ((j10 & (-128)) != 0) {
            try {
