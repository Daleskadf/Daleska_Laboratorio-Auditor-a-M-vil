...
public final class AutoProtoEncoderDoNotUseEncoder implements Configurator {
    ...
    public static final class MessagingClientEventEncoder implements ObjectEncoder<MessagingClientEvent> {
        ...
        private static final FieldDescriptor PACKAGENAME_DESCRIPTOR = FieldDescriptor.builder(com.taobao.accs.common.Constants.KEY_PACKAGE_NAME).withProperty(AtProtobuf.builder().tag(6).build()).build();
