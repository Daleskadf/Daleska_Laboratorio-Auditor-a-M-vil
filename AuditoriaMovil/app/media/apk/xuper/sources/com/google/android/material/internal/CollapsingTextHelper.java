...
public final class CollapsingTextHelper {
    ...
    private void calculateBaseOffsets() {
        ...
        if (i11 != 1) {
            if (i11 != 5) {
                ...
                this.collapsedDrawX = this.collapsedBounds.right - f10;
            }
        } else {
            this.collapsedDrawX = this.collapsedBounds.centerX() - (f10 / 2.0f);
        }
        ...
        if (i13 != 1) {
            if (i13 != 5) {
                ...
                this.expandedDrawX = this.expandedBounds.right - f12;
            }
        } else {
            this.expandedDrawX = this.expandedBounds.centerX() - (f12 / 2.0f);
        }
        clearTexture();
    ...
    private void calculateUsingTextSize(float f10) {
        ...
        if (width > 0.0f) {
            if (this.currentTextSize == f11 && !this.boundsChanged && !z11) {
                z11 = false;
            } else {
                z11 = true;
            }
    ...
    public void getCollapsedTextActualBounds(RectF rectF) {
        ...
        if (!calculateIsRtl) {
            calculateCollapsedTextWidth = rect.left;
        } else {
            calculateCollapsedTextWidth = rect.right - calculateCollapsedTextWidth();
        }
