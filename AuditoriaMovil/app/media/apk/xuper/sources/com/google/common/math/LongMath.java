...
public final class LongMath {
    ...
    public static long checkedPow(long j10, int i10) {
        ...
        if (z10 & z11) {
                ...
                if (i11 != -1) {
                    if (i11 != 0) {
                        ...
                        if (i11 == 2) {
                            ...
                            MathPreconditions.checkNoOverflow(z14, "checkedPow", j10, i10);
                            return 1 << i10;
                        }
            ...
            MathPreconditions.checkNoOverflow(z13, "checkedPow", j10, i10);
            if ((i10 & 1) == 0) {
                return 1 << i10;
            }
            return (-1) << i10;
        ...
        while (i12 != 0) {
            if (i12 != 1) {
                ...
                if (i13 > 0) {
                    ...
                    MathPreconditions.checkNoOverflow(z12, "checkedPow", j13, i13);
                    j13 *= j13;
                }
                j12 = j11;
                i12 = i13;
            ...
            for (long[] jArr2 : millerRabinBaseSets) {
                if (j10 <= jArr2[0]) {
                    for (int i10 = 1; i10 < jArr2.length; i10++) {
                        if (!MillerRabinTester.test(jArr2[i10], j10)) {
                            return false;
                        }
                    }
                    return true;
        ...
        switch (iArr[roundingMode.ordinal()]) {
            ...
            case 8:
                ...
                if (i10 != 6) {
                    if (i10 != 7) {
                        if (i10 == 8) {
                            if ((DoubleUtils.getSignificand(d11) & 1) != 0) {
                                return d10;
                            }
                            return d11;
                        }
    ...
    public static long sqrt(long j10, RoundingMode roundingMode) {
        ...
        switch (AnonymousClass1.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            ...
            case 8:
                ...
                long j12 = sqrt - i10;
                return j12 + lessThanBranchFree((j12 * j12) + j12, j10);
            default:
                throw new AssertionError();
        }
    }
