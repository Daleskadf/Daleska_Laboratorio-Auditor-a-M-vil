...
public final class CacheBuilder<K, V> {
    ...
    public CacheBuilder<K, V> keyEquivalence(Equivalence<Object> equivalence) {
        ...
        Preconditions.checkState(z10, "key equivalence was already set to %s", equivalence2);
    ...
    public CacheBuilder<K, V> valueEquivalence(Equivalence<Object> equivalence) {
        ...
        Preconditions.checkState(z10, "value equivalence was already set to %s", equivalence2);
