...
public class g {
    ...
    public static String U() {
        if (com.uc.crashsdk.a.g.a(f9748e.mVersion)) {
            return a.a();
        }
        return a(f9748e.mVersion);
    }

    public static String V() {
        if (com.uc.crashsdk.a.g.a(f9748e.mSubVersion)) {
            return "release";
        }
        return f9748e.mSubVersion;
    }

    public static String W() {
        if (com.uc.crashsdk.a.g.a(f9748e.mBuildId)) {
            return ae();
        }
        return a(f9748e.mBuildId);
    }
