...
public final class NativeJni {
    ...
    public final String d() {
        ...
        Gson gson = f9453d;
        if (gson != null && (castResult = (CastResult) gson.fromJson(Call, (Class<Object>) CastResult.class)) != null) {
    ...
    public final void e() {
        ...
        Gson gson2 = f9453d;
        if (gson2 != null && (castResult = (CastResult) gson2.fromJson(str2, (Class<Object>) CastResult.class)) != null) {
            castResult.getErr();
        }
    }
    ...
    public final Integer j(Device device) {
        ...
        Gson gson = f9453d;
        if (gson != null) {
            str = gson.toJson(device);
        } else {
            str = null;
        }
        String Call = Call("SelectDevice", e8.a.f12958a.c(str));
        Gson gson2 = f9453d;
        if (gson2 == null || (castResult = (CastResult) gson2.fromJson(Call, (Class<Object>) CastResult.class)) == null) {
            return null;
        }
        return Integer.valueOf(castResult.getErr());
    }
    ...
    public final Integer l(String str, CastMedia castMedia, String str2) {
        ...
        Gson gson = f9453d;
        if (gson != null) {
            str3 = gson.toJson(castMedia);
        } else {
            str3 = null;
        }
        String Call = Call("StartPlay", e8.a.f12958a.d(str, str3, str2));
        Gson gson2 = f9453d;
        if (gson2 == null || (castResult = (CastResult) gson2.fromJson(Call, (Class<Object>) CastResult.class)) == null) {
            return null;
        }
