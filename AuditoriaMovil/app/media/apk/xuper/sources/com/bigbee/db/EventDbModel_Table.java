...
public final class EventDbModel_Table extends ModelAdapter<EventDbModel> {
    ...
    static {
        Property<Integer> property = new Property<>(EventDbModel.class, "id");
        id = property;
        Property<String> property2 = new Property<>(EventDbModel.class, "appVer");
        appVer = property2;
        Property<String> property3 = new Property<>(EventDbModel.class, "sysVer");
        sysVer = property3;
        Property<Long> property4 = new Property<>(EventDbModel.class, AnalyticsConfig.RTD_START_TIME);
        startTime = property4;
        Property<Long> property5 = new Property<>(EventDbModel.class, "endTime");
        endTime = property5;
        Property<String> property6 = new Property<>(EventDbModel.class, "eventId");
        eventId = property6;
        Property<Boolean> property7 = new Property<>(EventDbModel.class, "reporting");
        reporting = property7;
        Property<String> property8 = new Property<>(EventDbModel.class, "cipherStr");
        cipherStr = property8;
        Property<String> property9 = new Property<>(EventDbModel.class, "commonStr");
        commonStr = property9;
        Property<Boolean> property10 = new Property<>(EventDbModel.class, "notIntactEvent");
        notIntactEvent = property10;
        Property<String> property11 = new Property<>(EventDbModel.class, "reserveA");
        reserveA = property11;
        Property<String> property12 = new Property<>(EventDbModel.class, "reserveB");
        reserveB = property12;
