...
public abstract class b0 extends k3.k implements Serializable {
    ...
    public String _coercedTypeDesc() {
        ...
        if (valueType != null && !valueType.K()) {
            z10 = (valueType.D() || valueType.b()) ? true : true;
            y10 = d4.h.G(valueType);
        } else {
            Class<?> handledType = handledType();
            z10 = (handledType.isArray() || Collection.class.isAssignableFrom(handledType) || Map.class.isAssignableFrom(handledType)) ? true : true;
    ...
    public final n3.q _findNullProvider(k3.g gVar, k3.d dVar, b3.j0 j0Var, k3.k kVar) {
        if (j0Var == b3.j0.FAIL) {
            if (dVar == null) {
                return o3.r.c(gVar.x(kVar.handledType()));
            }
            return o3.r.a(dVar);
        } else if (j0Var == b3.j0.AS_EMPTY) {
            if (kVar == null) {
                return null;
            }
            ...
            return new o3.p(kVar);
        } else if (j0Var != b3.j0.SKIP) {
            return null;
        } else {
            return o3.q.d();
        }
    ...
    public final String _parseString(c3.k kVar, k3.g gVar) {
        ...
        if (kVar.j0(c3.n.VALUE_EMBEDDED_OBJECT)) {
            ...
            return N.toString();
        } else if (kVar.j0(c3.n.START_OBJECT)) {
    ...
    public void _reportFailedNullCoerce(k3.g gVar, boolean z10, Enum<?> r52, String str) {
        ...
        gVar.z0(this, "Cannot coerce %s to Null value as %s (%s `%s.%s` to allow)", str, _coercedTypeDesc(), str2, r52.getDeclaringClass().getSimpleName(), r52.name());
    }
    ...
    public final void _verifyNullForPrimitiveCoercion(k3.g gVar, String str) {
        ...
        _reportFailedNullCoerce(gVar, z10, qVar, format);
    }
    ...
    public final void _verifyNullForScalarCoercion(k3.g gVar, String str) {
        ...
        if (!gVar.o0(qVar)) {
            ...
            _reportFailedNullCoerce(gVar, true, qVar, format);
        }
    }
    ...
    public final boolean _parseBooleanPrimitive(c3.k kVar, k3.g gVar) {
        ...
        if (_checkFromStringCoercion == m3.b.AsNull) {
            _verifyNullForPrimitive(gVar);
            return false;
        } else if (_checkFromStringCoercion == m3.b.AsEmpty) {
            return false;
        } else {
            String trim = z10.trim();
            int length = trim.length();
