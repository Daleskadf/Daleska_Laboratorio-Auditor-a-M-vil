...
public class c0 extends k3.p implements Serializable {
    ...
    public static final class a extends k3.p implements Serializable {
        ...
        public final Object a(String str, k3.g gVar) {
            ...
            try {
                ...
                return gVar.g0(this.f6502a, str, "not a valid representation", new Object[0]);
            } catch (Exception e10) {
    ...
    public static final class b extends c0 {
        ...
        public Object b(String str, k3.g gVar) {
            ...
            Enum l10 = kVar.l(str);
            if (l10 == null) {
                if (this.f6507g != null && gVar.n0(k3.h.READ_UNKNOWN_ENUM_VALUES_USING_DEFAULT_VALUE)) {
                    return this.f6507g;
                }
                if (!gVar.n0(k3.h.READ_UNKNOWN_ENUM_VALUES_AS_NULL)) {
                    return gVar.g0(this.f6500b, str, "not one of the values accepted for Enum class: %s", kVar.o());
                }
                return l10;
            }
            return l10;
    ...
    public Object b(String str, k3.g gVar) {
        switch (this.f6499a) {
            case 1:
                ...
                return gVar.g0(this.f6500b, str, "value not 'true' or 'false'", new Object[0]);
            case 2:
                int d10 = d(str);
                if (d10 >= -128 && d10 <= 255) {
                    return Byte.valueOf((byte) d10);
                }
                return gVar.g0(this.f6500b, str, "overflow, value cannot be represented as 8-bit value", new Object[0]);
            case 3:
                int d11 = d(str);
                if (d11 >= -32768 && d11 <= 32767) {
                    return Short.valueOf((short) d11);
                }
                return gVar.g0(this.f6500b, str, "overflow, value cannot be represented as 16-bit value", new Object[0]);
            case 4:
                if (str.length() == 1) {
                    return Character.valueOf(str.charAt(0));
                }
                return gVar.g0(this.f6500b, str, "can only convert 1-character Strings", new Object[0]);
            case 5:
