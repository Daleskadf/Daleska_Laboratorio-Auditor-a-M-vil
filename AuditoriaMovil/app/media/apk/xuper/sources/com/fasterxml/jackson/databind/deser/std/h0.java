...
public final class h0 extends i implements n3.i {
    ...
    public Collection deserialize(c3.k kVar, k3.g gVar) {
        ...
        if (kVar2 != null) {
            return (Collection) this.f6547f.y(gVar, kVar2.deserialize(kVar, gVar));
        }
        return deserialize(kVar, gVar, (Collection) this.f6547f.x(gVar));
    }
    ...
    */
    ...
    public h0 g(k3.k kVar, k3.k kVar2, n3.q qVar, Boolean bool) {
        if (Objects.equals(this.f6552d, bool) && this.f6550b == qVar && this.f6546e == kVar2 && this.f6548g == kVar) {
            return this;
        }
        return new h0(this.f6549a, this.f6547f, kVar, kVar2, qVar, bool);
    }
    ...
    public boolean isCachable() {
        if (this.f6546e == null && this.f6548g == null) {
            return true;
        }
        return false;
    }
