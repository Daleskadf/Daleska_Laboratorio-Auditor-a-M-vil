                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                if (1 == optInt) {
                                    str = "2G/3G";
                                    Object a12 = bn.a(jSONObject.optString("m"), jSONObject.optString("q"), new Class[]{bn.a(jSONObject.optString(com.umeng.analytics.pro.bt.aI)), Integer.TYPE}, a11, new Object[]{bn.a(jSONObject.optString(com.umeng.analytics.pro.bt.aI), new Class[]{String.class}, new Object[]{jSONObject.optString("a")}), 0});
                                ...
                                if (treeSet.isEmpty()) {
                                    ...
                                    while (it2.hasNext()) {
                                        i12++;
                                        jSONObject3.put(com.umeng.ccg.a.f10662v, i12);
                                        jSONObject3.put("apl", (JSONArray) it2.next());
                                        try {
