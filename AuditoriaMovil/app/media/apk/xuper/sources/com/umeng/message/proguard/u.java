                ...
                try {
                    ...
                    if (a10.f11600c && a10.f11599b) {
                        ...
                        b.c(new Runnable() { // from class: com.umeng.message.proguard.ax.2
                            /* JADX WARN: Not initialized variable reg: 18, insn: 0x0349: MOVE  (r1 I:??[OBJECT, ARRAY]) = (r18 I:??[OBJECT, ARRAY]), block:B:270:0x0349 */
                            ...
                            public final void run() {
                                ...
                                try {
                                    ...
                                    if (!axVar.f11602b.f11613a.b("e_s", true)) {
                                        if (Math.abs(System.currentTimeMillis() - axVar.f11602b.b()) > 86400000) {
                                            z12 = true;
                                        } else {
                                            z12 = false;
                                        }
                                    ...
                                    axVar.f11602b.f11613a.a("req_ts", System.currentTimeMillis());
                                    if (d.h(y.a())) {
                                        ax axVar3 = axVar;
                                        String str12 = name;
                                        Application a11 = y.a();
                                        ...
                                        if (jSONObject != null && jSONObject.optInt(Constants.KEY_HTTP_CODE) != 13043) {
                                            ...
                                            try {
                                                if (optJSONObject2 != null) {
                                                    ...
                                                    if (optJSONObject2.optInt("aps") == 1) {
                                                        z11 = true;
                                                    } else {
                                                        z11 = false;
                                                    }
                                                            ...
                                                            if (optJSONObject4 != null) {
                                                                ...
                                                                if (TextUtils.isEmpty(optString2)) {
                                                                    ...
                                                                    if (TextUtils.equals(optString2, str7)) {
                                                                        ...
                                                                        optJSONObject4.put(ITagManager.SUCCESS, i10);
                                                                        if (i13 < min - 1) {
                                                                            try {
                                                                                Thread.sleep(500L);
