            ...
            if (!pVar.f12128b) {
                ...
                b.b(new Runnable() { // from class: com.umeng.message.proguard.p.b.1
                    ...
                    public final void run() {
                        ...
                        if (TextUtils.isEmpty(l10) && TextUtils.isEmpty(e10)) {
                        ...
                        } else if (!messageSharedPrefs.a("l_u_q")) {
                            ...
                            if (a12 != null) {
                                ...
                                j11 = Math.max(60L, a12.optLong(com.umeng.analytics.pro.bt.f10040ba, 86400L));
                            } else {
                                z10 = false;
                            }
                            boolean m10 = messageSharedPrefs.m();
                            messageSharedPrefs.f11344b.a("l_u_e", z10);
                            messageSharedPrefs.a("l_u_q", j11);
                            if (z10) {
                                Runnable runnable = new Runnable() { // from class: com.umeng.message.proguard.p.b.1.1
                                    @Override // java.lang.Runnable
                                    public final void run() {
                                        try {
                                            b bVar2 = b.this;
                                ...
                                com.umeng.message.proguard.b.b(runnable, j10, TimeUnit.MINUTES);
                            } else {
