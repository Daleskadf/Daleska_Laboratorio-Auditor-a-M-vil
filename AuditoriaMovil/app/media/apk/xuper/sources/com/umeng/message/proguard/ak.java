                    ...
                    try {
                        ...
                        if (d10 != null && !d10.isFinishing()) {
                            ...
                            ao.a(d10, a10, new ao.a() { // from class: com.umeng.message.proguard.ak.2.1
                                ...
                                public final void a(ap apVar, boolean z13) {
                                    if (z13) {
                                        ...
                                        messageSharedPrefs2.f11344b.a("ia_times", String.format(Locale.getDefault(), "%d.%d.%d", Integer.valueOf(calendar.get(1)), Integer.valueOf(calendar.get(6)), Integer.valueOf(messageSharedPrefs.s() + 1)));
                                        if (!ak.this.f11506c.f11517a) {
                                            ak akVar2 = ak.this;
                                    ...
                                    long currentTimeMillis2 = System.currentTimeMillis() - messageSharedPrefs.q();
                                    if (currentTimeMillis2 >= ak.this.f11507d.f11523a) {
                                        currentTimeMillis2 = 0;
                                    }
                                    ak akVar3 = ak.this;
                                    akVar3.a(Math.max(akVar3.f11507d.f11526d, ak.this.f11507d.f11523a) - currentTimeMillis2);
                                }
                            });
                            return;
                        }
