...
public final class p {
    ...
    public class c implements Handler.Callback {
        ...
        public final boolean handleMessage(Message message) {
            ...
            String format2 = String.format("%s %s-%s %s %s %s", this.f12144e.format(Long.valueOf(aVar.f12132c)), Integer.valueOf(aVar.f12134e), Long.valueOf(aVar.f12135f), str, aVar.f12130a, aVar.f12131b);
