                ...
                public final void run() {
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                if (1 == optInt2) {
                                    Object a12 = bn.a(jSONObject3.optString("m"), jSONObject3.optString("q"), new Class[]{bn.a(jSONObject3.optString(com.umeng.analytics.pro.bt.aI)), Integer.TYPE}, a11, new Object[]{bn.a(jSONObject3.optString(com.umeng.analytics.pro.bt.aI), new Class[]{String.class}, new Object[]{jSONObject3.optString("a")}), 0});
                                    if (a12 instanceof List) {
                                        ...
                                        for (Object obj : (List) a12) {
                                            Object a15 = bn.a(a14, bn.a(a13, obj));
                                            if (a15 != null) {
                                    ...
                                    if (a16 instanceof List) {
                                        ...
                                        for (Object obj2 : (List) a16) {
                                            Object a18 = bn.a(a17, obj2);
                                            if (a18 != null) {
                                ...
                                if (treeSet.isEmpty()) {
                                    ...
                                    int i11 = 0;
                                    while (it.hasNext()) {
                                        Object a19 = f.a(a11, (String) it.next());
                                        if (a19 != null) {
                                    ...
                                    while (it2.hasNext()) {
                                        i12++;
                                        jSONObject5.put(com.umeng.ccg.a.f10662v, i12);
                                        jSONObject5.put("data", (JSONArray) it2.next());
                                        try {
