    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (i10 != 2 && i10 != 3) {
            if (i10 == 4) {
                ...
                ImageView imageView = (ImageView) inflate.findViewById(a.b("umeng_card_message_image"));
                ...
                ((Button) inflate.findViewById(a.b("umeng_card_message_ok"))).setOnClickListener(new View.OnClickListener() { // from class: com.umeng.message.inapp.UmengCardMessage.5
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                ...
                ((Button) inflate.findViewById(a.b("umeng_card_message_close"))).setOnClickListener(new View.OnClickListener() { // from class: com.umeng.message.inapp.UmengCardMessage.6
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                ...
                RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(this.f11398j, this.f11399k);
                ...
                LinearLayout.LayoutParams layoutParams5 = new LinearLayout.LayoutParams(-1, bo.a(35.0f));
                layoutParams5.setMargins(a10, bo.a(30.0f), a10, a10);
        ...
        if (getResources().getConfiguration().orientation == 1) {
            layoutParams = new RelativeLayout.LayoutParams(-1, -2);
        } else if (this.f11392d.msg_type == 2) {
            layoutParams = new RelativeLayout.LayoutParams(this.f11396h, this.f11397i);
        } else {
            layoutParams = new RelativeLayout.LayoutParams(-2, -1);
        }
        int a11 = bo.a(30.0f);
        ...
        ImageView imageView2 = new ImageView(this.f11391c);
        imageView2.setLayoutParams(layoutParams6);
        imageView2.setAdjustViewBounds(true);
        imageView2.setId(f.a());
        imageView2.setImageBitmap(this.f11394f);
        this.f11395g.addView(imageView2);
        int a14 = bo.a(24.0f);
        FrameLayout.LayoutParams layoutParams7 = new FrameLayout.LayoutParams(a14, a14, 5);
        br brVar = new br(this.f11391c);
        brVar.setLayoutParams(layoutParams7);
        this.f11395g.addView(brVar);
        relativeLayout2.addView(this.f11395g);
        imageView2.setOnClickListener(new View.OnClickListener() { // from class: com.umeng.message.inapp.UmengCardMessage.1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                UmengCardMessage.a(UmengCardMessage.this);
                if (TextUtils.equals("none", UmengCardMessage.this.f11392d.action_type)) {
