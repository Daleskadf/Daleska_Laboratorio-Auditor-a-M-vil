        ...
        try {
            ...
            for (int i10 = 0; i10 < length; i10++) {
                ...
                if (jSONObject.has(com.umeng.ccg.a.B)) {
                    i11 = Integer.valueOf(jSONObject.optInt(com.umeng.ccg.a.B));
                }
                if (!TextUtils.isEmpty(optString)) {
                    this.f9850d.add(new Pair<>(optString, i11));
                }
            }
            ...
            try {
                ...
                if (i10 != 0) {
                    if (i10 == 1) {
                        ...
                        jSONObject.put("target", (String) this.f9850d.get(randNumber).first);
                ...
                if (a10 != null) {
                    ...
                    if (i12 < this.f9849c) {
                        ...
                        jSONObject.put("target", (String) this.f9850d.get(i12).first);
                        ...
                        jSONObject.put("target", (String) this.f9850d.get(0).first);
