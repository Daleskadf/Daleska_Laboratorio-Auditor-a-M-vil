    ...
    */
    public static boolean a(java.lang.String r12, android.database.sqlite.SQLiteDatabase r13) {
        ...
        L4:
            ...
            r7[r1] = r12     // Catch: java.lang.Throwable -> L37 java.lang.Exception -> L3e
            ...
            r11 = 0
            r3 = r13
            android.database.Cursor r2 = r3.query(r4, r5, r6, r7, r8, r9, r10, r11)     // Catch: java.lang.Throwable -> L37 java.lang.Exception -> L3e
            boolean r12 = r2.moveToNext()     // Catch: java.lang.Throwable -> L37 java.lang.Exception -> L3e
            if (r12 == 0) goto L33
            int r12 = r2.getInt(r0)     // Catch: java.lang.Throwable -> L37 java.lang.Exception -> L3e
            if (r12 <= 0) goto L33
            r0 = 1
        L33:
            r2.close()
