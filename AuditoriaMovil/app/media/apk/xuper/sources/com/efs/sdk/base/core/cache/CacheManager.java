...
public class CacheManager {
    ...
    public static class b {
        ...
        /* renamed from: a  reason: collision with root package name */
        private static final CacheManager f6109a = new CacheManager((byte) 0);
    }
    ...
    public LogDto changeLogDto(File file) {
        ...
        try {
            ...
            if (a10 == null) {
                onChangeDtoError(file);
                return null;
            } else if (!a10.a(file, createLogDtoByName)) {
                onChangeDtoError(file);
                return null;
            } else {
    ...
    public void put(LogDto logDto) {
        ...
        if (!"wa".equals(logDto.getLogType()) && !Constants.LOG_TYPE_CODELOGPERF.equals(logDto.getLogType()) && !com.efs.sdk.base.core.cache.b.a().f6111a) {
            ...
            this.f6104a = true;
        } else if (Constants.LOG_TYPE_CODELOGPERF.equals(logDto.getLogType()) && !com.efs.sdk.base.core.cache.b.a().f6112b) {
        } else {
