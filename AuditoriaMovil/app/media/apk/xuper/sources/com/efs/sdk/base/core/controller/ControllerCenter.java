...
public class ControllerCenter implements Handler.Callback {
    ...
    public boolean handleMessage(Message message) {
        ...
        if (i10 != 0) {
            ...
            a10.f6193b = this;
            a10.f6194c.f6177a = this;
            a10.f6195d.f6177a = this;
            this.f6171f = true;
            ...
            f a11 = f.a.a();
            if (a11.f6193b != null && getGlobalEnvStruct().isEnableWaStat()) {
                a11.f6193b.send(new com.efs.sdk.base.core.d.b("efs_core", "pvuv", a11.f6192a.f6186c));
            }
        }
        return true;
    }
