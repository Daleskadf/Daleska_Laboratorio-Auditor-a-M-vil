...
public class y {
    ...
    public Object a(n3.t tVar) {
        ...
        try {
            ...
            return tVar.u().getNullValue(this.f17583b);
        } catch (k3.l e10) {
            r3.i d10 = tVar.d();
            if (d10 != null) {
    ...
    public boolean b(n3.t tVar, Object obj) {
        ...
        if (bitSet == null) {
            ...
            if (i10 != i11) {
                ...
                this.f17586e = i12;
                if (i12 <= 0) {
                    if (this.f17584c != null && this.f17590i == null) {
                        return false;
                    }
                    return true;
                }
    ...
    public Object[] g(n3.t[] tVarArr) {
        if (this.f17586e > 0) {
            if (this.f17588g == null) {
                ...
                while (i11 < length) {
                    if ((i10 & 1) == 0) {
                        this.f17585d[i11] = a(tVarArr[i11]);
                    }
                    i11++;
                    i10 >>= 1;
                }
                ...
                int i12 = 0;
                while (true) {
                    int nextClearBit = this.f17588g.nextClearBit(i12);
