...
public final class Cookie {
    ...
    private static boolean pathMatch(HttpUrl httpUrl, String str) {
        ...
        if (encodedPath.startsWith(str)) {
            if (str.endsWith(Operator.Operation.DIVISION) || encodedPath.charAt(str.length()) == '/') {
                return true;
            }
            return false;
        }
    ...
    public int hashCode() {
        ...
        return ((((((((((((((((527 + this.name.hashCode()) * 31) + this.value.hashCode()) * 31) + this.domain.hashCode()) * 31) + this.path.hashCode()) * 31) + ((int) (j10 ^ (j10 >>> 32)))) * 31) + (!this.secure ? 1 : 0)) * 31) + (!this.httpOnly ? 1 : 0)) * 31) + (!this.persistent ? 1 : 0)) * 31) + (!this.hostOnly ? 1 : 0);
    }
