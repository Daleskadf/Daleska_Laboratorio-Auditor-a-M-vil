...
class Huffman {
    ...
    public void encode(ByteString byteString, BufferedSink bufferedSink) {
        ...
        while (i10 < byteString.size()) {
            ...
            int i12 = CODES[i11];
            byte b11 = CODE_LENGTHS[i11];
            j10 = (j10 << b11) | i12;
            int i13 = b10 + b11;
            while (i13 >= 8) {
                i13 = (i13 == 1 ? 1 : 0) - 8;
                bufferedSink.writeByte((int) (j10 >> i13));
            }
            i10++;
            b10 = i13;
        }
        if (b10 > 0) {
            bufferedSink.writeByte((int) ((j10 << (8 - b10)) | (255 >>> b10)));
        }
    }
    ...
    public int encodedLength(ByteString byteString) {
        ...
        for (int i10 = 0; i10 < byteString.size(); i10++) {
            j10 += CODE_LENGTHS[byteString.getByte(i10) & UnsignedBytes.MAX_VALUE];
        }
        return (int) ((j10 + 7) >> 3);
    }
