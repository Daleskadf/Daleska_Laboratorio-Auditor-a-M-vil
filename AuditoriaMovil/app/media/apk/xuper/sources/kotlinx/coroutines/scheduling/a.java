...
public final class a implements Executor, Closeable {
    ...
    public final boolean a(h hVar) {
        ...
        if (z10) {
            return this.f15790f.a(hVar);
        }
        return this.f15789e.a(hVar);
    }
    ...
    public final class c extends Thread {
        ...
        public final boolean j() {
            if (this.nextParkedWorker != a.f15784l) {
                return true;
            }
            return false;
        }
        ...
        public final h m() {
            if (k(2) == 0) {
                ...
                return (h) a.this.f15790f.d();
            }
            h hVar2 = (h) a.this.f15790f.d();
            if (hVar2 != null) {
                return hVar2;
            }
            return (h) a.this.f15789e.d();
        }
        ...
        public final h t(boolean z10) {
            ...
            for (int i11 = 0; i11 < i10; i11++) {
                ...
                if (cVar != null && cVar != this) {
                    if (z10) {
                        l10 = this.f15794a.k(cVar.f15794a);
                    } else {
                        l10 = this.f15794a.l(cVar.f15794a);
                    }
                    if (l10 == -1) {
