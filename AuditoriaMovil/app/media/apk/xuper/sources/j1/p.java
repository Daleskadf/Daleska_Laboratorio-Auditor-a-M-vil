...
public final class p {
    ...
    public long a() {
        ...
        boolean z10 = false;
        if (c()) {
            if (this.f14594l == a1.a.LINEAR) {
                z10 = true;
            }
            if (z10) {
                scalb = this.f14595m * this.f14593k;
            } else {
                scalb = Math.scalb((float) this.f14595m, this.f14593k - 1);
            }
            return this.f14596n + Math.min(18000000L, scalb);
        }
        long j11 = 0;
        if (d()) {
            ...
            if (j12 == 0) {
                j10 = currentTimeMillis + this.f14589g;
            } else {
                j10 = j12;
            }
        ...
        long j15 = this.f14596n;
        if (j15 == 0) {
            j15 = System.currentTimeMillis();
        }
        return j15 + this.f14589g;
    }
    ...
    public boolean c() {
        if (this.f14584b == a1.s.ENQUEUED && this.f14593k > 0) {
            return true;
        }
        return false;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f14587e.equals(pVar.f14587e) && this.f14588f.equals(pVar.f14588f) && this.f14592j.equals(pVar.f14592j) && this.f14594l == pVar.f14594l && this.f14600r == pVar.f14600r) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((((((((((((((((((((((((((hashCode + i10) * 31) + this.f14587e.hashCode()) * 31) + this.f14588f.hashCode()) * 31) + ((int) (j10 ^ (j10 >>> 32)))) * 31) + ((int) (j11 ^ (j11 >>> 32)))) * 31) + ((int) (j12 ^ (j12 >>> 32)))) * 31) + this.f14592j.hashCode()) * 31) + this.f14593k) * 31) + this.f14594l.hashCode()) * 31) + ((int) (j13 ^ (j13 >>> 32)))) * 31) + ((int) (j14 ^ (j14 >>> 32)))) * 31) + ((int) (j15 ^ (j15 >>> 32)))) * 31) + ((int) (j16 ^ (j16 >>> 32)))) * 31) + (this.f14599q ? 1 : 0)) * 31) + this.f14600r.hashCode();
    }
