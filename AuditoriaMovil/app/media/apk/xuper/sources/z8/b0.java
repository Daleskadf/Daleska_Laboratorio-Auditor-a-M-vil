...
public class b0 implements q {
    ...
    */
    public final void s() {
        ...
        L5:
            monitor-enter(r3)
            java.util.List r1 = r3.f20300e     // Catch: java.lang.Throwable -> L3b
            boolean r1 = r1.isEmpty()     // Catch: java.lang.Throwable -> L3b
            if (r1 == 0) goto L1d
            r0 = 0
            r3.f20300e = r0     // Catch: java.lang.Throwable -> L3b
            r0 = 1
            r3.f20296a = r0     // Catch: java.lang.Throwable -> L3b
            z8.b0$o r0 = r3.f20301f     // Catch: java.lang.Throwable -> L3b
    ...
    public final void t(r rVar) {
        for (Runnable runnable : this.f20304i) {
            runnable.run();
        }
        this.f20304i = null;
        this.f20298c.g(rVar);
    ...
    public final void v(q qVar) {
        ...
        Preconditions.checkState(z10, "realStream already set to %s", qVar2);
        this.f20298c = qVar;
