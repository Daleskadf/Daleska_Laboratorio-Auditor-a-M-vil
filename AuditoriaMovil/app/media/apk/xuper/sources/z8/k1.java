...
public class k1 implements Closeable, y {
    ...
    public boolean isClosed() {
        if (this.f20679m == null && this.f20672f == null) {
            return true;
        }
        return false;
    }
                        ...
                        if (this.f20672f != null) {
                            try {
                                ...
                                if (bArr == null || this.f20674h == bArr.length) {
                                    this.f20673g = new byte[Math.min(h10, (int) AutoStrategy.BITRATE_LOW4)];
                                    this.f20674h = 0;
                                }
    ...
    public static final class d extends FilterInputStream {
        ...
        public final void b() {
            ...
            y8.k1 k1Var = y8.k1.f19898o;
            throw k1Var.r("Decompressed gRPC message exceeds maximum size " + this.f20688a).d();
        }
