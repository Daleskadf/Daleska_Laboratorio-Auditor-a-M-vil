    ...
    public static final class a extends t9.j implements s9.l {
        ...
        public final void b(GetLiveDataResult getLiveDataResult) {
            ...
            if (!TextUtils.isEmpty(data.getDataVersion())) {
                ...
                t9.i.d(data2);
                n0Var.j(context, "DATA_VERSION" + this.f16178b, data2.getDataVersion());
            }
            ...
            if (!TextUtils.isEmpty(data3.getExpireTimeStr())) {
                ...
                t9.i.d(data4);
                n0Var2.j(context2, "EXPIRE_TIME" + this.f16178b, data4.getExpireTimeStr());
            }
