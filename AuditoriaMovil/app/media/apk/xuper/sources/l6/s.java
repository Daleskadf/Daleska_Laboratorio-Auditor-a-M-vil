...
public final class s implements l5.a {
    ...
    public final boolean l(ExchangeCodeItem exchangeCodeItem) {
        if (!com.mobile.brasiltv.utils.b0.T(exchangeCodeItem.getStatus(), "1") && !com.mobile.brasiltv.utils.b0.T(exchangeCodeItem.getStatus(), "3")) {
            return false;
        }
        return true;
    }
    ...
    public final boolean m(ExchangeCodeItem exchangeCodeItem) {
        if (!com.mobile.brasiltv.utils.b0.T(exchangeCodeItem.getStatus(), "0") && !com.mobile.brasiltv.utils.b0.T(exchangeCodeItem.getStatus(), "2")) {
            return false;
        }
        return true;
    }
    ...
    public final List n(List list) {
        if (list != null && !list.isEmpty()) {
            return i9.r.I(i9.r.C(list, new Comparator() { // from class: l6.r
