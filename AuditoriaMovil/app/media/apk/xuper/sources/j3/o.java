...
public final class o {
    ...
    public int A() {
        ...
        return this.f14678g + this.f14680i;
    }
    ...
    public BigDecimal h() {
        ...
        if (i10 >= 0 && (cArr2 = this.f14673b) != null) {
            return f3.f.h(cArr2, i10, this.f14675d);
        }
        if (this.f14678g == 0 && (cArr = this.f14679h) != null) {
            return f3.f.h(cArr, 0, this.f14680i);
        }
        return f3.f.g(g());
    }
    ...
    public int j(boolean z10) {
        char[] cArr;
        int i10 = this.f14674c;
        if (i10 >= 0 && (cArr = this.f14673b) != null) {
            if (z10) {
                return -f3.f.k(cArr, i10 + 1, this.f14675d - 1);
            }
            return f3.f.k(cArr, i10, this.f14675d);
        } else if (z10) {
            return -f3.f.k(this.f14679h, 1, this.f14680i - 1);
        } else {
            return f3.f.k(this.f14679h, 0, this.f14680i);
        }
    }
    ...
    public long k(boolean z10) {
        ...
        if (i10 >= 0 && (cArr = this.f14673b) != null) {
            if (z10) {
                return -f3.f.m(cArr, i10 + 1, this.f14675d - 1);
            }
            return f3.f.m(cArr, i10, this.f14675d);
        } else if (z10) {
            return -f3.f.m(this.f14679h, 1, this.f14680i - 1);
        } else {
            return f3.f.m(this.f14679h, 0, this.f14680i);
        }
    }
        ...
        if (this.f14681j == null) {
            ...
            if (cArr != null) {
                ...
                if (i10 >= 0) {
                    ...
                    if (i12 == 0) {
                        if (i13 != 0) {
                            str = new String(this.f14679h, 0, i13);
                        }
                        this.f14681j = str;
                    } else {
    ...
    public final char[] y() {
        ...
        if (i11 >= 0) {
            ...
            if (i11 == 0) {
                return Arrays.copyOf(this.f14673b, i12);
            }
            return Arrays.copyOfRange(this.f14673b, i11, i12 + i11);
        }
        int A = A();
        if (A < 1) {
            return f14671l;
