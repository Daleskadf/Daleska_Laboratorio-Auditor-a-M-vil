...
public final class m {
    ...
    public final boolean K(String str, String str2) {
        if ((t9.i.b(str, f19179b) && (t9.i.b(str2, f19182e) || t9.i.b(str2, f19183f) || t9.i.b(str2, f19184g) || t9.i.b(str2, f19185h))) || t9.i.b(str, f19180c)) {
            return true;
        }
        return false;
    }
    ...
    public final void W(Context context, InAppMsg inAppMsg) {
        ...
        } else if (t9.i.b(inAppMsg.getMessageType(), f19180c)) {
    ...
    public final boolean v(InAppMsg inAppMsg, h9.k kVar) {
        t9.i.g(inAppMsg, Constant.KEY_MSG);
        t9.i.g(kVar, "msgType");
        if (t9.i.b(inAppMsg.getMessageType(), kVar.c()) && (t9.i.b(f19181d, kVar.d()) || t9.i.b(inAppMsg.getType(), kVar.d()))) {
            return true;
        }
        return false;
    }
    ...
    public final boolean w(InAppMsg inAppMsg) {
        if (t9.i.b(inAppMsg.getMessageType(), f19179b) && t9.i.b(inAppMsg.getType(), f19185h)) {
            ...
            boolean booleanValue = ((Boolean) u5.a.f19061a.a(App.f8263e.a(), "dont_remind", Boolean.FALSE)).booleanValue();
            if (f19193p || booleanValue) {
                return true;
            }
            return false;
        }
