...
public class d {
    ...
    private void a(String str, l.e eVar) {
        ...
        Request.Builder sslSocketFactory = new Request.Builder().setUrl(parse).addHeader("Connection", HTTP.CLOSE).setConnectTimeout(eVar.f4245b.f4216c).setReadTimeout(eVar.f4245b.f4217d).setRedirectEnable(false).setSslSocketFactory(new anet.channel.util.j(str));
        Request build = sslSocketFactory.setSeq("HR" + this.f3921b.getAndIncrement()).build();
