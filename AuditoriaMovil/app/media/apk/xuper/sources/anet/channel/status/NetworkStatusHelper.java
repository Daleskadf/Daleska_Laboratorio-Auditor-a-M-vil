...
public class NetworkStatusHelper {
    ...
    public static String getDnsServerAddress() {
        if (!b.f4130l.isEmpty()) {
            return b.f4130l.get(0).getHostAddress();
        }
        return b.f();
    }
    ...
    public static String getProxyType() {
        ...
        if (networkStatus.isMobile() && b.f4123e.contains("wap")) {
            return "wap";
        }
        if (networkStatus.isMobile() && anet.channel.util.g.a() != null) {
    ...
    public static boolean isProxy() {
        ...
        if (networkStatus != NetworkStatus.WIFI || getWifiProxy() == null) {
            if (networkStatus.isMobile()) {
                if (str.contains("wap") || anet.channel.util.g.a() != null) {
                    return true;
                }
                return false;
            }
