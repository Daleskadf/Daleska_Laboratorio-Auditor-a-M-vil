...
public class e {
    ...
    public double a(double d10, double d11) {
        ...
        if (j10 == 0) {
            ...
            double d17 = this.f4036g;
            double min = Math.min(Math.max(Math.abs((this.f4033d * 1.05d) - ((0.0025d * d17) * d17)), this.f4033d * 0.8d), this.f4033d * 1.25d);
            this.f4033d = min;
            double d18 = this.f4034e;
            double d19 = d18 / ((0.9025d * d18) + min);
            this.f4035f = d19;
            double d20 = this.f4037h + (1.0526315789473684d * d14) + (d19 * this.f4036g);
            this.f4037h = d20;
            if (c10 == 1) {
                this.f4037h = Math.min(d20, this.f4031b);
            } else if (c10 == 2) {
                this.f4037h = Math.max(d20, this.f4031b);
            }
            this.f4034e = (1.0d - (0.95d * this.f4035f)) * (this.f4034e + this.f4032c);
        }
        double d21 = this.f4037h;
        if (d21 < 0.0d) {
            double d22 = this.f4039j * 0.7d;
            this.f4040k = d22;
            this.f4037h = d22;
        } else {
            this.f4040k = d21;
