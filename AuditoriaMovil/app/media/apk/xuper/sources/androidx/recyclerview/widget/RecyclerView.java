...
public class RecyclerView extends ViewGroup implements b0.v {
    ...
    public static class a0 {
        ...
        public int b() {
            if (this.f3014h) {
                return this.f3009c - this.f3010d;
            }
            return this.f3012f;
        }
    ...
    public class c0 implements Runnable {
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                int i13 = currX - this.f3025a;
                int i14 = currY - this.f3026b;
                this.f3025a = currX;
                this.f3026b = currY;
                RecyclerView recyclerView2 = RecyclerView.this;
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    if (i10 != 4) {
                        if (i10 == 8) {
                            RecyclerView recyclerView = RecyclerView.this;
                            recyclerView.mLayout.onItemsMoved(recyclerView, bVar.f3144b, bVar.f3146d, 1);
                            return;
                        }
                        return;
                    }
                    RecyclerView recyclerView2 = RecyclerView.this;
                    recyclerView2.mLayout.onItemsUpdated(recyclerView2, bVar.f3144b, bVar.f3146d, bVar.f3145c);
                    return;
                }
                RecyclerView recyclerView3 = RecyclerView.this;
                recyclerView3.mLayout.onItemsRemoved(recyclerView3, bVar.f3144b, bVar.f3146d);
                return;
            }
            RecyclerView recyclerView4 = RecyclerView.this;
            recyclerView4.mLayout.onItemsAdded(recyclerView4, bVar.f3144b, bVar.f3146d);
        }
    }
    ...
    public static abstract class o {
        ...
        */
        ...
        public boolean shouldMeasureChild(View view, int i10, int i11, p pVar) {
            if (!view.isLayoutRequested() && this.mMeasurementCacheEnabled && e(view.getWidth(), i10, ((ViewGroup.MarginLayoutParams) pVar).width) && e(view.getHeight(), i11, ((ViewGroup.MarginLayoutParams) pVar).height)) {
                return false;
            }
            return true;
        }
        ...
        public boolean shouldReMeasureChild(View view, int i10, int i11, p pVar) {
            if (this.mMeasurementCacheEnabled && e(view.getMeasuredWidth(), i10, ((ViewGroup.MarginLayoutParams) pVar).width) && e(view.getMeasuredHeight(), i11, ((ViewGroup.MarginLayoutParams) pVar).height)) {
                return false;
            }
            return true;
        }
    ...
    static {
        ...
        FORCE_INVALIDATE_DISPLAY_LIST = z10;
        if (i10 >= 23) {
            z11 = true;
        } else {
            z11 = false;
        }
        ALLOW_SIZE_IN_UNSPECIFIED_SPEC = z11;
    ...
    private void dispatchLayoutStep1() {
        ...
        a0Var.f3015i = (a0Var.f3017k && this.mItemsChanged) ? false : false;
    ...
    private void dispatchLayoutStep2() {
        ...
        if (a0Var2.f3017k && this.mItemAnimator != null) {
            z10 = true;
        } else {
            z10 = false;
        }
    ...
    private void processAdapterUpdatesAndSetAnimationFlags() {
        ...
        a0Var.f3017k = z11;
        a0 a0Var2 = this.mState;
        if (a0Var2.f3017k && z10 && !this.mDataSetHasChangedAfterLayout && predictiveItemAnimationsEnabled()) {
            z13 = true;
        }
        a0Var2.f3018l = z13;
    }
    ...
    */
    ...
    private void recoverFocusFromState() {
        ...
        if (this.mPreserveFocusAfterLayout && this.mAdapter != null && hasFocus() && getDescendantFocusability() != 393216) {
            if (getDescendantFocusability() != 131072 || !isFocused()) {
                ...
                View view = null;
                if (this.mState.f3020n != -1 && this.mAdapter.hasStableIds()) {
                    d0Var = findViewHolderForItemId(this.mState.f3020n);
                } else {
                    d0Var = null;
                }
    ...
    private void saveFocusInfo() {
        ...
        a0Var2.f3019m = adapterPosition;
        this.mState.f3021o = getDeepestFocusedViewWithId(d0Var.itemView);
    }
    ...
    */
    ...
    public boolean fling(int i10, int i11) {
        ...
        if (oVar == null) {
            ...
            i10 = (canScrollHorizontally == 0 || Math.abs(i10) < this.mMinFlingVelocity) ? 0 : 0;
            i11 = (!canScrollVertically || Math.abs(i11) < this.mMinFlingVelocity) ? 0 : 0;
            if (i10 == 0 && i11 == 0) {
                return false;
            }
            float f10 = i10;
