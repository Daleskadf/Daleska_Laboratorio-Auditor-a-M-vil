...
public class a implements l.a {
        ...
        public String a() {
            ...
            if (i10 != 1) {
                if (i10 != 2) {
                    ...
                    return com.umeng.analytics.pro.f.R;
                }
                return "rm";
            }
            return "add";
    ...
    public final void k(b bVar) {
        ...
        if (i11 != 1 && i11 != 8) {
            ...
            for (int i15 = 1; i15 < bVar.f3146d; i15++) {
                int z12 = z(bVar.f3144b + (i10 * i15), bVar.f3143a);
                int i16 = bVar.f3143a;
                ...
                if (z10) {
                    ...
                    b a10 = a(i16, z11, i14, bVar.f3145c);
                    l(a10, i12);
                    b(a10);
                    if (bVar.f3143a == 4) {
                        i12 += i14;
            ...
            b(bVar);
            if (i14 > 0) {
                b a11 = a(bVar.f3143a, z11, i14, obj);
                l(a11, i12);
                b(a11);
                return;
            }
    ...
    public boolean q() {
        if (!this.f3137c.isEmpty() && !this.f3136b.isEmpty()) {
            return true;
        }
        return false;
    }
