...
public class b {
    ...
    public static class a {
        ...
        public int b(int i10) {
            ...
            if (aVar == null) {
                if (i10 >= 64) {
                    return Long.bitCount(this.f3150a);
                }
                return Long.bitCount(this.f3150a & ((1 << i10) - 1));
            } else if (i10 < 64) {
                return Long.bitCount(this.f3150a & ((1 << i10) - 1));
            } else {
                return aVar.b(i10 - 64) + Long.bitCount(this.f3150a);
            }
        }
    ...
    public void a(View view, int i10, boolean z10) {
        ...
        this.f3148b.e(h10, z10);
        if (z10) {
            l(view);
        }
        this.f3147a.f(view, h10);
    }
    ...
    public void c(View view, int i10, ViewGroup.LayoutParams layoutParams, boolean z10) {
        ...
        this.f3147a.k(view, h10, layoutParams);
    }
