...
public class StaggeredGridLayoutManager extends RecyclerView.o implements RecyclerView.z.b {
    ...
    public class b {
        ...
        public void a() {
            int m10;
            if (this.f3106c) {
                m10 = StaggeredGridLayoutManager.this.f3081c.i();
            } else {
                m10 = StaggeredGridLayoutManager.this.f3081c.m();
            }
            this.f3105b = m10;
        }
    ...
    public class f {
        ...
        public void b(boolean z10, int i10) {
            ...
            if (!z10 || r10 >= StaggeredGridLayoutManager.this.f3081c.i()) {
                if (!z10 && r10 > StaggeredGridLayoutManager.this.f3081c.m()) {
                    return;
                }
        ...
        public int f() {
            if (StaggeredGridLayoutManager.this.f3086h) {
                return j(this.f3129a.size() - 1, -1, true);
            }
            return j(0, this.f3129a.size(), true);
        }

        public int g() {
            if (StaggeredGridLayoutManager.this.f3086h) {
                return k(0, this.f3129a.size(), true);
            }
            return k(this.f3129a.size() - 1, -1, true);
        }
        ...
        public int i(int i10, int i11, boolean z10, boolean z11, boolean z12) {
            ...
            int i13 = StaggeredGridLayoutManager.this.f3081c.i();
            if (i11 > i10) {
                i12 = 1;
            } else {
                i12 = -1;
        ...
        public View o(int i10, int i11) {
            ...
            if (i11 == -1) {
                ...
                int i12 = 0;
                while (i12 < size) {
                    View view2 = (View) this.f3129a.get(i12);
                ...
                int size2 = this.f3129a.size() - 1;
                while (size2 >= 0) {
                    View view3 = (View) this.f3129a.get(size2);
    ...
    */
    public final void K(int r7, int r8, int r9) {
        ...
        L1c:
            r3 = r7
        L1d:
            androidx.recyclerview.widget.StaggeredGridLayoutManager$d r4 = r6.f3091m
            r4.h(r3)
            r4 = 1
            if (r9 == r4) goto L3c
            r5 = 2
            ...
            goto L41
        L2b:
            androidx.recyclerview.widget.StaggeredGridLayoutManager$d r9 = r6.f3091m
            r9.k(r7, r4)
            androidx.recyclerview.widget.StaggeredGridLayoutManager$d r7 = r6.f3091m
            r7.j(r8, r4)
            goto L41
        L36:
            androidx.recyclerview.widget.StaggeredGridLayoutManager$d r9 = r6.f3091m
    ...
    */
    public android.view.View L() {
        ...
        L2e:
            ...
            androidx.recyclerview.widget.StaggeredGridLayoutManager$f r9 = r8.f3111e
            int r9 = r9.f3133e
        ...
        L59:
            ...
            boolean r10 = r12.f3087i
            if (r10 == 0) goto L77
            androidx.recyclerview.widget.m r10 = r12.f3081c
            int r10 = r10.d(r7)
            androidx.recyclerview.widget.m r11 = r12.f3081c
            int r11 = r11.d(r9)
            if (r10 >= r11) goto L74
            return r7
        L74:
        ...
        L8b:
            ...
            androidx.recyclerview.widget.StaggeredGridLayoutManager$f r8 = r8.f3111e
            int r8 = r8.f3133e
            androidx.recyclerview.widget.StaggeredGridLayoutManager$f r9 = r9.f3111e
            int r9 = r9.f3133e
            int r8 = r8 - r9
            if (r8 >= 0) goto La0
            r8 = 1
    ...
    public final void N(View view, int i10, int i11, boolean z10) {
        ...
        if (z10) {
            shouldMeasureChild = shouldReMeasureChild(view, g02, g03, cVar);
        } else {
            shouldMeasureChild = shouldMeasureChild(view, g02, g03, cVar);
        }
    ...
    */
    ...
    public final void T(RecyclerView.v vVar, i iVar) {
        ...
        if (iVar.f3250a && !iVar.f3258i) {
            if (iVar.f3251b == 0) {
            ...
            } else if (iVar.f3254e == -1) {
                int i10 = iVar.f3255f;
                int G = i10 - G(i10);
                if (G < 0) {
                    min2 = iVar.f3256g;
                } else {
                    min2 = iVar.f3256g - Math.min(G, iVar.f3251b);
                }
                U(vVar, min2);
            } else {
                ...
                if (H < 0) {
                    ...
                    min = Math.min(H, iVar.f3251b) + iVar.f3255f;
                }
                V(vVar, min);
            }
        }
                ...
                if (eVar != null && eVar.f3119a != -1 && eVar.f3121c >= 1) {
                    ...
                    if (findViewByPosition != null) {
                        ...
                        if (this.f3090l != Integer.MIN_VALUE) {
                            ...
                            return true;
                        } else if (this.f3081c.e(findViewByPosition) > this.f3081c.n()) {
                            if (bVar.f3106c) {
                                m10 = this.f3081c.i();
                            } else {
                                m10 = this.f3081c.m();
        ...
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 != 17) {
                    if (i10 != 33) {
                        if (i10 != 66) {
                            if (i10 == 130 && this.f3083e == 1) {
                                return 1;
                            }
                            return Integer.MIN_VALUE;
                        } else if (this.f3083e == 0) {
                            return 1;
                        } else {
                            return Integer.MIN_VALUE;
                        }
            ...
            } else if (this.f3083e != 1 && isLayoutRTL()) {
                return -1;
            } else {
                return 1;
            }
    ...
    */
    public final void d0(int r5, androidx.recyclerview.widget.RecyclerView.a0 r6) {
        /*
            r4 = this;
            androidx.recyclerview.widget.i r0 = r4.f3085g
            r1 = 0
            r0.f3251b = r1
            r0.f3252c = r5
        ...
        L1c:
            if (r0 != r5) goto L25
            androidx.recyclerview.widget.m r5 = r4.f3081c
            int r5 = r5.n()
            goto L2f
        L25:
            androidx.recyclerview.widget.m r5 = r4.f3081c
        ...
        L30:
            ...
            if (r0 == 0) goto L4d
            androidx.recyclerview.widget.i r0 = r4.f3085g
            androidx.recyclerview.widget.m r3 = r4.f3081c
            int r3 = r3.m()
            int r3 = r3 - r6
            r0.f3255f = r3
            androidx.recyclerview.widget.i r6 = r4.f3085g
            androidx.recyclerview.widget.m r0 = r4.f3081c
            int r0 = r0.i()
            int r0 = r0 + r5
            r6.f3256g = r0
            goto L5d
        L4d:
            ...
            int r3 = r3 + r5
            r0.f3256g = r3
            androidx.recyclerview.widget.i r5 = r4.f3085g
            int r6 = -r6
            r5.f3255f = r6
        L5d:
            androidx.recyclerview.widget.i r5 = r4.f3085g
            r5.f3257h = r1
            r5.f3250a = r2
            androidx.recyclerview.widget.m r6 = r4.f3081c
            int r6 = r6.k()
            if (r6 != 0) goto L74
            androidx.recyclerview.widget.m r6 = r4.f3081c
            int r6 = r6.h()
    ...
    public View onFocusSearchFailed(View view, int i10, RecyclerView.v vVar, RecyclerView.a0 a0Var) {
        ...
        if (!z12 && (o10 = fVar.o(D, convertFocusDirectionToLayoutDirection)) != null && o10 != findContainingItemView) {
            return o10;
        }
        if (Q(convertFocusDirectionToLayoutDirection)) {
            for (int i11 = this.f3079a - 1; i11 >= 0; i11--) {
                View o11 = this.f3080b[i11].o(D, convertFocusDirectionToLayoutDirection);
            ...
            for (int i12 = 0; i12 < this.f3079a; i12++) {
                View o12 = this.f3080b[i12].o(D, convertFocusDirectionToLayoutDirection);
                if (o12 != null && o12 != findContainingItemView) {
                    return o12;
                }
            }
        }
        boolean z13 = !this.f3086h;
        if (convertFocusDirectionToLayoutDirection == -1) {
            z10 = true;
        } else {
            z10 = false;
        ...
        if (Q(convertFocusDirectionToLayoutDirection)) {
            for (int i13 = this.f3079a - 1; i13 >= 0; i13--) {
                if (i13 != fVar.f3133e) {
                    if (z11) {
                        h11 = this.f3080b[i13].f();
                    } else {
                        h11 = this.f3080b[i13].h();
                    }
            ...
            for (int i14 = 0; i14 < this.f3079a; i14++) {
                if (z11) {
                    h10 = this.f3080b[i14].f();
                } else {
                    h10 = this.f3080b[i14].h();
                }
    ...
    public final int u(RecyclerView.v vVar, i iVar, RecyclerView.a0 a0Var) {
        ...
        if (this.f3085g.f3258i) {
            ...
            if (iVar.f3254e == 1) {
                i10 = iVar.f3256g + iVar.f3251b;
            } else {
                i10 = iVar.f3255f - iVar.f3251b;
            }
            i11 = i10;
        }
        Z(iVar.f3254e, i11);
        ...
        while (iVar.a(a0Var) && (this.f3085g.f3258i || !this.f3088j.isEmpty())) {
            ...
            if (isLayoutRTL() && this.f3083e == 1) {
                if (cVar.f3112f) {
                    ...
                    i14 = this.f3082d.i() - (((this.f3079a - 1) - fVar2.f3133e) * this.f3084f);
                }
                e11 = i14;
                i13 = i14 - this.f3082d.e(b10);
            } else {
                if (cVar.f3112f) {
                    m11 = this.f3082d.m();
                } else {
                    m11 = (fVar2.f3133e * this.f3084f) + this.f3082d.m();
                }
                i13 = m11;
                e11 = this.f3082d.e(b10) + m11;
            }
            if (this.f3083e == 1) {
            ...
            if (cVar.f3112f) {
                Z(this.f3085g.f3254e, i11);
            } else {
                f0(fVar2, this.f3085g.f3254e, i11);
            }
            T(vVar, this.f3085g);
        ...
        if (this.f3085g.f3254e == -1) {
            F = this.f3081c.m() - I(this.f3081c.m());
        } else {
            F = F(this.f3081c.i()) - this.f3081c.i();
        }
        if (F > 0) {
            return Math.min(iVar.f3251b, F);
        }
        return 0;
    }
    ...
    public static class d {
        ...
        public final int i(int i10) {
            ...
            return ((a) this.f3114b.get(i11)).f3115a;
        }
