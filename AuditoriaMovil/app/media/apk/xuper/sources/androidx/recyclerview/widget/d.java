...
public class d extends RecyclerView.n implements RecyclerView.s {
    ...
    public class c extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            if (this.f3231a) {
                this.f3231a = false;
            } else if (((Float) d.this.f3228z.getAnimatedValue()).floatValue() == 0.0f) {
                d dVar = d.this;
                dVar.A = 0;
                dVar.p(0);
            } else {
    ...
    public final void d(Canvas canvas) {
        ...
        int i14 = this.f3216n;
        int i15 = i13 - (i14 / 2);
        this.f3209g.setBounds(0, 0, i14, i11);
    ...
    public void onTouchEvent(RecyclerView recyclerView, MotionEvent motionEvent) {
        ...
        } else if (motionEvent.getAction() == 1 && this.f3224v == 2) {
            this.f3215m = 0.0f;
            this.f3218p = 0.0f;
            p(1);
            this.f3225w = 0;
        } else if (motionEvent.getAction() == 2 && this.f3224v == 2) {
            r();
            if (this.f3225w == 1) {
                i(motionEvent.getX());
            }
    ...
    public void s(int i10, int i11) {
        ...
        int i12 = this.f3220r;
        if (computeVerticalScrollRange - i12 > 0 && i12 >= this.f3203a) {
            z10 = true;
        } else {
            z10 = false;
        }
        ...
        int i13 = this.f3219q;
        if (computeHorizontalScrollRange - i13 > 0 && i13 >= this.f3203a) {
            z11 = true;
        } else {
            z11 = false;
        }
        this.f3223u = z11;
        boolean z12 = this.f3222t;
        if (!z12 && !z11) {
            if (this.f3224v != 0) {
                p(0);
                return;
