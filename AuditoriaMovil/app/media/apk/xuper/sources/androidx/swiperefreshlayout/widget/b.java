    ...
    public static class c {
        ...
        public void b(Canvas canvas, float f10, float f11, RectF rectF) {
            if (this.f3401n) {
                ...
                path3.lineTo((this.f3405r * f12) / 2.0f, this.f3406s * f12);
                this.f3402o.offset(((Math.min(rectF.width(), rectF.height()) / 2.0f) + rectF.centerX()) - ((this.f3405r * this.f3403p) / 2.0f), rectF.centerY() + (this.f3395h / 2.0f));
                this.f3402o.close();
