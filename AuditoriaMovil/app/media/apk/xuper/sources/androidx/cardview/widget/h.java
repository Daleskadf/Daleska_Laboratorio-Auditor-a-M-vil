...
public class h extends Drawable {
    ...
    public final void i(Rect rect) {
        ...
        if (this.f1768f) {
            float d10 = i.d(this.f1767e, this.f1763a, this.f1769g);
            this.f1766d.inset((int) Math.ceil(i.c(this.f1767e, this.f1763a, this.f1769g)), (int) Math.ceil(d10));
    ...
    public boolean isStateful() {
        ...
        if ((colorStateList2 != null && colorStateList2.isStateful()) || (((colorStateList = this.f1770h) != null && colorStateList.isStateful()) || super.isStateful())) {
            return true;
        }
        return false;
    }
    ...
    public boolean onStateChange(int[] iArr) {
        ...
        if (colorForState != this.f1764b.getColor()) {
            z10 = true;
        } else {
            z10 = false;
        }
