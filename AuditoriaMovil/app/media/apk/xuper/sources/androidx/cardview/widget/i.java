...
public class i extends Drawable {
    ...
    public static float c(float f10, float f11, boolean z10) {
        if (z10) {
            ...
            Double.isNaN(d11);
            Double.isNaN(d10);
            return (float) (d10 + ((1.0d - f1774q) * d11));
        }
        return f10;
    }
    ...
    public final void b() {
        ...
        float f17 = (-f15) - f16;
        int i11 = this.f1788m;
        paint2.setShader(new LinearGradient(0.0f, (-f15) + f16, 0.0f, f17, new int[]{i11, i11, this.f1789n}, new float[]{0.0f, 0.5f, 1.0f}, Shader.TileMode.CLAMP));
    ...
    public final void e(Canvas canvas) {
        ...
        float f13 = f12 * 2.0f;
        if (this.f1780e.width() - f13 > 0.0f) {
            z10 = true;
        } else {
            z10 = false;
        }
        if (this.f1780e.height() - f13 > 0.0f) {
            z11 = true;
        } else {
            z11 = false;
        }
