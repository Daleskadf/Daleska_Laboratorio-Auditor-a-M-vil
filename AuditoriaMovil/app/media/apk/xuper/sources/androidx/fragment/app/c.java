...
public class c extends j0 {
    ...
    public static class k extends l {
        ...
        public f.d e(Context context) {
            ...
            f.d c10 = androidx.fragment.app.f.c(context, f10, z10, this.f2224c);
            this.f2226e = c10;
            this.f2225d = true;
            return c10;
        }
    ...
    public static class m extends l {
        ...
        public m(j0.e eVar, x.b bVar, boolean z10, boolean z11) {
            ...
            if (eVar.e() == j0.e.c.VISIBLE) {
                ...
                this.f2230d = allowEnterTransitionOverlap;
            } else {
                if (z10) {
    ...
    public void f(List list, boolean z10) {
        ...
        while (it.hasNext()) {
            ...
            if (i10 != 1 && i10 != 2 && i10 != 3) {
                if (i10 == 4 && c10 != j0.e.c.VISIBLE) {
                    eVar2 = eVar3;
                }
            } else if (c10 == j0.e.c.VISIBLE && eVar == null) {
                eVar = eVar3;
            }
        }
                ...
                if (e10 == null) {
                    ...
                    if (animator == null) {
                        ...
                        if (Boolean.TRUE.equals(map.get(b10))) {
                            ...
                            animator.addListener(new C0031c(m10, view, z11, b10, kVar));
    ...
    public final Map x(List list, List list2, boolean z10, j0.e eVar, j0.e eVar2) {
            ...
            if (mVar4.d()) {
                ...
                if (g10 == null) {
                    ...
                    if (arrayList10.isEmpty()) {
                        ...
                        arrayList2 = collection;
                        eVar3 = eVar10;
                        g0Var3.t(g10, g10, arrayList10, null, null, null, null);
                        if (b10.e() == j0.e.c.GONE) {
                            eVar4 = b10;
                            list2.remove(eVar4);
                            ArrayList arrayList11 = new ArrayList(arrayList10);
                            arrayList11.remove(eVar4.f().mView);
                            g0Var3.r(g10, eVar4.f().mView, arrayList11);
                            b0.d0.a(m(), new i(arrayList10));
                        } else {
                            eVar4 = b10;
                        }
                    }
        ...
        if (c1.Q(m())) {
            z.A(arrayList9, 4);
            ArrayList o10 = g0Var3.o(arrayList12);
            g0Var3.c(m(), m10);
            g0Var3.y(m(), arrayList13, arrayList12, o10, aVar5);
            z.A(arrayList9, 0);
            g0Var3.A(obj3, arrayList13, arrayList12);
            return hashMap;
        }
        return hashMap;
    }
