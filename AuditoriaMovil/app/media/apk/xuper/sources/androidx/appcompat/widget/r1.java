...
public class r1 extends ListView {
    ...
    */
    ...
    public final void f(int i10, View view) {
        ...
        try {
            boolean z11 = this.f1604g.getBoolean(this);
            if (view.isEnabled() != z11) {
                Field field = this.f1604g;
                if (!z11) {
                    z10 = true;
                } else {
                    z10 = false;
    ...
    public boolean hasWindowFocus() {
        if (!this.f1607j && !super.hasWindowFocus()) {
            return false;
        }
        return true;
    }
    ...
    public boolean isFocused() {
        if (!this.f1607j && !super.isFocused()) {
            return false;
        }
        return true;
    }
    ...
    public boolean isInTouchMode() {
        if ((this.f1607j && this.f1606i) || super.isInTouchMode()) {
            return true;
        }
        return false;
    }
