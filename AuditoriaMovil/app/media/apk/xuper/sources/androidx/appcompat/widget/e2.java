...
public final class e2 {
    ...
    public static boolean q(Drawable drawable) {
        if (!(drawable instanceof x0.n) && !"android.graphics.drawable.VectorDrawable".equals(drawable.getClass().getName())) {
            return false;
        }
        return true;
    }
