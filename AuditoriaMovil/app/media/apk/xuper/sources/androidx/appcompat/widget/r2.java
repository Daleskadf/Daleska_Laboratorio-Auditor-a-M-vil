...
public class r2 {
    ...
    public ColorStateList c(int i10) {
        int resourceId;
        ColorStateList c10;
        if (this.f1615b.hasValue(i10) && (resourceId = this.f1615b.getResourceId(i10, 0)) != 0 && (c10 = d.b.c(this.f1614a, resourceId)) != null) {
            return c10;
        }
        return this.f1615b.getColorStateList(i10);
    }
    ...
    public Drawable g(int i10) {
        ...
        if (this.f1615b.hasValue(i10) && (resourceId = this.f1615b.getResourceId(i10, 0)) != 0) {
            return d.b.d(this.f1614a, resourceId);
        }
        return this.f1615b.getDrawable(i10);
    }
