...
public class l2 extends e0.c implements View.OnClickListener {
    ...
    public static final class a {
        ...
        public a(View view) {
            this.f1544a = (TextView) view.findViewById(16908308);
            this.f1545b = (TextView) view.findViewById(16908309);
            this.f1546c = (ImageView) view.findViewById(16908295);
            this.f1547d = (ImageView) view.findViewById(16908296);
    ...
    public void e(View view, Context context, Cursor cursor) {
        ...
        if (aVar.f1545b != null) {
            String w11 = w(cursor, this.f1540w);
            if (w11 != null) {
                w10 = l(w11);
            } else {
                w10 = w(cursor, this.f1539v);
            }
    ...
    public final Drawable n(ComponentName componentName) {
        ...
        if (this.f1533p.containsKey(flattenToShortString)) {
            Drawable.ConstantState constantState2 = (Drawable.ConstantState) this.f1533p.get(flattenToShortString);
            if (constantState2 == null) {
                return null;
            }
            return constantState2.newDrawable(this.f1532o.getResources());
        }
        Drawable m10 = m(componentName);
        if (m10 != null) {
            constantState = m10.getConstantState();
        }
        this.f1533p.put(flattenToShortString, constantState);
        return m10;
    }
    ...
    public final Drawable p(Cursor cursor) {
        ...
        return this.f12834d.getPackageManager().getDefaultActivityIcon();
    }
