...
public class ActionBarContextView extends androidx.appcompat.widget.a {
    ...
    public void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (view != null && view.getVisibility() != 8) {
            ...
            paddingLeft = androidx.appcompat.widget.a.d(d10 + e(this.f1285k, d10, paddingTop, paddingTop2, b10), i15, b10);
        }
        int i16 = paddingLeft;
        ...
        if (mode == 1073741824) {
            if (View.MeasureSpec.getMode(i11) != 0) {
                ...
                if (view2 != null) {
                    ...
                    this.f1286l.measure(View.MeasureSpec.makeMeasureSpec(paddingLeft, i12), View.MeasureSpec.makeMeasureSpec(i16, i14));
                }
                if (this.f1429e <= 0) {
