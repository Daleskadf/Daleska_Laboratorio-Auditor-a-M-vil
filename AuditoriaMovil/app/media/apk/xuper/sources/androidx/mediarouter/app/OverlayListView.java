...
final class OverlayListView extends ListView {
    ...
    public static class a {
        ...
        public boolean j(long j10) {
            ...
            float f10 = 0.0f;
            float max = Math.max(0.0f, Math.min(1.0f, ((float) (j10 - this.f2741j)) / ((float) this.f2736e)));
            if (this.f2742k) {
                f10 = max;
            }
            ...
            float f11 = this.f2739h;
            float f12 = f11 + ((this.f2740i - f11) * interpolation);
            this.f2733b = f12;
