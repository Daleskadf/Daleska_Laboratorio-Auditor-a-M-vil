...
public abstract class g {
    ...
    public static int q(int i10, byte[] bArr, int i11) {
        ...
        if (i10 < f13068a) {
            ...
            int i14 = i10 / 1000;
            return a(i10 - (i14 * 1000), bArr, c(i14, bArr, i11));
        }
        int i15 = f13069b;
        if (i10 >= i15) {
            int i16 = i10 - i15;
            ...
            return e(i16, bArr, i12);
        }
        int i17 = i10 / 1000;
        int i18 = i17 / 1000;
        return a(i10 - (i17 * 1000), bArr, a(i17 - (i18 * 1000), bArr, c(i18, bArr, i11)));
    }
    ...
    public static int r(int i10, char[] cArr, int i11) {
        ...
        if (i10 >= i14) {
            ...
            return f(i15, cArr, i12);
        }
        int i16 = i10 / 1000;
        int i17 = i16 / 1000;
        return b(i10 - (i16 * 1000), cArr, b(i16 - (i17 * 1000), cArr, d(i17, cArr, i11)));
    }
