...
public class a {
    ...
    public final y2.a b(String str) {
        ...
        builder.retryOnConnectionFailure(true).connectTimeout(this.f19411d, timeUnit).readTimeout(this.f19411d, timeUnit).writeTimeout(this.f19411d, timeUnit).dispatcher(new Dispatcher(j.f170a.d())).addInterceptor(new w2.a());
