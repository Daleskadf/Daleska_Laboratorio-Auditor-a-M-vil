...
public class b extends c {
    ...
    public Boolean b() {
        ...
        return Boolean.valueOf((registerReceiver.getIntExtra(Constant.KEY_STATUS, -1) == 1 || ((float) registerReceiver.getIntExtra(FirebaseAnalytics.Param.LEVEL, -1)) / ((float) registerReceiver.getIntExtra("scale", -1)) > 0.15f) ? true : true);
    }
}
