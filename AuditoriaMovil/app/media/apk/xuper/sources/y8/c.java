...
public final class c {
    ...
    static {
        b bVar = new b();
        bVar.f19810f = (Object[][]) Array.newInstance(Object.class, 0, 2);
    ...
    public c s(C0345c c0345c, Object obj) {
        ...
        int length = this.f19800f.length;
        if (i11 == -1) {
            i10 = 1;
        } else {
            i10 = 0;
        }
        Object[][] objArr2 = (Object[][]) Array.newInstance(Object.class, length + i10, 2);
        k10.f19810f = objArr2;
        Object[][] objArr3 = this.f19800f;
        System.arraycopy(objArr3, 0, objArr2, 0, objArr3.length);
        if (i11 == -1) {
            Object[][] objArr4 = k10.f19810f;
            int length2 = this.f19800f.length;
            Object[] objArr5 = new Object[2];
            objArr5[0] = c0345c;
            objArr5[1] = obj;
            objArr4[length2] = objArr5;
        } else {
            Object[][] objArr6 = k10.f19810f;
    ...
    public String toString() {
        ...
        return add.add("executor", cls).add("compressorName", this.f19799e).add("customOptions", Arrays.deepToString(this.f19800f)).add("waitForReady", j()).add("maxInboundMessageSize", this.f19803i).add("maxOutboundMessageSize", this.f19804j).add("streamTracerFactories", this.f19801g).toString();
    }
