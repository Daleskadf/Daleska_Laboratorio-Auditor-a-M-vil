...
public final class d implements Converter {
    ...
    public Object convert(ResponseBody responseBody) {
        ...
        try {
            ...
            BaseResponse baseResponse = (BaseResponse) this.f14417b.fromJson(string, (Class<Object>) BaseResponse.class);
            if (this.f14421f) {
                if ("0".equals(baseResponse.getReturnCode())) {
                    return b(string);
                }
                EncryptJsonBean encryptJsonBean = (EncryptJsonBean) this.f14417b.fromJson(string, (Class<Object>) EncryptJsonBean.class);
                if (!TextUtils.isEmpty(encryptJsonBean.getData())) {
                    str = i.a(encryptJsonBean.getData(), this.f14422g);
                } else {
                    str = null;
                }
    ...
    public final Object b(String str) {
        if (i.h() && this.f14423h) {
            EncryptJsonBean encryptJsonBean = (EncryptJsonBean) this.f14417b.fromJson(str, (Class<Object>) EncryptJsonBean.class);
            String a10 = i.a(encryptJsonBean.getData(), this.f14422g);
            return this.f14417b.fromJson(str.replace("\"" + encryptJsonBean.getData() + "\"", a10), this.f14419d);
        }
