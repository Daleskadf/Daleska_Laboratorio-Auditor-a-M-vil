...
public interface h0 {
    ...
    public static class a implements h0, Serializable {
        ...
        public a h(f.c cVar) {
            ...
            f.c cVar2 = cVar;
            if (this.f18436c == cVar2) {
                return this;
            }
            return new a(this.f18434a, this.f18435b, cVar2, this.f18437d, this.f18438e);
        }
        ...
        public a n(f.c cVar, f.c cVar2, f.c cVar3, f.c cVar4, f.c cVar5) {
            if (cVar == this.f18434a && cVar2 == this.f18435b && cVar3 == this.f18436c && cVar4 == this.f18437d && cVar5 == this.f18438e) {
                return this;
            }
        ...
        public a a(b3.f fVar) {
            if (fVar != null) {
                return n(m(this.f18434a, fVar.getterVisibility()), m(this.f18435b, fVar.isGetterVisibility()), m(this.f18436c, fVar.setterVisibility()), m(this.f18437d, fVar.creatorVisibility()), m(this.f18438e, fVar.fieldVisibility()));
            }
            return this;
        }
        ...
        public a l(f.c cVar) {
            ...
            f.c cVar2 = cVar;
            if (this.f18437d == cVar2) {
                return this;
            }
            return new a(this.f18434a, this.f18435b, this.f18436c, cVar2, this.f18438e);
        }
        ...
        public a c(f.c cVar) {
            ...
            f.c cVar2 = cVar;
            if (this.f18438e == cVar2) {
                return this;
            }
            return new a(this.f18434a, this.f18435b, this.f18436c, this.f18437d, cVar2);
        }
        ...
        public a b(f.c cVar) {
            ...
            f.c cVar2 = cVar;
            if (this.f18434a == cVar2) {
                return this;
            }
            return new a(cVar2, this.f18435b, this.f18436c, this.f18437d, this.f18438e);
        }
        ...
        public a k(f.c cVar) {
            ...
            f.c cVar2 = cVar;
            if (this.f18435b == cVar2) {
                return this;
            }
            return new a(this.f18434a, cVar2, this.f18436c, this.f18437d, this.f18438e);
        }
