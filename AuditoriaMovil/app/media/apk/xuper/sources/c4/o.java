...
public class o implements Serializable {
        ...
        if (q10 == Object.class) {
            ...
            if (jVar.j().n()) {
                ...
                if (length == 0) {
                    ...
                    i10 = i(null, cls, b(jVar, length, cls, z10));
                }
            }
        } else {
    ...
    public k3.j i(c cVar, Class cls, n nVar) {
        ...
        k3.j jVar2 = (k3.j) this.f5601a.get(obj);
        if (jVar2 != null) {
            return jVar2;
        }
        if (cVar == null) {
        ...
        if (cls.isArray()) {
            jVar = a.b0(g(b10, cls.getComponentType(), nVar), nVar);
        } else {
            if (cls.isInterface()) {
                s10 = s(b10, cls, nVar);
                r10 = null;
            ...
            if (cls == Properties.class) {
                l lVar = f5595t;
                jVar2 = h.d0(cls, nVar, jVar3, jVarArr, lVar, lVar);
            } else if (jVar3 != null) {
                jVar2 = jVar3.P(cls, nVar, jVar3, jVarArr);
            }
            if (jVar2 == null && (jVar2 = l(b10, cls, nVar, jVar3, jVarArr)) == null && (jVar2 = m(b10, cls, nVar, jVar3, jVarArr)) == null) {
        ...
        b10.d(jVar);
        if (!jVar.x()) {
            this.f5601a.putIfAbsent(obj, jVar);
        }
        return jVar;
    }
