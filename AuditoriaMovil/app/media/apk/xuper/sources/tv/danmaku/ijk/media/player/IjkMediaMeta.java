...
public class IjkMediaMeta {
    ...
    public static final String IJKM_KEY_CHANNELS = "channels";
    ...
    public static class IjkStreamMeta {
        ...
        public String getBitrateInline() {
            ...
            if (j10 < 1000) {
                return String.format(Locale.US, "%d bit/s", Long.valueOf(j10));
            }
            return String.format(Locale.US, "%d kb/s", Long.valueOf(j10 / 1000));
        }
        ...
        public String getChannelLayoutInline() {
            ...
            return String.format(Locale.US, "%x", Long.valueOf(j10));
        }
        ...
        public String getResolutionInline() {
            ...
            if (i10 > 0 && this.mHeight > 0) {
                if (this.mSarNum > 0 && this.mSarDen > 0) {
                    return String.format(Locale.US, "%d x %d [SAR %d:%d]", Integer.valueOf(i10), Integer.valueOf(this.mHeight), Integer.valueOf(this.mSarNum), Integer.valueOf(this.mSarDen));
                }
                return String.format(Locale.US, "%d x %d", Integer.valueOf(i10), Integer.valueOf(this.mHeight));
            }
            return "N/A";
        }
        ...
        public String getSampleRateInline() {
            ...
            return String.format(Locale.US, "%d Hz", Integer.valueOf(i10));
        }
