...
public class a extends q {
    ...
    public String u(c3.k kVar, k3.g gVar) {
        if (!kVar.n0()) {
            ...
            k3.j r10 = r();
            c3.n nVar = c3.n.START_ARRAY;
            gVar.F0(r10, nVar, "need JSON Array to contain As.WRAPPER_ARRAY type information for class " + s(), new Object[0]);
            return null;
        }
        c3.n s02 = kVar.s0();
        c3.n nVar2 = c3.n.VALUE_STRING;
        if (s02 == nVar2) {
            String Y = kVar.Y();
            kVar.s0();
            return Y;
        }
        gVar.F0(r(), nVar2, "need JSON String that contains type id (for subtype of %s)", s());
        return null;
    }
