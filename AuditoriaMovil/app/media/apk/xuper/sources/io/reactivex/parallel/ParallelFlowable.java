...
public abstract class ParallelFlowable<T> {
    ...
    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> concatMapDelayError(@NonNull Function<? super T, ? extends b> function, boolean z10) {
    ...
    @CheckReturnValue
    public static <T> ParallelFlowable<T> from(@NonNull b bVar, int i10) {
        return from(bVar, i10, Flowable.bufferSize());
    }

    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> concatMap(@NonNull Function<? super T, ? extends b> function, int i10) {
    ...
    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> concatMapDelayError(@NonNull Function<? super T, ? extends b> function, int i10, boolean z10) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i10, "prefetch");
    ...
    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> flatMap(@NonNull Function<? super T, ? extends b> function, boolean z10) {
        return flatMap(function, z10, Integer.MAX_VALUE, Flowable.bufferSize());
    }
    ...
    @CheckReturnValue
    @NonNull
    public static <T> ParallelFlowable<T> from(@NonNull b bVar, int i10, int i11) {
    ...
    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> flatMap(@NonNull Function<? super T, ? extends b> function, boolean z10, int i10) {
    ...
    @CheckReturnValue
    @NonNull
    public final <R> ParallelFlowable<R> flatMap(@NonNull Function<? super T, ? extends b> function, boolean z10, int i10, int i11) {
        ObjectHelper.requireNonNull(function, "mapper is null");
