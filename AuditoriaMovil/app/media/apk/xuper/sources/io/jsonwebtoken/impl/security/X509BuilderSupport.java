...
public class X509BuilderSupport implements X509Builder<X509BuilderSupport> {
    ...
    public void apply() {
        ...
        List list = (List) this.map.get((Parameter<Object>) AbstractAsymmetricJwk.X5C);
        boolean z10 = false;
        ...
        if (bool == null) {
            if (x509Certificate != null && !this.computeX509Sha1Thumbprint && Objects.isEmpty((byte[]) this.map.get((Parameter<Object>) AbstractAsymmetricJwk.X5T_S256))) {
                z10 = true;
            }
