...
class DefaultEcPublicJwk extends AbstractPublicJwk<ECPublicKey> implements EcPublicJwk {
    ...
    public static boolean equalsPublic(ParameterReadable parameterReadable, Object obj) {
        if (Parameters.equals(parameterReadable, obj, (Parameter) CRV) && Parameters.equals(parameterReadable, obj, (Parameter) X) && Parameters.equals(parameterReadable, obj, (Parameter) Y)) {
            return true;
        }
        return false;
    }
    ...
    public boolean equals(PublicJwk<?> publicJwk) {
        if ((publicJwk instanceof EcPublicJwk) && equalsPublic(this, publicJwk)) {
            return true;
        }
        return false;
    }
