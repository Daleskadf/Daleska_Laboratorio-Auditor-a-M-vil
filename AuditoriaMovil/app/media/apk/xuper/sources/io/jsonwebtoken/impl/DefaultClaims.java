...
public class DefaultClaims extends ParameterMap implements Claims {
    ...
    static {
        ...
        JTI = string3;
        PARAMS = Parameters.registry(string, string2, stringSet, rfcDate, rfcDate2, rfcDate3, string3);
    }
    ...
    public Set<String> getAudience() {
        return (Set) get((Parameter<Object>) AUDIENCE);
    }

    @Override // io.jsonwebtoken.Claims
    public Date getExpiration() {
        return (Date) get((Parameter<Object>) EXPIRATION);
    }

    @Override // io.jsonwebtoken.Claims, io.jsonwebtoken.Identifiable
    public String getId() {
        return (String) get((Parameter<Object>) JTI);
    }

    @Override // io.jsonwebtoken.Claims
    public Date getIssuedAt() {
        return (Date) get((Parameter<Object>) ISSUED_AT);
    }

    @Override // io.jsonwebtoken.Claims
    public String getIssuer() {
        return (String) get((Parameter<Object>) ISSUER);
    }
    ...
    public Date getNotBefore() {
        return (Date) get((Parameter<Object>) NOT_BEFORE);
    }

    @Override // io.jsonwebtoken.Claims
    public String getSubject() {
        return (String) get((Parameter<Object>) SUBJECT);
    }
