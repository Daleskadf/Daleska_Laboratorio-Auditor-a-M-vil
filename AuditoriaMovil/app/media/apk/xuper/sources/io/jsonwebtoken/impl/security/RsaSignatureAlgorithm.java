...
public final class RsaSignatureAlgorithm extends AbstractSignatureAlgorithm {
    ...
    public KeyPairBuilder keyPair() {
        ...
        return new DefaultKeyPairBuilder(str, this.preferredKeyBitLength).random(Randoms.secureRandom());
    }
