...
final class DefaultKeyOperationPolicy implements KeyOperationPolicy {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.allowUnrelated == defaultKeyOperationPolicy.allowUnrelated && Collections.size(this.ops) == Collections.size(defaultKeyOperationPolicy.ops) && this.ops.containsAll(defaultKeyOperationPolicy.ops)) {
            return true;
        }
        return false;
    }
