...
public class DefaultJwkContext<K extends Key> extends AbstractX509Context<JwkContext<K>> implements JwkContext<K> {
    ...
    public String getAlgorithm() {
        return (String) get((Parameter<Object>) AbstractJwk.ALG);
    }

    @Override // io.jsonwebtoken.Identifiable
    public String getId() {
        return (String) get((Parameter<Object>) AbstractJwk.KID);
    }
    ...
    public String getName() {
        StringBuilder sb;
        String str = (String) get((Parameter<Object>) AbstractJwk.KTY);
        if ("oct".equals(str)) {
            str = "Secret";
    ...
    public Set<KeyOperation> getOperations() {
        return (Set) get((Parameter<Object>) AbstractJwk.KEY_OPS);
    }
    ...
    public String getPublicKeyUse() {
        return (String) get((Parameter<Object>) AbstractAsymmetricJwk.USE);
    }
    ...
    public String getType() {
        return (String) get((Parameter<Object>) AbstractJwk.KTY);
    }
    ...
    public JwkContext<K> parameter(Parameter<?> parameter) {
        ...
        K k10 = this.key;
        if (k10 != null) {
            defaultJwkContext = new DefaultJwkContext(linkedHashSet, this, k10);
        } else {
