    ...
    public static class f implements c {
        ...
        public void c(MediaMetadataCompat mediaMetadataCompat) {
            ...
            if (mediaMetadataCompat == null) {
                ...
                a10 = android.support.v4.media.u.a(mediaMetadataCompat.g());
            }
            mediaSession.setMetadata(a10);
        }
    ...
    public static class i implements c {
        ...
        public class c extends b.a {
            ...
            public void A(String str, Bundle bundle, ResultReceiverWrapper resultReceiverWrapper) {
                ...
                if (resultReceiverWrapper == null) {
                    ...
                    resultReceiver = resultReceiverWrapper.f639a;
                }
                        ...
                        case 28:
                            ...
                            if (list != null) {
                                ...
                                if (i10 >= 0 && i10 < list.size()) {
                                    queueItem = (QueueItem) i.this.f686v.get(message.arg1);
                                } else {
                                    queueItem = null;
                                }
                                if (queueItem != null) {
        ...
        */
        public void b(android.support.v4.media.session.MediaSessionCompat.b r5, android.os.Handler r6) {
            /*
                r4 = this;
                java.lang.Object r0 = r4.f675k
                monitor-enter(r0)
                android.support.v4.media.session.MediaSessionCompat$i$d r1 = r4.f677m     // Catch: java.lang.Throwable -> L37
                r2 = 0
                if (r1 == 0) goto Lb
            ...
            L1a:
                r1 = r2
            L1b:
                r4.f677m = r1     // Catch: java.lang.Throwable -> L37
                android.support.v4.media.session.MediaSessionCompat$b r1 = r4.f680p     // Catch: java.lang.Throwable -> L37
                if (r1 == r5) goto L2a
                android.support.v4.media.session.MediaSessionCompat$b r1 = r4.f680p     // Catch: java.lang.Throwable -> L37
                if (r1 == 0) goto L2a
                android.support.v4.media.session.MediaSessionCompat$b r1 = r4.f680p     // Catch: java.lang.Throwable -> L37
            ...
            L2a:
                r4.f680p = r5     // Catch: java.lang.Throwable -> L37
                android.support.v4.media.session.MediaSessionCompat$b r5 = r4.f680p     // Catch: java.lang.Throwable -> L37
                if (r5 == 0) goto L35
                android.support.v4.media.session.MediaSessionCompat$b r5 = r4.f680p     // Catch: java.lang.Throwable -> L37
            ...
            if (playbackStateCompat.f() != -1) {
                if (playbackStateCompat.g() == 3 || playbackStateCompat.g() == 4 || playbackStateCompat.g() == 5) {
                    if (playbackStateCompat.c() > 0) {
                        long elapsedRealtime = SystemClock.elapsedRealtime();
                        long d10 = (playbackStateCompat.d() * ((float) (elapsedRealtime - c10))) + playbackStateCompat.f();
