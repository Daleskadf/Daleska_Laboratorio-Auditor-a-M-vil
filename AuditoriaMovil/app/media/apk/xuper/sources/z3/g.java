...
public class g extends q {
    ...
    public static final BigDecimal f20174d = BigDecimal.valueOf((long) TTL.MAX_VALUE);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && (obj instanceof g) && ((g) obj).f20177a.compareTo(this.f20177a) == 0) {
            return true;
        }
        return false;
    }
    ...
    @Override // z3.q
    public boolean v() {
        if (this.f20177a.compareTo(f20173c) >= 0 && this.f20177a.compareTo(f20174d) <= 0) {
            return true;
        }
        return false;
    }
    ...
    @Override // z3.q
    public boolean w() {
        if (this.f20177a.compareTo(f20175e) >= 0 && this.f20177a.compareTo(f20176f) <= 0) {
            return true;
        }
        return false;
    }
