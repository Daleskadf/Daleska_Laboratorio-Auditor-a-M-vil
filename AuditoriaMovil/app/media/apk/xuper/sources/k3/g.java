...
public abstract class g extends e implements Serializable {
    ...
    public Object W(Class cls, n3.w wVar, c3.k kVar, String str, Object... objArr) {
        ...
        if (d02 == null) {
            if (wVar == null) {
                return p(cls, String.format("Cannot construct instance of %s: %s", d4.h.X(cls), b10));
            }
            if (!wVar.l()) {
                return p(cls, String.format("Cannot construct instance of %s (no Creators, like default constructor, exist): %s", d4.h.X(cls), b10));
            }
            return w0(cls, String.format("Cannot construct instance of %s (although at least one Creator exists): %s", d4.h.X(cls), b10), new Object[0]);
        }
        androidx.appcompat.app.m.a(d02.c());
        throw null;
    }
        ...
        if (d02 == null) {
            if (b10 == null) {
                ...
                if (nVar == null) {
                    ...
                    b10 = String.format("Cannot deserialize value of type %s from %s (token `JsonToken.%s`)", G, t(nVar), nVar);
                }
            }
            if (nVar != null && nVar.e()) {
                kVar.Y();
    ...
    public boolean e0(c3.k kVar, k kVar2, Object obj, String str) {
        ...
        if (d02 == null) {
            ...
            throw p3.h.v(this.f14885g, obj, str, collection);
        }
        androidx.appcompat.app.m.a(d02.c());
        throw null;
    }
