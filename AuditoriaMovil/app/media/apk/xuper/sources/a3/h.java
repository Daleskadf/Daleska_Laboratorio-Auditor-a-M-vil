...
public class h extends SSLSocketFactory {
    ...
    static {
        ...
        try {
            ...
            if (sSLSocket != null) {
                ...
                f167b = (String[]) linkedList.toArray(new String[linkedList.size()]);
                if (Build.VERSION.SDK_INT < 21) {
                    ...
                    f168c = (String[]) hashSet.toArray(new String[hashSet.size()]);
                }
            }
    ...
    public h(X509TrustManager x509TrustManager) {
        try {
            ...
            this.f169a = sSLContext.getSocketFactory();
    ...
    public final void a(SSLSocket sSLSocket) {
        String[] strArr;
        String[] strArr2 = f167b;
        if (strArr2 != null) {
            sSLSocket.setEnabledProtocols(strArr2);
        }
        if (Build.VERSION.SDK_INT < 21 && (strArr = f168c) != null) {
    ...
    public Socket createSocket(Socket socket, String str, int i10, boolean z10) {
        Socket createSocket = this.f169a.createSocket(socket, str, i10, z10);
    ...
    public Socket createSocket(String str, int i10) {
        Socket createSocket = this.f169a.createSocket(str, i10);
        if (createSocket instanceof SSLSocket) {
            a((SSLSocket) createSocket);
        }
        return createSocket;
    ...
    public Socket createSocket(String str, int i10, InetAddress inetAddress, int i11) {
        Socket createSocket = this.f169a.createSocket(str, i10, inetAddress, i11);
        if (createSocket instanceof SSLSocket) {
            a((SSLSocket) createSocket);
        }
        return createSocket;
    ...
    public Socket createSocket(InetAddress inetAddress, int i10) {
        Socket createSocket = this.f169a.createSocket(inetAddress, i10);
        if (createSocket instanceof SSLSocket) {
            a((SSLSocket) createSocket);
        }
        return createSocket;
    ...
    public Socket createSocket(InetAddress inetAddress, int i10, InetAddress inetAddress2, int i11) {
        Socket createSocket = this.f169a.createSocket(inetAddress, i10, inetAddress2, i11);
        if (createSocket instanceof SSLSocket) {
            a((SSLSocket) createSocket);
        }
        return createSocket;
