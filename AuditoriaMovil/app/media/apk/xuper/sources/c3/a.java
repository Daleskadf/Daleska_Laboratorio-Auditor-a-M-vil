...
public final class a implements Serializable {
    ...
    public boolean d() {
        if (this.f5393h != EnumC0080a.PADDING_FORBIDDEN) {
            return true;
        }
        return false;
    }
    ...
    public boolean equals(Object obj) {
        ...
        a aVar = (a) obj;
        if (aVar.f5390e == this.f5390e && aVar.f5391f == this.f5391f && aVar.f5392g == this.f5392g && aVar.f5393h == this.f5393h && this.f5389d.equals(aVar.f5389d)) {
            return true;
        }
        return false;
    }
    ...
    public int m(int i10, int i11, byte[] bArr, int i12) {
        ...
        if (v()) {
            byte b11 = (byte) this.f5390e;
            int i15 = i14 + 1;
            if (i11 == 2) {
                b10 = this.f5388c[(i10 >> 6) & 63];
            } else {
                b10 = b11;
            }
            bArr[i14] = b10;
    ...
    public boolean t() {
        if (this.f5393h == EnumC0080a.PADDING_REQUIRED) {
            return true;
        }
        return false;
    }
