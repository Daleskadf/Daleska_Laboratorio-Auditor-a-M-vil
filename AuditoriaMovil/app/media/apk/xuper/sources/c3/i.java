...
public class i implements Serializable {
    ...
    */
    ...
    public boolean equals(Object obj) {
        ...
        if (this.f5452c == iVar.f5452c && this.f5453d == iVar.f5453d && this.f5451b == iVar.f5451b && c() == iVar.c()) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return (((hashCode ^ this.f5452c) + this.f5453d) ^ ((int) this.f5451b)) + ((int) this.f5450a);
    }
