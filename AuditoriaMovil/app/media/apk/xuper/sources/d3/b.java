...
public abstract class b extends c {
    ...
    public String E() {
        g3.c e10;
        n nVar = this.f12503c;
        if ((nVar == n.START_OBJECT || nVar == n.START_ARRAY) && (e10 = this.f12491y.e()) != null) {
            return e10.b();
        }
    ...
    public void H0() {
        ...
        if (!this.f12491y.h()) {
            ...
            Q0(String.format(": expected close marker for %s (start marker at %s)", str, this.f12491y.s(o1())), null);
        }
    }
