...
public class f extends b {
    ...
    public c J(c0 c0Var, r3.s sVar, l lVar, boolean z10, r3.i iVar) {
        ...
        k3.o h02 = c0Var.h0(F, aVar);
        if (!f10.D() && !f10.b()) {
            V = null;
        } else {
            V = V(f10, c0Var.k(), iVar);
        }
        return lVar.c(c0Var, sVar, f10, h02, W(f10, c0Var.k(), iVar), V, iVar, z10);
    }
    ...
    public k3.o M(c0 c0Var, k3.j jVar, k3.c cVar, boolean z10) {
        ...
        if (U == null) {
            ...
            a02 = a0(c0Var, cVar, N, U);
        }
        c0Var.W().d(k10, cVar.u(), a02);
        if (this.f180a.b()) {
        ...
        List R = R(k10, cVar, S(k10, cVar, a02));
        if (this.f180a.b()) {
            Iterator it2 = this.f180a.d().iterator();
            if (it2.hasNext()) {
                androidx.appcompat.app.m.a(it2.next());
