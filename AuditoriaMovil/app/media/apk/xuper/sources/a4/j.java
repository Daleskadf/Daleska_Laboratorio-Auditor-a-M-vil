...
public abstract class j extends c0 implements Serializable {
    ...
    public void E0(c3.h hVar, Object obj, k3.j jVar, k3.o oVar) {
        ...
        if (S == null) {
            if (this.f14850a.c0(b0.WRAP_ROOT_VALUE)) {
                if (jVar == null) {
                    J = this.f14850a.I(obj.getClass());
                } else {
                    J = this.f14850a.J(jVar);
                }
                x0(hVar, obj, oVar, J);
                return;
            }
    ...
    public k3.o t0(r3.b bVar, Object obj) {
        ...
        if (obj instanceof k3.o) {
            ...
            if (!(obj instanceof Class)) {
                k3.j f10 = bVar.f();
                q(f10, "AnnotationIntrospector returned serializer definition of type " + obj.getClass().getName() + "; expected type JsonSerializer or Class<JsonSerializer> instead");
            }
            Class cls = (Class) obj;
            ...
            if (!k3.o.class.isAssignableFrom(cls)) {
                k3.j f11 = bVar.f();
                q(f11, "AnnotationIntrospector returned Class " + cls.getName() + "; expected Class<JsonSerializer>");
            }
            this.f14850a.u();
