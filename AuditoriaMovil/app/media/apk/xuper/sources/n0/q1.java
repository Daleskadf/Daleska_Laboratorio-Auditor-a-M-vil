...
public final class q1 extends p0 implements ServiceConnection {
            ...
            switch (i10) {
                ...
                case 4:
                    if (obj == null || (obj instanceof Bundle)) {
                        ...
                        return aVar.f(i11, string, (Bundle) obj);
                    }
                    return false;
                case 5:
                    if (obj == null || (obj instanceof Bundle)) {
    ...
    public boolean G(String str, String str2) {
        if (this.f16965i.getPackageName().equals(str) && this.f16965i.getClassName().equals(str2)) {
            return true;
        }
        return false;
    }
    ...
    public final boolean Q() {
        if (this.f16968l) {
            if (p() != null || !this.f16967k.isEmpty()) {
                return true;
            }
            return false;
        }
