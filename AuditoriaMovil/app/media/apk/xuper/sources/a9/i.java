...
public class i implements v, b.a, q.d {
        ...
        public void run() {
            ...
            try {
                try {
                    ...
                    this.f424b.v(Okio.sink(sSLSocket), sSLSocket);
                    i iVar4 = i.this;
                    a.b d10 = iVar4.f415u.d().d(a0.f19776a, sSLSocket.getRemoteSocketAddress()).d(a0.f19777b, sSLSocket.getLocalSocketAddress()).d(a0.f19778c, sSLSession);
                    a.c cVar = p0.f20821a;
                    if (sSLSession == null) {
                        e1Var = e1.NONE;
                    } else {
                    ...
                    iVar4.f415u = d10.d(cVar, e1Var).a();
                    i iVar5 = i.this;
                    iVar5.f414t = new e(iVar5.f401g.a(buffer2, true));
                    synchronized (i.this.f405k) {
                        i.this.D = (Socket) Preconditions.checkNotNull(sSLSocket, "socket");
                        if (sSLSession != null) {
                    ...
                    iVar = i.this;
                    eVar = new e(iVar.f401g.a(buffer, true));
                    iVar.f414t = eVar;
                } catch (Exception e11) {
                    i.this.h(e11);
                    iVar = i.this;
                ...
                i iVar6 = i.this;
                iVar6.f414t = new e(iVar6.f401g.a(buffer, true));
                throw th;
            }
        }
    }
    ...
    public class e implements b.a, Runnable {
        ...
        public final int a(List list) {
            ...
            return (int) Math.min(j10, (long) TTL.MAX_VALUE);
        }
        ...
        public void d(int i10, c9.a aVar) {
            ...
            synchronized (i.this.f405k) {
                ...
                if (hVar != null) {
                    ...
                    iVar.U(i10, f10, aVar2, z10, null, null);
                }
            }
        }
        ...
        */
        public void windowUpdate(int r8, long r9) {
            ...
            L42:
                ...
                a9.h$b r1 = r1.y()     // Catch: java.lang.Throwable -> L8e
    ...
    public static k1 p0(c9.a aVar) {
        ...
        if (k1Var == null) {
            k1 k1Var2 = k1.f19891h;
            return k1Var2.r("Unknown http2 error code: " + aVar.f5663a);
        }
        return k1Var;
    }
    ...
    public final d9.b R(InetSocketAddress inetSocketAddress, String str, String str2) {
        ...
        b.C0210b d10 = e10.d("Host", a10.c() + SOAP.DELIM + a10.f()).d("User-Agent", this.f397c);
    ...
    public q.c[] a() {
        ...
        synchronized (this.f405k) {
            ...
            int i10 = 0;
            for (h hVar : this.f408n.values()) {
                cVarArr[i10] = hVar.y().b0();
                i10++;
            }
        }
        return cVarArr;
    ...
    public final void i0() {
        synchronized (this.f405k) {
            ...
            int i10 = this.f400f;
            if (i10 > 65535) {
                this.f403i.windowUpdate(0, i10 - Message.MAXLENGTH);
            }
        }
    }
    ...
    public void o0(h hVar) {
        if (this.f416v != null) {
            hVar.y().M(this.f416v, r.a.MISCARRIED, true, new y8.v0());
