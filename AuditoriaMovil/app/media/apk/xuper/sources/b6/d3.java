...
public final class d3 extends e<l6.m1> implements j6.i {
    ...
    public static final void H3(d3 d3Var, View view) {
        ...
        com.mobile.brasiltv.utils.b0.k0(d3Var, com.mobile.brasiltv.utils.b0.x(m7.c.g()) + "/#/app-help?isFree=" + b10 + "&appId=" + na.a.g() + "&userId=" + cVar.H() + "&lang=" + com.mobile.brasiltv.utils.f0.a() + "&appVersion=" + na.a.b() + "&timestamp=" + new Date().getTime() + "&portalCode=" + cVar.v(), false, true, false, 8, null);
    }
    ...
    public static final void K3(d3 d3Var) {
        ...
        new BaseGuideManager(d3Var.getContext(), (ImageView) d3Var.t3(R$id.mIvAdultContent), "keyFirstMineOnCharge", string, GuideDialog.Direction.TOP_RIGHT, null, false, false, null, 480, null).showGuide();
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:20:0x00b3, code lost:
        if (r1.equals(com.titans.entity.CdnType.DIGITAL_TYPE_PCDN) == false) goto L40;
     */
