...
public class b extends Dialog implements h7.c {
    ...
    /* loaded from: classes3.dex */
    public class View$OnClickListenerC0232b implements View.OnClickListener {
        public View$OnClickListenerC0232b() {
        }
    ...
    public final void k() {
        ...
        if (!this.f14338b.h().isEmpty()) {
            textView2.setText(getContext().getString(R$string.upgrade_progress_contract_email, this.f14338b.h()));
        }
    ...
    public final void m() {
        ...
        textView.setOnClickListener(new View$OnClickListenerC0232b());
