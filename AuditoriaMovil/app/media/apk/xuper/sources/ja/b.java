...
public final class b implements Dns {
    ...
    public final boolean e(String str) {
        if (!TextUtils.isDigitsOnly(s.j(s.j(str, ".", "", false, 4, null), SOAP.DELIM, "", false, 4, null))) {
            return false;
        }
        return true;
    }
    ...
    public final void l(String str, String str2, String str3, String str4, String str5) {
        if (ba.t.o(str5, ".bigbee", false, 2, null)) {
        ...
        } else if (ba.t.o(str5, ".img", false, 2, null)) {
            ...
            if (!set.contains(str6)) {
                ...
                e.b(e.f5339a, "app_dns", hashMap, SystemClock.elapsedRealtime(), 0L, false, false, 56, null);
            }
        } else {
            ...
            e.b(e.f5339a, "app_dns", hashMap2, SystemClock.elapsedRealtime(), 0L, false, false, 56, null);
        }
    }
