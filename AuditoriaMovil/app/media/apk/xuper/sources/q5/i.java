...
public final class i {
    ...
    public final Notification h(a aVar) {
        ...
        if (!TextUtils.isEmpty(aVar.d())) {
            ...
            if (i10 >= 26) {
                z10 = new s.e(f10, aVar.d());
            } else {
                z10 = new s.e(f10).z(1);
            }
            s.e y10 = z10.m(-1).A(aVar.l()).H(System.currentTimeMillis()).k(aVar.c()).j(aVar.b()).y(aVar.j());
    ...
    public final void l(Context context) {
        ...
        try {
            ...
            if (e10 instanceof ActivityNotFoundException) {
                ...
                intent2.setData(Uri.fromParts(Constants.KEY_PACKAGE, str, null));
                if (context != null) {
