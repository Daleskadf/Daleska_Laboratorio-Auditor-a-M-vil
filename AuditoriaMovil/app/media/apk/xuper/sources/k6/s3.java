    ...
    public static final class f extends ha.a {
        ...
        public void onNext(List list) {
            ...
            if (!list.isEmpty()) {
                ...
                s3 s3Var = s3.this;
                int i11 = s3Var.f15528l;
                if (list.size() % s3.this.f15527k == 0) {
                    i10 = 0;
                } else {
                    i10 = 1;
                }
                s3Var.f15528l = i11 + i10;
        ...
        if (t9.i.b(str, this.f15518b.X())) {
            if (searchByNameResult.getData() != null) {
                ...
                if (com.mobile.brasiltv.utils.b0.I(data.getSearchItemList())) {
                    ...
                    t9.i.d(data5);
                    for (SearchItem searchItem : data5.getSearchItemList()) {
                        List<SearchShelveItem> itemList = searchItem.getItemList();
                        t9.i.d(itemList);
                        for (SearchShelveItem searchShelveItem : itemList) {
                            arrayList.add(searchShelveItem);
                        }
                    }
