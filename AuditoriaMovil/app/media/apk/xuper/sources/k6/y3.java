...
public final class y3 implements l5.a {
    ...
    @Override // l5.a
    public void e() {
        i6.v0 v0Var = this.f15669b;
        v0Var.J('V' + com.mobile.brasiltv.utils.e.b(this.f15668a));
        xa.c.c().o(this);
    }
    ...
    public void h() {
        String string;
        if (q5.i.f18197a.j(this.f15668a)) {
            string = this.f15668a.getString(R.string.msg_notify_on);
        } else {
            string = this.f15668a.getString(R.string.msg_notify_off);
        }
