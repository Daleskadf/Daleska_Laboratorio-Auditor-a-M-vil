...
public final class j0 implements i6.s {
    ...
    public static final class a extends ha.a {
        ...
        public void onNext(AreaCodeResult areaCodeResult) {
            ...
            String str = (data == null || (str = data.getAreaCode()) == null) ? "" : "";
            i6.t H = j0.this.H();
    ...
    public static final class e extends ha.a {
        ...
        public void onNext(LoginResult loginResult) {
            ...
            if (com.mobile.brasiltv.utils.b0.I(list)) {
                ...
                t9.i.d(data3);
                d6.b.G(bVar, D, data3, this.f15325c, this.f15326d, null, null, null, false, 240, null);
                String str3 = "";
    ...
    public static final class f extends ha.a {
        ...
        public void onNext(LoginResult loginResult) {
            ...
            for (SwitchAccountBean switchAccountBean : j0.this.G()) {
            ...
            if (com.mobile.brasiltv.utils.b0.I(list)) {
                ...
                UserData data3 = loginResult.getData();
                t9.i.d(data3);
                d6.b.G(bVar, D, data3, (String) this.f15335d.f18961a, this.f15336e, null, null, null, false, 240, null);
    ...
    public static final class g extends ha.a {
        ...
        public void onNext(LoginResult loginResult) {
            ...
            if (com.mobile.brasiltv.utils.b0.I(list)) {
                ...
                UserData data3 = loginResult.getData();
                t9.i.d(data3);
                d6.b.G(bVar, D, data3, "", "", this.f15340c, this.f15342e.a(), null, false, 192, null);
                String str4 = "";
                if (!TextUtils.isEmpty(this.f15340c)) {
                    ...
                    if (t9.i.b(str, "yes")) {
                        ...
                        if (t9.i.b(str3, "1")) {
                            ...
                            String str5 = this.f15340c;
                            x7.a aVar = this.f15342e;
                            String str6 = this.f15339b;
                            String str7 = this.f15341d;
                            String str8 = (String) this.f15343f.f18961a;
                            if (str8 == null) {
                                str2 = "";
                            } else {
                                str2 = str8;
                            }
                            eVar.o(cVar, str5, aVar, str6, str7, str2);
                            return;
                        }
                    }
                }
                ...
                UserData data6 = loginResult.getData();
                switchAccountBean.setUserName((data6 == null || (r2 = data6.getGoogleEmail()) == null) ? "" : "");
                UserData data7 = loginResult.getData();
                switchAccountBean.setEmail((data7 == null || (r2 = data7.getEmail()) == null) ? "" : "");
                UserData data8 = loginResult.getData();
                switchAccountBean.setPhone((data8 == null || (r2 = data8.getMobile()) == null) ? "" : "");
                UserData data9 = loginResult.getData();
                switchAccountBean.setUserId((data9 == null || (r2 = data9.getUserId()) == null) ? "" : "");
                UserData data10 = loginResult.getData();
                switchAccountBean.setNickName((data10 == null || (r2 = data10.getGoogleNickName()) == null) ? "" : "");
    ...
    public static final class h extends ha.a {
        ...
        public void onNext(LoginResult loginResult) {
            ...
            if (com.mobile.brasiltv.utils.b0.I(list)) {
                ...
                UserData data3 = loginResult.getData();
                t9.i.d(data3);
                d6.b.G(bVar, D, data3, "", "", this.f15349c, this.f15350d, null, false, 192, null);
                ...
                SwitchAccountBean switchAccountBean3 = this.f15348b;
                UserData data7 = loginResult.getData();
    ...
    public void C(String str, String str2, String str3) {
        ...
        } else if (!com.mobile.brasiltv.utils.z0.a(str, str2)) {
    ...
    public void M(String str, String str2, String str3, String str4, String str5, boolean z10) {
        ...
        z();
        w6.i.X1(w6.i.f19214g.b(), str3, str4, str, str2, str5, null, null, 64, null).compose(this.f15307a.O1()).subscribe(new e(str3, str, str2, str4, str5, z10));
    }
    ...
    public void R(String str, String str2, String str3, String str4, boolean z10) {
        ...
        } else if (com.mobile.brasiltv.utils.b0.J(str2)) {
            this.f15308b.n(R.string.wrong_pohone_number_or_pwd);
        } else if (!com.mobile.brasiltv.utils.z0.a(str, str3)) {
            this.f15308b.d(R.string.invalid_phone_number);
        } else {
            this.f15308b.hideErrorHint(0L);
    ...
    public void v(String str, String str2, boolean z10) {
        ...
        } else if (!com.mobile.brasiltv.utils.j1.f(str2)) {
            this.f15308b.n(R.string.password_format_incorrect);
        } else {
            if (com.mobile.brasiltv.utils.j1.e(str)) {
                str3 = "1";
            } else if (ba.t.o(str, "@", false, 2, null)) {
                str3 = "2";
            } else {
