...
public final class g1 implements i6.y {
    ...
    public void d(boolean z10) {
        ...
        if (z11 && (disposable2 = this.f15179c) != null) {
            disposable2.dispose();
        }
        Disposable disposable4 = this.f15180d;
        if (((disposable4 == null || disposable4.isDisposed()) ? false : false) && (disposable = this.f15180d) != null) {
            disposable.dispose();
        }
        if (z10) {
            str = "1";
        ...
        Observable compose = w6.i.f19214g.b().u1("vod", str).compose(this.f15177a.O1());
