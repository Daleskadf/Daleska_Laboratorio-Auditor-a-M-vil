...
public final class c extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (i.b(action, "android.intent.action.CLOSE_SYSTEM_DIALOGS")) {
            ...
            boolean z10 = true;
            if (i.b(stringExtra, this.f18910c)) {
                b10 = true;
            } else {
                b10 = i.b(stringExtra, this.f18909b);
            }
            if (b10) {
                b11 = true;
            } else {
                b11 = i.b(stringExtra, this.f18911d);
            }
            if (b11) {
                b12 = true;
            } else {
                b12 = i.b(stringExtra, this.f18912e);
            }
            if (!b12) {
                z10 = i.b(stringExtra, this.f18913f);
            }
            if (z10) {
